module @m {
  func.func @cifar_bn_train_step(%x: tensor<128x3072xf32>, %W1: tensor<32x3x3x3xf32>, %b1: tensor<32xf32>, %g1: tensor<f32>, %bt1: tensor<f32>, %W2: tensor<32x32x3x3xf32>, %b2: tensor<32xf32>, %g2: tensor<f32>, %bt2: tensor<f32>, %W3: tensor<64x32x3x3xf32>, %b3: tensor<64xf32>, %g3: tensor<f32>, %bt3: tensor<f32>, %W4: tensor<64x64x3x3xf32>, %b4: tensor<64xf32>, %g4: tensor<f32>, %bt4: tensor<f32>, %W5: tensor<4096x512xf32>, %b5: tensor<512xf32>, %W6: tensor<512x512xf32>, %b6: tensor<512xf32>, %W7: tensor<512x10xf32>, %b7: tensor<10xf32>, %onehot: tensor<128x10xf32>) -> (tensor<32x3x3x3xf32>, tensor<32xf32>, tensor<f32>, tensor<f32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<f32>, tensor<f32>, tensor<64x32x3x3xf32>, tensor<64xf32>, tensor<f32>, tensor<f32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<f32>, tensor<f32>, tensor<4096x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>) {
    ...
    %bn1_nf = stablehlo.constant dense<32768.0> : tensor<128x32768xf32>
    %bn1_ep = stablehlo.constant dense<1.0e-05> : tensor<128x32768xf32>
    %bn1_smr = stablehlo.reduce(%hc1f init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<128xf32>
    %bn1_sm = stablehlo.broadcast_in_dim %bn1_smr, dims = [0] : (tensor<128xf32>) -> tensor<128x32768xf32>
    %bn1_mu = stablehlo.divide %bn1_sm, %bn1_nf : tensor<128x32768xf32>
    %bn1_xc = stablehlo.subtract %hc1f, %bn1_mu : tensor<128x32768xf32>
    %bn1_sq = stablehlo.multiply %bn1_xc, %bn1_xc : tensor<128x32768xf32>
    %bn1_vsr = stablehlo.reduce(%bn1_sq init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<128xf32>
    %bn1_vs = stablehlo.broadcast_in_dim %bn1_vsr, dims = [0] : (tensor<128xf32>) -> tensor<128x32768xf32>
    %bn1_var = stablehlo.divide %bn1_vs, %bn1_nf : tensor<128x32768xf32>
    %bn1_ve = stablehlo.add %bn1_var, %bn1_ep : tensor<128x32768xf32>
    %bn1_istd = stablehlo.rsqrt %bn1_ve : tensor<128x32768xf32>
    %bn1_xhat = stablehlo.multiply %bn1_xc, %bn1_istd : tensor<128x32768xf32>
    %bn1_gb = stablehlo.broadcast_in_dim %g1, dims = [] : (tensor<f32>) -> tensor<128x32768xf32>
    %bn1_bb = stablehlo.broadcast_in_dim %bt1, dims = [] : (tensor<f32>) -> tensor<128x32768xf32>
    %bn1_gx = stablehlo.multiply %bn1_xhat, %bn1_gb : tensor<128x32768xf32>
    %bn1 = stablehlo.add %bn1_gx, %bn1_bb : tensor<128x32768xf32>
    ...
    %bn2_nf = stablehlo.constant dense<32768.0> : tensor<128x32768xf32>
    %bn2_ep = stablehlo.constant dense<1.0e-05> : tensor<128x32768xf32>
    %bn2_smr = stablehlo.reduce(%hc2f init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<128xf32>
    %bn2_sm = stablehlo.broadcast_in_dim %bn2_smr, dims = [0] : (tensor<128xf32>) -> tensor<128x32768xf32>
    %bn2_mu = stablehlo.divide %bn2_sm, %bn2_nf : tensor<128x32768xf32>
    %bn2_xc = stablehlo.subtract %hc2f, %bn2_mu : tensor<128x32768xf32>
    %bn2_sq = stablehlo.multiply %bn2_xc, %bn2_xc : tensor<128x32768xf32>
    %bn2_vsr = stablehlo.reduce(%bn2_sq init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<128xf32>
    %bn2_vs = stablehlo.broadcast_in_dim %bn2_vsr, dims = [0] : (tensor<128xf32>) -> tensor<128x32768xf32>
    %bn2_var = stablehlo.divide %bn2_vs, %bn2_nf : tensor<128x32768xf32>
    %bn2_ve = stablehlo.add %bn2_var, %bn2_ep : tensor<128x32768xf32>
    %bn2_istd = stablehlo.rsqrt %bn2_ve : tensor<128x32768xf32>
    %bn2_xhat = stablehlo.multiply %bn2_xc, %bn2_istd : tensor<128x32768xf32>
    %bn2_gb = stablehlo.broadcast_in_dim %g2, dims = [] : (tensor<f32>) -> tensor<128x32768xf32>
    %bn2_bb = stablehlo.broadcast_in_dim %bt2, dims = [] : (tensor<f32>) -> tensor<128x32768xf32>
    %bn2_gx = stablehlo.multiply %bn2_xhat, %bn2_gb : tensor<128x32768xf32>
    %bn2 = stablehlo.add %bn2_gx, %bn2_bb : tensor<128x32768xf32>
    ...
    %bn3_nf = stablehlo.constant dense<16384.0> : tensor<128x16384xf32>
    %bn3_ep = stablehlo.constant dense<1.0e-05> : tensor<128x16384xf32>
    %bn3_smr = stablehlo.reduce(%hc3f init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<128xf32>
    %bn3_sm = stablehlo.broadcast_in_dim %bn3_smr, dims = [0] : (tensor<128xf32>) -> tensor<128x16384xf32>
    %bn3_mu = stablehlo.divide %bn3_sm, %bn3_nf : tensor<128x16384xf32>
    %bn3_xc = stablehlo.subtract %hc3f, %bn3_mu : tensor<128x16384xf32>
    %bn3_sq = stablehlo.multiply %bn3_xc, %bn3_xc : tensor<128x16384xf32>
    %bn3_vsr = stablehlo.reduce(%bn3_sq init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<128xf32>
    %bn3_vs = stablehlo.broadcast_in_dim %bn3_vsr, dims = [0] : (tensor<128xf32>) -> tensor<128x16384xf32>
    %bn3_var = stablehlo.divide %bn3_vs, %bn3_nf : tensor<128x16384xf32>
    %bn3_ve = stablehlo.add %bn3_var, %bn3_ep : tensor<128x16384xf32>
    %bn3_istd = stablehlo.rsqrt %bn3_ve : tensor<128x16384xf32>
    %bn3_xhat = stablehlo.multiply %bn3_xc, %bn3_istd : tensor<128x16384xf32>
    %bn3_gb = stablehlo.broadcast_in_dim %g3, dims = [] : (tensor<f32>) -> tensor<128x16384xf32>
    %bn3_bb = stablehlo.broadcast_in_dim %bt3, dims = [] : (tensor<f32>) -> tensor<128x16384xf32>
    %bn3_gx = stablehlo.multiply %bn3_xhat, %bn3_gb : tensor<128x16384xf32>
    %bn3 = stablehlo.add %bn3_gx, %bn3_bb : tensor<128x16384xf32>
    ...
    %bn4_nf = stablehlo.constant dense<16384.0> : tensor<128x16384xf32>
    %bn4_ep = stablehlo.constant dense<1.0e-05> : tensor<128x16384xf32>
    %bn4_smr = stablehlo.reduce(%hc4f init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<128xf32>
    %bn4_sm = stablehlo.broadcast_in_dim %bn4_smr, dims = [0] : (tensor<128xf32>) -> tensor<128x16384xf32>
    %bn4_mu = stablehlo.divide %bn4_sm, %bn4_nf : tensor<128x16384xf32>
    %bn4_xc = stablehlo.subtract %hc4f, %bn4_mu : tensor<128x16384xf32>
    %bn4_sq = stablehlo.multiply %bn4_xc, %bn4_xc : tensor<128x16384xf32>
    %bn4_vsr = stablehlo.reduce(%bn4_sq init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<128xf32>
    %bn4_vs = stablehlo.broadcast_in_dim %bn4_vsr, dims = [0] : (tensor<128xf32>) -> tensor<128x16384xf32>
    %bn4_var = stablehlo.divide %bn4_vs, %bn4_nf : tensor<128x16384xf32>
    %bn4_ve = stablehlo.add %bn4_var, %bn4_ep : tensor<128x16384xf32>
    %bn4_istd = stablehlo.rsqrt %bn4_ve : tensor<128x16384xf32>
    %bn4_xhat = stablehlo.multiply %bn4_xc, %bn4_istd : tensor<128x16384xf32>
    %bn4_gb = stablehlo.broadcast_in_dim %g4, dims = [] : (tensor<f32>) -> tensor<128x16384xf32>
    %bn4_bb = stablehlo.broadcast_in_dim %bt4, dims = [] : (tensor<f32>) -> tensor<128x16384xf32>
    %bn4_gx = stablehlo.multiply %bn4_xhat, %bn4_gb : tensor<128x16384xf32>
    %bn4 = stablehlo.add %bn4_gx, %bn4_bb : tensor<128x16384xf32>
    ...
    %dhc4f_gb = stablehlo.broadcast_in_dim %g4, dims = [] : (tensor<f32>) -> tensor<128x16384xf32>
    %dhc4f_dxh = stablehlo.multiply %dhc4f_gb, %dbn4 : tensor<128x16384xf32>
    %dhc4f_sdxr = stablehlo.reduce(%dhc4f_dxh init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<128xf32>
    %dhc4f_sdx = stablehlo.broadcast_in_dim %dhc4f_sdxr, dims = [0] : (tensor<128xf32>) -> tensor<128x16384xf32>
    %dhc4f_xd = stablehlo.multiply %bn4_xhat, %dhc4f_dxh : tensor<128x16384xf32>
    %dhc4f_sxdr = stablehlo.reduce(%dhc4f_xd init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<128xf32>
    %dhc4f_sxd = stablehlo.broadcast_in_dim %dhc4f_sxdr, dims = [0] : (tensor<128xf32>) -> tensor<128x16384xf32>
    %dhc4f_t1 = stablehlo.multiply %dhc4f_dxh, %bn4_nf : tensor<128x16384xf32>
    %dhc4f_i1 = stablehlo.subtract %dhc4f_t1, %dhc4f_sdx : tensor<128x16384xf32>
    %dhc4f_xs = stablehlo.multiply %bn4_xhat, %dhc4f_sxd : tensor<128x16384xf32>
    %dhc4f_i2 = stablehlo.subtract %dhc4f_i1, %dhc4f_xs : tensor<128x16384xf32>
    %dhc4f_s = stablehlo.divide %bn4_istd, %bn4_nf : tensor<128x16384xf32>
    %dhc4f = stablehlo.multiply %dhc4f_s, %dhc4f_i2 : tensor<128x16384xf32>
    %dg4_p = stablehlo.multiply %dbn4, %bn4_xhat : tensor<128x16384xf32>
    %dg4 = stablehlo.reduce(%dg4_p init: %sc) applies stablehlo.add across dimensions = [0, 1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<f32>
    %dbt4 = stablehlo.reduce(%dbn4 init: %sc) applies stablehlo.add across dimensions = [0, 1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<f32>
    ...
    %dhc3f_gb = stablehlo.broadcast_in_dim %g3, dims = [] : (tensor<f32>) -> tensor<128x16384xf32>
    %dhc3f_dxh = stablehlo.multiply %dhc3f_gb, %dbn3 : tensor<128x16384xf32>
    %dhc3f_sdxr = stablehlo.reduce(%dhc3f_dxh init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<128xf32>
    %dhc3f_sdx = stablehlo.broadcast_in_dim %dhc3f_sdxr, dims = [0] : (tensor<128xf32>) -> tensor<128x16384xf32>
    %dhc3f_xd = stablehlo.multiply %bn3_xhat, %dhc3f_dxh : tensor<128x16384xf32>
    %dhc3f_sxdr = stablehlo.reduce(%dhc3f_xd init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<128xf32>
    %dhc3f_sxd = stablehlo.broadcast_in_dim %dhc3f_sxdr, dims = [0] : (tensor<128xf32>) -> tensor<128x16384xf32>
    %dhc3f_t1 = stablehlo.multiply %dhc3f_dxh, %bn3_nf : tensor<128x16384xf32>
    %dhc3f_i1 = stablehlo.subtract %dhc3f_t1, %dhc3f_sdx : tensor<128x16384xf32>
    %dhc3f_xs = stablehlo.multiply %bn3_xhat, %dhc3f_sxd : tensor<128x16384xf32>
    %dhc3f_i2 = stablehlo.subtract %dhc3f_i1, %dhc3f_xs : tensor<128x16384xf32>
    %dhc3f_s = stablehlo.divide %bn3_istd, %bn3_nf : tensor<128x16384xf32>
    %dhc3f = stablehlo.multiply %dhc3f_s, %dhc3f_i2 : tensor<128x16384xf32>
    %dg3_p = stablehlo.multiply %dbn3, %bn3_xhat : tensor<128x16384xf32>
    %dg3 = stablehlo.reduce(%dg3_p init: %sc) applies stablehlo.add across dimensions = [0, 1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<f32>
    %dbt3 = stablehlo.reduce(%dbn3 init: %sc) applies stablehlo.add across dimensions = [0, 1] : (tensor<128x16384xf32>, tensor<f32>) -> tensor<f32>
    ...
    %dhc2f_gb = stablehlo.broadcast_in_dim %g2, dims = [] : (tensor<f32>) -> tensor<128x32768xf32>
    %dhc2f_dxh = stablehlo.multiply %dhc2f_gb, %dbn2 : tensor<128x32768xf32>
    %dhc2f_sdxr = stablehlo.reduce(%dhc2f_dxh init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<128xf32>
    %dhc2f_sdx = stablehlo.broadcast_in_dim %dhc2f_sdxr, dims = [0] : (tensor<128xf32>) -> tensor<128x32768xf32>
    %dhc2f_xd = stablehlo.multiply %bn2_xhat, %dhc2f_dxh : tensor<128x32768xf32>
    %dhc2f_sxdr = stablehlo.reduce(%dhc2f_xd init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<128xf32>
    %dhc2f_sxd = stablehlo.broadcast_in_dim %dhc2f_sxdr, dims = [0] : (tensor<128xf32>) -> tensor<128x32768xf32>
    %dhc2f_t1 = stablehlo.multiply %dhc2f_dxh, %bn2_nf : tensor<128x32768xf32>
    %dhc2f_i1 = stablehlo.subtract %dhc2f_t1, %dhc2f_sdx : tensor<128x32768xf32>
    %dhc2f_xs = stablehlo.multiply %bn2_xhat, %dhc2f_sxd : tensor<128x32768xf32>
    %dhc2f_i2 = stablehlo.subtract %dhc2f_i1, %dhc2f_xs : tensor<128x32768xf32>
    %dhc2f_s = stablehlo.divide %bn2_istd, %bn2_nf : tensor<128x32768xf32>
    %dhc2f = stablehlo.multiply %dhc2f_s, %dhc2f_i2 : tensor<128x32768xf32>
    %dg2_p = stablehlo.multiply %dbn2, %bn2_xhat : tensor<128x32768xf32>
    %dg2 = stablehlo.reduce(%dg2_p init: %sc) applies stablehlo.add across dimensions = [0, 1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<f32>
    %dbt2 = stablehlo.reduce(%dbn2 init: %sc) applies stablehlo.add across dimensions = [0, 1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<f32>
    ...
    %dhc1f_gb = stablehlo.broadcast_in_dim %g1, dims = [] : (tensor<f32>) -> tensor<128x32768xf32>
    %dhc1f_dxh = stablehlo.multiply %dhc1f_gb, %dbn1 : tensor<128x32768xf32>
    %dhc1f_sdxr = stablehlo.reduce(%dhc1f_dxh init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<128xf32>
    %dhc1f_sdx = stablehlo.broadcast_in_dim %dhc1f_sdxr, dims = [0] : (tensor<128xf32>) -> tensor<128x32768xf32>
    %dhc1f_xd = stablehlo.multiply %bn1_xhat, %dhc1f_dxh : tensor<128x32768xf32>
    %dhc1f_sxdr = stablehlo.reduce(%dhc1f_xd init: %sc) applies stablehlo.add across dimensions = [1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<128xf32>
    %dhc1f_sxd = stablehlo.broadcast_in_dim %dhc1f_sxdr, dims = [0] : (tensor<128xf32>) -> tensor<128x32768xf32>
    %dhc1f_t1 = stablehlo.multiply %dhc1f_dxh, %bn1_nf : tensor<128x32768xf32>
    %dhc1f_i1 = stablehlo.subtract %dhc1f_t1, %dhc1f_sdx : tensor<128x32768xf32>
    %dhc1f_xs = stablehlo.multiply %bn1_xhat, %dhc1f_sxd : tensor<128x32768xf32>
    %dhc1f_i2 = stablehlo.subtract %dhc1f_i1, %dhc1f_xs : tensor<128x32768xf32>
    %dhc1f_s = stablehlo.divide %bn1_istd, %bn1_nf : tensor<128x32768xf32>
    %dhc1f = stablehlo.multiply %dhc1f_s, %dhc1f_i2 : tensor<128x32768xf32>
    %dg1_p = stablehlo.multiply %dbn1, %bn1_xhat : tensor<128x32768xf32>
    %dg1 = stablehlo.reduce(%dg1_p init: %sc) applies stablehlo.add across dimensions = [0, 1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<f32>
    %dbt1 = stablehlo.reduce(%dbn1 init: %sc) applies stablehlo.add across dimensions = [0, 1] : (tensor<128x32768xf32>, tensor<f32>) -> tensor<f32>
    ...
    %g3l = stablehlo.constant dense<0.00078125> : tensor<f32>
    %g3s = stablehlo.multiply %dg3, %g3l : tensor<f32>
    %g3n = stablehlo.subtract %g3, %g3s : tensor<f32>
    %bt3l = stablehlo.constant dense<0.00078125> : tensor<f32>
    %bt3s = stablehlo.multiply %dbt3, %bt3l : tensor<f32>
    %bt3n = stablehlo.subtract %bt3, %bt3s : tensor<f32>
    ...
    %g4l = stablehlo.constant dense<0.00078125> : tensor<f32>
    %g4s = stablehlo.multiply %dg4, %g4l : tensor<f32>
    %g4n = stablehlo.subtract %g4, %g4s : tensor<f32>
    %bt4l = stablehlo.constant dense<0.00078125> : tensor<f32>
    %bt4s = stablehlo.multiply %dbt4, %bt4l : tensor<f32>
    %bt4n = stablehlo.subtract %bt4, %bt4s : tensor<f32>
    ...
    return %W1n, %b1n, %g1n, %bt1n, %W2n, %b2n, %g2n, %bt2n, %W3n, %b3n, %g3n, %bt3n, %W4n, %b4n, %g4n, %bt4n, %W5n, %b5n, %W6n, %b6n, %W7n, %b7n : tensor<32x3x3x3xf32>, tensor<32xf32>, tensor<f32>, tensor<f32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<f32>, tensor<f32>, tensor<64x32x3x3xf32>, tensor<64xf32>, tensor<f32>, tensor<f32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<f32>, tensor<f32>, tensor<4096x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>
  }
}
