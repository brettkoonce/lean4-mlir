module @m {
  func.func @cifar8wb_adam_train_step(%x: tensor<128x3072xf32>, %W1: tensor<16x3x3x3xf32>, %cb1: tensor<16xf32>, %W2: tensor<16x16x3x3xf32>, %cb2: tensor<16xf32>, %W3: tensor<16x16x3x3xf32>, %cb3: tensor<16xf32>, %W4: tensor<16x16x3x3xf32>, %cb4: tensor<16xf32>, %W5: tensor<32x16x3x3xf32>, %cb5: tensor<32xf32>, %W6: tensor<32x32x3x3xf32>, %cb6: tensor<32xf32>, %W7: tensor<32x32x3x3xf32>, %cb7: tensor<32xf32>, %W8: tensor<32x32x3x3xf32>, %cb8: tensor<32xf32>, %W9: tensor<128x512xf32>, %b9: tensor<512xf32>, %Wa: tensor<512x512xf32>, %ba: tensor<512xf32>, %Wb: tensor<512x10xf32>, %bb: tensor<10xf32>, %W1m: tensor<16x3x3x3xf32>, %cb1m: tensor<16xf32>, %W2m: tensor<16x16x3x3xf32>, %cb2m: tensor<16xf32>, %W3m: tensor<16x16x3x3xf32>, %cb3m: tensor<16xf32>, %W4m: tensor<16x16x3x3xf32>, %cb4m: tensor<16xf32>, %W5m: tensor<32x16x3x3xf32>, %cb5m: tensor<32xf32>, %W6m: tensor<32x32x3x3xf32>, %cb6m: tensor<32xf32>, %W7m: tensor<32x32x3x3xf32>, %cb7m: tensor<32xf32>, %W8m: tensor<32x32x3x3xf32>, %cb8m: tensor<32xf32>, %W9m: tensor<128x512xf32>, %b9m: tensor<512xf32>, %Wam: tensor<512x512xf32>, %bam: tensor<512xf32>, %Wbm: tensor<512x10xf32>, %bbm: tensor<10xf32>, %W1v: tensor<16x3x3x3xf32>, %cb1v: tensor<16xf32>, %W2v: tensor<16x16x3x3xf32>, %cb2v: tensor<16xf32>, %W3v: tensor<16x16x3x3xf32>, %cb3v: tensor<16xf32>, %W4v: tensor<16x16x3x3xf32>, %cb4v: tensor<16xf32>, %W5v: tensor<32x16x3x3xf32>, %cb5v: tensor<32xf32>, %W6v: tensor<32x32x3x3xf32>, %cb6v: tensor<32xf32>, %W7v: tensor<32x32x3x3xf32>, %cb7v: tensor<32xf32>, %W8v: tensor<32x32x3x3xf32>, %cb8v: tensor<32xf32>, %W9v: tensor<128x512xf32>, %b9v: tensor<512xf32>, %Wav: tensor<512x512xf32>, %bav: tensor<512xf32>, %Wbv: tensor<512x10xf32>, %bbv: tensor<10xf32>, %lr: tensor<f32>, %bc1: tensor<f32>, %bc2: tensor<f32>, %onehot: tensor<128x10xf32>) -> (tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>) {
    ...
    %v893 = stablehlo.dot_general %v87, %v122, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x512xf32>) -> tensor<128x512xf32>
    %v894 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v895 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v896 = stablehlo.multiply %v894, %W9m : tensor<128x512xf32>
    %v897 = stablehlo.multiply %v895, %v893 : tensor<128x512xf32>
    %v898 = stablehlo.add %v896, %v897 : tensor<128x512xf32>
    %v899 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v900 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v901 = stablehlo.multiply %v899, %W9v : tensor<128x512xf32>
    %v902 = stablehlo.multiply %v893, %v893 : tensor<128x512xf32>
    %v903 = stablehlo.multiply %v900, %v902 : tensor<128x512xf32>
    %v904 = stablehlo.add %v901, %v903 : tensor<128x512xf32>
    %v905 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v906 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v907 = stablehlo.divide %v898, %v905 : tensor<128x512xf32>
    %v908 = stablehlo.divide %v904, %v906 : tensor<128x512xf32>
    %v909 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v910 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v911 = stablehlo.sqrt %v908 : tensor<128x512xf32>
    %v912 = stablehlo.add %v911, %v910 : tensor<128x512xf32>
    %v913 = stablehlo.divide %v907, %v912 : tensor<128x512xf32>
    %v914 = stablehlo.multiply %v909, %v913 : tensor<128x512xf32>
    %v915 = stablehlo.subtract %W9, %v914 : tensor<128x512xf32>
    %v916 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v917 = stablehlo.multiply %v916, %v909 : tensor<128x512xf32>
    %v918 = stablehlo.multiply %v917, %W9 : tensor<128x512xf32>
    %v919 = stablehlo.subtract %v915, %v918 : tensor<128x512xf32>
    %v920 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v921 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v922 = stablehlo.multiply %v920, %W9m : tensor<128x512xf32>
    %v923 = stablehlo.multiply %v921, %v893 : tensor<128x512xf32>
    %v924 = stablehlo.add %v922, %v923 : tensor<128x512xf32>
    %v925 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v926 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v927 = stablehlo.multiply %v925, %W9v : tensor<128x512xf32>
    %v928 = stablehlo.multiply %v893, %v893 : tensor<128x512xf32>
    %v929 = stablehlo.multiply %v926, %v928 : tensor<128x512xf32>
    %v930 = stablehlo.add %v927, %v929 : tensor<128x512xf32>
    %v931 = stablehlo.constant dense<0.0> : tensor<f32>
    %v932 = stablehlo.reduce(%v122 init: %v931) applies stablehlo.add across dimensions = [0] : (tensor<128x512xf32>, tensor<f32>) -> tensor<512xf32>
    %v933 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v934 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v935 = stablehlo.multiply %v933, %b9m : tensor<512xf32>
    %v936 = stablehlo.multiply %v934, %v932 : tensor<512xf32>
    %v937 = stablehlo.add %v935, %v936 : tensor<512xf32>
    %v938 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v939 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v940 = stablehlo.multiply %v938, %b9v : tensor<512xf32>
    %v941 = stablehlo.multiply %v932, %v932 : tensor<512xf32>
    %v942 = stablehlo.multiply %v939, %v941 : tensor<512xf32>
    %v943 = stablehlo.add %v940, %v942 : tensor<512xf32>
    %v944 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v945 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v946 = stablehlo.divide %v937, %v944 : tensor<512xf32>
    %v947 = stablehlo.divide %v943, %v945 : tensor<512xf32>
    %v948 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v949 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v950 = stablehlo.sqrt %v947 : tensor<512xf32>
    %v951 = stablehlo.add %v950, %v949 : tensor<512xf32>
    %v952 = stablehlo.divide %v946, %v951 : tensor<512xf32>
    %v953 = stablehlo.multiply %v948, %v952 : tensor<512xf32>
    %v954 = stablehlo.subtract %b9, %v953 : tensor<512xf32>
    %v955 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v956 = stablehlo.multiply %v955, %v948 : tensor<512xf32>
    %v957 = stablehlo.multiply %v956, %b9 : tensor<512xf32>
    %v958 = stablehlo.subtract %v954, %v957 : tensor<512xf32>
    %v959 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v960 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v961 = stablehlo.multiply %v959, %b9m : tensor<512xf32>
    %v962 = stablehlo.multiply %v960, %v932 : tensor<512xf32>
    %v963 = stablehlo.add %v961, %v962 : tensor<512xf32>
    %v964 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v965 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v966 = stablehlo.multiply %v964, %b9v : tensor<512xf32>
    %v967 = stablehlo.multiply %v932, %v932 : tensor<512xf32>
    %v968 = stablehlo.multiply %v965, %v967 : tensor<512xf32>
    %v969 = stablehlo.add %v966, %v968 : tensor<512xf32>
    %v970 = stablehlo.dot_general %v92, %v116, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x512xf32>, tensor<128x512xf32>) -> tensor<512x512xf32>
    %v971 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v972 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v973 = stablehlo.multiply %v971, %Wam : tensor<512x512xf32>
    %v974 = stablehlo.multiply %v972, %v970 : tensor<512x512xf32>
    %v975 = stablehlo.add %v973, %v974 : tensor<512x512xf32>
    %v976 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v977 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v978 = stablehlo.multiply %v976, %Wav : tensor<512x512xf32>
    %v979 = stablehlo.multiply %v970, %v970 : tensor<512x512xf32>
    %v980 = stablehlo.multiply %v977, %v979 : tensor<512x512xf32>
    %v981 = stablehlo.add %v978, %v980 : tensor<512x512xf32>
    %v982 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v983 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v984 = stablehlo.divide %v975, %v982 : tensor<512x512xf32>
    %v985 = stablehlo.divide %v981, %v983 : tensor<512x512xf32>
    %v986 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v987 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v988 = stablehlo.sqrt %v985 : tensor<512x512xf32>
    %v989 = stablehlo.add %v988, %v987 : tensor<512x512xf32>
    %v990 = stablehlo.divide %v984, %v989 : tensor<512x512xf32>
    %v991 = stablehlo.multiply %v986, %v990 : tensor<512x512xf32>
    %v992 = stablehlo.subtract %Wa, %v991 : tensor<512x512xf32>
    %v993 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v994 = stablehlo.multiply %v993, %v986 : tensor<512x512xf32>
    %v995 = stablehlo.multiply %v994, %Wa : tensor<512x512xf32>
    %v996 = stablehlo.subtract %v992, %v995 : tensor<512x512xf32>
    %v997 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v998 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v999 = stablehlo.multiply %v997, %Wam : tensor<512x512xf32>
    %v1000 = stablehlo.multiply %v998, %v970 : tensor<512x512xf32>
    %v1001 = stablehlo.add %v999, %v1000 : tensor<512x512xf32>
    %v1002 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1003 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1004 = stablehlo.multiply %v1002, %Wav : tensor<512x512xf32>
    %v1005 = stablehlo.multiply %v970, %v970 : tensor<512x512xf32>
    %v1006 = stablehlo.multiply %v1003, %v1005 : tensor<512x512xf32>
    %v1007 = stablehlo.add %v1004, %v1006 : tensor<512x512xf32>
    %v1008 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1009 = stablehlo.reduce(%v116 init: %v1008) applies stablehlo.add across dimensions = [0] : (tensor<128x512xf32>, tensor<f32>) -> tensor<512xf32>
    %v1010 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1011 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1012 = stablehlo.multiply %v1010, %bam : tensor<512xf32>
    %v1013 = stablehlo.multiply %v1011, %v1009 : tensor<512xf32>
    %v1014 = stablehlo.add %v1012, %v1013 : tensor<512xf32>
    %v1015 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1016 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1017 = stablehlo.multiply %v1015, %bav : tensor<512xf32>
    %v1018 = stablehlo.multiply %v1009, %v1009 : tensor<512xf32>
    %v1019 = stablehlo.multiply %v1016, %v1018 : tensor<512xf32>
    %v1020 = stablehlo.add %v1017, %v1019 : tensor<512xf32>
    %v1021 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1022 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1023 = stablehlo.divide %v1014, %v1021 : tensor<512xf32>
    %v1024 = stablehlo.divide %v1020, %v1022 : tensor<512xf32>
    %v1025 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1026 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1027 = stablehlo.sqrt %v1024 : tensor<512xf32>
    %v1028 = stablehlo.add %v1027, %v1026 : tensor<512xf32>
    %v1029 = stablehlo.divide %v1023, %v1028 : tensor<512xf32>
    %v1030 = stablehlo.multiply %v1025, %v1029 : tensor<512xf32>
    %v1031 = stablehlo.subtract %ba, %v1030 : tensor<512xf32>
    %v1032 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1033 = stablehlo.multiply %v1032, %v1025 : tensor<512xf32>
    %v1034 = stablehlo.multiply %v1033, %ba : tensor<512xf32>
    %v1035 = stablehlo.subtract %v1031, %v1034 : tensor<512xf32>
    %v1036 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1037 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1038 = stablehlo.multiply %v1036, %bam : tensor<512xf32>
    %v1039 = stablehlo.multiply %v1037, %v1009 : tensor<512xf32>
    %v1040 = stablehlo.add %v1038, %v1039 : tensor<512xf32>
    %v1041 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1042 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1043 = stablehlo.multiply %v1041, %bav : tensor<512xf32>
    %v1044 = stablehlo.multiply %v1009, %v1009 : tensor<512xf32>
    %v1045 = stablehlo.multiply %v1042, %v1044 : tensor<512xf32>
    %v1046 = stablehlo.add %v1043, %v1045 : tensor<512xf32>
    %v1047 = stablehlo.dot_general %v97, %v110, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x512xf32>, tensor<128x10xf32>) -> tensor<512x10xf32>
    %v1048 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1049 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1050 = stablehlo.multiply %v1048, %Wbm : tensor<512x10xf32>
    %v1051 = stablehlo.multiply %v1049, %v1047 : tensor<512x10xf32>
    %v1052 = stablehlo.add %v1050, %v1051 : tensor<512x10xf32>
    %v1053 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1054 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1055 = stablehlo.multiply %v1053, %Wbv : tensor<512x10xf32>
    %v1056 = stablehlo.multiply %v1047, %v1047 : tensor<512x10xf32>
    %v1057 = stablehlo.multiply %v1054, %v1056 : tensor<512x10xf32>
    %v1058 = stablehlo.add %v1055, %v1057 : tensor<512x10xf32>
    %v1059 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1060 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1061 = stablehlo.divide %v1052, %v1059 : tensor<512x10xf32>
    %v1062 = stablehlo.divide %v1058, %v1060 : tensor<512x10xf32>
    %v1063 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1064 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1065 = stablehlo.sqrt %v1062 : tensor<512x10xf32>
    %v1066 = stablehlo.add %v1065, %v1064 : tensor<512x10xf32>
    %v1067 = stablehlo.divide %v1061, %v1066 : tensor<512x10xf32>
    %v1068 = stablehlo.multiply %v1063, %v1067 : tensor<512x10xf32>
    %v1069 = stablehlo.subtract %Wb, %v1068 : tensor<512x10xf32>
    %v1070 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1071 = stablehlo.multiply %v1070, %v1063 : tensor<512x10xf32>
    %v1072 = stablehlo.multiply %v1071, %Wb : tensor<512x10xf32>
    %v1073 = stablehlo.subtract %v1069, %v1072 : tensor<512x10xf32>
    %v1074 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1075 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1076 = stablehlo.multiply %v1074, %Wbm : tensor<512x10xf32>
    %v1077 = stablehlo.multiply %v1075, %v1047 : tensor<512x10xf32>
    %v1078 = stablehlo.add %v1076, %v1077 : tensor<512x10xf32>
    %v1079 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1080 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1081 = stablehlo.multiply %v1079, %Wbv : tensor<512x10xf32>
    %v1082 = stablehlo.multiply %v1047, %v1047 : tensor<512x10xf32>
    %v1083 = stablehlo.multiply %v1080, %v1082 : tensor<512x10xf32>
    %v1084 = stablehlo.add %v1081, %v1083 : tensor<512x10xf32>
    ...
    return %v260, %v300, %v343, %v383, %v426, %v466, %v509, %v549, %v592, %v632, %v675, %v715, %v758, %v798, %v841, %v881, %v919, %v958, %v996, %v1035, %v1073, %v1112, %v265, %v305, %v348, %v388, %v431, %v471, %v514, %v554, %v597, %v637, %v680, %v720, %v763, %v803, %v846, %v886, %v924, %v963, %v1001, %v1040, %v1078, %v1117, %v271, %v311, %v354, %v394, %v437, %v477, %v520, %v560, %v603, %v643, %v686, %v726, %v769, %v809, %v852, %v892, %v930, %v969, %v1007, %v1046, %v1084, %v1123, %loss, %bc1, %bc2 : tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>
  }
}
