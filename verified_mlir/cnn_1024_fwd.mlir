module @m {
  func.func @cnn_1024_fwd(%x: tensor<128x784xf32>, %W1: tensor<32x1x3x3xf32>, %b1: tensor<32xf32>, %W2: tensor<32x32x3x3xf32>, %b2: tensor<32xf32>, %W3: tensor<6272x1024xf32>, %b3: tensor<1024xf32>, %W4: tensor<1024x1024xf32>, %b4: tensor<1024xf32>, %W5: tensor<1024x10xf32>, %b5: tensor<10xf32>) -> tensor<128x10xf32> {
