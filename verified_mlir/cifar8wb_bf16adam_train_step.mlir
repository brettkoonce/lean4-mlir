module @m {
  func.func @cifar8wb_bf16adam_train_step(%x: tensor<128x3072xf32>, %W1: tensor<16x3x3x3xf32>, %cb1: tensor<16xf32>, %W2: tensor<16x16x3x3xf32>, %cb2: tensor<16xf32>, %W3: tensor<16x16x3x3xf32>, %cb3: tensor<16xf32>, %W4: tensor<16x16x3x3xf32>, %cb4: tensor<16xf32>, %W5: tensor<32x16x3x3xf32>, %cb5: tensor<32xf32>, %W6: tensor<32x32x3x3xf32>, %cb6: tensor<32xf32>, %W7: tensor<32x32x3x3xf32>, %cb7: tensor<32xf32>, %W8: tensor<32x32x3x3xf32>, %cb8: tensor<32xf32>, %W9: tensor<128x512xf32>, %b9: tensor<512xf32>, %Wa: tensor<512x512xf32>, %ba: tensor<512xf32>, %Wb: tensor<512x10xf32>, %bb: tensor<10xf32>, %W1m: tensor<16x3x3x3xf32>, %cb1m: tensor<16xf32>, %W2m: tensor<16x16x3x3xf32>, %cb2m: tensor<16xf32>, %W3m: tensor<16x16x3x3xf32>, %cb3m: tensor<16xf32>, %W4m: tensor<16x16x3x3xf32>, %cb4m: tensor<16xf32>, %W5m: tensor<32x16x3x3xf32>, %cb5m: tensor<32xf32>, %W6m: tensor<32x32x3x3xf32>, %cb6m: tensor<32xf32>, %W7m: tensor<32x32x3x3xf32>, %cb7m: tensor<32xf32>, %W8m: tensor<32x32x3x3xf32>, %cb8m: tensor<32xf32>, %W9m: tensor<128x512xf32>, %b9m: tensor<512xf32>, %Wam: tensor<512x512xf32>, %bam: tensor<512xf32>, %Wbm: tensor<512x10xf32>, %bbm: tensor<10xf32>, %W1v: tensor<16x3x3x3xf32>, %cb1v: tensor<16xf32>, %W2v: tensor<16x16x3x3xf32>, %cb2v: tensor<16xf32>, %W3v: tensor<16x16x3x3xf32>, %cb3v: tensor<16xf32>, %W4v: tensor<16x16x3x3xf32>, %cb4v: tensor<16xf32>, %W5v: tensor<32x16x3x3xf32>, %cb5v: tensor<32xf32>, %W6v: tensor<32x32x3x3xf32>, %cb6v: tensor<32xf32>, %W7v: tensor<32x32x3x3xf32>, %cb7v: tensor<32xf32>, %W8v: tensor<32x32x3x3xf32>, %cb8v: tensor<32xf32>, %W9v: tensor<128x512xf32>, %b9v: tensor<512xf32>, %Wav: tensor<512x512xf32>, %bav: tensor<512xf32>, %Wbv: tensor<512x10xf32>, %bbv: tensor<10xf32>, %lr: tensor<f32>, %bc1: tensor<f32>, %bc2: tensor<f32>, %onehot: tensor<128x10xf32>) -> (tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>) {
    ...
    %v922 = stablehlo.dot_general %v95, %v130, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x512xf32>) -> tensor<128x512xf32>
    %v923 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v924 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v925 = stablehlo.multiply %v923, %W9m : tensor<128x512xf32>
    %v926 = stablehlo.multiply %v924, %v922 : tensor<128x512xf32>
    %v927 = stablehlo.add %v925, %v926 : tensor<128x512xf32>
    %v928 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v929 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v930 = stablehlo.multiply %v928, %W9v : tensor<128x512xf32>
    %v931 = stablehlo.multiply %v922, %v922 : tensor<128x512xf32>
    %v932 = stablehlo.multiply %v929, %v931 : tensor<128x512xf32>
    %v933 = stablehlo.add %v930, %v932 : tensor<128x512xf32>
    %v934 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v935 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v936 = stablehlo.divide %v927, %v934 : tensor<128x512xf32>
    %v937 = stablehlo.divide %v933, %v935 : tensor<128x512xf32>
    %v938 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v939 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v940 = stablehlo.sqrt %v937 : tensor<128x512xf32>
    %v941 = stablehlo.add %v940, %v939 : tensor<128x512xf32>
    %v942 = stablehlo.divide %v936, %v941 : tensor<128x512xf32>
    %v943 = stablehlo.multiply %v938, %v942 : tensor<128x512xf32>
    %v944 = stablehlo.subtract %W9, %v943 : tensor<128x512xf32>
    %v945 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v946 = stablehlo.multiply %v945, %v938 : tensor<128x512xf32>
    %v947 = stablehlo.multiply %v946, %W9 : tensor<128x512xf32>
    %v948 = stablehlo.subtract %v944, %v947 : tensor<128x512xf32>
    %v949 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v950 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v951 = stablehlo.multiply %v949, %W9m : tensor<128x512xf32>
    %v952 = stablehlo.multiply %v950, %v922 : tensor<128x512xf32>
    %v953 = stablehlo.add %v951, %v952 : tensor<128x512xf32>
    %v954 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v955 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v956 = stablehlo.multiply %v954, %W9v : tensor<128x512xf32>
    %v957 = stablehlo.multiply %v922, %v922 : tensor<128x512xf32>
    %v958 = stablehlo.multiply %v955, %v957 : tensor<128x512xf32>
    %v959 = stablehlo.add %v956, %v958 : tensor<128x512xf32>
    %v960 = stablehlo.constant dense<0.0> : tensor<f32>
    %v961 = stablehlo.reduce(%v130 init: %v960) applies stablehlo.add across dimensions = [0] : (tensor<128x512xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v964 = stablehlo.multiply %v962, %b9m : tensor<512xf32>
    ...
    %v969 = stablehlo.multiply %v967, %b9v : tensor<512xf32>
    ...
    %v990 = stablehlo.multiply %v988, %b9m : tensor<512xf32>
    ...
    %v995 = stablehlo.multiply %v993, %b9v : tensor<512xf32>
    ...
    %v999 = stablehlo.dot_general %v100, %v124, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x512xf32>, tensor<128x512xf32>) -> tensor<512x512xf32>
    %v1000 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1001 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1002 = stablehlo.multiply %v1000, %Wam : tensor<512x512xf32>
    %v1003 = stablehlo.multiply %v1001, %v999 : tensor<512x512xf32>
    %v1004 = stablehlo.add %v1002, %v1003 : tensor<512x512xf32>
    %v1005 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1006 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1007 = stablehlo.multiply %v1005, %Wav : tensor<512x512xf32>
    %v1008 = stablehlo.multiply %v999, %v999 : tensor<512x512xf32>
    %v1009 = stablehlo.multiply %v1006, %v1008 : tensor<512x512xf32>
    %v1010 = stablehlo.add %v1007, %v1009 : tensor<512x512xf32>
    %v1011 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1012 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1013 = stablehlo.divide %v1004, %v1011 : tensor<512x512xf32>
    %v1014 = stablehlo.divide %v1010, %v1012 : tensor<512x512xf32>
    %v1015 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1016 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1017 = stablehlo.sqrt %v1014 : tensor<512x512xf32>
    %v1018 = stablehlo.add %v1017, %v1016 : tensor<512x512xf32>
    %v1019 = stablehlo.divide %v1013, %v1018 : tensor<512x512xf32>
    %v1020 = stablehlo.multiply %v1015, %v1019 : tensor<512x512xf32>
    %v1021 = stablehlo.subtract %Wa, %v1020 : tensor<512x512xf32>
    %v1022 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1023 = stablehlo.multiply %v1022, %v1015 : tensor<512x512xf32>
    %v1024 = stablehlo.multiply %v1023, %Wa : tensor<512x512xf32>
    %v1025 = stablehlo.subtract %v1021, %v1024 : tensor<512x512xf32>
    %v1026 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1027 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1028 = stablehlo.multiply %v1026, %Wam : tensor<512x512xf32>
    %v1029 = stablehlo.multiply %v1027, %v999 : tensor<512x512xf32>
    %v1030 = stablehlo.add %v1028, %v1029 : tensor<512x512xf32>
    %v1031 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1032 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v1033 = stablehlo.multiply %v1031, %Wav : tensor<512x512xf32>
    %v1034 = stablehlo.multiply %v999, %v999 : tensor<512x512xf32>
    %v1035 = stablehlo.multiply %v1032, %v1034 : tensor<512x512xf32>
    %v1036 = stablehlo.add %v1033, %v1035 : tensor<512x512xf32>
    %v1037 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1038 = stablehlo.reduce(%v124 init: %v1037) applies stablehlo.add across dimensions = [0] : (tensor<128x512xf32>, tensor<f32>) -> tensor<512xf32>
    %v1039 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1040 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1041 = stablehlo.multiply %v1039, %bam : tensor<512xf32>
    %v1042 = stablehlo.multiply %v1040, %v1038 : tensor<512xf32>
    %v1043 = stablehlo.add %v1041, %v1042 : tensor<512xf32>
    %v1044 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1045 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1046 = stablehlo.multiply %v1044, %bav : tensor<512xf32>
    %v1047 = stablehlo.multiply %v1038, %v1038 : tensor<512xf32>
    %v1048 = stablehlo.multiply %v1045, %v1047 : tensor<512xf32>
    %v1049 = stablehlo.add %v1046, %v1048 : tensor<512xf32>
    %v1050 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1051 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1052 = stablehlo.divide %v1043, %v1050 : tensor<512xf32>
    %v1053 = stablehlo.divide %v1049, %v1051 : tensor<512xf32>
    %v1054 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1055 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1056 = stablehlo.sqrt %v1053 : tensor<512xf32>
    %v1057 = stablehlo.add %v1056, %v1055 : tensor<512xf32>
    %v1058 = stablehlo.divide %v1052, %v1057 : tensor<512xf32>
    %v1059 = stablehlo.multiply %v1054, %v1058 : tensor<512xf32>
    %v1060 = stablehlo.subtract %ba, %v1059 : tensor<512xf32>
    %v1061 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1062 = stablehlo.multiply %v1061, %v1054 : tensor<512xf32>
    %v1063 = stablehlo.multiply %v1062, %ba : tensor<512xf32>
    %v1064 = stablehlo.subtract %v1060, %v1063 : tensor<512xf32>
    %v1065 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1066 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1067 = stablehlo.multiply %v1065, %bam : tensor<512xf32>
    %v1068 = stablehlo.multiply %v1066, %v1038 : tensor<512xf32>
    %v1069 = stablehlo.add %v1067, %v1068 : tensor<512xf32>
    %v1070 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1071 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v1072 = stablehlo.multiply %v1070, %bav : tensor<512xf32>
    %v1073 = stablehlo.multiply %v1038, %v1038 : tensor<512xf32>
    %v1074 = stablehlo.multiply %v1071, %v1073 : tensor<512xf32>
    %v1075 = stablehlo.add %v1072, %v1074 : tensor<512xf32>
    %v1076 = stablehlo.dot_general %v105, %v118, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x512xf32>, tensor<128x10xf32>) -> tensor<512x10xf32>
    %v1077 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1078 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1079 = stablehlo.multiply %v1077, %Wbm : tensor<512x10xf32>
    %v1080 = stablehlo.multiply %v1078, %v1076 : tensor<512x10xf32>
    %v1081 = stablehlo.add %v1079, %v1080 : tensor<512x10xf32>
    %v1082 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1083 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1084 = stablehlo.multiply %v1082, %Wbv : tensor<512x10xf32>
    %v1085 = stablehlo.multiply %v1076, %v1076 : tensor<512x10xf32>
    %v1086 = stablehlo.multiply %v1083, %v1085 : tensor<512x10xf32>
    %v1087 = stablehlo.add %v1084, %v1086 : tensor<512x10xf32>
    %v1088 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1089 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1090 = stablehlo.divide %v1081, %v1088 : tensor<512x10xf32>
    %v1091 = stablehlo.divide %v1087, %v1089 : tensor<512x10xf32>
    %v1092 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1093 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1094 = stablehlo.sqrt %v1091 : tensor<512x10xf32>
    %v1095 = stablehlo.add %v1094, %v1093 : tensor<512x10xf32>
    %v1096 = stablehlo.divide %v1090, %v1095 : tensor<512x10xf32>
    %v1097 = stablehlo.multiply %v1092, %v1096 : tensor<512x10xf32>
    %v1098 = stablehlo.subtract %Wb, %v1097 : tensor<512x10xf32>
    %v1099 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1100 = stablehlo.multiply %v1099, %v1092 : tensor<512x10xf32>
    %v1101 = stablehlo.multiply %v1100, %Wb : tensor<512x10xf32>
    %v1102 = stablehlo.subtract %v1098, %v1101 : tensor<512x10xf32>
    %v1103 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1104 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1105 = stablehlo.multiply %v1103, %Wbm : tensor<512x10xf32>
    %v1106 = stablehlo.multiply %v1104, %v1076 : tensor<512x10xf32>
    %v1107 = stablehlo.add %v1105, %v1106 : tensor<512x10xf32>
    %v1108 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1109 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1110 = stablehlo.multiply %v1108, %Wbv : tensor<512x10xf32>
    %v1111 = stablehlo.multiply %v1076, %v1076 : tensor<512x10xf32>
    %v1112 = stablehlo.multiply %v1109, %v1111 : tensor<512x10xf32>
    %v1113 = stablehlo.add %v1110, %v1112 : tensor<512x10xf32>
    ...
    return %v268, %v308, %v354, %v394, %v440, %v480, %v526, %v566, %v612, %v652, %v698, %v738, %v784, %v824, %v870, %v910, %v948, %v987, %v1025, %v1064, %v1102, %v1141, %v273, %v313, %v359, %v399, %v445, %v485, %v531, %v571, %v617, %v657, %v703, %v743, %v789, %v829, %v875, %v915, %v953, %v992, %v1030, %v1069, %v1107, %v1146, %v279, %v319, %v365, %v405, %v451, %v491, %v537, %v577, %v623, %v663, %v709, %v749, %v795, %v835, %v881, %v921, %v959, %v998, %v1036, %v1075, %v1113, %v1152, %loss, %bc1, %bc2 : tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>
  }
}
