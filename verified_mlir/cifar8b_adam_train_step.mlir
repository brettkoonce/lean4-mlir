module @m {
  func.func @cifar8b_adam_train_step(%x: tensor<128x3072xf32>, %W1: tensor<16x3x3x3xf32>, %cb1: tensor<16xf32>, %W2: tensor<16x16x3x3xf32>, %cb2: tensor<16xf32>, %W3: tensor<16x16x3x3xf32>, %cb3: tensor<16xf32>, %W4: tensor<16x16x3x3xf32>, %cb4: tensor<16xf32>, %W5: tensor<32x16x3x3xf32>, %cb5: tensor<32xf32>, %W6: tensor<32x32x3x3xf32>, %cb6: tensor<32xf32>, %W7: tensor<32x32x3x3xf32>, %cb7: tensor<32xf32>, %W8: tensor<32x32x3x3xf32>, %cb8: tensor<32xf32>, %W9: tensor<128x64xf32>, %b9: tensor<64xf32>, %Wa: tensor<64x64xf32>, %ba: tensor<64xf32>, %Wb: tensor<64x10xf32>, %bb: tensor<10xf32>, %W1m: tensor<16x3x3x3xf32>, %cb1m: tensor<16xf32>, %W2m: tensor<16x16x3x3xf32>, %cb2m: tensor<16xf32>, %W3m: tensor<16x16x3x3xf32>, %cb3m: tensor<16xf32>, %W4m: tensor<16x16x3x3xf32>, %cb4m: tensor<16xf32>, %W5m: tensor<32x16x3x3xf32>, %cb5m: tensor<32xf32>, %W6m: tensor<32x32x3x3xf32>, %cb6m: tensor<32xf32>, %W7m: tensor<32x32x3x3xf32>, %cb7m: tensor<32xf32>, %W8m: tensor<32x32x3x3xf32>, %cb8m: tensor<32xf32>, %W9m: tensor<128x64xf32>, %b9m: tensor<64xf32>, %Wam: tensor<64x64xf32>, %bam: tensor<64xf32>, %Wbm: tensor<64x10xf32>, %bbm: tensor<10xf32>, %W1v: tensor<16x3x3x3xf32>, %cb1v: tensor<16xf32>, %W2v: tensor<16x16x3x3xf32>, %cb2v: tensor<16xf32>, %W3v: tensor<16x16x3x3xf32>, %cb3v: tensor<16xf32>, %W4v: tensor<16x16x3x3xf32>, %cb4v: tensor<16xf32>, %W5v: tensor<32x16x3x3xf32>, %cb5v: tensor<32xf32>, %W6v: tensor<32x32x3x3xf32>, %cb6v: tensor<32xf32>, %W7v: tensor<32x32x3x3xf32>, %cb7v: tensor<32xf32>, %W8v: tensor<32x32x3x3xf32>, %cb8v: tensor<32xf32>, %W9v: tensor<128x64xf32>, %b9v: tensor<64xf32>, %Wav: tensor<64x64xf32>, %bav: tensor<64xf32>, %Wbv: tensor<64x10xf32>, %bbv: tensor<10xf32>, %lr: tensor<f32>, %bc1: tensor<f32>, %bc2: tensor<f32>, %onehot: tensor<128x10xf32>) -> (tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>) {
    ...
    %v96 = stablehlo.dot_general %v95, %Wb, contracting_dims = [2] x [1], precision = [DEFAULT, DEFAULT] : (tensor<128x1x10xf32>, tensor<64x10xf32>) -> tensor<128x1x64xf32>
    %v97 = stablehlo.reshape %v96 : (tensor<128x1x64xf32>) -> tensor<128x64xf32>
    %v98 = stablehlo.constant dense<0.0> : tensor<128x64xf32>
    %v99 = stablehlo.compare GT, %v79, %v98 : (tensor<128x64xf32>, tensor<128x64xf32>) -> tensor<128x64xi1>
    %v100 = stablehlo.select %v99, %v97, %v98 : tensor<128x64xi1>, tensor<128x64xf32>
    %v101 = stablehlo.reshape %v100 : (tensor<128x64xf32>) -> tensor<128x1x64xf32>
    %v102 = stablehlo.dot_general %v101, %Wa, contracting_dims = [2] x [1], precision = [DEFAULT, DEFAULT] : (tensor<128x1x64xf32>, tensor<64x64xf32>) -> tensor<128x1x64xf32>
    %v103 = stablehlo.reshape %v102 : (tensor<128x1x64xf32>) -> tensor<128x64xf32>
    %v104 = stablehlo.constant dense<0.0> : tensor<128x64xf32>
    %v105 = stablehlo.compare GT, %v74, %v104 : (tensor<128x64xf32>, tensor<128x64xf32>) -> tensor<128x64xi1>
    %v106 = stablehlo.select %v105, %v103, %v104 : tensor<128x64xi1>, tensor<128x64xf32>
    %v107 = stablehlo.reshape %v106 : (tensor<128x64xf32>) -> tensor<128x1x64xf32>
    %v108 = stablehlo.dot_general %v107, %W9, contracting_dims = [2] x [1], precision = [DEFAULT, DEFAULT] : (tensor<128x1x64xf32>, tensor<128x64xf32>) -> tensor<128x1x128xf32>
    ...
    %v853 = stablehlo.dot_general %v71, %v106, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x64xf32>) -> tensor<128x64xf32>
    %v854 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v855 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v856 = stablehlo.multiply %v854, %W9m : tensor<128x64xf32>
    %v857 = stablehlo.multiply %v855, %v853 : tensor<128x64xf32>
    %v858 = stablehlo.add %v856, %v857 : tensor<128x64xf32>
    %v859 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v860 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v861 = stablehlo.multiply %v859, %W9v : tensor<128x64xf32>
    %v862 = stablehlo.multiply %v853, %v853 : tensor<128x64xf32>
    %v863 = stablehlo.multiply %v860, %v862 : tensor<128x64xf32>
    %v864 = stablehlo.add %v861, %v863 : tensor<128x64xf32>
    %v865 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v866 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v867 = stablehlo.divide %v858, %v865 : tensor<128x64xf32>
    %v868 = stablehlo.divide %v864, %v866 : tensor<128x64xf32>
    %v869 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v870 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v871 = stablehlo.sqrt %v868 : tensor<128x64xf32>
    %v872 = stablehlo.add %v871, %v870 : tensor<128x64xf32>
    %v873 = stablehlo.divide %v867, %v872 : tensor<128x64xf32>
    %v874 = stablehlo.multiply %v869, %v873 : tensor<128x64xf32>
    %v875 = stablehlo.subtract %W9, %v874 : tensor<128x64xf32>
    %v876 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v877 = stablehlo.multiply %v876, %v869 : tensor<128x64xf32>
    %v878 = stablehlo.multiply %v877, %W9 : tensor<128x64xf32>
    %v879 = stablehlo.subtract %v875, %v878 : tensor<128x64xf32>
    %v880 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v881 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v882 = stablehlo.multiply %v880, %W9m : tensor<128x64xf32>
    %v883 = stablehlo.multiply %v881, %v853 : tensor<128x64xf32>
    %v884 = stablehlo.add %v882, %v883 : tensor<128x64xf32>
    %v885 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v886 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v887 = stablehlo.multiply %v885, %W9v : tensor<128x64xf32>
    %v888 = stablehlo.multiply %v853, %v853 : tensor<128x64xf32>
    %v889 = stablehlo.multiply %v886, %v888 : tensor<128x64xf32>
    %v890 = stablehlo.add %v887, %v889 : tensor<128x64xf32>
    %v891 = stablehlo.constant dense<0.0> : tensor<f32>
    %v892 = stablehlo.reduce(%v106 init: %v891) applies stablehlo.add across dimensions = [0] : (tensor<128x64xf32>, tensor<f32>) -> tensor<64xf32>
    %v893 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v894 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v895 = stablehlo.multiply %v893, %b9m : tensor<64xf32>
    %v896 = stablehlo.multiply %v894, %v892 : tensor<64xf32>
    %v897 = stablehlo.add %v895, %v896 : tensor<64xf32>
    %v898 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v899 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v900 = stablehlo.multiply %v898, %b9v : tensor<64xf32>
    %v901 = stablehlo.multiply %v892, %v892 : tensor<64xf32>
    %v902 = stablehlo.multiply %v899, %v901 : tensor<64xf32>
    %v903 = stablehlo.add %v900, %v902 : tensor<64xf32>
    %v904 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v905 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v906 = stablehlo.divide %v897, %v904 : tensor<64xf32>
    %v907 = stablehlo.divide %v903, %v905 : tensor<64xf32>
    %v908 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v909 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v910 = stablehlo.sqrt %v907 : tensor<64xf32>
    %v911 = stablehlo.add %v910, %v909 : tensor<64xf32>
    %v912 = stablehlo.divide %v906, %v911 : tensor<64xf32>
    %v913 = stablehlo.multiply %v908, %v912 : tensor<64xf32>
    %v914 = stablehlo.subtract %b9, %v913 : tensor<64xf32>
    %v915 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v916 = stablehlo.multiply %v915, %v908 : tensor<64xf32>
    %v917 = stablehlo.multiply %v916, %b9 : tensor<64xf32>
    %v918 = stablehlo.subtract %v914, %v917 : tensor<64xf32>
    %v919 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v920 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v921 = stablehlo.multiply %v919, %b9m : tensor<64xf32>
    %v922 = stablehlo.multiply %v920, %v892 : tensor<64xf32>
    %v923 = stablehlo.add %v921, %v922 : tensor<64xf32>
    %v924 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v925 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v926 = stablehlo.multiply %v924, %b9v : tensor<64xf32>
    %v927 = stablehlo.multiply %v892, %v892 : tensor<64xf32>
    %v928 = stablehlo.multiply %v925, %v927 : tensor<64xf32>
    %v929 = stablehlo.add %v926, %v928 : tensor<64xf32>
    %v930 = stablehlo.dot_general %v76, %v100, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x64xf32>, tensor<128x64xf32>) -> tensor<64x64xf32>
    %v931 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v932 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v933 = stablehlo.multiply %v931, %Wam : tensor<64x64xf32>
    %v934 = stablehlo.multiply %v932, %v930 : tensor<64x64xf32>
    %v935 = stablehlo.add %v933, %v934 : tensor<64x64xf32>
    %v936 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v937 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v938 = stablehlo.multiply %v936, %Wav : tensor<64x64xf32>
    %v939 = stablehlo.multiply %v930, %v930 : tensor<64x64xf32>
    %v940 = stablehlo.multiply %v937, %v939 : tensor<64x64xf32>
    %v941 = stablehlo.add %v938, %v940 : tensor<64x64xf32>
    %v942 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v943 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v944 = stablehlo.divide %v935, %v942 : tensor<64x64xf32>
    %v945 = stablehlo.divide %v941, %v943 : tensor<64x64xf32>
    %v946 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v947 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v948 = stablehlo.sqrt %v945 : tensor<64x64xf32>
    %v949 = stablehlo.add %v948, %v947 : tensor<64x64xf32>
    %v950 = stablehlo.divide %v944, %v949 : tensor<64x64xf32>
    %v951 = stablehlo.multiply %v946, %v950 : tensor<64x64xf32>
    %v952 = stablehlo.subtract %Wa, %v951 : tensor<64x64xf32>
    %v953 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v954 = stablehlo.multiply %v953, %v946 : tensor<64x64xf32>
    %v955 = stablehlo.multiply %v954, %Wa : tensor<64x64xf32>
    %v956 = stablehlo.subtract %v952, %v955 : tensor<64x64xf32>
    %v957 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v958 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v959 = stablehlo.multiply %v957, %Wam : tensor<64x64xf32>
    %v960 = stablehlo.multiply %v958, %v930 : tensor<64x64xf32>
    %v961 = stablehlo.add %v959, %v960 : tensor<64x64xf32>
    %v962 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v963 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v964 = stablehlo.multiply %v962, %Wav : tensor<64x64xf32>
    %v965 = stablehlo.multiply %v930, %v930 : tensor<64x64xf32>
    %v966 = stablehlo.multiply %v963, %v965 : tensor<64x64xf32>
    %v967 = stablehlo.add %v964, %v966 : tensor<64x64xf32>
    %v968 = stablehlo.constant dense<0.0> : tensor<f32>
    %v969 = stablehlo.reduce(%v100 init: %v968) applies stablehlo.add across dimensions = [0] : (tensor<128x64xf32>, tensor<f32>) -> tensor<64xf32>
    %v970 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v971 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v972 = stablehlo.multiply %v970, %bam : tensor<64xf32>
    %v973 = stablehlo.multiply %v971, %v969 : tensor<64xf32>
    %v974 = stablehlo.add %v972, %v973 : tensor<64xf32>
    %v975 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v976 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v977 = stablehlo.multiply %v975, %bav : tensor<64xf32>
    %v978 = stablehlo.multiply %v969, %v969 : tensor<64xf32>
    %v979 = stablehlo.multiply %v976, %v978 : tensor<64xf32>
    %v980 = stablehlo.add %v977, %v979 : tensor<64xf32>
    %v981 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v982 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v983 = stablehlo.divide %v974, %v981 : tensor<64xf32>
    %v984 = stablehlo.divide %v980, %v982 : tensor<64xf32>
    %v985 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v986 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v987 = stablehlo.sqrt %v984 : tensor<64xf32>
    %v988 = stablehlo.add %v987, %v986 : tensor<64xf32>
    %v989 = stablehlo.divide %v983, %v988 : tensor<64xf32>
    %v990 = stablehlo.multiply %v985, %v989 : tensor<64xf32>
    %v991 = stablehlo.subtract %ba, %v990 : tensor<64xf32>
    %v992 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v993 = stablehlo.multiply %v992, %v985 : tensor<64xf32>
    %v994 = stablehlo.multiply %v993, %ba : tensor<64xf32>
    %v995 = stablehlo.subtract %v991, %v994 : tensor<64xf32>
    %v996 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v997 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v998 = stablehlo.multiply %v996, %bam : tensor<64xf32>
    %v999 = stablehlo.multiply %v997, %v969 : tensor<64xf32>
    %v1000 = stablehlo.add %v998, %v999 : tensor<64xf32>
    %v1001 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1002 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1003 = stablehlo.multiply %v1001, %bav : tensor<64xf32>
    %v1004 = stablehlo.multiply %v969, %v969 : tensor<64xf32>
    %v1005 = stablehlo.multiply %v1002, %v1004 : tensor<64xf32>
    %v1006 = stablehlo.add %v1003, %v1005 : tensor<64xf32>
    %v1007 = stablehlo.dot_general %v81, %v94, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x64xf32>, tensor<128x10xf32>) -> tensor<64x10xf32>
    %v1008 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1009 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1010 = stablehlo.multiply %v1008, %Wbm : tensor<64x10xf32>
    %v1011 = stablehlo.multiply %v1009, %v1007 : tensor<64x10xf32>
    %v1012 = stablehlo.add %v1010, %v1011 : tensor<64x10xf32>
    %v1013 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1014 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1015 = stablehlo.multiply %v1013, %Wbv : tensor<64x10xf32>
    %v1016 = stablehlo.multiply %v1007, %v1007 : tensor<64x10xf32>
    %v1017 = stablehlo.multiply %v1014, %v1016 : tensor<64x10xf32>
    %v1018 = stablehlo.add %v1015, %v1017 : tensor<64x10xf32>
    %v1019 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1020 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1021 = stablehlo.divide %v1012, %v1019 : tensor<64x10xf32>
    %v1022 = stablehlo.divide %v1018, %v1020 : tensor<64x10xf32>
    %v1023 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1024 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1025 = stablehlo.sqrt %v1022 : tensor<64x10xf32>
    %v1026 = stablehlo.add %v1025, %v1024 : tensor<64x10xf32>
    %v1027 = stablehlo.divide %v1021, %v1026 : tensor<64x10xf32>
    %v1028 = stablehlo.multiply %v1023, %v1027 : tensor<64x10xf32>
    %v1029 = stablehlo.subtract %Wb, %v1028 : tensor<64x10xf32>
    %v1030 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1031 = stablehlo.multiply %v1030, %v1023 : tensor<64x10xf32>
    %v1032 = stablehlo.multiply %v1031, %Wb : tensor<64x10xf32>
    %v1033 = stablehlo.subtract %v1029, %v1032 : tensor<64x10xf32>
    %v1034 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1035 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1036 = stablehlo.multiply %v1034, %Wbm : tensor<64x10xf32>
    %v1037 = stablehlo.multiply %v1035, %v1007 : tensor<64x10xf32>
    %v1038 = stablehlo.add %v1036, %v1037 : tensor<64x10xf32>
    %v1039 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1040 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1041 = stablehlo.multiply %v1039, %Wbv : tensor<64x10xf32>
    %v1042 = stablehlo.multiply %v1007, %v1007 : tensor<64x10xf32>
    %v1043 = stablehlo.multiply %v1040, %v1042 : tensor<64x10xf32>
    %v1044 = stablehlo.add %v1041, %v1043 : tensor<64x10xf32>
    ...
    return %v220, %v260, %v303, %v343, %v386, %v426, %v469, %v509, %v552, %v592, %v635, %v675, %v718, %v758, %v801, %v841, %v879, %v918, %v956, %v995, %v1033, %v1072, %v225, %v265, %v308, %v348, %v391, %v431, %v474, %v514, %v557, %v597, %v640, %v680, %v723, %v763, %v806, %v846, %v884, %v923, %v961, %v1000, %v1038, %v1077, %v231, %v271, %v314, %v354, %v397, %v437, %v480, %v520, %v563, %v603, %v646, %v686, %v729, %v769, %v812, %v852, %v890, %v929, %v967, %v1006, %v1044, %v1083, %loss, %bc1, %bc2 : tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>
  }
}
