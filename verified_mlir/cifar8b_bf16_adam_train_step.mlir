module @m {
  func.func @cifar8b_bf16_adam_train_step(%x: tensor<128x3072xf32>, %W1: tensor<16x3x3x3xf32>, %cb1: tensor<16xf32>, %W2: tensor<16x16x3x3xf32>, %cb2: tensor<16xf32>, %W3: tensor<16x16x3x3xf32>, %cb3: tensor<16xf32>, %W4: tensor<16x16x3x3xf32>, %cb4: tensor<16xf32>, %W5: tensor<32x16x3x3xf32>, %cb5: tensor<32xf32>, %W6: tensor<32x32x3x3xf32>, %cb6: tensor<32xf32>, %W7: tensor<32x32x3x3xf32>, %cb7: tensor<32xf32>, %W8: tensor<32x32x3x3xf32>, %cb8: tensor<32xf32>, %W9: tensor<128x64xf32>, %b9: tensor<64xf32>, %Wa: tensor<64x64xf32>, %ba: tensor<64xf32>, %Wb: tensor<64x10xf32>, %bb: tensor<10xf32>, %W1m: tensor<16x3x3x3xf32>, %cb1m: tensor<16xf32>, %W2m: tensor<16x16x3x3xf32>, %cb2m: tensor<16xf32>, %W3m: tensor<16x16x3x3xf32>, %cb3m: tensor<16xf32>, %W4m: tensor<16x16x3x3xf32>, %cb4m: tensor<16xf32>, %W5m: tensor<32x16x3x3xf32>, %cb5m: tensor<32xf32>, %W6m: tensor<32x32x3x3xf32>, %cb6m: tensor<32xf32>, %W7m: tensor<32x32x3x3xf32>, %cb7m: tensor<32xf32>, %W8m: tensor<32x32x3x3xf32>, %cb8m: tensor<32xf32>, %W9m: tensor<128x64xf32>, %b9m: tensor<64xf32>, %Wam: tensor<64x64xf32>, %bam: tensor<64xf32>, %Wbm: tensor<64x10xf32>, %bbm: tensor<10xf32>, %W1v: tensor<16x3x3x3xf32>, %cb1v: tensor<16xf32>, %W2v: tensor<16x16x3x3xf32>, %cb2v: tensor<16xf32>, %W3v: tensor<16x16x3x3xf32>, %cb3v: tensor<16xf32>, %W4v: tensor<16x16x3x3xf32>, %cb4v: tensor<16xf32>, %W5v: tensor<32x16x3x3xf32>, %cb5v: tensor<32xf32>, %W6v: tensor<32x32x3x3xf32>, %cb6v: tensor<32xf32>, %W7v: tensor<32x32x3x3xf32>, %cb7v: tensor<32xf32>, %W8v: tensor<32x32x3x3xf32>, %cb8v: tensor<32xf32>, %W9v: tensor<128x64xf32>, %b9v: tensor<64xf32>, %Wav: tensor<64x64xf32>, %bav: tensor<64xf32>, %Wbv: tensor<64x10xf32>, %bbv: tensor<10xf32>, %lr: tensor<f32>, %bc1: tensor<f32>, %bc2: tensor<f32>, %onehot: tensor<128x10xf32>) -> (tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>) {
    ...
    %v962 = stablehlo.dot_general %v111, %v146, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x64xf32>) -> tensor<128x64xf32>
    %v963 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v964 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v965 = stablehlo.multiply %v963, %W9m : tensor<128x64xf32>
    %v966 = stablehlo.multiply %v964, %v962 : tensor<128x64xf32>
    %v967 = stablehlo.add %v965, %v966 : tensor<128x64xf32>
    %v968 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v969 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v970 = stablehlo.multiply %v968, %W9v : tensor<128x64xf32>
    %v971 = stablehlo.multiply %v962, %v962 : tensor<128x64xf32>
    %v972 = stablehlo.multiply %v969, %v971 : tensor<128x64xf32>
    %v973 = stablehlo.add %v970, %v972 : tensor<128x64xf32>
    %v974 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v975 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v976 = stablehlo.divide %v967, %v974 : tensor<128x64xf32>
    %v977 = stablehlo.divide %v973, %v975 : tensor<128x64xf32>
    %v978 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v979 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v980 = stablehlo.sqrt %v977 : tensor<128x64xf32>
    %v981 = stablehlo.add %v980, %v979 : tensor<128x64xf32>
    %v982 = stablehlo.divide %v976, %v981 : tensor<128x64xf32>
    %v983 = stablehlo.multiply %v978, %v982 : tensor<128x64xf32>
    %v984 = stablehlo.subtract %W9, %v983 : tensor<128x64xf32>
    %v985 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v986 = stablehlo.multiply %v985, %v978 : tensor<128x64xf32>
    %v987 = stablehlo.multiply %v986, %W9 : tensor<128x64xf32>
    %v988 = stablehlo.subtract %v984, %v987 : tensor<128x64xf32>
    %v989 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v990 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v991 = stablehlo.multiply %v989, %W9m : tensor<128x64xf32>
    %v992 = stablehlo.multiply %v990, %v962 : tensor<128x64xf32>
    %v993 = stablehlo.add %v991, %v992 : tensor<128x64xf32>
    %v994 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v995 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x64xf32>
    %v996 = stablehlo.multiply %v994, %W9v : tensor<128x64xf32>
    %v997 = stablehlo.multiply %v962, %v962 : tensor<128x64xf32>
    %v998 = stablehlo.multiply %v995, %v997 : tensor<128x64xf32>
    %v999 = stablehlo.add %v996, %v998 : tensor<128x64xf32>
    %v1000 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1001 = stablehlo.reduce(%v146 init: %v1000) applies stablehlo.add across dimensions = [0] : (tensor<128x64xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v1004 = stablehlo.multiply %v1002, %b9m : tensor<64xf32>
    ...
    %v1009 = stablehlo.multiply %v1007, %b9v : tensor<64xf32>
    ...
    %v1030 = stablehlo.multiply %v1028, %b9m : tensor<64xf32>
    ...
    %v1035 = stablehlo.multiply %v1033, %b9v : tensor<64xf32>
    ...
    %v1039 = stablehlo.dot_general %v116, %v140, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x64xf32>, tensor<128x64xf32>) -> tensor<64x64xf32>
    %v1040 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1041 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1042 = stablehlo.multiply %v1040, %Wam : tensor<64x64xf32>
    %v1043 = stablehlo.multiply %v1041, %v1039 : tensor<64x64xf32>
    %v1044 = stablehlo.add %v1042, %v1043 : tensor<64x64xf32>
    %v1045 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1046 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1047 = stablehlo.multiply %v1045, %Wav : tensor<64x64xf32>
    %v1048 = stablehlo.multiply %v1039, %v1039 : tensor<64x64xf32>
    %v1049 = stablehlo.multiply %v1046, %v1048 : tensor<64x64xf32>
    %v1050 = stablehlo.add %v1047, %v1049 : tensor<64x64xf32>
    %v1051 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1052 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1053 = stablehlo.divide %v1044, %v1051 : tensor<64x64xf32>
    %v1054 = stablehlo.divide %v1050, %v1052 : tensor<64x64xf32>
    %v1055 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1056 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1057 = stablehlo.sqrt %v1054 : tensor<64x64xf32>
    %v1058 = stablehlo.add %v1057, %v1056 : tensor<64x64xf32>
    %v1059 = stablehlo.divide %v1053, %v1058 : tensor<64x64xf32>
    %v1060 = stablehlo.multiply %v1055, %v1059 : tensor<64x64xf32>
    %v1061 = stablehlo.subtract %Wa, %v1060 : tensor<64x64xf32>
    %v1062 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1063 = stablehlo.multiply %v1062, %v1055 : tensor<64x64xf32>
    %v1064 = stablehlo.multiply %v1063, %Wa : tensor<64x64xf32>
    %v1065 = stablehlo.subtract %v1061, %v1064 : tensor<64x64xf32>
    %v1066 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1067 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1068 = stablehlo.multiply %v1066, %Wam : tensor<64x64xf32>
    %v1069 = stablehlo.multiply %v1067, %v1039 : tensor<64x64xf32>
    %v1070 = stablehlo.add %v1068, %v1069 : tensor<64x64xf32>
    %v1071 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1072 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64x64xf32>
    %v1073 = stablehlo.multiply %v1071, %Wav : tensor<64x64xf32>
    %v1074 = stablehlo.multiply %v1039, %v1039 : tensor<64x64xf32>
    %v1075 = stablehlo.multiply %v1072, %v1074 : tensor<64x64xf32>
    %v1076 = stablehlo.add %v1073, %v1075 : tensor<64x64xf32>
    %v1077 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1078 = stablehlo.reduce(%v140 init: %v1077) applies stablehlo.add across dimensions = [0] : (tensor<128x64xf32>, tensor<f32>) -> tensor<64xf32>
    %v1079 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1080 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1081 = stablehlo.multiply %v1079, %bam : tensor<64xf32>
    %v1082 = stablehlo.multiply %v1080, %v1078 : tensor<64xf32>
    %v1083 = stablehlo.add %v1081, %v1082 : tensor<64xf32>
    %v1084 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1085 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1086 = stablehlo.multiply %v1084, %bav : tensor<64xf32>
    %v1087 = stablehlo.multiply %v1078, %v1078 : tensor<64xf32>
    %v1088 = stablehlo.multiply %v1085, %v1087 : tensor<64xf32>
    %v1089 = stablehlo.add %v1086, %v1088 : tensor<64xf32>
    %v1090 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1091 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1092 = stablehlo.divide %v1083, %v1090 : tensor<64xf32>
    %v1093 = stablehlo.divide %v1089, %v1091 : tensor<64xf32>
    %v1094 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1095 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1096 = stablehlo.sqrt %v1093 : tensor<64xf32>
    %v1097 = stablehlo.add %v1096, %v1095 : tensor<64xf32>
    %v1098 = stablehlo.divide %v1092, %v1097 : tensor<64xf32>
    %v1099 = stablehlo.multiply %v1094, %v1098 : tensor<64xf32>
    %v1100 = stablehlo.subtract %ba, %v1099 : tensor<64xf32>
    %v1101 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1102 = stablehlo.multiply %v1101, %v1094 : tensor<64xf32>
    %v1103 = stablehlo.multiply %v1102, %ba : tensor<64xf32>
    %v1104 = stablehlo.subtract %v1100, %v1103 : tensor<64xf32>
    %v1105 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1106 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1107 = stablehlo.multiply %v1105, %bam : tensor<64xf32>
    %v1108 = stablehlo.multiply %v1106, %v1078 : tensor<64xf32>
    %v1109 = stablehlo.add %v1107, %v1108 : tensor<64xf32>
    %v1110 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1111 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %v1112 = stablehlo.multiply %v1110, %bav : tensor<64xf32>
    %v1113 = stablehlo.multiply %v1078, %v1078 : tensor<64xf32>
    %v1114 = stablehlo.multiply %v1111, %v1113 : tensor<64xf32>
    %v1115 = stablehlo.add %v1112, %v1114 : tensor<64xf32>
    %v1116 = stablehlo.dot_general %v121, %v134, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x64xf32>, tensor<128x10xf32>) -> tensor<64x10xf32>
    %v1117 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1118 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1119 = stablehlo.multiply %v1117, %Wbm : tensor<64x10xf32>
    %v1120 = stablehlo.multiply %v1118, %v1116 : tensor<64x10xf32>
    %v1121 = stablehlo.add %v1119, %v1120 : tensor<64x10xf32>
    %v1122 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1123 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1124 = stablehlo.multiply %v1122, %Wbv : tensor<64x10xf32>
    %v1125 = stablehlo.multiply %v1116, %v1116 : tensor<64x10xf32>
    %v1126 = stablehlo.multiply %v1123, %v1125 : tensor<64x10xf32>
    %v1127 = stablehlo.add %v1124, %v1126 : tensor<64x10xf32>
    %v1128 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1129 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1130 = stablehlo.divide %v1121, %v1128 : tensor<64x10xf32>
    %v1131 = stablehlo.divide %v1127, %v1129 : tensor<64x10xf32>
    %v1132 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1133 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1134 = stablehlo.sqrt %v1131 : tensor<64x10xf32>
    %v1135 = stablehlo.add %v1134, %v1133 : tensor<64x10xf32>
    %v1136 = stablehlo.divide %v1130, %v1135 : tensor<64x10xf32>
    %v1137 = stablehlo.multiply %v1132, %v1136 : tensor<64x10xf32>
    %v1138 = stablehlo.subtract %Wb, %v1137 : tensor<64x10xf32>
    %v1139 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1140 = stablehlo.multiply %v1139, %v1132 : tensor<64x10xf32>
    %v1141 = stablehlo.multiply %v1140, %Wb : tensor<64x10xf32>
    %v1142 = stablehlo.subtract %v1138, %v1141 : tensor<64x10xf32>
    %v1143 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1144 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1145 = stablehlo.multiply %v1143, %Wbm : tensor<64x10xf32>
    %v1146 = stablehlo.multiply %v1144, %v1116 : tensor<64x10xf32>
    %v1147 = stablehlo.add %v1145, %v1146 : tensor<64x10xf32>
    %v1148 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1149 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<64x10xf32>
    %v1150 = stablehlo.multiply %v1148, %Wbv : tensor<64x10xf32>
    %v1151 = stablehlo.multiply %v1116, %v1116 : tensor<64x10xf32>
    %v1152 = stablehlo.multiply %v1149, %v1151 : tensor<64x10xf32>
    %v1153 = stablehlo.add %v1150, %v1152 : tensor<64x10xf32>
    ...
    return %v308, %v348, %v394, %v434, %v480, %v520, %v566, %v606, %v652, %v692, %v738, %v778, %v824, %v864, %v910, %v950, %v988, %v1027, %v1065, %v1104, %v1142, %v1181, %v313, %v353, %v399, %v439, %v485, %v525, %v571, %v611, %v657, %v697, %v743, %v783, %v829, %v869, %v915, %v955, %v993, %v1032, %v1070, %v1109, %v1147, %v1186, %v319, %v359, %v405, %v445, %v491, %v531, %v577, %v617, %v663, %v703, %v749, %v789, %v835, %v875, %v921, %v961, %v999, %v1038, %v1076, %v1115, %v1153, %v1192, %loss, %bc1, %bc2 : tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>
  }
}
