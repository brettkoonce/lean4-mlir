...
| `convnext_adamwx_train_step.mlir` | train_step | `adamwx` | AdamW, wd-on-x | 1.0 | `LeanMlir/Proofs/Codegen/ConvNeXtRenderB.lean` | — |
...
| `convnextin_adamwxclipdropbf16_train_step.mlir` | train_step | `adamwxclipdropbf16` | AdamW, stochastic depth, wd-on-x, grad clip, bf16 | 1.2 | `LeanMlir/Proofs/Codegen/ConvNeXtRenderB.lean` | — |
...
| `mnv4in_adam64bf16_train_step.mlir` | train_step | `adam64bf16` | AdamW, bf16, batch 64 | 1.6 | `LeanMlir/Proofs/Codegen/MobileNetV4RenderB.lean` | 3 |
...
| `mnv4in_adamdp64bf16_train_step.mlir` | train_step | `adamdp64bf16` | AdamW, data-parallel, bf16, batch 64 | 1.8 | `LeanMlir/Proofs/Codegen/MobileNetV4RenderB.lean` | 6 |
...
| `resnet50in_emalambacc4x128wxclipdropbcebf16_train_step.mlir` | train_step | `emalambacc4x128wxclipdropbcebf16` | EMA shadow (4-region blob), LAMB, grad-accum ×4, stochastic depth, wd-on-x, grad clip, BCE loss, bf16 | 1.5 | `LeanMlir/Proofs/Codegen/ResNet50RenderB.lean` | — |
...
| `resnet50in_emalambacc4x128wxclipdropbcewd001bf16_train_step.mlir` | train_step | `emalambacc4x128wxclipdropbcewd001bf16` | EMA shadow (4-region blob), LAMB, grad-accum ×4, stochastic depth, wd-on-x, grad clip, BCE loss, bf16 | 1.5 | `LeanMlir/Proofs/Codegen/ResNet50RenderB.lean` | — |
| `resnet50in_emalambaccdp4x128wxclipdropbce_train_step.mlir` | train_step | `emalambaccdp4x128wxclipdropbce` | EMA shadow (4-region blob), LAMB, data-parallel, grad-accum ×4, stochastic depth, wd-on-x, grad clip, BCE loss | 1.7 | `LeanMlir/Proofs/Codegen/ResNet50RenderB.lean` | — |
| `resnet50in_emalambaccdp4x128wxclipdropbcebf16_train_step.mlir` | train_step | `emalambaccdp4x128wxclipdropbcebf16` | EMA shadow (4-region blob), LAMB, data-parallel, grad-accum ×4, stochastic depth, wd-on-x, grad clip, BCE loss, bf16 | 1.7 | `LeanMlir/Proofs/Codegen/ResNet50RenderB.lean` | — |
| `resnet50in_emalambaccdp4x128wxclipdropbcewd001_train_step.mlir` | train_step | `emalambaccdp4x128wxclipdropbcewd001` | EMA shadow (4-region blob), LAMB, data-parallel, grad-accum ×4, stochastic depth, wd-on-x, grad clip, BCE loss | 1.7 | `LeanMlir/Proofs/Codegen/ResNet50RenderB.lean` | — |
| `resnet50in_emalambaccdp4x128wxclipdropbcewd001bf16_train_step.mlir` | train_step | `emalambaccdp4x128wxclipdropbcewd001bf16` | EMA shadow (4-region blob), LAMB, data-parallel, grad-accum ×4, stochastic depth, wd-on-x, grad clip, BCE loss, bf16 | 1.7 | `LeanMlir/Proofs/Codegen/ResNet50RenderB.lean` | — |
...
| `resnet50in160_lambaccdp8x64wxclipbce_train_step.mlir` | train_step | `lambaccdp8x64wxclipbce` | LAMB, data-parallel, grad-accum ×8, wd-on-x, grad clip, BCE loss | 1.6 | `LeanMlir/Proofs/Codegen/ResNet50RenderB.lean` | — |
| `resnet50in160_lambaccdp8x64wxclipbcebf16_train_step.mlir` | train_step | `lambaccdp8x64wxclipbcebf16` | LAMB, data-parallel, grad-accum ×8, wd-on-x, grad clip, BCE loss, bf16 | 1.6 | `LeanMlir/Proofs/Codegen/ResNet50RenderB.lean` | — |
...
| `vit_adamwx_train_step.mlir` | train_step | `adamwx` | AdamW, wd-on-x | 1.2 | `LeanMlir/Proofs/Codegen/ViTRenderB.lean` | — |
...
| `vitin_adam128wxclip_train_step.mlir` | train_step | `adam128wxclip` | AdamW, wd-on-x, grad clip, batch 128 | 1.4 | `LeanMlir/Proofs/Codegen/ViTRenderB.lean` | — |
...
| `vitin_adamwxclipdropbf16_train_step.mlir` | train_step | `adamwxclipdropbf16` | AdamW, stochastic depth, wd-on-x, grad clip, bf16 | 1.5 | `LeanMlir/Proofs/Codegen/ViTRenderB.lean` | — |
...
| `vitin_emadp128x4wxclipdropbf16_train_step.mlir` | train_step | `emadp128x4wxclipdropbf16` | EMA shadow (4-region blob), data-parallel, stochastic depth, wd-on-x, grad clip, bf16, batch 128 | 1.7 | `LeanMlir/Proofs/Codegen/ViTRenderB.lean` | — |
...
| `vitsin_adamdp128x4wxclipdrop_train_step.mlir` | train_step | `adamdp128x4wxclipdrop` | AdamW, data-parallel, stochastic depth, wd-on-x, grad clip, batch 128 | 1.9 | `LeanMlir/Proofs/Codegen/ViTRenderB.lean` | 2 |
| `vitsin_adamdp128x4wxclipdropbf16_train_step.mlir` | train_step | `adamdp128x4wxclipdropbf16` | AdamW, data-parallel, stochastic depth, wd-on-x, grad clip, bf16, batch 128 | 2.0 | `LeanMlir/Proofs/Codegen/ViTRenderB.lean` | 2 |
