module @m {
  func.func @mlp_4096x512_train_step(%x: tensor<128x784xf32>, %W0: tensor<784x4096xf32>, %b0: tensor<4096xf32>, %W1: tensor<4096x512xf32>, %b1: tensor<512xf32>, %W2: tensor<512x10xf32>, %b2: tensor<10xf32>, %onehot: tensor<128x10xf32>) -> (tensor<784x4096xf32>, tensor<4096xf32>, tensor<4096x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>) {
    ...
    %v5 = stablehlo.dot_general %v4, %W1, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x4096xf32>, tensor<4096x512xf32>) -> tensor<128x512xf32>
    ...
    %v23 = stablehlo.dot_general %v22, %W1, contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<128x512xf32>, tensor<4096x512xf32>) -> tensor<128x4096xf32>
    ...
    %v36 = stablehlo.dot_general %v4, %v22, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x4096xf32>, tensor<128x512xf32>) -> tensor<4096x512xf32>
    %v37 = stablehlo.constant dense<0.00078125> : tensor<4096x512xf32>
    %v38 = stablehlo.multiply %v36, %v37 : tensor<4096x512xf32>
    %v39 = stablehlo.subtract %W1, %v38 : tensor<4096x512xf32>
    ...
    return %v48, %v53, %v39, %v44, %v30, %v35 : tensor<784x4096xf32>, tensor<4096xf32>, tensor<4096x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>
  }
}
