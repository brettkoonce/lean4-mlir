module @m {
  func.func @cifar8_adamdp_train_step(%x: tensor<128x3072xf32>, %W1: tensor<16x3x3x3xf32>, %cb1: tensor<16xf32>, %W2: tensor<16x16x3x3xf32>, %cb2: tensor<16xf32>, %W3: tensor<16x16x3x3xf32>, %cb3: tensor<16xf32>, %W4: tensor<16x16x3x3xf32>, %cb4: tensor<16xf32>, %W5: tensor<32x16x3x3xf32>, %cb5: tensor<32xf32>, %W6: tensor<32x32x3x3xf32>, %cb6: tensor<32xf32>, %W7: tensor<32x32x3x3xf32>, %cb7: tensor<32xf32>, %W8: tensor<32x32x3x3xf32>, %cb8: tensor<32xf32>, %W9: tensor<128x64xf32>, %b9: tensor<64xf32>, %Wa: tensor<64x64xf32>, %ba: tensor<64xf32>, %Wb: tensor<64x10xf32>, %bb: tensor<10xf32>, %W1m: tensor<16x3x3x3xf32>, %cb1m: tensor<16xf32>, %W2m: tensor<16x16x3x3xf32>, %cb2m: tensor<16xf32>, %W3m: tensor<16x16x3x3xf32>, %cb3m: tensor<16xf32>, %W4m: tensor<16x16x3x3xf32>, %cb4m: tensor<16xf32>, %W5m: tensor<32x16x3x3xf32>, %cb5m: tensor<32xf32>, %W6m: tensor<32x32x3x3xf32>, %cb6m: tensor<32xf32>, %W7m: tensor<32x32x3x3xf32>, %cb7m: tensor<32xf32>, %W8m: tensor<32x32x3x3xf32>, %cb8m: tensor<32xf32>, %W9m: tensor<128x64xf32>, %b9m: tensor<64xf32>, %Wam: tensor<64x64xf32>, %bam: tensor<64xf32>, %Wbm: tensor<64x10xf32>, %bbm: tensor<10xf32>, %W1v: tensor<16x3x3x3xf32>, %cb1v: tensor<16xf32>, %W2v: tensor<16x16x3x3xf32>, %cb2v: tensor<16xf32>, %W3v: tensor<16x16x3x3xf32>, %cb3v: tensor<16xf32>, %W4v: tensor<16x16x3x3xf32>, %cb4v: tensor<16xf32>, %W5v: tensor<32x16x3x3xf32>, %cb5v: tensor<32xf32>, %W6v: tensor<32x32x3x3xf32>, %cb6v: tensor<32xf32>, %W7v: tensor<32x32x3x3xf32>, %cb7v: tensor<32xf32>, %W8v: tensor<32x32x3x3xf32>, %cb8v: tensor<32xf32>, %W9v: tensor<128x64xf32>, %b9v: tensor<64xf32>, %Wav: tensor<64x64xf32>, %bav: tensor<64xf32>, %Wbv: tensor<64x10xf32>, %bbv: tensor<10xf32>, %lr: tensor<f32>, %bc1: tensor<f32>, %bc2: tensor<f32>, %onehot: tensor<128x10xf32>) -> (tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>) {
    ...
    %arsumW1 = "stablehlo.all_reduce"(%v226) ({
    ...
    %v230 = stablehlo.multiply %v228, %armeanW1 : tensor<16x3x3x3xf32>
    ...
    %v235 = stablehlo.multiply %armeanW1, %armeanW1 : tensor<16x3x3x3xf32>
    ...
    %v256 = stablehlo.multiply %v254, %armeanW1 : tensor<16x3x3x3xf32>
    ...
    %v261 = stablehlo.multiply %armeanW1, %armeanW1 : tensor<16x3x3x3xf32>
    ...
    %arsumcb1 = "stablehlo.all_reduce"(%v266) ({
    ...
    %v270 = stablehlo.multiply %v268, %armeancb1 : tensor<16xf32>
    ...
    %v275 = stablehlo.multiply %armeancb1, %armeancb1 : tensor<16xf32>
    ...
    %v296 = stablehlo.multiply %v294, %armeancb1 : tensor<16xf32>
    ...
    %v301 = stablehlo.multiply %armeancb1, %armeancb1 : tensor<16xf32>
    ...
    %arsumW2 = "stablehlo.all_reduce"(%v309) ({
    ...
    %v313 = stablehlo.multiply %v311, %armeanW2 : tensor<16x16x3x3xf32>
    ...
    %v318 = stablehlo.multiply %armeanW2, %armeanW2 : tensor<16x16x3x3xf32>
    ...
    %v339 = stablehlo.multiply %v337, %armeanW2 : tensor<16x16x3x3xf32>
    ...
    %v344 = stablehlo.multiply %armeanW2, %armeanW2 : tensor<16x16x3x3xf32>
    ...
    %arsumcb2 = "stablehlo.all_reduce"(%v349) ({
    ...
    %v353 = stablehlo.multiply %v351, %armeancb2 : tensor<16xf32>
    ...
    %v358 = stablehlo.multiply %armeancb2, %armeancb2 : tensor<16xf32>
    ...
    %v379 = stablehlo.multiply %v377, %armeancb2 : tensor<16xf32>
    ...
    %v384 = stablehlo.multiply %armeancb2, %armeancb2 : tensor<16xf32>
    ...
    %arsumW3 = "stablehlo.all_reduce"(%v392) ({
    ...
    %v396 = stablehlo.multiply %v394, %armeanW3 : tensor<16x16x3x3xf32>
    ...
    %v401 = stablehlo.multiply %armeanW3, %armeanW3 : tensor<16x16x3x3xf32>
    ...
    %v422 = stablehlo.multiply %v420, %armeanW3 : tensor<16x16x3x3xf32>
    ...
    %v427 = stablehlo.multiply %armeanW3, %armeanW3 : tensor<16x16x3x3xf32>
    ...
    %arsumcb3 = "stablehlo.all_reduce"(%v432) ({
    ...
    %v436 = stablehlo.multiply %v434, %armeancb3 : tensor<16xf32>
    ...
    %v441 = stablehlo.multiply %armeancb3, %armeancb3 : tensor<16xf32>
    ...
    %v462 = stablehlo.multiply %v460, %armeancb3 : tensor<16xf32>
    ...
    %v467 = stablehlo.multiply %armeancb3, %armeancb3 : tensor<16xf32>
    ...
    %arsumW4 = "stablehlo.all_reduce"(%v475) ({
    ...
    %v479 = stablehlo.multiply %v477, %armeanW4 : tensor<16x16x3x3xf32>
    ...
    %v484 = stablehlo.multiply %armeanW4, %armeanW4 : tensor<16x16x3x3xf32>
    ...
    %v505 = stablehlo.multiply %v503, %armeanW4 : tensor<16x16x3x3xf32>
    ...
    %v510 = stablehlo.multiply %armeanW4, %armeanW4 : tensor<16x16x3x3xf32>
    ...
    %arsumcb4 = "stablehlo.all_reduce"(%v515) ({
    ...
    %v519 = stablehlo.multiply %v517, %armeancb4 : tensor<16xf32>
    ...
    %v524 = stablehlo.multiply %armeancb4, %armeancb4 : tensor<16xf32>
    ...
    %v545 = stablehlo.multiply %v543, %armeancb4 : tensor<16xf32>
    ...
    %v550 = stablehlo.multiply %armeancb4, %armeancb4 : tensor<16xf32>
    ...
    %arsumW5 = "stablehlo.all_reduce"(%v558) ({
    ...
    %v562 = stablehlo.multiply %v560, %armeanW5 : tensor<32x16x3x3xf32>
    ...
    %v567 = stablehlo.multiply %armeanW5, %armeanW5 : tensor<32x16x3x3xf32>
    ...
    %v588 = stablehlo.multiply %v586, %armeanW5 : tensor<32x16x3x3xf32>
    ...
    %v593 = stablehlo.multiply %armeanW5, %armeanW5 : tensor<32x16x3x3xf32>
    ...
    %arsumcb5 = "stablehlo.all_reduce"(%v598) ({
    ...
    %v602 = stablehlo.multiply %v600, %armeancb5 : tensor<32xf32>
    ...
    %v607 = stablehlo.multiply %armeancb5, %armeancb5 : tensor<32xf32>
    ...
    %v628 = stablehlo.multiply %v626, %armeancb5 : tensor<32xf32>
    ...
    %v633 = stablehlo.multiply %armeancb5, %armeancb5 : tensor<32xf32>
    ...
    %arsumW6 = "stablehlo.all_reduce"(%v641) ({
    ...
    %v645 = stablehlo.multiply %v643, %armeanW6 : tensor<32x32x3x3xf32>
    ...
    %v650 = stablehlo.multiply %armeanW6, %armeanW6 : tensor<32x32x3x3xf32>
    ...
    %v671 = stablehlo.multiply %v669, %armeanW6 : tensor<32x32x3x3xf32>
    ...
    %v676 = stablehlo.multiply %armeanW6, %armeanW6 : tensor<32x32x3x3xf32>
    ...
    %arsumcb6 = "stablehlo.all_reduce"(%v681) ({
    ...
    %v685 = stablehlo.multiply %v683, %armeancb6 : tensor<32xf32>
    ...
    %v690 = stablehlo.multiply %armeancb6, %armeancb6 : tensor<32xf32>
    ...
    %v711 = stablehlo.multiply %v709, %armeancb6 : tensor<32xf32>
    ...
    %v716 = stablehlo.multiply %armeancb6, %armeancb6 : tensor<32xf32>
    ...
    %arsumW7 = "stablehlo.all_reduce"(%v724) ({
    ...
    %v728 = stablehlo.multiply %v726, %armeanW7 : tensor<32x32x3x3xf32>
    ...
    %v733 = stablehlo.multiply %armeanW7, %armeanW7 : tensor<32x32x3x3xf32>
    ...
    %v754 = stablehlo.multiply %v752, %armeanW7 : tensor<32x32x3x3xf32>
    ...
    %v759 = stablehlo.multiply %armeanW7, %armeanW7 : tensor<32x32x3x3xf32>
    ...
    %arsumcb7 = "stablehlo.all_reduce"(%v764) ({
    ...
    %v768 = stablehlo.multiply %v766, %armeancb7 : tensor<32xf32>
    ...
    %v773 = stablehlo.multiply %armeancb7, %armeancb7 : tensor<32xf32>
    ...
    %v794 = stablehlo.multiply %v792, %armeancb7 : tensor<32xf32>
    ...
    %v799 = stablehlo.multiply %armeancb7, %armeancb7 : tensor<32xf32>
    ...
    %arsumW8 = "stablehlo.all_reduce"(%v807) ({
    ...
    %v811 = stablehlo.multiply %v809, %armeanW8 : tensor<32x32x3x3xf32>
    ...
    %v816 = stablehlo.multiply %armeanW8, %armeanW8 : tensor<32x32x3x3xf32>
    ...
    %v837 = stablehlo.multiply %v835, %armeanW8 : tensor<32x32x3x3xf32>
    ...
    %v842 = stablehlo.multiply %armeanW8, %armeanW8 : tensor<32x32x3x3xf32>
    ...
    %arsumcb8 = "stablehlo.all_reduce"(%v847) ({
    ...
    %v851 = stablehlo.multiply %v849, %armeancb8 : tensor<32xf32>
    ...
    %v856 = stablehlo.multiply %armeancb8, %armeancb8 : tensor<32xf32>
    ...
    %v877 = stablehlo.multiply %v875, %armeancb8 : tensor<32xf32>
    ...
    %v882 = stablehlo.multiply %armeancb8, %armeancb8 : tensor<32xf32>
    ...
    %arsumW9 = "stablehlo.all_reduce"(%v885) ({
    ...
    %v889 = stablehlo.multiply %v887, %armeanW9 : tensor<128x64xf32>
    ...
    %v894 = stablehlo.multiply %armeanW9, %armeanW9 : tensor<128x64xf32>
    ...
    %v915 = stablehlo.multiply %v913, %armeanW9 : tensor<128x64xf32>
    ...
    %v920 = stablehlo.multiply %armeanW9, %armeanW9 : tensor<128x64xf32>
    ...
    %arsumb9 = "stablehlo.all_reduce"(%v924) ({
    ...
    %v928 = stablehlo.multiply %v926, %armeanb9 : tensor<64xf32>
    ...
    %v933 = stablehlo.multiply %armeanb9, %armeanb9 : tensor<64xf32>
    ...
    %v954 = stablehlo.multiply %v952, %armeanb9 : tensor<64xf32>
    ...
    %v959 = stablehlo.multiply %armeanb9, %armeanb9 : tensor<64xf32>
    ...
    %arsumWa = "stablehlo.all_reduce"(%v962) ({
    ...
    %v966 = stablehlo.multiply %v964, %armeanWa : tensor<64x64xf32>
    ...
    %v971 = stablehlo.multiply %armeanWa, %armeanWa : tensor<64x64xf32>
    ...
    %v992 = stablehlo.multiply %v990, %armeanWa : tensor<64x64xf32>
    ...
    %v997 = stablehlo.multiply %armeanWa, %armeanWa : tensor<64x64xf32>
    ...
    %arsumba = "stablehlo.all_reduce"(%v1001) ({
    ...
    %v1005 = stablehlo.multiply %v1003, %armeanba : tensor<64xf32>
    ...
    %v1010 = stablehlo.multiply %armeanba, %armeanba : tensor<64xf32>
    ...
    %v1031 = stablehlo.multiply %v1029, %armeanba : tensor<64xf32>
    ...
    %v1036 = stablehlo.multiply %armeanba, %armeanba : tensor<64xf32>
    ...
    %arsumWb = "stablehlo.all_reduce"(%v1039) ({
    ...
    %v1043 = stablehlo.multiply %v1041, %armeanWb : tensor<64x10xf32>
    ...
    %v1048 = stablehlo.multiply %armeanWb, %armeanWb : tensor<64x10xf32>
    ...
    %v1069 = stablehlo.multiply %v1067, %armeanWb : tensor<64x10xf32>
    ...
    %v1074 = stablehlo.multiply %armeanWb, %armeanWb : tensor<64x10xf32>
    ...
    %arsumbb = "stablehlo.all_reduce"(%v1078) ({
    ...
    %v1082 = stablehlo.multiply %v1080, %armeanbb : tensor<10xf32>
    ...
    %v1087 = stablehlo.multiply %armeanbb, %armeanbb : tensor<10xf32>
    ...
    %v1108 = stablehlo.multiply %v1106, %armeanbb : tensor<10xf32>
    ...
    %v1113 = stablehlo.multiply %armeanbb, %armeanbb : tensor<10xf32>
