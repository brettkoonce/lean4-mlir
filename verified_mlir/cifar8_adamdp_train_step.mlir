module @m {
  func.func @cifar8_adamdp_train_step(%x: tensor<128x3072xf32>, %W1: tensor<16x3x3x3xf32>, %cb1: tensor<16xf32>, %W2: tensor<16x16x3x3xf32>, %cb2: tensor<16xf32>, %W3: tensor<16x16x3x3xf32>, %cb3: tensor<16xf32>, %W4: tensor<16x16x3x3xf32>, %cb4: tensor<16xf32>, %W5: tensor<32x16x3x3xf32>, %cb5: tensor<32xf32>, %W6: tensor<32x32x3x3xf32>, %cb6: tensor<32xf32>, %W7: tensor<32x32x3x3xf32>, %cb7: tensor<32xf32>, %W8: tensor<32x32x3x3xf32>, %cb8: tensor<32xf32>, %W9: tensor<128x64xf32>, %b9: tensor<64xf32>, %Wa: tensor<64x64xf32>, %ba: tensor<64xf32>, %Wb: tensor<64x10xf32>, %bb: tensor<10xf32>, %W1m: tensor<16x3x3x3xf32>, %cb1m: tensor<16xf32>, %W2m: tensor<16x16x3x3xf32>, %cb2m: tensor<16xf32>, %W3m: tensor<16x16x3x3xf32>, %cb3m: tensor<16xf32>, %W4m: tensor<16x16x3x3xf32>, %cb4m: tensor<16xf32>, %W5m: tensor<32x16x3x3xf32>, %cb5m: tensor<32xf32>, %W6m: tensor<32x32x3x3xf32>, %cb6m: tensor<32xf32>, %W7m: tensor<32x32x3x3xf32>, %cb7m: tensor<32xf32>, %W8m: tensor<32x32x3x3xf32>, %cb8m: tensor<32xf32>, %W9m: tensor<128x64xf32>, %b9m: tensor<64xf32>, %Wam: tensor<64x64xf32>, %bam: tensor<64xf32>, %Wbm: tensor<64x10xf32>, %bbm: tensor<10xf32>, %W1v: tensor<16x3x3x3xf32>, %cb1v: tensor<16xf32>, %W2v: tensor<16x16x3x3xf32>, %cb2v: tensor<16xf32>, %W3v: tensor<16x16x3x3xf32>, %cb3v: tensor<16xf32>, %W4v: tensor<16x16x3x3xf32>, %cb4v: tensor<16xf32>, %W5v: tensor<32x16x3x3xf32>, %cb5v: tensor<32xf32>, %W6v: tensor<32x32x3x3xf32>, %cb6v: tensor<32xf32>, %W7v: tensor<32x32x3x3xf32>, %cb7v: tensor<32xf32>, %W8v: tensor<32x32x3x3xf32>, %cb8v: tensor<32xf32>, %W9v: tensor<128x64xf32>, %b9v: tensor<64xf32>, %Wav: tensor<64x64xf32>, %bav: tensor<64xf32>, %Wbv: tensor<64x10xf32>, %bbv: tensor<10xf32>, %lr: tensor<f32>, %bc1: tensor<f32>, %bc2: tensor<f32>, %onehot: tensor<128x10xf32>) -> (tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>) {
    ...
    %arsumW1 = "stablehlo.all_reduce"(%v186) ({
    ^bb0(%araW1: tensor<f32>, %arbW1: tensor<f32>):
      %araddW1 = stablehlo.add %araW1, %arbW1 : tensor<f32>
      stablehlo.return %araddW1 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<16x3x3x3xf32>) -> tensor<16x3x3x3xf32>
    %arnW1 = stablehlo.constant dense<2.0> : tensor<16x3x3x3xf32>
    %armeanW1 = stablehlo.divide %arsumW1, %arnW1 : tensor<16x3x3x3xf32>
    ...
    %v190 = stablehlo.multiply %v188, %armeanW1 : tensor<16x3x3x3xf32>
    ...
    %v195 = stablehlo.multiply %armeanW1, %armeanW1 : tensor<16x3x3x3xf32>
    ...
    %v216 = stablehlo.multiply %v214, %armeanW1 : tensor<16x3x3x3xf32>
    ...
    %v221 = stablehlo.multiply %armeanW1, %armeanW1 : tensor<16x3x3x3xf32>
    ...
    %arsumcb1 = "stablehlo.all_reduce"(%v226) ({
    ^bb0(%aracb1: tensor<f32>, %arbcb1: tensor<f32>):
      %araddcb1 = stablehlo.add %aracb1, %arbcb1 : tensor<f32>
      stablehlo.return %araddcb1 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<16xf32>) -> tensor<16xf32>
    %arncb1 = stablehlo.constant dense<2.0> : tensor<16xf32>
    %armeancb1 = stablehlo.divide %arsumcb1, %arncb1 : tensor<16xf32>
    ...
    %v230 = stablehlo.multiply %v228, %armeancb1 : tensor<16xf32>
    ...
    %v235 = stablehlo.multiply %armeancb1, %armeancb1 : tensor<16xf32>
    ...
    %v256 = stablehlo.multiply %v254, %armeancb1 : tensor<16xf32>
    ...
    %v261 = stablehlo.multiply %armeancb1, %armeancb1 : tensor<16xf32>
    ...
    %arsumW2 = "stablehlo.all_reduce"(%v269) ({
    ^bb0(%araW2: tensor<f32>, %arbW2: tensor<f32>):
      %araddW2 = stablehlo.add %araW2, %arbW2 : tensor<f32>
      stablehlo.return %araddW2 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<16x16x3x3xf32>) -> tensor<16x16x3x3xf32>
    %arnW2 = stablehlo.constant dense<2.0> : tensor<16x16x3x3xf32>
    %armeanW2 = stablehlo.divide %arsumW2, %arnW2 : tensor<16x16x3x3xf32>
    ...
    %v273 = stablehlo.multiply %v271, %armeanW2 : tensor<16x16x3x3xf32>
    ...
    %v278 = stablehlo.multiply %armeanW2, %armeanW2 : tensor<16x16x3x3xf32>
    ...
    %v299 = stablehlo.multiply %v297, %armeanW2 : tensor<16x16x3x3xf32>
    ...
    %v304 = stablehlo.multiply %armeanW2, %armeanW2 : tensor<16x16x3x3xf32>
    ...
    %arsumcb2 = "stablehlo.all_reduce"(%v309) ({
    ^bb0(%aracb2: tensor<f32>, %arbcb2: tensor<f32>):
      %araddcb2 = stablehlo.add %aracb2, %arbcb2 : tensor<f32>
      stablehlo.return %araddcb2 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<16xf32>) -> tensor<16xf32>
    %arncb2 = stablehlo.constant dense<2.0> : tensor<16xf32>
    %armeancb2 = stablehlo.divide %arsumcb2, %arncb2 : tensor<16xf32>
    ...
    %v313 = stablehlo.multiply %v311, %armeancb2 : tensor<16xf32>
    ...
    %v318 = stablehlo.multiply %armeancb2, %armeancb2 : tensor<16xf32>
    ...
    %v339 = stablehlo.multiply %v337, %armeancb2 : tensor<16xf32>
    ...
    %v344 = stablehlo.multiply %armeancb2, %armeancb2 : tensor<16xf32>
    ...
    %arsumW3 = "stablehlo.all_reduce"(%v352) ({
    ^bb0(%araW3: tensor<f32>, %arbW3: tensor<f32>):
      %araddW3 = stablehlo.add %araW3, %arbW3 : tensor<f32>
      stablehlo.return %araddW3 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<16x16x3x3xf32>) -> tensor<16x16x3x3xf32>
    %arnW3 = stablehlo.constant dense<2.0> : tensor<16x16x3x3xf32>
    %armeanW3 = stablehlo.divide %arsumW3, %arnW3 : tensor<16x16x3x3xf32>
    ...
    %v356 = stablehlo.multiply %v354, %armeanW3 : tensor<16x16x3x3xf32>
    ...
    %v361 = stablehlo.multiply %armeanW3, %armeanW3 : tensor<16x16x3x3xf32>
    ...
    %v382 = stablehlo.multiply %v380, %armeanW3 : tensor<16x16x3x3xf32>
    ...
    %v387 = stablehlo.multiply %armeanW3, %armeanW3 : tensor<16x16x3x3xf32>
    ...
    %arsumcb3 = "stablehlo.all_reduce"(%v392) ({
    ^bb0(%aracb3: tensor<f32>, %arbcb3: tensor<f32>):
      %araddcb3 = stablehlo.add %aracb3, %arbcb3 : tensor<f32>
      stablehlo.return %araddcb3 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<16xf32>) -> tensor<16xf32>
    %arncb3 = stablehlo.constant dense<2.0> : tensor<16xf32>
    %armeancb3 = stablehlo.divide %arsumcb3, %arncb3 : tensor<16xf32>
    ...
    %v396 = stablehlo.multiply %v394, %armeancb3 : tensor<16xf32>
    ...
    %v401 = stablehlo.multiply %armeancb3, %armeancb3 : tensor<16xf32>
    ...
    %v422 = stablehlo.multiply %v420, %armeancb3 : tensor<16xf32>
    ...
    %v427 = stablehlo.multiply %armeancb3, %armeancb3 : tensor<16xf32>
    ...
    %arsumW4 = "stablehlo.all_reduce"(%v435) ({
    ^bb0(%araW4: tensor<f32>, %arbW4: tensor<f32>):
      %araddW4 = stablehlo.add %araW4, %arbW4 : tensor<f32>
      stablehlo.return %araddW4 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<16x16x3x3xf32>) -> tensor<16x16x3x3xf32>
    %arnW4 = stablehlo.constant dense<2.0> : tensor<16x16x3x3xf32>
    %armeanW4 = stablehlo.divide %arsumW4, %arnW4 : tensor<16x16x3x3xf32>
    ...
    %v439 = stablehlo.multiply %v437, %armeanW4 : tensor<16x16x3x3xf32>
    ...
    %v444 = stablehlo.multiply %armeanW4, %armeanW4 : tensor<16x16x3x3xf32>
    ...
    %v465 = stablehlo.multiply %v463, %armeanW4 : tensor<16x16x3x3xf32>
    ...
    %v470 = stablehlo.multiply %armeanW4, %armeanW4 : tensor<16x16x3x3xf32>
    ...
    %arsumcb4 = "stablehlo.all_reduce"(%v475) ({
    ^bb0(%aracb4: tensor<f32>, %arbcb4: tensor<f32>):
      %araddcb4 = stablehlo.add %aracb4, %arbcb4 : tensor<f32>
      stablehlo.return %araddcb4 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<16xf32>) -> tensor<16xf32>
    %arncb4 = stablehlo.constant dense<2.0> : tensor<16xf32>
    %armeancb4 = stablehlo.divide %arsumcb4, %arncb4 : tensor<16xf32>
    ...
    %v479 = stablehlo.multiply %v477, %armeancb4 : tensor<16xf32>
    ...
    %v484 = stablehlo.multiply %armeancb4, %armeancb4 : tensor<16xf32>
    ...
    %v505 = stablehlo.multiply %v503, %armeancb4 : tensor<16xf32>
    ...
    %v510 = stablehlo.multiply %armeancb4, %armeancb4 : tensor<16xf32>
    ...
    %arsumW5 = "stablehlo.all_reduce"(%v518) ({
    ^bb0(%araW5: tensor<f32>, %arbW5: tensor<f32>):
      %araddW5 = stablehlo.add %araW5, %arbW5 : tensor<f32>
      stablehlo.return %araddW5 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<32x16x3x3xf32>) -> tensor<32x16x3x3xf32>
    %arnW5 = stablehlo.constant dense<2.0> : tensor<32x16x3x3xf32>
    %armeanW5 = stablehlo.divide %arsumW5, %arnW5 : tensor<32x16x3x3xf32>
    ...
    %v522 = stablehlo.multiply %v520, %armeanW5 : tensor<32x16x3x3xf32>
    ...
    %v527 = stablehlo.multiply %armeanW5, %armeanW5 : tensor<32x16x3x3xf32>
    ...
    %v548 = stablehlo.multiply %v546, %armeanW5 : tensor<32x16x3x3xf32>
    ...
    %v553 = stablehlo.multiply %armeanW5, %armeanW5 : tensor<32x16x3x3xf32>
    ...
    %arsumcb5 = "stablehlo.all_reduce"(%v558) ({
    ^bb0(%aracb5: tensor<f32>, %arbcb5: tensor<f32>):
      %araddcb5 = stablehlo.add %aracb5, %arbcb5 : tensor<f32>
      stablehlo.return %araddcb5 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<32xf32>) -> tensor<32xf32>
    %arncb5 = stablehlo.constant dense<2.0> : tensor<32xf32>
    %armeancb5 = stablehlo.divide %arsumcb5, %arncb5 : tensor<32xf32>
    ...
    %v562 = stablehlo.multiply %v560, %armeancb5 : tensor<32xf32>
    ...
    %v567 = stablehlo.multiply %armeancb5, %armeancb5 : tensor<32xf32>
    ...
    %v588 = stablehlo.multiply %v586, %armeancb5 : tensor<32xf32>
    ...
    %v593 = stablehlo.multiply %armeancb5, %armeancb5 : tensor<32xf32>
    ...
    %arsumW6 = "stablehlo.all_reduce"(%v601) ({
    ^bb0(%araW6: tensor<f32>, %arbW6: tensor<f32>):
      %araddW6 = stablehlo.add %araW6, %arbW6 : tensor<f32>
      stablehlo.return %araddW6 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<32x32x3x3xf32>) -> tensor<32x32x3x3xf32>
    %arnW6 = stablehlo.constant dense<2.0> : tensor<32x32x3x3xf32>
    %armeanW6 = stablehlo.divide %arsumW6, %arnW6 : tensor<32x32x3x3xf32>
    ...
    %v605 = stablehlo.multiply %v603, %armeanW6 : tensor<32x32x3x3xf32>
    ...
    %v610 = stablehlo.multiply %armeanW6, %armeanW6 : tensor<32x32x3x3xf32>
    ...
    %v631 = stablehlo.multiply %v629, %armeanW6 : tensor<32x32x3x3xf32>
    ...
    %v636 = stablehlo.multiply %armeanW6, %armeanW6 : tensor<32x32x3x3xf32>
    ...
    %arsumcb6 = "stablehlo.all_reduce"(%v641) ({
    ^bb0(%aracb6: tensor<f32>, %arbcb6: tensor<f32>):
      %araddcb6 = stablehlo.add %aracb6, %arbcb6 : tensor<f32>
      stablehlo.return %araddcb6 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<32xf32>) -> tensor<32xf32>
    %arncb6 = stablehlo.constant dense<2.0> : tensor<32xf32>
    %armeancb6 = stablehlo.divide %arsumcb6, %arncb6 : tensor<32xf32>
    ...
    %v645 = stablehlo.multiply %v643, %armeancb6 : tensor<32xf32>
    ...
    %v650 = stablehlo.multiply %armeancb6, %armeancb6 : tensor<32xf32>
    ...
    %v671 = stablehlo.multiply %v669, %armeancb6 : tensor<32xf32>
    ...
    %v676 = stablehlo.multiply %armeancb6, %armeancb6 : tensor<32xf32>
    ...
    %arsumW7 = "stablehlo.all_reduce"(%v684) ({
    ^bb0(%araW7: tensor<f32>, %arbW7: tensor<f32>):
      %araddW7 = stablehlo.add %araW7, %arbW7 : tensor<f32>
      stablehlo.return %araddW7 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<32x32x3x3xf32>) -> tensor<32x32x3x3xf32>
    %arnW7 = stablehlo.constant dense<2.0> : tensor<32x32x3x3xf32>
    %armeanW7 = stablehlo.divide %arsumW7, %arnW7 : tensor<32x32x3x3xf32>
    ...
    %v688 = stablehlo.multiply %v686, %armeanW7 : tensor<32x32x3x3xf32>
    ...
    %v693 = stablehlo.multiply %armeanW7, %armeanW7 : tensor<32x32x3x3xf32>
    ...
    %v714 = stablehlo.multiply %v712, %armeanW7 : tensor<32x32x3x3xf32>
    ...
    %v719 = stablehlo.multiply %armeanW7, %armeanW7 : tensor<32x32x3x3xf32>
    ...
    %arsumcb7 = "stablehlo.all_reduce"(%v724) ({
    ^bb0(%aracb7: tensor<f32>, %arbcb7: tensor<f32>):
      %araddcb7 = stablehlo.add %aracb7, %arbcb7 : tensor<f32>
      stablehlo.return %araddcb7 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<32xf32>) -> tensor<32xf32>
    %arncb7 = stablehlo.constant dense<2.0> : tensor<32xf32>
    %armeancb7 = stablehlo.divide %arsumcb7, %arncb7 : tensor<32xf32>
    ...
    %v728 = stablehlo.multiply %v726, %armeancb7 : tensor<32xf32>
    ...
    %v733 = stablehlo.multiply %armeancb7, %armeancb7 : tensor<32xf32>
    ...
    %v754 = stablehlo.multiply %v752, %armeancb7 : tensor<32xf32>
    ...
    %v759 = stablehlo.multiply %armeancb7, %armeancb7 : tensor<32xf32>
    ...
    %arsumW8 = "stablehlo.all_reduce"(%v767) ({
    ^bb0(%araW8: tensor<f32>, %arbW8: tensor<f32>):
      %araddW8 = stablehlo.add %araW8, %arbW8 : tensor<f32>
      stablehlo.return %araddW8 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<32x32x3x3xf32>) -> tensor<32x32x3x3xf32>
    %arnW8 = stablehlo.constant dense<2.0> : tensor<32x32x3x3xf32>
    %armeanW8 = stablehlo.divide %arsumW8, %arnW8 : tensor<32x32x3x3xf32>
    ...
    %v771 = stablehlo.multiply %v769, %armeanW8 : tensor<32x32x3x3xf32>
    ...
    %v776 = stablehlo.multiply %armeanW8, %armeanW8 : tensor<32x32x3x3xf32>
    ...
    %v797 = stablehlo.multiply %v795, %armeanW8 : tensor<32x32x3x3xf32>
    ...
    %v802 = stablehlo.multiply %armeanW8, %armeanW8 : tensor<32x32x3x3xf32>
    ...
    %arsumcb8 = "stablehlo.all_reduce"(%v807) ({
    ^bb0(%aracb8: tensor<f32>, %arbcb8: tensor<f32>):
      %araddcb8 = stablehlo.add %aracb8, %arbcb8 : tensor<f32>
      stablehlo.return %araddcb8 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<32xf32>) -> tensor<32xf32>
    %arncb8 = stablehlo.constant dense<2.0> : tensor<32xf32>
    %armeancb8 = stablehlo.divide %arsumcb8, %arncb8 : tensor<32xf32>
    ...
    %v811 = stablehlo.multiply %v809, %armeancb8 : tensor<32xf32>
    ...
    %v816 = stablehlo.multiply %armeancb8, %armeancb8 : tensor<32xf32>
    ...
    %v837 = stablehlo.multiply %v835, %armeancb8 : tensor<32xf32>
    ...
    %v842 = stablehlo.multiply %armeancb8, %armeancb8 : tensor<32xf32>
    %v843 = stablehlo.multiply %v840, %v842 : tensor<32xf32>
    %v844 = stablehlo.add %v841, %v843 : tensor<32xf32>
    %v845 = stablehlo.dot_general %v71, %v100, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x64xf32>) -> tensor<128x64xf32>
    %arsumW9 = "stablehlo.all_reduce"(%v845) ({
    ^bb0(%araW9: tensor<f32>, %arbW9: tensor<f32>):
      %araddW9 = stablehlo.add %araW9, %arbW9 : tensor<f32>
      stablehlo.return %araddW9 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<128x64xf32>) -> tensor<128x64xf32>
    %arnW9 = stablehlo.constant dense<2.0> : tensor<128x64xf32>
    %armeanW9 = stablehlo.divide %arsumW9, %arnW9 : tensor<128x64xf32>
    ...
    %v849 = stablehlo.multiply %v847, %armeanW9 : tensor<128x64xf32>
    ...
    %v854 = stablehlo.multiply %armeanW9, %armeanW9 : tensor<128x64xf32>
    ...
    %v875 = stablehlo.multiply %v873, %armeanW9 : tensor<128x64xf32>
    ...
    %v880 = stablehlo.multiply %armeanW9, %armeanW9 : tensor<128x64xf32>
    ...
    %v884 = stablehlo.reduce(%v100 init: %v883) applies stablehlo.add across dimensions = [0] : (tensor<128x64xf32>, tensor<f32>) -> tensor<64xf32>
    %arsumb9 = "stablehlo.all_reduce"(%v884) ({
    ^bb0(%arab9: tensor<f32>, %arbb9: tensor<f32>):
      %araddb9 = stablehlo.add %arab9, %arbb9 : tensor<f32>
      stablehlo.return %araddb9 : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<64xf32>) -> tensor<64xf32>
    %arnb9 = stablehlo.constant dense<2.0> : tensor<64xf32>
    %armeanb9 = stablehlo.divide %arsumb9, %arnb9 : tensor<64xf32>
    ...
    %v888 = stablehlo.multiply %v886, %armeanb9 : tensor<64xf32>
    ...
    %v893 = stablehlo.multiply %armeanb9, %armeanb9 : tensor<64xf32>
    ...
    %v914 = stablehlo.multiply %v912, %armeanb9 : tensor<64xf32>
    ...
    %v919 = stablehlo.multiply %armeanb9, %armeanb9 : tensor<64xf32>
    %v920 = stablehlo.multiply %v917, %v919 : tensor<64xf32>
    %v921 = stablehlo.add %v918, %v920 : tensor<64xf32>
    %v922 = stablehlo.dot_general %v76, %v96, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x64xf32>, tensor<128x64xf32>) -> tensor<64x64xf32>
    %arsumWa = "stablehlo.all_reduce"(%v922) ({
    ^bb0(%araWa: tensor<f32>, %arbWa: tensor<f32>):
      %araddWa = stablehlo.add %araWa, %arbWa : tensor<f32>
      stablehlo.return %araddWa : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<64x64xf32>) -> tensor<64x64xf32>
    %arnWa = stablehlo.constant dense<2.0> : tensor<64x64xf32>
    %armeanWa = stablehlo.divide %arsumWa, %arnWa : tensor<64x64xf32>
    ...
    %v926 = stablehlo.multiply %v924, %armeanWa : tensor<64x64xf32>
    ...
    %v931 = stablehlo.multiply %armeanWa, %armeanWa : tensor<64x64xf32>
    ...
    %v952 = stablehlo.multiply %v950, %armeanWa : tensor<64x64xf32>
    ...
    %v957 = stablehlo.multiply %armeanWa, %armeanWa : tensor<64x64xf32>
    ...
    %v961 = stablehlo.reduce(%v96 init: %v960) applies stablehlo.add across dimensions = [0] : (tensor<128x64xf32>, tensor<f32>) -> tensor<64xf32>
    %arsumba = "stablehlo.all_reduce"(%v961) ({
    ^bb0(%araba: tensor<f32>, %arbba: tensor<f32>):
      %araddba = stablehlo.add %araba, %arbba : tensor<f32>
      stablehlo.return %araddba : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<64xf32>) -> tensor<64xf32>
    %arnba = stablehlo.constant dense<2.0> : tensor<64xf32>
    %armeanba = stablehlo.divide %arsumba, %arnba : tensor<64xf32>
    ...
    %v965 = stablehlo.multiply %v963, %armeanba : tensor<64xf32>
    ...
    %v970 = stablehlo.multiply %armeanba, %armeanba : tensor<64xf32>
    ...
    %v991 = stablehlo.multiply %v989, %armeanba : tensor<64xf32>
    ...
    %v996 = stablehlo.multiply %armeanba, %armeanba : tensor<64xf32>
    %v997 = stablehlo.multiply %v994, %v996 : tensor<64xf32>
    %v998 = stablehlo.add %v995, %v997 : tensor<64xf32>
    %v999 = stablehlo.dot_general %v81, %v92, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x64xf32>, tensor<128x10xf32>) -> tensor<64x10xf32>
    %arsumWb = "stablehlo.all_reduce"(%v999) ({
    ^bb0(%araWb: tensor<f32>, %arbWb: tensor<f32>):
      %araddWb = stablehlo.add %araWb, %arbWb : tensor<f32>
      stablehlo.return %araddWb : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<64x10xf32>) -> tensor<64x10xf32>
    %arnWb = stablehlo.constant dense<2.0> : tensor<64x10xf32>
    %armeanWb = stablehlo.divide %arsumWb, %arnWb : tensor<64x10xf32>
    ...
    %v1003 = stablehlo.multiply %v1001, %armeanWb : tensor<64x10xf32>
    ...
    %v1008 = stablehlo.multiply %armeanWb, %armeanWb : tensor<64x10xf32>
    ...
    %v1029 = stablehlo.multiply %v1027, %armeanWb : tensor<64x10xf32>
    ...
    %v1034 = stablehlo.multiply %armeanWb, %armeanWb : tensor<64x10xf32>
    ...
    %arsumbb = "stablehlo.all_reduce"(%v1038) ({
    ^bb0(%arabb: tensor<f32>, %arbbb: tensor<f32>):
      %araddbb = stablehlo.add %arabb, %arbbb : tensor<f32>
      stablehlo.return %araddbb : tensor<f32>
    }) { replica_groups = dense<[[0, 1]]> : tensor<1x2xi64> } : (tensor<10xf32>) -> tensor<10xf32>
    %arnbb = stablehlo.constant dense<2.0> : tensor<10xf32>
    %armeanbb = stablehlo.divide %arsumbb, %arnbb : tensor<10xf32>
    ...
    %v1042 = stablehlo.multiply %v1040, %armeanbb : tensor<10xf32>
    ...
    %v1047 = stablehlo.multiply %armeanbb, %armeanbb : tensor<10xf32>
    ...
    %v1068 = stablehlo.multiply %v1066, %armeanbb : tensor<10xf32>
    ...
    %v1073 = stablehlo.multiply %armeanbb, %armeanbb : tensor<10xf32>
