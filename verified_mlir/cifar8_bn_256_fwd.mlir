module @m {
  func.func @cifar8_bn_256_fwd(%x: tensor<128x3072xf32>, %W1: tensor<16x3x3x3xf32>, %b1: tensor<16xf32>, %g1: tensor<16xf32>, %bt1: tensor<16xf32>, %W2: tensor<16x16x3x3xf32>, %b2: tensor<16xf32>, %g2: tensor<16xf32>, %bt2: tensor<16xf32>, %W3: tensor<16x16x3x3xf32>, %b3: tensor<16xf32>, %g3: tensor<16xf32>, %bt3: tensor<16xf32>, %W4: tensor<16x16x3x3xf32>, %b4: tensor<16xf32>, %g4: tensor<16xf32>, %bt4: tensor<16xf32>, %W5: tensor<32x16x3x3xf32>, %b5: tensor<32xf32>, %g5: tensor<32xf32>, %bt5: tensor<32xf32>, %W6: tensor<32x32x3x3xf32>, %b6: tensor<32xf32>, %g6: tensor<32xf32>, %bt6: tensor<32xf32>, %W7: tensor<32x32x3x3xf32>, %b7: tensor<32xf32>, %g7: tensor<32xf32>, %bt7: tensor<32xf32>, %W8: tensor<32x32x3x3xf32>, %b8: tensor<32xf32>, %g8: tensor<32xf32>, %bt8: tensor<32xf32>, %W9: tensor<128x256xf32>, %b9: tensor<256xf32>, %Wa: tensor<256x256xf32>, %ba: tensor<256xf32>, %Wb: tensor<256x10xf32>, %bb: tensor<10xf32>) -> tensor<128x10xf32> {
    ...
    %v232 = stablehlo.dot_general %v231, %W9, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x256xf32>) -> tensor<128x256xf32>
    %v233 = stablehlo.broadcast_in_dim %b9, dims = [1] : (tensor<256xf32>) -> tensor<128x256xf32>
    %v234 = stablehlo.add %v232, %v233 : tensor<128x256xf32>
    %v235 = stablehlo.constant dense<0.0> : tensor<128x256xf32>
    %v236 = stablehlo.maximum %v234, %v235 : tensor<128x256xf32>
    %v237 = stablehlo.dot_general %v236, %Wa, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x256xf32>, tensor<256x256xf32>) -> tensor<128x256xf32>
    %v238 = stablehlo.broadcast_in_dim %ba, dims = [1] : (tensor<256xf32>) -> tensor<128x256xf32>
    %v239 = stablehlo.add %v237, %v238 : tensor<128x256xf32>
    %v240 = stablehlo.constant dense<0.0> : tensor<128x256xf32>
    %v241 = stablehlo.maximum %v239, %v240 : tensor<128x256xf32>
    %v242 = stablehlo.dot_general %v241, %Wb, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x256xf32>, tensor<256x10xf32>) -> tensor<128x10xf32>
