module @m {
  func.func @resnet34_adamdp_train_step(%x: tensor<32x150528xf32>, %sW: tensor<64x3x7x7xf32>, %sg: tensor<64xf32>, %sbt: tensor<64xf32>, %s1b0W1: tensor<64x64x3x3xf32>, %s1b0g1: tensor<64xf32>, %s1b0bt1: tensor<64xf32>, %s1b0W2: tensor<64x64x3x3xf32>, %s1b0g2: tensor<64xf32>, %s1b0bt2: tensor<64xf32>, %s1b1W1: tensor<64x64x3x3xf32>, %s1b1g1: tensor<64xf32>, %s1b1bt1: tensor<64xf32>, %s1b1W2: tensor<64x64x3x3xf32>, %s1b1g2: tensor<64xf32>, %s1b1bt2: tensor<64xf32>, %s1b2W1: tensor<64x64x3x3xf32>, %s1b2g1: tensor<64xf32>, %s1b2bt1: tensor<64xf32>, %s1b2W2: tensor<64x64x3x3xf32>, %s1b2g2: tensor<64xf32>, %s1b2bt2: tensor<64xf32>, %d2W1: tensor<128x64x3x3xf32>, %d2g1: tensor<128xf32>, %d2bt1: tensor<128xf32>, %d2W2: tensor<128x128x3x3xf32>, %d2g2: tensor<128xf32>, %d2bt2: tensor<128xf32>, %d2Wp: tensor<128x64x1x1xf32>, %d2gp: tensor<128xf32>, %d2btp: tensor<128xf32>, %s2b0W1: tensor<128x128x3x3xf32>, %s2b0g1: tensor<128xf32>, %s2b0bt1: tensor<128xf32>, %s2b0W2: tensor<128x128x3x3xf32>, %s2b0g2: tensor<128xf32>, %s2b0bt2: tensor<128xf32>, %s2b1W1: tensor<128x128x3x3xf32>, %s2b1g1: tensor<128xf32>, %s2b1bt1: tensor<128xf32>, %s2b1W2: tensor<128x128x3x3xf32>, %s2b1g2: tensor<128xf32>, %s2b1bt2: tensor<128xf32>, %s2b2W1: tensor<128x128x3x3xf32>, %s2b2g1: tensor<128xf32>, %s2b2bt1: tensor<128xf32>, %s2b2W2: tensor<128x128x3x3xf32>, %s2b2g2: tensor<128xf32>, %s2b2bt2: tensor<128xf32>, %d3W1: tensor<256x128x3x3xf32>, %d3g1: tensor<256xf32>, %d3bt1: tensor<256xf32>, %d3W2: tensor<256x256x3x3xf32>, %d3g2: tensor<256xf32>, %d3bt2: tensor<256xf32>, %d3Wp: tensor<256x128x1x1xf32>, %d3gp: tensor<256xf32>, %d3btp: tensor<256xf32>, %s3b0W1: tensor<256x256x3x3xf32>, %s3b0g1: tensor<256xf32>, %s3b0bt1: tensor<256xf32>, %s3b0W2: tensor<256x256x3x3xf32>, %s3b0g2: tensor<256xf32>, %s3b0bt2: tensor<256xf32>, %s3b1W1: tensor<256x256x3x3xf32>, %s3b1g1: tensor<256xf32>, %s3b1bt1: tensor<256xf32>, %s3b1W2: tensor<256x256x3x3xf32>, %s3b1g2: tensor<256xf32>, %s3b1bt2: tensor<256xf32>, %s3b2W1: tensor<256x256x3x3xf32>, %s3b2g1: tensor<256xf32>, %s3b2bt1: tensor<256xf32>, %s3b2W2: tensor<256x256x3x3xf32>, %s3b2g2: tensor<256xf32>, %s3b2bt2: tensor<256xf32>, %s3b3W1: tensor<256x256x3x3xf32>, %s3b3g1: tensor<256xf32>, %s3b3bt1: tensor<256xf32>, %s3b3W2: tensor<256x256x3x3xf32>, %s3b3g2: tensor<256xf32>, %s3b3bt2: tensor<256xf32>, %s3b4W1: tensor<256x256x3x3xf32>, %s3b4g1: tensor<256xf32>, %s3b4bt1: tensor<256xf32>, %s3b4W2: tensor<256x256x3x3xf32>, %s3b4g2: tensor<256xf32>, %s3b4bt2: tensor<256xf32>, %d4W1: tensor<512x256x3x3xf32>, %d4g1: tensor<512xf32>, %d4bt1: tensor<512xf32>, %d4W2: tensor<512x512x3x3xf32>, %d4g2: tensor<512xf32>, %d4bt2: tensor<512xf32>, %d4Wp: tensor<512x256x1x1xf32>, %d4gp: tensor<512xf32>, %d4btp: tensor<512xf32>, %s4b0W1: tensor<512x512x3x3xf32>, %s4b0g1: tensor<512xf32>, %s4b0bt1: tensor<512xf32>, %s4b0W2: tensor<512x512x3x3xf32>, %s4b0g2: tensor<512xf32>, %s4b0bt2: tensor<512xf32>, %s4b1W1: tensor<512x512x3x3xf32>, %s4b1g1: tensor<512xf32>, %s4b1bt1: tensor<512xf32>, %s4b1W2: tensor<512x512x3x3xf32>, %s4b1g2: tensor<512xf32>, %s4b1bt2: tensor<512xf32>, %Wd: tensor<512x10xf32>, %bd: tensor<10xf32>, %sWm: tensor<64x3x7x7xf32>, %sgm: tensor<64xf32>, %sbtm: tensor<64xf32>, %s1b0W1m: tensor<64x64x3x3xf32>, %s1b0g1m: tensor<64xf32>, %s1b0bt1m: tensor<64xf32>, %s1b0W2m: tensor<64x64x3x3xf32>, %s1b0g2m: tensor<64xf32>, %s1b0bt2m: tensor<64xf32>, %s1b1W1m: tensor<64x64x3x3xf32>, %s1b1g1m: tensor<64xf32>, %s1b1bt1m: tensor<64xf32>, %s1b1W2m: tensor<64x64x3x3xf32>, %s1b1g2m: tensor<64xf32>, %s1b1bt2m: tensor<64xf32>, %s1b2W1m: tensor<64x64x3x3xf32>, %s1b2g1m: tensor<64xf32>, %s1b2bt1m: tensor<64xf32>, %s1b2W2m: tensor<64x64x3x3xf32>, %s1b2g2m: tensor<64xf32>, %s1b2bt2m: tensor<64xf32>, %d2W1m: tensor<128x64x3x3xf32>, %d2g1m: tensor<128xf32>, %d2bt1m: tensor<128xf32>, %d2W2m: tensor<128x128x3x3xf32>, %d2g2m: tensor<128xf32>, %d2bt2m: tensor<128xf32>, %d2Wpm: tensor<128x64x1x1xf32>, %d2gpm: tensor<128xf32>, %d2btpm: tensor<128xf32>, %s2b0W1m: tensor<128x128x3x3xf32>, %s2b0g1m: tensor<128xf32>, %s2b0bt1m: tensor<128xf32>, %s2b0W2m: tensor<128x128x3x3xf32>, %s2b0g2m: tensor<128xf32>, %s2b0bt2m: tensor<128xf32>, %s2b1W1m: tensor<128x128x3x3xf32>, %s2b1g1m: tensor<128xf32>, %s2b1bt1m: tensor<128xf32>, %s2b1W2m: tensor<128x128x3x3xf32>, %s2b1g2m: tensor<128xf32>, %s2b1bt2m: tensor<128xf32>, %s2b2W1m: tensor<128x128x3x3xf32>, %s2b2g1m: tensor<128xf32>, %s2b2bt1m: tensor<128xf32>, %s2b2W2m: tensor<128x128x3x3xf32>, %s2b2g2m: tensor<128xf32>, %s2b2bt2m: tensor<128xf32>, %d3W1m: tensor<256x128x3x3xf32>, %d3g1m: tensor<256xf32>, %d3bt1m: tensor<256xf32>, %d3W2m: tensor<256x256x3x3xf32>, %d3g2m: tensor<256xf32>, %d3bt2m: tensor<256xf32>, %d3Wpm: tensor<256x128x1x1xf32>, %d3gpm: tensor<256xf32>, %d3btpm: tensor<256xf32>, %s3b0W1m: tensor<256x256x3x3xf32>, %s3b0g1m: tensor<256xf32>, %s3b0bt1m: tensor<256xf32>, %s3b0W2m: tensor<256x256x3x3xf32>, %s3b0g2m: tensor<256xf32>, %s3b0bt2m: tensor<256xf32>, %s3b1W1m: tensor<256x256x3x3xf32>, %s3b1g1m: tensor<256xf32>, %s3b1bt1m: tensor<256xf32>, %s3b1W2m: tensor<256x256x3x3xf32>, %s3b1g2m: tensor<256xf32>, %s3b1bt2m: tensor<256xf32>, %s3b2W1m: tensor<256x256x3x3xf32>, %s3b2g1m: tensor<256xf32>, %s3b2bt1m: tensor<256xf32>, %s3b2W2m: tensor<256x256x3x3xf32>, %s3b2g2m: tensor<256xf32>, %s3b2bt2m: tensor<256xf32>, %s3b3W1m: tensor<256x256x3x3xf32>, %s3b3g1m: tensor<256xf32>, %s3b3bt1m: tensor<256xf32>, %s3b3W2m: tensor<256x256x3x3xf32>, %s3b3g2m: tensor<256xf32>, %s3b3bt2m: tensor<256xf32>, %s3b4W1m: tensor<256x256x3x3xf32>, %s3b4g1m: tensor<256xf32>, %s3b4bt1m: tensor<256xf32>, %s3b4W2m: tensor<256x256x3x3xf32>, %s3b4g2m: tensor<256xf32>, %s3b4bt2m: tensor<256xf32>, %d4W1m: tensor<512x256x3x3xf32>, %d4g1m: tensor<512xf32>, %d4bt1m: tensor<512xf32>, %d4W2m: tensor<512x512x3x3xf32>, %d4g2m: tensor<512xf32>, %d4bt2m: tensor<512xf32>, %d4Wpm: tensor<512x256x1x1xf32>, %d4gpm: tensor<512xf32>, %d4btpm: tensor<512xf32>, %s4b0W1m: tensor<512x512x3x3xf32>, %s4b0g1m: tensor<512xf32>, %s4b0bt1m: tensor<512xf32>, %s4b0W2m: tensor<512x512x3x3xf32>, %s4b0g2m: tensor<512xf32>, %s4b0bt2m: tensor<512xf32>, %s4b1W1m: tensor<512x512x3x3xf32>, %s4b1g1m: tensor<512xf32>, %s4b1bt1m: tensor<512xf32>, %s4b1W2m: tensor<512x512x3x3xf32>, %s4b1g2m: tensor<512xf32>, %s4b1bt2m: tensor<512xf32>, %Wdm: tensor<512x10xf32>, %bdm: tensor<10xf32>, %sWv: tensor<64x3x7x7xf32>, %sgv: tensor<64xf32>, %sbtv: tensor<64xf32>, %s1b0W1v: tensor<64x64x3x3xf32>, %s1b0g1v: tensor<64xf32>, %s1b0bt1v: tensor<64xf32>, %s1b0W2v: tensor<64x64x3x3xf32>, %s1b0g2v: tensor<64xf32>, %s1b0bt2v: tensor<64xf32>, %s1b1W1v: tensor<64x64x3x3xf32>, %s1b1g1v: tensor<64xf32>, %s1b1bt1v: tensor<64xf32>, %s1b1W2v: tensor<64x64x3x3xf32>, %s1b1g2v: tensor<64xf32>, %s1b1bt2v: tensor<64xf32>, %s1b2W1v: tensor<64x64x3x3xf32>, %s1b2g1v: tensor<64xf32>, %s1b2bt1v: tensor<64xf32>, %s1b2W2v: tensor<64x64x3x3xf32>, %s1b2g2v: tensor<64xf32>, %s1b2bt2v: tensor<64xf32>, %d2W1v: tensor<128x64x3x3xf32>, %d2g1v: tensor<128xf32>, %d2bt1v: tensor<128xf32>, %d2W2v: tensor<128x128x3x3xf32>, %d2g2v: tensor<128xf32>, %d2bt2v: tensor<128xf32>, %d2Wpv: tensor<128x64x1x1xf32>, %d2gpv: tensor<128xf32>, %d2btpv: tensor<128xf32>, %s2b0W1v: tensor<128x128x3x3xf32>, %s2b0g1v: tensor<128xf32>, %s2b0bt1v: tensor<128xf32>, %s2b0W2v: tensor<128x128x3x3xf32>, %s2b0g2v: tensor<128xf32>, %s2b0bt2v: tensor<128xf32>, %s2b1W1v: tensor<128x128x3x3xf32>, %s2b1g1v: tensor<128xf32>, %s2b1bt1v: tensor<128xf32>, %s2b1W2v: tensor<128x128x3x3xf32>, %s2b1g2v: tensor<128xf32>, %s2b1bt2v: tensor<128xf32>, %s2b2W1v: tensor<128x128x3x3xf32>, %s2b2g1v: tensor<128xf32>, %s2b2bt1v: tensor<128xf32>, %s2b2W2v: tensor<128x128x3x3xf32>, %s2b2g2v: tensor<128xf32>, %s2b2bt2v: tensor<128xf32>, %d3W1v: tensor<256x128x3x3xf32>, %d3g1v: tensor<256xf32>, %d3bt1v: tensor<256xf32>, %d3W2v: tensor<256x256x3x3xf32>, %d3g2v: tensor<256xf32>, %d3bt2v: tensor<256xf32>, %d3Wpv: tensor<256x128x1x1xf32>, %d3gpv: tensor<256xf32>, %d3btpv: tensor<256xf32>, %s3b0W1v: tensor<256x256x3x3xf32>, %s3b0g1v: tensor<256xf32>, %s3b0bt1v: tensor<256xf32>, %s3b0W2v: tensor<256x256x3x3xf32>, %s3b0g2v: tensor<256xf32>, %s3b0bt2v: tensor<256xf32>, %s3b1W1v: tensor<256x256x3x3xf32>, %s3b1g1v: tensor<256xf32>, %s3b1bt1v: tensor<256xf32>, %s3b1W2v: tensor<256x256x3x3xf32>, %s3b1g2v: tensor<256xf32>, %s3b1bt2v: tensor<256xf32>, %s3b2W1v: tensor<256x256x3x3xf32>, %s3b2g1v: tensor<256xf32>, %s3b2bt1v: tensor<256xf32>, %s3b2W2v: tensor<256x256x3x3xf32>, %s3b2g2v: tensor<256xf32>, %s3b2bt2v: tensor<256xf32>, %s3b3W1v: tensor<256x256x3x3xf32>, %s3b3g1v: tensor<256xf32>, %s3b3bt1v: tensor<256xf32>, %s3b3W2v: tensor<256x256x3x3xf32>, %s3b3g2v: tensor<256xf32>, %s3b3bt2v: tensor<256xf32>, %s3b4W1v: tensor<256x256x3x3xf32>, %s3b4g1v: tensor<256xf32>, %s3b4bt1v: tensor<256xf32>, %s3b4W2v: tensor<256x256x3x3xf32>, %s3b4g2v: tensor<256xf32>, %s3b4bt2v: tensor<256xf32>, %d4W1v: tensor<512x256x3x3xf32>, %d4g1v: tensor<512xf32>, %d4bt1v: tensor<512xf32>, %d4W2v: tensor<512x512x3x3xf32>, %d4g2v: tensor<512xf32>, %d4bt2v: tensor<512xf32>, %d4Wpv: tensor<512x256x1x1xf32>, %d4gpv: tensor<512xf32>, %d4btpv: tensor<512xf32>, %s4b0W1v: tensor<512x512x3x3xf32>, %s4b0g1v: tensor<512xf32>, %s4b0bt1v: tensor<512xf32>, %s4b0W2v: tensor<512x512x3x3xf32>, %s4b0g2v: tensor<512xf32>, %s4b0bt2v: tensor<512xf32>, %s4b1W1v: tensor<512x512x3x3xf32>, %s4b1g1v: tensor<512xf32>, %s4b1bt1v: tensor<512xf32>, %s4b1W2v: tensor<512x512x3x3xf32>, %s4b1g2v: tensor<512xf32>, %s4b1bt2v: tensor<512xf32>, %Wdv: tensor<512x10xf32>, %bdv: tensor<10xf32>, %lr: tensor<f32>, %bc1: tensor<f32>, %bc2: tensor<f32>, %stnmui: tensor<64xf32>, %stnvari: tensor<64xf32>, %s1b0n1mui: tensor<64xf32>, %s1b0n1vari: tensor<64xf32>, %s1b0n2mui: tensor<64xf32>, %s1b0n2vari: tensor<64xf32>, %s1b1n1mui: tensor<64xf32>, %s1b1n1vari: tensor<64xf32>, %s1b1n2mui: tensor<64xf32>, %s1b1n2vari: tensor<64xf32>, %s1b2n1mui: tensor<64xf32>, %s1b2n1vari: tensor<64xf32>, %s1b2n2mui: tensor<64xf32>, %s1b2n2vari: tensor<64xf32>, %d2n1mui: tensor<128xf32>, %d2n1vari: tensor<128xf32>, %d2n2mui: tensor<128xf32>, %d2n2vari: tensor<128xf32>, %d2npmui: tensor<128xf32>, %d2npvari: tensor<128xf32>, %s2b0n1mui: tensor<128xf32>, %s2b0n1vari: tensor<128xf32>, %s2b0n2mui: tensor<128xf32>, %s2b0n2vari: tensor<128xf32>, %s2b1n1mui: tensor<128xf32>, %s2b1n1vari: tensor<128xf32>, %s2b1n2mui: tensor<128xf32>, %s2b1n2vari: tensor<128xf32>, %s2b2n1mui: tensor<128xf32>, %s2b2n1vari: tensor<128xf32>, %s2b2n2mui: tensor<128xf32>, %s2b2n2vari: tensor<128xf32>, %d3n1mui: tensor<256xf32>, %d3n1vari: tensor<256xf32>, %d3n2mui: tensor<256xf32>, %d3n2vari: tensor<256xf32>, %d3npmui: tensor<256xf32>, %d3npvari: tensor<256xf32>, %s3b0n1mui: tensor<256xf32>, %s3b0n1vari: tensor<256xf32>, %s3b0n2mui: tensor<256xf32>, %s3b0n2vari: tensor<256xf32>, %s3b1n1mui: tensor<256xf32>, %s3b1n1vari: tensor<256xf32>, %s3b1n2mui: tensor<256xf32>, %s3b1n2vari: tensor<256xf32>, %s3b2n1mui: tensor<256xf32>, %s3b2n1vari: tensor<256xf32>, %s3b2n2mui: tensor<256xf32>, %s3b2n2vari: tensor<256xf32>, %s3b3n1mui: tensor<256xf32>, %s3b3n1vari: tensor<256xf32>, %s3b3n2mui: tensor<256xf32>, %s3b3n2vari: tensor<256xf32>, %s3b4n1mui: tensor<256xf32>, %s3b4n1vari: tensor<256xf32>, %s3b4n2mui: tensor<256xf32>, %s3b4n2vari: tensor<256xf32>, %d4n1mui: tensor<512xf32>, %d4n1vari: tensor<512xf32>, %d4n2mui: tensor<512xf32>, %d4n2vari: tensor<512xf32>, %d4npmui: tensor<512xf32>, %d4npvari: tensor<512xf32>, %s4b0n1mui: tensor<512xf32>, %s4b0n1vari: tensor<512xf32>, %s4b0n2mui: tensor<512xf32>, %s4b0n2vari: tensor<512xf32>, %s4b1n1mui: tensor<512xf32>, %s4b1n1vari: tensor<512xf32>, %s4b1n2mui: tensor<512xf32>, %s4b1n2vari: tensor<512xf32>, %onehot: tensor<32x10xf32>) -> (tensor<64x3x7x7xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<128x64x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x64x1x1xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<256x128x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x128x1x1xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<512x256x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x256x1x1xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<64x3x7x7xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<128x64x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x64x1x1xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<256x128x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x128x1x1xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<512x256x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x256x1x1xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<64x3x7x7xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64x64x3x3xf32>, tensor<64xf32>, tensor<64xf32>, tensor<128x64x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x64x1x1xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128x3x3xf32>, tensor<128xf32>, tensor<128xf32>, tensor<256x128x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x128x1x1xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256x256x3x3xf32>, tensor<256xf32>, tensor<256xf32>, tensor<512x256x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x256x1x1xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x512x3x3xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<64xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<256xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>, tensor<512xf32>) {
    ...
    %v7 = stablehlo.constant dense<401408.0> : tensor<64xf32>
    %v8 = stablehlo.reduce(%v5 init: %v6) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x112x112xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v10 = stablehlo.reshape %v4 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v11 = stablehlo.constant dense<0.0> : tensor<f32>
    %v12 = stablehlo.constant dense<401408.0> : tensor<64xf32>
    %v13 = stablehlo.reduce(%v10 init: %v11) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x112x112xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v16 = stablehlo.subtract %v10, %v15 : tensor<32x64x112x112xf32>
    %v17 = stablehlo.multiply %v16, %v16 : tensor<32x64x112x112xf32>
    %v18 = stablehlo.reduce(%v17 init: %v11) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x112x112xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v24 = stablehlo.reshape %v4 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v25 = stablehlo.slice %v23 [0:64] : (tensor<128xf32>) -> tensor<64xf32>
    %v26 = stablehlo.slice %v23 [64:128] : (tensor<128xf32>) -> tensor<64xf32>
    %v27 = stablehlo.broadcast_in_dim %v25, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v28 = stablehlo.broadcast_in_dim %v26, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v29 = stablehlo.constant dense<1.0e-05> : tensor<32x64x112x112xf32>
    %v30 = stablehlo.add %v28, %v29 : tensor<32x64x112x112xf32>
    %v31 = stablehlo.rsqrt %v30 : tensor<32x64x112x112xf32>
    %v32 = stablehlo.subtract %v24, %v27 : tensor<32x64x112x112xf32>
    %v33 = stablehlo.multiply %v32, %v31 : tensor<32x64x112x112xf32>
    %v34 = stablehlo.broadcast_in_dim %sg, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v35 = stablehlo.broadcast_in_dim %sbt, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v36 = stablehlo.multiply %v33, %v34 : tensor<32x64x112x112xf32>
    %v37 = stablehlo.add %v36, %v35 : tensor<32x64x112x112xf32>
    %v38 = stablehlo.reshape %v37 : (tensor<32x64x112x112xf32>) -> tensor<32x802816xf32>
    %v39 = stablehlo.constant dense<0.0> : tensor<32x802816xf32>
    %v40 = stablehlo.maximum %v38, %v39 : tensor<32x802816xf32>
    %v41 = stablehlo.reshape %v40 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    ...
    %v44 = stablehlo.reshape %v43 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v45 = stablehlo.reshape %v44 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v47 = stablehlo.broadcast_in_dim %zb64, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v48 = stablehlo.add %v46, %v47 : tensor<32x64x56x56xf32>
    %v49 = stablehlo.reshape %v48 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v50 = stablehlo.reshape %v49 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v51 = stablehlo.constant dense<0.0> : tensor<f32>
    %v52 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v53 = stablehlo.reduce(%v50 init: %v51) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v55 = stablehlo.reshape %v49 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v56 = stablehlo.constant dense<0.0> : tensor<f32>
    %v57 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v58 = stablehlo.reduce(%v55 init: %v56) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v59 = stablehlo.divide %v58, %v57 : tensor<64xf32>
    %v60 = stablehlo.broadcast_in_dim %v59, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v61 = stablehlo.subtract %v55, %v60 : tensor<32x64x56x56xf32>
    %v62 = stablehlo.multiply %v61, %v61 : tensor<32x64x56x56xf32>
    %v63 = stablehlo.reduce(%v62 init: %v56) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v69 = stablehlo.reshape %v49 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v70 = stablehlo.slice %v68 [0:64] : (tensor<128xf32>) -> tensor<64xf32>
    %v71 = stablehlo.slice %v68 [64:128] : (tensor<128xf32>) -> tensor<64xf32>
    %v72 = stablehlo.broadcast_in_dim %v70, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v73 = stablehlo.broadcast_in_dim %v71, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v77 = stablehlo.subtract %v69, %v72 : tensor<32x64x56x56xf32>
    %v78 = stablehlo.multiply %v77, %v76 : tensor<32x64x56x56xf32>
    %v79 = stablehlo.broadcast_in_dim %s1b0g1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v80 = stablehlo.broadcast_in_dim %s1b0bt1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v81 = stablehlo.multiply %v78, %v79 : tensor<32x64x56x56xf32>
    %v82 = stablehlo.add %v81, %v80 : tensor<32x64x56x56xf32>
    %v83 = stablehlo.reshape %v82 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    ...
    %v93 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v94 = stablehlo.reduce(%v91 init: %v92) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v96 = stablehlo.reshape %v90 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v97 = stablehlo.constant dense<0.0> : tensor<f32>
    %v98 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v99 = stablehlo.reduce(%v96 init: %v97) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v102 = stablehlo.subtract %v96, %v101 : tensor<32x64x56x56xf32>
    %v103 = stablehlo.multiply %v102, %v102 : tensor<32x64x56x56xf32>
    %v104 = stablehlo.reduce(%v103 init: %v97) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v110 = stablehlo.reshape %v90 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v111 = stablehlo.slice %v109 [0:64] : (tensor<128xf32>) -> tensor<64xf32>
    %v112 = stablehlo.slice %v109 [64:128] : (tensor<128xf32>) -> tensor<64xf32>
    %v113 = stablehlo.broadcast_in_dim %v111, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v114 = stablehlo.broadcast_in_dim %v112, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v118 = stablehlo.subtract %v110, %v113 : tensor<32x64x56x56xf32>
    %v119 = stablehlo.multiply %v118, %v117 : tensor<32x64x56x56xf32>
    %v120 = stablehlo.broadcast_in_dim %s1b0g2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v121 = stablehlo.broadcast_in_dim %s1b0bt2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v122 = stablehlo.multiply %v119, %v120 : tensor<32x64x56x56xf32>
    %v123 = stablehlo.add %v122, %v121 : tensor<32x64x56x56xf32>
    %v124 = stablehlo.reshape %v123 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v125 = stablehlo.reshape %v124 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v126 = stablehlo.reshape %v44 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v130 = stablehlo.constant dense<0.0> : tensor<32x64x56x56xf32>
    %v131 = stablehlo.maximum %v129, %v130 : tensor<32x64x56x56xf32>
    %v132 = stablehlo.reshape %v131 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v133 = stablehlo.reshape %v132 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v134 = stablehlo.convolution(%v133, %s1b1W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x64x56x56xf32>, tensor<64x64x3x3xf32>) -> tensor<32x64x56x56xf32>
    %v135 = stablehlo.broadcast_in_dim %zb64, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v138 = stablehlo.reshape %v137 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v139 = stablehlo.constant dense<0.0> : tensor<f32>
    %v140 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v141 = stablehlo.reduce(%v138 init: %v139) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v143 = stablehlo.reshape %v137 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v144 = stablehlo.constant dense<0.0> : tensor<f32>
    %v145 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v146 = stablehlo.reduce(%v143 init: %v144) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v149 = stablehlo.subtract %v143, %v148 : tensor<32x64x56x56xf32>
    %v150 = stablehlo.multiply %v149, %v149 : tensor<32x64x56x56xf32>
    %v151 = stablehlo.reduce(%v150 init: %v144) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v157 = stablehlo.reshape %v137 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v158 = stablehlo.slice %v156 [0:64] : (tensor<128xf32>) -> tensor<64xf32>
    %v159 = stablehlo.slice %v156 [64:128] : (tensor<128xf32>) -> tensor<64xf32>
    %v160 = stablehlo.broadcast_in_dim %v158, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v161 = stablehlo.broadcast_in_dim %v159, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v162 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v163 = stablehlo.add %v161, %v162 : tensor<32x64x56x56xf32>
    %v164 = stablehlo.rsqrt %v163 : tensor<32x64x56x56xf32>
    %v165 = stablehlo.subtract %v157, %v160 : tensor<32x64x56x56xf32>
    %v166 = stablehlo.multiply %v165, %v164 : tensor<32x64x56x56xf32>
    %v167 = stablehlo.broadcast_in_dim %s1b1g1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v168 = stablehlo.broadcast_in_dim %s1b1bt1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v169 = stablehlo.multiply %v166, %v167 : tensor<32x64x56x56xf32>
    %v170 = stablehlo.add %v169, %v168 : tensor<32x64x56x56xf32>
    %v171 = stablehlo.reshape %v170 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v172 = stablehlo.constant dense<0.0> : tensor<32x200704xf32>
    %v173 = stablehlo.maximum %v171, %v172 : tensor<32x200704xf32>
    %v174 = stablehlo.reshape %v173 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v175 = stablehlo.convolution(%v174, %s1b1W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x64x56x56xf32>, tensor<64x64x3x3xf32>) -> tensor<32x64x56x56xf32>
    %v176 = stablehlo.broadcast_in_dim %zb64, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v177 = stablehlo.add %v175, %v176 : tensor<32x64x56x56xf32>
    %v178 = stablehlo.reshape %v177 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v179 = stablehlo.reshape %v178 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v180 = stablehlo.constant dense<0.0> : tensor<f32>
    %v181 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v182 = stablehlo.reduce(%v179 init: %v180) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v184 = stablehlo.reshape %v178 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v185 = stablehlo.constant dense<0.0> : tensor<f32>
    %v186 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v187 = stablehlo.reduce(%v184 init: %v185) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v188 = stablehlo.divide %v187, %v186 : tensor<64xf32>
    %v189 = stablehlo.broadcast_in_dim %v188, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v190 = stablehlo.subtract %v184, %v189 : tensor<32x64x56x56xf32>
    %v191 = stablehlo.multiply %v190, %v190 : tensor<32x64x56x56xf32>
    %v192 = stablehlo.reduce(%v191 init: %v185) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v198 = stablehlo.reshape %v178 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v199 = stablehlo.slice %v197 [0:64] : (tensor<128xf32>) -> tensor<64xf32>
    %v200 = stablehlo.slice %v197 [64:128] : (tensor<128xf32>) -> tensor<64xf32>
    %v201 = stablehlo.broadcast_in_dim %v199, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v202 = stablehlo.broadcast_in_dim %v200, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v203 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v204 = stablehlo.add %v202, %v203 : tensor<32x64x56x56xf32>
    %v205 = stablehlo.rsqrt %v204 : tensor<32x64x56x56xf32>
    %v206 = stablehlo.subtract %v198, %v201 : tensor<32x64x56x56xf32>
    %v207 = stablehlo.multiply %v206, %v205 : tensor<32x64x56x56xf32>
    %v208 = stablehlo.broadcast_in_dim %s1b1g2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v209 = stablehlo.broadcast_in_dim %s1b1bt2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v210 = stablehlo.multiply %v207, %v208 : tensor<32x64x56x56xf32>
    %v211 = stablehlo.add %v210, %v209 : tensor<32x64x56x56xf32>
    %v212 = stablehlo.reshape %v211 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v213 = stablehlo.reshape %v212 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v214 = stablehlo.reshape %v132 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v215 = stablehlo.add %v213, %v214 : tensor<32x64x56x56xf32>
    %v216 = stablehlo.reshape %v215 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v217 = stablehlo.reshape %v216 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v218 = stablehlo.constant dense<0.0> : tensor<32x64x56x56xf32>
    %v219 = stablehlo.maximum %v217, %v218 : tensor<32x64x56x56xf32>
    %v220 = stablehlo.reshape %v219 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v221 = stablehlo.reshape %v220 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v222 = stablehlo.convolution(%v221, %s1b2W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x64x56x56xf32>, tensor<64x64x3x3xf32>) -> tensor<32x64x56x56xf32>
    %v223 = stablehlo.broadcast_in_dim %zb64, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v224 = stablehlo.add %v222, %v223 : tensor<32x64x56x56xf32>
    %v225 = stablehlo.reshape %v224 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v226 = stablehlo.reshape %v225 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v227 = stablehlo.constant dense<0.0> : tensor<f32>
    %v228 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v229 = stablehlo.reduce(%v226 init: %v227) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v231 = stablehlo.reshape %v225 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v232 = stablehlo.constant dense<0.0> : tensor<f32>
    %v233 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v234 = stablehlo.reduce(%v231 init: %v232) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v235 = stablehlo.divide %v234, %v233 : tensor<64xf32>
    %v236 = stablehlo.broadcast_in_dim %v235, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v237 = stablehlo.subtract %v231, %v236 : tensor<32x64x56x56xf32>
    %v238 = stablehlo.multiply %v237, %v237 : tensor<32x64x56x56xf32>
    %v239 = stablehlo.reduce(%v238 init: %v232) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v245 = stablehlo.reshape %v225 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v246 = stablehlo.slice %v244 [0:64] : (tensor<128xf32>) -> tensor<64xf32>
    %v247 = stablehlo.slice %v244 [64:128] : (tensor<128xf32>) -> tensor<64xf32>
    %v248 = stablehlo.broadcast_in_dim %v246, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v249 = stablehlo.broadcast_in_dim %v247, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v250 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v251 = stablehlo.add %v249, %v250 : tensor<32x64x56x56xf32>
    %v252 = stablehlo.rsqrt %v251 : tensor<32x64x56x56xf32>
    %v253 = stablehlo.subtract %v245, %v248 : tensor<32x64x56x56xf32>
    %v254 = stablehlo.multiply %v253, %v252 : tensor<32x64x56x56xf32>
    %v255 = stablehlo.broadcast_in_dim %s1b2g1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v256 = stablehlo.broadcast_in_dim %s1b2bt1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v257 = stablehlo.multiply %v254, %v255 : tensor<32x64x56x56xf32>
    %v258 = stablehlo.add %v257, %v256 : tensor<32x64x56x56xf32>
    %v259 = stablehlo.reshape %v258 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v260 = stablehlo.constant dense<0.0> : tensor<32x200704xf32>
    %v261 = stablehlo.maximum %v259, %v260 : tensor<32x200704xf32>
    %v262 = stablehlo.reshape %v261 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v263 = stablehlo.convolution(%v262, %s1b2W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x64x56x56xf32>, tensor<64x64x3x3xf32>) -> tensor<32x64x56x56xf32>
    %v264 = stablehlo.broadcast_in_dim %zb64, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v265 = stablehlo.add %v263, %v264 : tensor<32x64x56x56xf32>
    %v266 = stablehlo.reshape %v265 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v267 = stablehlo.reshape %v266 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v268 = stablehlo.constant dense<0.0> : tensor<f32>
    %v269 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v270 = stablehlo.reduce(%v267 init: %v268) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v272 = stablehlo.reshape %v266 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v273 = stablehlo.constant dense<0.0> : tensor<f32>
    %v274 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v275 = stablehlo.reduce(%v272 init: %v273) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v276 = stablehlo.divide %v275, %v274 : tensor<64xf32>
    %v277 = stablehlo.broadcast_in_dim %v276, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v278 = stablehlo.subtract %v272, %v277 : tensor<32x64x56x56xf32>
    %v279 = stablehlo.multiply %v278, %v278 : tensor<32x64x56x56xf32>
    %v280 = stablehlo.reduce(%v279 init: %v273) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v286 = stablehlo.reshape %v266 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v287 = stablehlo.slice %v285 [0:64] : (tensor<128xf32>) -> tensor<64xf32>
    %v288 = stablehlo.slice %v285 [64:128] : (tensor<128xf32>) -> tensor<64xf32>
    %v289 = stablehlo.broadcast_in_dim %v287, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v290 = stablehlo.broadcast_in_dim %v288, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v291 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v292 = stablehlo.add %v290, %v291 : tensor<32x64x56x56xf32>
    %v293 = stablehlo.rsqrt %v292 : tensor<32x64x56x56xf32>
    %v294 = stablehlo.subtract %v286, %v289 : tensor<32x64x56x56xf32>
    %v295 = stablehlo.multiply %v294, %v293 : tensor<32x64x56x56xf32>
    %v296 = stablehlo.broadcast_in_dim %s1b2g2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v297 = stablehlo.broadcast_in_dim %s1b2bt2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v298 = stablehlo.multiply %v295, %v296 : tensor<32x64x56x56xf32>
    %v299 = stablehlo.add %v298, %v297 : tensor<32x64x56x56xf32>
    %v300 = stablehlo.reshape %v299 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v301 = stablehlo.reshape %v300 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v302 = stablehlo.reshape %v220 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v303 = stablehlo.add %v301, %v302 : tensor<32x64x56x56xf32>
    %v304 = stablehlo.reshape %v303 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v305 = stablehlo.reshape %v304 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v306 = stablehlo.constant dense<0.0> : tensor<32x64x56x56xf32>
    %v307 = stablehlo.maximum %v305, %v306 : tensor<32x64x56x56xf32>
    %v308 = stablehlo.reshape %v307 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v309 = stablehlo.reshape %v308 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v311 = stablehlo.broadcast_in_dim %zb128, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v312 = stablehlo.add %v310, %v311 : tensor<32x128x28x28xf32>
    %v313 = stablehlo.reshape %v312 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v314 = stablehlo.reshape %v313 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v315 = stablehlo.constant dense<0.0> : tensor<f32>
    %v316 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v317 = stablehlo.reduce(%v314 init: %v315) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v319 = stablehlo.reshape %v313 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v320 = stablehlo.constant dense<0.0> : tensor<f32>
    %v321 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v322 = stablehlo.reduce(%v319 init: %v320) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v323 = stablehlo.divide %v322, %v321 : tensor<128xf32>
    %v324 = stablehlo.broadcast_in_dim %v323, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v325 = stablehlo.subtract %v319, %v324 : tensor<32x128x28x28xf32>
    %v326 = stablehlo.multiply %v325, %v325 : tensor<32x128x28x28xf32>
    %v327 = stablehlo.reduce(%v326 init: %v320) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v333 = stablehlo.reshape %v313 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v336 = stablehlo.broadcast_in_dim %v334, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v337 = stablehlo.broadcast_in_dim %v335, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v338 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v339 = stablehlo.add %v337, %v338 : tensor<32x128x28x28xf32>
    %v340 = stablehlo.rsqrt %v339 : tensor<32x128x28x28xf32>
    %v341 = stablehlo.subtract %v333, %v336 : tensor<32x128x28x28xf32>
    %v342 = stablehlo.multiply %v341, %v340 : tensor<32x128x28x28xf32>
    %v343 = stablehlo.broadcast_in_dim %d2g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v344 = stablehlo.broadcast_in_dim %d2bt1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v345 = stablehlo.multiply %v342, %v343 : tensor<32x128x28x28xf32>
    %v346 = stablehlo.add %v345, %v344 : tensor<32x128x28x28xf32>
    %v347 = stablehlo.reshape %v346 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v348 = stablehlo.constant dense<0.0> : tensor<32x100352xf32>
    %v349 = stablehlo.maximum %v347, %v348 : tensor<32x100352xf32>
    %v350 = stablehlo.reshape %v349 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v352 = stablehlo.broadcast_in_dim %zb128, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v353 = stablehlo.add %v351, %v352 : tensor<32x128x28x28xf32>
    %v354 = stablehlo.reshape %v353 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v355 = stablehlo.reshape %v354 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v356 = stablehlo.constant dense<0.0> : tensor<f32>
    %v357 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v358 = stablehlo.reduce(%v355 init: %v356) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v360 = stablehlo.reshape %v354 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v361 = stablehlo.constant dense<0.0> : tensor<f32>
    %v362 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v363 = stablehlo.reduce(%v360 init: %v361) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v364 = stablehlo.divide %v363, %v362 : tensor<128xf32>
    %v365 = stablehlo.broadcast_in_dim %v364, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v366 = stablehlo.subtract %v360, %v365 : tensor<32x128x28x28xf32>
    %v367 = stablehlo.multiply %v366, %v366 : tensor<32x128x28x28xf32>
    %v368 = stablehlo.reduce(%v367 init: %v361) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v374 = stablehlo.reshape %v354 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v377 = stablehlo.broadcast_in_dim %v375, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v378 = stablehlo.broadcast_in_dim %v376, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v379 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v380 = stablehlo.add %v378, %v379 : tensor<32x128x28x28xf32>
    %v381 = stablehlo.rsqrt %v380 : tensor<32x128x28x28xf32>
    %v382 = stablehlo.subtract %v374, %v377 : tensor<32x128x28x28xf32>
    %v383 = stablehlo.multiply %v382, %v381 : tensor<32x128x28x28xf32>
    %v384 = stablehlo.broadcast_in_dim %d2g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v385 = stablehlo.broadcast_in_dim %d2bt2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v386 = stablehlo.multiply %v383, %v384 : tensor<32x128x28x28xf32>
    %v387 = stablehlo.add %v386, %v385 : tensor<32x128x28x28xf32>
    %v388 = stablehlo.reshape %v387 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v389 = stablehlo.reshape %v308 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v391 = stablehlo.broadcast_in_dim %zb128, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v392 = stablehlo.add %v390, %v391 : tensor<32x128x28x28xf32>
    %v393 = stablehlo.reshape %v392 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v394 = stablehlo.reshape %v393 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v395 = stablehlo.constant dense<0.0> : tensor<f32>
    %v396 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v397 = stablehlo.reduce(%v394 init: %v395) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v399 = stablehlo.reshape %v393 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v400 = stablehlo.constant dense<0.0> : tensor<f32>
    %v401 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v402 = stablehlo.reduce(%v399 init: %v400) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v403 = stablehlo.divide %v402, %v401 : tensor<128xf32>
    %v404 = stablehlo.broadcast_in_dim %v403, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v405 = stablehlo.subtract %v399, %v404 : tensor<32x128x28x28xf32>
    %v406 = stablehlo.multiply %v405, %v405 : tensor<32x128x28x28xf32>
    %v407 = stablehlo.reduce(%v406 init: %v400) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v413 = stablehlo.reshape %v393 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v416 = stablehlo.broadcast_in_dim %v414, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v417 = stablehlo.broadcast_in_dim %v415, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v418 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v419 = stablehlo.add %v417, %v418 : tensor<32x128x28x28xf32>
    %v420 = stablehlo.rsqrt %v419 : tensor<32x128x28x28xf32>
    %v421 = stablehlo.subtract %v413, %v416 : tensor<32x128x28x28xf32>
    %v422 = stablehlo.multiply %v421, %v420 : tensor<32x128x28x28xf32>
    %v423 = stablehlo.broadcast_in_dim %d2gp, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v424 = stablehlo.broadcast_in_dim %d2btp, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v425 = stablehlo.multiply %v422, %v423 : tensor<32x128x28x28xf32>
    %v426 = stablehlo.add %v425, %v424 : tensor<32x128x28x28xf32>
    %v427 = stablehlo.reshape %v426 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v428 = stablehlo.add %v388, %v427 : tensor<32x100352xf32>
    %v429 = stablehlo.constant dense<0.0> : tensor<32x100352xf32>
    %v430 = stablehlo.maximum %v428, %v429 : tensor<32x100352xf32>
    %v431 = stablehlo.reshape %v430 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v432 = stablehlo.convolution(%v431, %s2b0W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v433 = stablehlo.broadcast_in_dim %zb128, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v434 = stablehlo.add %v432, %v433 : tensor<32x128x28x28xf32>
    ...
    %v438 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v439 = stablehlo.reduce(%v436 init: %v437) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v441 = stablehlo.reshape %v435 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v442 = stablehlo.constant dense<0.0> : tensor<f32>
    %v443 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v444 = stablehlo.reduce(%v441 init: %v442) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v447 = stablehlo.subtract %v441, %v446 : tensor<32x128x28x28xf32>
    %v448 = stablehlo.multiply %v447, %v447 : tensor<32x128x28x28xf32>
    %v449 = stablehlo.reduce(%v448 init: %v442) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v455 = stablehlo.reshape %v435 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v458 = stablehlo.broadcast_in_dim %v456, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v459 = stablehlo.broadcast_in_dim %v457, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v460 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v461 = stablehlo.add %v459, %v460 : tensor<32x128x28x28xf32>
    %v462 = stablehlo.rsqrt %v461 : tensor<32x128x28x28xf32>
    %v463 = stablehlo.subtract %v455, %v458 : tensor<32x128x28x28xf32>
    %v464 = stablehlo.multiply %v463, %v462 : tensor<32x128x28x28xf32>
    %v465 = stablehlo.broadcast_in_dim %s2b0g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v466 = stablehlo.broadcast_in_dim %s2b0bt1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v467 = stablehlo.multiply %v464, %v465 : tensor<32x128x28x28xf32>
    %v468 = stablehlo.add %v467, %v466 : tensor<32x128x28x28xf32>
    %v469 = stablehlo.reshape %v468 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v470 = stablehlo.constant dense<0.0> : tensor<32x100352xf32>
    %v471 = stablehlo.maximum %v469, %v470 : tensor<32x100352xf32>
    %v472 = stablehlo.reshape %v471 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v473 = stablehlo.convolution(%v472, %s2b0W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v474 = stablehlo.broadcast_in_dim %zb128, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v475 = stablehlo.add %v473, %v474 : tensor<32x128x28x28xf32>
    %v476 = stablehlo.reshape %v475 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v477 = stablehlo.reshape %v476 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v478 = stablehlo.constant dense<0.0> : tensor<f32>
    %v479 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v480 = stablehlo.reduce(%v477 init: %v478) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v482 = stablehlo.reshape %v476 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v483 = stablehlo.constant dense<0.0> : tensor<f32>
    %v484 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v485 = stablehlo.reduce(%v482 init: %v483) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v486 = stablehlo.divide %v485, %v484 : tensor<128xf32>
    %v487 = stablehlo.broadcast_in_dim %v486, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v488 = stablehlo.subtract %v482, %v487 : tensor<32x128x28x28xf32>
    %v489 = stablehlo.multiply %v488, %v488 : tensor<32x128x28x28xf32>
    %v490 = stablehlo.reduce(%v489 init: %v483) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v496 = stablehlo.reshape %v476 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v499 = stablehlo.broadcast_in_dim %v497, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v500 = stablehlo.broadcast_in_dim %v498, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v501 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v502 = stablehlo.add %v500, %v501 : tensor<32x128x28x28xf32>
    %v503 = stablehlo.rsqrt %v502 : tensor<32x128x28x28xf32>
    %v504 = stablehlo.subtract %v496, %v499 : tensor<32x128x28x28xf32>
    %v505 = stablehlo.multiply %v504, %v503 : tensor<32x128x28x28xf32>
    %v506 = stablehlo.broadcast_in_dim %s2b0g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v507 = stablehlo.broadcast_in_dim %s2b0bt2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v508 = stablehlo.multiply %v505, %v506 : tensor<32x128x28x28xf32>
    %v509 = stablehlo.add %v508, %v507 : tensor<32x128x28x28xf32>
    %v510 = stablehlo.reshape %v509 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v511 = stablehlo.reshape %v510 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v512 = stablehlo.reshape %v430 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v513 = stablehlo.add %v511, %v512 : tensor<32x128x28x28xf32>
    %v514 = stablehlo.reshape %v513 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v515 = stablehlo.reshape %v514 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v516 = stablehlo.constant dense<0.0> : tensor<32x128x28x28xf32>
    %v517 = stablehlo.maximum %v515, %v516 : tensor<32x128x28x28xf32>
    %v518 = stablehlo.reshape %v517 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v519 = stablehlo.reshape %v518 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v520 = stablehlo.convolution(%v519, %s2b1W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v521 = stablehlo.broadcast_in_dim %zb128, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v522 = stablehlo.add %v520, %v521 : tensor<32x128x28x28xf32>
    %v523 = stablehlo.reshape %v522 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v524 = stablehlo.reshape %v523 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v525 = stablehlo.constant dense<0.0> : tensor<f32>
    %v526 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v527 = stablehlo.reduce(%v524 init: %v525) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v529 = stablehlo.reshape %v523 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v530 = stablehlo.constant dense<0.0> : tensor<f32>
    %v531 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v532 = stablehlo.reduce(%v529 init: %v530) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v533 = stablehlo.divide %v532, %v531 : tensor<128xf32>
    %v534 = stablehlo.broadcast_in_dim %v533, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v535 = stablehlo.subtract %v529, %v534 : tensor<32x128x28x28xf32>
    %v536 = stablehlo.multiply %v535, %v535 : tensor<32x128x28x28xf32>
    %v537 = stablehlo.reduce(%v536 init: %v530) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v543 = stablehlo.reshape %v523 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v546 = stablehlo.broadcast_in_dim %v544, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v547 = stablehlo.broadcast_in_dim %v545, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v548 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v549 = stablehlo.add %v547, %v548 : tensor<32x128x28x28xf32>
    %v550 = stablehlo.rsqrt %v549 : tensor<32x128x28x28xf32>
    %v551 = stablehlo.subtract %v543, %v546 : tensor<32x128x28x28xf32>
    %v552 = stablehlo.multiply %v551, %v550 : tensor<32x128x28x28xf32>
    %v553 = stablehlo.broadcast_in_dim %s2b1g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v554 = stablehlo.broadcast_in_dim %s2b1bt1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v555 = stablehlo.multiply %v552, %v553 : tensor<32x128x28x28xf32>
    %v556 = stablehlo.add %v555, %v554 : tensor<32x128x28x28xf32>
    %v557 = stablehlo.reshape %v556 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v558 = stablehlo.constant dense<0.0> : tensor<32x100352xf32>
    %v559 = stablehlo.maximum %v557, %v558 : tensor<32x100352xf32>
    %v560 = stablehlo.reshape %v559 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v561 = stablehlo.convolution(%v560, %s2b1W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v562 = stablehlo.broadcast_in_dim %zb128, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v563 = stablehlo.add %v561, %v562 : tensor<32x128x28x28xf32>
    %v564 = stablehlo.reshape %v563 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v565 = stablehlo.reshape %v564 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v566 = stablehlo.constant dense<0.0> : tensor<f32>
    %v567 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v568 = stablehlo.reduce(%v565 init: %v566) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v570 = stablehlo.reshape %v564 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v571 = stablehlo.constant dense<0.0> : tensor<f32>
    %v572 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v573 = stablehlo.reduce(%v570 init: %v571) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v574 = stablehlo.divide %v573, %v572 : tensor<128xf32>
    %v575 = stablehlo.broadcast_in_dim %v574, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v576 = stablehlo.subtract %v570, %v575 : tensor<32x128x28x28xf32>
    %v577 = stablehlo.multiply %v576, %v576 : tensor<32x128x28x28xf32>
    %v578 = stablehlo.reduce(%v577 init: %v571) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v584 = stablehlo.reshape %v564 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v587 = stablehlo.broadcast_in_dim %v585, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v588 = stablehlo.broadcast_in_dim %v586, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v589 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v590 = stablehlo.add %v588, %v589 : tensor<32x128x28x28xf32>
    %v591 = stablehlo.rsqrt %v590 : tensor<32x128x28x28xf32>
    %v592 = stablehlo.subtract %v584, %v587 : tensor<32x128x28x28xf32>
    %v593 = stablehlo.multiply %v592, %v591 : tensor<32x128x28x28xf32>
    %v594 = stablehlo.broadcast_in_dim %s2b1g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v595 = stablehlo.broadcast_in_dim %s2b1bt2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v596 = stablehlo.multiply %v593, %v594 : tensor<32x128x28x28xf32>
    %v597 = stablehlo.add %v596, %v595 : tensor<32x128x28x28xf32>
    %v598 = stablehlo.reshape %v597 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v599 = stablehlo.reshape %v598 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v600 = stablehlo.reshape %v518 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v601 = stablehlo.add %v599, %v600 : tensor<32x128x28x28xf32>
    %v602 = stablehlo.reshape %v601 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v603 = stablehlo.reshape %v602 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v604 = stablehlo.constant dense<0.0> : tensor<32x128x28x28xf32>
    %v605 = stablehlo.maximum %v603, %v604 : tensor<32x128x28x28xf32>
    %v606 = stablehlo.reshape %v605 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v607 = stablehlo.reshape %v606 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v608 = stablehlo.convolution(%v607, %s2b2W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v609 = stablehlo.broadcast_in_dim %zb128, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v610 = stablehlo.add %v608, %v609 : tensor<32x128x28x28xf32>
    %v611 = stablehlo.reshape %v610 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v612 = stablehlo.reshape %v611 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v613 = stablehlo.constant dense<0.0> : tensor<f32>
    %v614 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v615 = stablehlo.reduce(%v612 init: %v613) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v617 = stablehlo.reshape %v611 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v618 = stablehlo.constant dense<0.0> : tensor<f32>
    %v619 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v620 = stablehlo.reduce(%v617 init: %v618) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v621 = stablehlo.divide %v620, %v619 : tensor<128xf32>
    %v622 = stablehlo.broadcast_in_dim %v621, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v623 = stablehlo.subtract %v617, %v622 : tensor<32x128x28x28xf32>
    %v624 = stablehlo.multiply %v623, %v623 : tensor<32x128x28x28xf32>
    %v625 = stablehlo.reduce(%v624 init: %v618) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v631 = stablehlo.reshape %v611 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v634 = stablehlo.broadcast_in_dim %v632, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v635 = stablehlo.broadcast_in_dim %v633, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v636 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v637 = stablehlo.add %v635, %v636 : tensor<32x128x28x28xf32>
    %v638 = stablehlo.rsqrt %v637 : tensor<32x128x28x28xf32>
    %v639 = stablehlo.subtract %v631, %v634 : tensor<32x128x28x28xf32>
    %v640 = stablehlo.multiply %v639, %v638 : tensor<32x128x28x28xf32>
    %v641 = stablehlo.broadcast_in_dim %s2b2g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v642 = stablehlo.broadcast_in_dim %s2b2bt1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v643 = stablehlo.multiply %v640, %v641 : tensor<32x128x28x28xf32>
    %v644 = stablehlo.add %v643, %v642 : tensor<32x128x28x28xf32>
    %v645 = stablehlo.reshape %v644 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v646 = stablehlo.constant dense<0.0> : tensor<32x100352xf32>
    %v647 = stablehlo.maximum %v645, %v646 : tensor<32x100352xf32>
    %v648 = stablehlo.reshape %v647 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v649 = stablehlo.convolution(%v648, %s2b2W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v650 = stablehlo.broadcast_in_dim %zb128, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v651 = stablehlo.add %v649, %v650 : tensor<32x128x28x28xf32>
    %v652 = stablehlo.reshape %v651 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v653 = stablehlo.reshape %v652 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v654 = stablehlo.constant dense<0.0> : tensor<f32>
    %v655 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v656 = stablehlo.reduce(%v653 init: %v654) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v658 = stablehlo.reshape %v652 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v659 = stablehlo.constant dense<0.0> : tensor<f32>
    %v660 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v661 = stablehlo.reduce(%v658 init: %v659) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v662 = stablehlo.divide %v661, %v660 : tensor<128xf32>
    %v663 = stablehlo.broadcast_in_dim %v662, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v664 = stablehlo.subtract %v658, %v663 : tensor<32x128x28x28xf32>
    %v665 = stablehlo.multiply %v664, %v664 : tensor<32x128x28x28xf32>
    %v666 = stablehlo.reduce(%v665 init: %v659) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v672 = stablehlo.reshape %v652 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v675 = stablehlo.broadcast_in_dim %v673, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v676 = stablehlo.broadcast_in_dim %v674, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v677 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v678 = stablehlo.add %v676, %v677 : tensor<32x128x28x28xf32>
    %v679 = stablehlo.rsqrt %v678 : tensor<32x128x28x28xf32>
    %v680 = stablehlo.subtract %v672, %v675 : tensor<32x128x28x28xf32>
    %v681 = stablehlo.multiply %v680, %v679 : tensor<32x128x28x28xf32>
    %v682 = stablehlo.broadcast_in_dim %s2b2g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v683 = stablehlo.broadcast_in_dim %s2b2bt2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v684 = stablehlo.multiply %v681, %v682 : tensor<32x128x28x28xf32>
    %v685 = stablehlo.add %v684, %v683 : tensor<32x128x28x28xf32>
    %v686 = stablehlo.reshape %v685 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v687 = stablehlo.reshape %v686 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v688 = stablehlo.reshape %v606 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v689 = stablehlo.add %v687, %v688 : tensor<32x128x28x28xf32>
    %v690 = stablehlo.reshape %v689 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v691 = stablehlo.reshape %v690 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v692 = stablehlo.constant dense<0.0> : tensor<32x128x28x28xf32>
    %v693 = stablehlo.maximum %v691, %v692 : tensor<32x128x28x28xf32>
    %v694 = stablehlo.reshape %v693 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v695 = stablehlo.reshape %v694 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v697 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v702 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v703 = stablehlo.reduce(%v700 init: %v701) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v705 = stablehlo.reshape %v699 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v706 = stablehlo.constant dense<0.0> : tensor<f32>
    %v707 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v708 = stablehlo.reduce(%v705 init: %v706) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v709 = stablehlo.divide %v708, %v707 : tensor<256xf32>
    %v710 = stablehlo.broadcast_in_dim %v709, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v711 = stablehlo.subtract %v705, %v710 : tensor<32x256x14x14xf32>
    %v712 = stablehlo.multiply %v711, %v711 : tensor<32x256x14x14xf32>
    %v713 = stablehlo.reduce(%v712 init: %v706) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v719 = stablehlo.reshape %v699 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v722 = stablehlo.broadcast_in_dim %v720, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v723 = stablehlo.broadcast_in_dim %v721, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v724 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v725 = stablehlo.add %v723, %v724 : tensor<32x256x14x14xf32>
    %v726 = stablehlo.rsqrt %v725 : tensor<32x256x14x14xf32>
    %v727 = stablehlo.subtract %v719, %v722 : tensor<32x256x14x14xf32>
    %v728 = stablehlo.multiply %v727, %v726 : tensor<32x256x14x14xf32>
    %v729 = stablehlo.broadcast_in_dim %d3g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v730 = stablehlo.broadcast_in_dim %d3bt1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v731 = stablehlo.multiply %v728, %v729 : tensor<32x256x14x14xf32>
    %v732 = stablehlo.add %v731, %v730 : tensor<32x256x14x14xf32>
    %v733 = stablehlo.reshape %v732 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v734 = stablehlo.constant dense<0.0> : tensor<32x50176xf32>
    %v735 = stablehlo.maximum %v733, %v734 : tensor<32x50176xf32>
    ...
    %v738 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v739 = stablehlo.add %v737, %v738 : tensor<32x256x14x14xf32>
    %v740 = stablehlo.reshape %v739 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v741 = stablehlo.reshape %v740 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v742 = stablehlo.constant dense<0.0> : tensor<f32>
    %v743 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v744 = stablehlo.reduce(%v741 init: %v742) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v746 = stablehlo.reshape %v740 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v747 = stablehlo.constant dense<0.0> : tensor<f32>
    %v748 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v749 = stablehlo.reduce(%v746 init: %v747) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v752 = stablehlo.subtract %v746, %v751 : tensor<32x256x14x14xf32>
    %v753 = stablehlo.multiply %v752, %v752 : tensor<32x256x14x14xf32>
    %v754 = stablehlo.reduce(%v753 init: %v747) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v760 = stablehlo.reshape %v740 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v763 = stablehlo.broadcast_in_dim %v761, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v764 = stablehlo.broadcast_in_dim %v762, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v765 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v766 = stablehlo.add %v764, %v765 : tensor<32x256x14x14xf32>
    %v767 = stablehlo.rsqrt %v766 : tensor<32x256x14x14xf32>
    %v768 = stablehlo.subtract %v760, %v763 : tensor<32x256x14x14xf32>
    %v769 = stablehlo.multiply %v768, %v767 : tensor<32x256x14x14xf32>
    %v770 = stablehlo.broadcast_in_dim %d3g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v771 = stablehlo.broadcast_in_dim %d3bt2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v772 = stablehlo.multiply %v769, %v770 : tensor<32x256x14x14xf32>
    %v773 = stablehlo.add %v772, %v771 : tensor<32x256x14x14xf32>
    %v774 = stablehlo.reshape %v773 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v775 = stablehlo.reshape %v694 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v782 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v783 = stablehlo.reduce(%v780 init: %v781) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v785 = stablehlo.reshape %v779 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v786 = stablehlo.constant dense<0.0> : tensor<f32>
    %v787 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v788 = stablehlo.reduce(%v785 init: %v786) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v791 = stablehlo.subtract %v785, %v790 : tensor<32x256x14x14xf32>
    %v792 = stablehlo.multiply %v791, %v791 : tensor<32x256x14x14xf32>
    %v793 = stablehlo.reduce(%v792 init: %v786) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v799 = stablehlo.reshape %v779 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v802 = stablehlo.broadcast_in_dim %v800, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v803 = stablehlo.broadcast_in_dim %v801, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v804 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v805 = stablehlo.add %v803, %v804 : tensor<32x256x14x14xf32>
    %v806 = stablehlo.rsqrt %v805 : tensor<32x256x14x14xf32>
    %v807 = stablehlo.subtract %v799, %v802 : tensor<32x256x14x14xf32>
    %v808 = stablehlo.multiply %v807, %v806 : tensor<32x256x14x14xf32>
    %v809 = stablehlo.broadcast_in_dim %d3gp, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v810 = stablehlo.broadcast_in_dim %d3btp, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v814 = stablehlo.add %v774, %v813 : tensor<32x50176xf32>
    %v815 = stablehlo.constant dense<0.0> : tensor<32x50176xf32>
    %v816 = stablehlo.maximum %v814, %v815 : tensor<32x50176xf32>
    %v817 = stablehlo.reshape %v816 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v818 = stablehlo.convolution(%v817, %s3b0W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v819 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v820 = stablehlo.add %v818, %v819 : tensor<32x256x14x14xf32>
    %v821 = stablehlo.reshape %v820 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v822 = stablehlo.reshape %v821 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v823 = stablehlo.constant dense<0.0> : tensor<f32>
    %v824 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v825 = stablehlo.reduce(%v822 init: %v823) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v827 = stablehlo.reshape %v821 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v828 = stablehlo.constant dense<0.0> : tensor<f32>
    %v829 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v830 = stablehlo.reduce(%v827 init: %v828) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v831 = stablehlo.divide %v830, %v829 : tensor<256xf32>
    %v832 = stablehlo.broadcast_in_dim %v831, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v833 = stablehlo.subtract %v827, %v832 : tensor<32x256x14x14xf32>
    %v834 = stablehlo.multiply %v833, %v833 : tensor<32x256x14x14xf32>
    %v835 = stablehlo.reduce(%v834 init: %v828) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v841 = stablehlo.reshape %v821 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v844 = stablehlo.broadcast_in_dim %v842, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v845 = stablehlo.broadcast_in_dim %v843, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v846 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v847 = stablehlo.add %v845, %v846 : tensor<32x256x14x14xf32>
    %v848 = stablehlo.rsqrt %v847 : tensor<32x256x14x14xf32>
    %v849 = stablehlo.subtract %v841, %v844 : tensor<32x256x14x14xf32>
    %v850 = stablehlo.multiply %v849, %v848 : tensor<32x256x14x14xf32>
    %v851 = stablehlo.broadcast_in_dim %s3b0g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v852 = stablehlo.broadcast_in_dim %s3b0bt1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v853 = stablehlo.multiply %v850, %v851 : tensor<32x256x14x14xf32>
    %v854 = stablehlo.add %v853, %v852 : tensor<32x256x14x14xf32>
    %v855 = stablehlo.reshape %v854 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v856 = stablehlo.constant dense<0.0> : tensor<32x50176xf32>
    %v857 = stablehlo.maximum %v855, %v856 : tensor<32x50176xf32>
    %v858 = stablehlo.reshape %v857 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v859 = stablehlo.convolution(%v858, %s3b0W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v860 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v861 = stablehlo.add %v859, %v860 : tensor<32x256x14x14xf32>
    %v862 = stablehlo.reshape %v861 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v863 = stablehlo.reshape %v862 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v864 = stablehlo.constant dense<0.0> : tensor<f32>
    %v865 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v866 = stablehlo.reduce(%v863 init: %v864) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v868 = stablehlo.reshape %v862 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v869 = stablehlo.constant dense<0.0> : tensor<f32>
    %v870 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v871 = stablehlo.reduce(%v868 init: %v869) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v872 = stablehlo.divide %v871, %v870 : tensor<256xf32>
    %v873 = stablehlo.broadcast_in_dim %v872, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v874 = stablehlo.subtract %v868, %v873 : tensor<32x256x14x14xf32>
    %v875 = stablehlo.multiply %v874, %v874 : tensor<32x256x14x14xf32>
    %v876 = stablehlo.reduce(%v875 init: %v869) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v882 = stablehlo.reshape %v862 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v885 = stablehlo.broadcast_in_dim %v883, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v886 = stablehlo.broadcast_in_dim %v884, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v887 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v888 = stablehlo.add %v886, %v887 : tensor<32x256x14x14xf32>
    %v889 = stablehlo.rsqrt %v888 : tensor<32x256x14x14xf32>
    %v890 = stablehlo.subtract %v882, %v885 : tensor<32x256x14x14xf32>
    %v891 = stablehlo.multiply %v890, %v889 : tensor<32x256x14x14xf32>
    %v892 = stablehlo.broadcast_in_dim %s3b0g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v893 = stablehlo.broadcast_in_dim %s3b0bt2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v894 = stablehlo.multiply %v891, %v892 : tensor<32x256x14x14xf32>
    %v895 = stablehlo.add %v894, %v893 : tensor<32x256x14x14xf32>
    %v896 = stablehlo.reshape %v895 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v897 = stablehlo.reshape %v896 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v898 = stablehlo.reshape %v816 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v899 = stablehlo.add %v897, %v898 : tensor<32x256x14x14xf32>
    %v900 = stablehlo.reshape %v899 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v901 = stablehlo.reshape %v900 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v902 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v903 = stablehlo.maximum %v901, %v902 : tensor<32x256x14x14xf32>
    %v904 = stablehlo.reshape %v903 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v905 = stablehlo.reshape %v904 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v906 = stablehlo.convolution(%v905, %s3b1W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v907 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v908 = stablehlo.add %v906, %v907 : tensor<32x256x14x14xf32>
    %v909 = stablehlo.reshape %v908 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v910 = stablehlo.reshape %v909 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v911 = stablehlo.constant dense<0.0> : tensor<f32>
    %v912 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v913 = stablehlo.reduce(%v910 init: %v911) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v915 = stablehlo.reshape %v909 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v916 = stablehlo.constant dense<0.0> : tensor<f32>
    %v917 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v918 = stablehlo.reduce(%v915 init: %v916) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v919 = stablehlo.divide %v918, %v917 : tensor<256xf32>
    %v920 = stablehlo.broadcast_in_dim %v919, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v921 = stablehlo.subtract %v915, %v920 : tensor<32x256x14x14xf32>
    %v922 = stablehlo.multiply %v921, %v921 : tensor<32x256x14x14xf32>
    %v923 = stablehlo.reduce(%v922 init: %v916) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v929 = stablehlo.reshape %v909 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v932 = stablehlo.broadcast_in_dim %v930, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v933 = stablehlo.broadcast_in_dim %v931, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v934 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v935 = stablehlo.add %v933, %v934 : tensor<32x256x14x14xf32>
    %v936 = stablehlo.rsqrt %v935 : tensor<32x256x14x14xf32>
    %v937 = stablehlo.subtract %v929, %v932 : tensor<32x256x14x14xf32>
    %v938 = stablehlo.multiply %v937, %v936 : tensor<32x256x14x14xf32>
    %v939 = stablehlo.broadcast_in_dim %s3b1g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v940 = stablehlo.broadcast_in_dim %s3b1bt1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v941 = stablehlo.multiply %v938, %v939 : tensor<32x256x14x14xf32>
    %v942 = stablehlo.add %v941, %v940 : tensor<32x256x14x14xf32>
    %v943 = stablehlo.reshape %v942 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v944 = stablehlo.constant dense<0.0> : tensor<32x50176xf32>
    %v945 = stablehlo.maximum %v943, %v944 : tensor<32x50176xf32>
    %v946 = stablehlo.reshape %v945 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v947 = stablehlo.convolution(%v946, %s3b1W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v948 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v949 = stablehlo.add %v947, %v948 : tensor<32x256x14x14xf32>
    %v950 = stablehlo.reshape %v949 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v951 = stablehlo.reshape %v950 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v952 = stablehlo.constant dense<0.0> : tensor<f32>
    %v953 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v954 = stablehlo.reduce(%v951 init: %v952) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v956 = stablehlo.reshape %v950 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v957 = stablehlo.constant dense<0.0> : tensor<f32>
    %v958 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v959 = stablehlo.reduce(%v956 init: %v957) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v960 = stablehlo.divide %v959, %v958 : tensor<256xf32>
    %v961 = stablehlo.broadcast_in_dim %v960, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v962 = stablehlo.subtract %v956, %v961 : tensor<32x256x14x14xf32>
    %v963 = stablehlo.multiply %v962, %v962 : tensor<32x256x14x14xf32>
    %v964 = stablehlo.reduce(%v963 init: %v957) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v970 = stablehlo.reshape %v950 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v973 = stablehlo.broadcast_in_dim %v971, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v974 = stablehlo.broadcast_in_dim %v972, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v975 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v976 = stablehlo.add %v974, %v975 : tensor<32x256x14x14xf32>
    %v977 = stablehlo.rsqrt %v976 : tensor<32x256x14x14xf32>
    %v978 = stablehlo.subtract %v970, %v973 : tensor<32x256x14x14xf32>
    %v979 = stablehlo.multiply %v978, %v977 : tensor<32x256x14x14xf32>
    %v980 = stablehlo.broadcast_in_dim %s3b1g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v981 = stablehlo.broadcast_in_dim %s3b1bt2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v982 = stablehlo.multiply %v979, %v980 : tensor<32x256x14x14xf32>
    %v983 = stablehlo.add %v982, %v981 : tensor<32x256x14x14xf32>
    %v984 = stablehlo.reshape %v983 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v985 = stablehlo.reshape %v984 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v986 = stablehlo.reshape %v904 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v987 = stablehlo.add %v985, %v986 : tensor<32x256x14x14xf32>
    %v988 = stablehlo.reshape %v987 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v989 = stablehlo.reshape %v988 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v990 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v991 = stablehlo.maximum %v989, %v990 : tensor<32x256x14x14xf32>
    %v992 = stablehlo.reshape %v991 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v993 = stablehlo.reshape %v992 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v994 = stablehlo.convolution(%v993, %s3b2W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v995 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v996 = stablehlo.add %v994, %v995 : tensor<32x256x14x14xf32>
    %v997 = stablehlo.reshape %v996 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v998 = stablehlo.reshape %v997 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v999 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1000 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1001 = stablehlo.reduce(%v998 init: %v999) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1003 = stablehlo.reshape %v997 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1004 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1005 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1006 = stablehlo.reduce(%v1003 init: %v1004) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v1007 = stablehlo.divide %v1006, %v1005 : tensor<256xf32>
    %v1008 = stablehlo.broadcast_in_dim %v1007, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1009 = stablehlo.subtract %v1003, %v1008 : tensor<32x256x14x14xf32>
    %v1010 = stablehlo.multiply %v1009, %v1009 : tensor<32x256x14x14xf32>
    %v1011 = stablehlo.reduce(%v1010 init: %v1004) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1017 = stablehlo.reshape %v997 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v1020 = stablehlo.broadcast_in_dim %v1018, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1021 = stablehlo.broadcast_in_dim %v1019, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1022 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v1023 = stablehlo.add %v1021, %v1022 : tensor<32x256x14x14xf32>
    %v1024 = stablehlo.rsqrt %v1023 : tensor<32x256x14x14xf32>
    %v1025 = stablehlo.subtract %v1017, %v1020 : tensor<32x256x14x14xf32>
    %v1026 = stablehlo.multiply %v1025, %v1024 : tensor<32x256x14x14xf32>
    %v1027 = stablehlo.broadcast_in_dim %s3b2g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1028 = stablehlo.broadcast_in_dim %s3b2bt1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1029 = stablehlo.multiply %v1026, %v1027 : tensor<32x256x14x14xf32>
    %v1030 = stablehlo.add %v1029, %v1028 : tensor<32x256x14x14xf32>
    %v1031 = stablehlo.reshape %v1030 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1032 = stablehlo.constant dense<0.0> : tensor<32x50176xf32>
    %v1033 = stablehlo.maximum %v1031, %v1032 : tensor<32x50176xf32>
    %v1034 = stablehlo.reshape %v1033 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1035 = stablehlo.convolution(%v1034, %s3b2W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v1036 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1037 = stablehlo.add %v1035, %v1036 : tensor<32x256x14x14xf32>
    %v1038 = stablehlo.reshape %v1037 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1039 = stablehlo.reshape %v1038 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1040 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1041 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1042 = stablehlo.reduce(%v1039 init: %v1040) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1044 = stablehlo.reshape %v1038 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1045 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1046 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1047 = stablehlo.reduce(%v1044 init: %v1045) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v1048 = stablehlo.divide %v1047, %v1046 : tensor<256xf32>
    %v1049 = stablehlo.broadcast_in_dim %v1048, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1050 = stablehlo.subtract %v1044, %v1049 : tensor<32x256x14x14xf32>
    %v1051 = stablehlo.multiply %v1050, %v1050 : tensor<32x256x14x14xf32>
    %v1052 = stablehlo.reduce(%v1051 init: %v1045) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1058 = stablehlo.reshape %v1038 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v1061 = stablehlo.broadcast_in_dim %v1059, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1062 = stablehlo.broadcast_in_dim %v1060, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1063 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v1064 = stablehlo.add %v1062, %v1063 : tensor<32x256x14x14xf32>
    %v1065 = stablehlo.rsqrt %v1064 : tensor<32x256x14x14xf32>
    %v1066 = stablehlo.subtract %v1058, %v1061 : tensor<32x256x14x14xf32>
    %v1067 = stablehlo.multiply %v1066, %v1065 : tensor<32x256x14x14xf32>
    %v1068 = stablehlo.broadcast_in_dim %s3b2g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1069 = stablehlo.broadcast_in_dim %s3b2bt2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1070 = stablehlo.multiply %v1067, %v1068 : tensor<32x256x14x14xf32>
    %v1071 = stablehlo.add %v1070, %v1069 : tensor<32x256x14x14xf32>
    %v1072 = stablehlo.reshape %v1071 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1073 = stablehlo.reshape %v1072 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1074 = stablehlo.reshape %v992 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1075 = stablehlo.add %v1073, %v1074 : tensor<32x256x14x14xf32>
    %v1076 = stablehlo.reshape %v1075 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1077 = stablehlo.reshape %v1076 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1078 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v1079 = stablehlo.maximum %v1077, %v1078 : tensor<32x256x14x14xf32>
    %v1080 = stablehlo.reshape %v1079 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1081 = stablehlo.reshape %v1080 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1082 = stablehlo.convolution(%v1081, %s3b3W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v1083 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1084 = stablehlo.add %v1082, %v1083 : tensor<32x256x14x14xf32>
    %v1085 = stablehlo.reshape %v1084 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1086 = stablehlo.reshape %v1085 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1087 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1088 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1089 = stablehlo.reduce(%v1086 init: %v1087) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1091 = stablehlo.reshape %v1085 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1092 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1093 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1094 = stablehlo.reduce(%v1091 init: %v1092) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v1095 = stablehlo.divide %v1094, %v1093 : tensor<256xf32>
    %v1096 = stablehlo.broadcast_in_dim %v1095, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1097 = stablehlo.subtract %v1091, %v1096 : tensor<32x256x14x14xf32>
    %v1098 = stablehlo.multiply %v1097, %v1097 : tensor<32x256x14x14xf32>
    %v1099 = stablehlo.reduce(%v1098 init: %v1092) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1105 = stablehlo.reshape %v1085 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v1108 = stablehlo.broadcast_in_dim %v1106, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1109 = stablehlo.broadcast_in_dim %v1107, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1110 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v1111 = stablehlo.add %v1109, %v1110 : tensor<32x256x14x14xf32>
    %v1112 = stablehlo.rsqrt %v1111 : tensor<32x256x14x14xf32>
    %v1113 = stablehlo.subtract %v1105, %v1108 : tensor<32x256x14x14xf32>
    %v1114 = stablehlo.multiply %v1113, %v1112 : tensor<32x256x14x14xf32>
    %v1115 = stablehlo.broadcast_in_dim %s3b3g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1116 = stablehlo.broadcast_in_dim %s3b3bt1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1117 = stablehlo.multiply %v1114, %v1115 : tensor<32x256x14x14xf32>
    %v1118 = stablehlo.add %v1117, %v1116 : tensor<32x256x14x14xf32>
    %v1119 = stablehlo.reshape %v1118 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1120 = stablehlo.constant dense<0.0> : tensor<32x50176xf32>
    %v1121 = stablehlo.maximum %v1119, %v1120 : tensor<32x50176xf32>
    %v1122 = stablehlo.reshape %v1121 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1123 = stablehlo.convolution(%v1122, %s3b3W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v1124 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1125 = stablehlo.add %v1123, %v1124 : tensor<32x256x14x14xf32>
    %v1126 = stablehlo.reshape %v1125 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1127 = stablehlo.reshape %v1126 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1128 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1129 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1130 = stablehlo.reduce(%v1127 init: %v1128) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1132 = stablehlo.reshape %v1126 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1133 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1134 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1135 = stablehlo.reduce(%v1132 init: %v1133) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v1136 = stablehlo.divide %v1135, %v1134 : tensor<256xf32>
    %v1137 = stablehlo.broadcast_in_dim %v1136, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1138 = stablehlo.subtract %v1132, %v1137 : tensor<32x256x14x14xf32>
    %v1139 = stablehlo.multiply %v1138, %v1138 : tensor<32x256x14x14xf32>
    %v1140 = stablehlo.reduce(%v1139 init: %v1133) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1146 = stablehlo.reshape %v1126 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v1149 = stablehlo.broadcast_in_dim %v1147, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1150 = stablehlo.broadcast_in_dim %v1148, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1151 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v1152 = stablehlo.add %v1150, %v1151 : tensor<32x256x14x14xf32>
    %v1153 = stablehlo.rsqrt %v1152 : tensor<32x256x14x14xf32>
    %v1154 = stablehlo.subtract %v1146, %v1149 : tensor<32x256x14x14xf32>
    %v1155 = stablehlo.multiply %v1154, %v1153 : tensor<32x256x14x14xf32>
    %v1156 = stablehlo.broadcast_in_dim %s3b3g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1157 = stablehlo.broadcast_in_dim %s3b3bt2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1158 = stablehlo.multiply %v1155, %v1156 : tensor<32x256x14x14xf32>
    %v1159 = stablehlo.add %v1158, %v1157 : tensor<32x256x14x14xf32>
    %v1160 = stablehlo.reshape %v1159 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1161 = stablehlo.reshape %v1160 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1162 = stablehlo.reshape %v1080 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1163 = stablehlo.add %v1161, %v1162 : tensor<32x256x14x14xf32>
    %v1164 = stablehlo.reshape %v1163 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1165 = stablehlo.reshape %v1164 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1166 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v1167 = stablehlo.maximum %v1165, %v1166 : tensor<32x256x14x14xf32>
    %v1168 = stablehlo.reshape %v1167 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1169 = stablehlo.reshape %v1168 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1170 = stablehlo.convolution(%v1169, %s3b4W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v1171 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1172 = stablehlo.add %v1170, %v1171 : tensor<32x256x14x14xf32>
    %v1173 = stablehlo.reshape %v1172 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1174 = stablehlo.reshape %v1173 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1175 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1176 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1177 = stablehlo.reduce(%v1174 init: %v1175) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1179 = stablehlo.reshape %v1173 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1180 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1181 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1182 = stablehlo.reduce(%v1179 init: %v1180) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v1183 = stablehlo.divide %v1182, %v1181 : tensor<256xf32>
    %v1184 = stablehlo.broadcast_in_dim %v1183, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1185 = stablehlo.subtract %v1179, %v1184 : tensor<32x256x14x14xf32>
    %v1186 = stablehlo.multiply %v1185, %v1185 : tensor<32x256x14x14xf32>
    %v1187 = stablehlo.reduce(%v1186 init: %v1180) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1193 = stablehlo.reshape %v1173 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v1196 = stablehlo.broadcast_in_dim %v1194, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1197 = stablehlo.broadcast_in_dim %v1195, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1198 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v1199 = stablehlo.add %v1197, %v1198 : tensor<32x256x14x14xf32>
    %v1200 = stablehlo.rsqrt %v1199 : tensor<32x256x14x14xf32>
    %v1201 = stablehlo.subtract %v1193, %v1196 : tensor<32x256x14x14xf32>
    %v1202 = stablehlo.multiply %v1201, %v1200 : tensor<32x256x14x14xf32>
    %v1203 = stablehlo.broadcast_in_dim %s3b4g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1204 = stablehlo.broadcast_in_dim %s3b4bt1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1205 = stablehlo.multiply %v1202, %v1203 : tensor<32x256x14x14xf32>
    %v1206 = stablehlo.add %v1205, %v1204 : tensor<32x256x14x14xf32>
    %v1207 = stablehlo.reshape %v1206 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1208 = stablehlo.constant dense<0.0> : tensor<32x50176xf32>
    %v1209 = stablehlo.maximum %v1207, %v1208 : tensor<32x50176xf32>
    %v1210 = stablehlo.reshape %v1209 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1211 = stablehlo.convolution(%v1210, %s3b4W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v1212 = stablehlo.broadcast_in_dim %zb256, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1213 = stablehlo.add %v1211, %v1212 : tensor<32x256x14x14xf32>
    %v1214 = stablehlo.reshape %v1213 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1215 = stablehlo.reshape %v1214 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1216 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1217 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1218 = stablehlo.reduce(%v1215 init: %v1216) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1220 = stablehlo.reshape %v1214 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1221 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1222 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v1223 = stablehlo.reduce(%v1220 init: %v1221) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v1224 = stablehlo.divide %v1223, %v1222 : tensor<256xf32>
    %v1225 = stablehlo.broadcast_in_dim %v1224, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1226 = stablehlo.subtract %v1220, %v1225 : tensor<32x256x14x14xf32>
    %v1227 = stablehlo.multiply %v1226, %v1226 : tensor<32x256x14x14xf32>
    %v1228 = stablehlo.reduce(%v1227 init: %v1221) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v1234 = stablehlo.reshape %v1214 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v1237 = stablehlo.broadcast_in_dim %v1235, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1238 = stablehlo.broadcast_in_dim %v1236, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1239 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v1240 = stablehlo.add %v1238, %v1239 : tensor<32x256x14x14xf32>
    %v1241 = stablehlo.rsqrt %v1240 : tensor<32x256x14x14xf32>
    %v1242 = stablehlo.subtract %v1234, %v1237 : tensor<32x256x14x14xf32>
    %v1243 = stablehlo.multiply %v1242, %v1241 : tensor<32x256x14x14xf32>
    %v1244 = stablehlo.broadcast_in_dim %s3b4g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1245 = stablehlo.broadcast_in_dim %s3b4bt2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v1246 = stablehlo.multiply %v1243, %v1244 : tensor<32x256x14x14xf32>
    %v1247 = stablehlo.add %v1246, %v1245 : tensor<32x256x14x14xf32>
    %v1248 = stablehlo.reshape %v1247 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1249 = stablehlo.reshape %v1248 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1250 = stablehlo.reshape %v1168 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1251 = stablehlo.add %v1249, %v1250 : tensor<32x256x14x14xf32>
    %v1252 = stablehlo.reshape %v1251 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1253 = stablehlo.reshape %v1252 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v1254 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v1255 = stablehlo.maximum %v1253, %v1254 : tensor<32x256x14x14xf32>
    %v1256 = stablehlo.reshape %v1255 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v1257 = stablehlo.reshape %v1256 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v1259 = stablehlo.broadcast_in_dim %zb512, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1260 = stablehlo.add %v1258, %v1259 : tensor<32x512x7x7xf32>
    %v1261 = stablehlo.reshape %v1260 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1262 = stablehlo.reshape %v1261 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1263 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1264 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1265 = stablehlo.reduce(%v1262 init: %v1263) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1267 = stablehlo.reshape %v1261 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1268 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1269 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1270 = stablehlo.reduce(%v1267 init: %v1268) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1271 = stablehlo.divide %v1270, %v1269 : tensor<512xf32>
    %v1272 = stablehlo.broadcast_in_dim %v1271, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1273 = stablehlo.subtract %v1267, %v1272 : tensor<32x512x7x7xf32>
    %v1274 = stablehlo.multiply %v1273, %v1273 : tensor<32x512x7x7xf32>
    %v1275 = stablehlo.reduce(%v1274 init: %v1268) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1281 = stablehlo.reshape %v1261 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1284 = stablehlo.broadcast_in_dim %v1282, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1285 = stablehlo.broadcast_in_dim %v1283, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1286 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1287 = stablehlo.add %v1285, %v1286 : tensor<32x512x7x7xf32>
    %v1288 = stablehlo.rsqrt %v1287 : tensor<32x512x7x7xf32>
    %v1289 = stablehlo.subtract %v1281, %v1284 : tensor<32x512x7x7xf32>
    %v1290 = stablehlo.multiply %v1289, %v1288 : tensor<32x512x7x7xf32>
    %v1291 = stablehlo.broadcast_in_dim %d4g1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1292 = stablehlo.broadcast_in_dim %d4bt1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1293 = stablehlo.multiply %v1290, %v1291 : tensor<32x512x7x7xf32>
    %v1294 = stablehlo.add %v1293, %v1292 : tensor<32x512x7x7xf32>
    %v1295 = stablehlo.reshape %v1294 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1296 = stablehlo.constant dense<0.0> : tensor<32x25088xf32>
    %v1297 = stablehlo.maximum %v1295, %v1296 : tensor<32x25088xf32>
    %v1298 = stablehlo.reshape %v1297 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1300 = stablehlo.broadcast_in_dim %zb512, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1301 = stablehlo.add %v1299, %v1300 : tensor<32x512x7x7xf32>
    %v1302 = stablehlo.reshape %v1301 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1303 = stablehlo.reshape %v1302 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1304 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1305 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1306 = stablehlo.reduce(%v1303 init: %v1304) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1308 = stablehlo.reshape %v1302 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1309 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1310 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1311 = stablehlo.reduce(%v1308 init: %v1309) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1314 = stablehlo.subtract %v1308, %v1313 : tensor<32x512x7x7xf32>
    %v1315 = stablehlo.multiply %v1314, %v1314 : tensor<32x512x7x7xf32>
    %v1316 = stablehlo.reduce(%v1315 init: %v1309) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1322 = stablehlo.reshape %v1302 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1325 = stablehlo.broadcast_in_dim %v1323, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1326 = stablehlo.broadcast_in_dim %v1324, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1327 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1328 = stablehlo.add %v1326, %v1327 : tensor<32x512x7x7xf32>
    %v1329 = stablehlo.rsqrt %v1328 : tensor<32x512x7x7xf32>
    %v1330 = stablehlo.subtract %v1322, %v1325 : tensor<32x512x7x7xf32>
    %v1331 = stablehlo.multiply %v1330, %v1329 : tensor<32x512x7x7xf32>
    %v1332 = stablehlo.broadcast_in_dim %d4g2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1333 = stablehlo.broadcast_in_dim %d4bt2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1334 = stablehlo.multiply %v1331, %v1332 : tensor<32x512x7x7xf32>
    %v1335 = stablehlo.add %v1334, %v1333 : tensor<32x512x7x7xf32>
    %v1336 = stablehlo.reshape %v1335 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1337 = stablehlo.reshape %v1256 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v1339 = stablehlo.broadcast_in_dim %zb512, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1340 = stablehlo.add %v1338, %v1339 : tensor<32x512x7x7xf32>
    %v1341 = stablehlo.reshape %v1340 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1342 = stablehlo.reshape %v1341 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1343 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1344 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    ...
    %v1347 = stablehlo.reshape %v1341 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1348 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1349 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1350 = stablehlo.reduce(%v1347 init: %v1348) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1351 = stablehlo.divide %v1350, %v1349 : tensor<512xf32>
    %v1352 = stablehlo.broadcast_in_dim %v1351, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1353 = stablehlo.subtract %v1347, %v1352 : tensor<32x512x7x7xf32>
    %v1354 = stablehlo.multiply %v1353, %v1353 : tensor<32x512x7x7xf32>
    %v1355 = stablehlo.reduce(%v1354 init: %v1348) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1361 = stablehlo.reshape %v1341 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1364 = stablehlo.broadcast_in_dim %v1362, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1365 = stablehlo.broadcast_in_dim %v1363, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1366 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1367 = stablehlo.add %v1365, %v1366 : tensor<32x512x7x7xf32>
    %v1368 = stablehlo.rsqrt %v1367 : tensor<32x512x7x7xf32>
    %v1369 = stablehlo.subtract %v1361, %v1364 : tensor<32x512x7x7xf32>
    %v1370 = stablehlo.multiply %v1369, %v1368 : tensor<32x512x7x7xf32>
    %v1371 = stablehlo.broadcast_in_dim %d4gp, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1372 = stablehlo.broadcast_in_dim %d4btp, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1373 = stablehlo.multiply %v1370, %v1371 : tensor<32x512x7x7xf32>
    %v1374 = stablehlo.add %v1373, %v1372 : tensor<32x512x7x7xf32>
    %v1375 = stablehlo.reshape %v1374 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1376 = stablehlo.add %v1336, %v1375 : tensor<32x25088xf32>
    %v1377 = stablehlo.constant dense<0.0> : tensor<32x25088xf32>
    %v1378 = stablehlo.maximum %v1376, %v1377 : tensor<32x25088xf32>
    %v1379 = stablehlo.reshape %v1378 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1380 = stablehlo.convolution(%v1379, %s4b0W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x512x7x7xf32>, tensor<512x512x3x3xf32>) -> tensor<32x512x7x7xf32>
    %v1381 = stablehlo.broadcast_in_dim %zb512, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1382 = stablehlo.add %v1380, %v1381 : tensor<32x512x7x7xf32>
    %v1383 = stablehlo.reshape %v1382 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1384 = stablehlo.reshape %v1383 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1385 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1386 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1387 = stablehlo.reduce(%v1384 init: %v1385) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1389 = stablehlo.reshape %v1383 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1390 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1391 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1392 = stablehlo.reduce(%v1389 init: %v1390) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1393 = stablehlo.divide %v1392, %v1391 : tensor<512xf32>
    %v1394 = stablehlo.broadcast_in_dim %v1393, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1395 = stablehlo.subtract %v1389, %v1394 : tensor<32x512x7x7xf32>
    %v1396 = stablehlo.multiply %v1395, %v1395 : tensor<32x512x7x7xf32>
    %v1397 = stablehlo.reduce(%v1396 init: %v1390) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1403 = stablehlo.reshape %v1383 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1406 = stablehlo.broadcast_in_dim %v1404, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1407 = stablehlo.broadcast_in_dim %v1405, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1408 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1409 = stablehlo.add %v1407, %v1408 : tensor<32x512x7x7xf32>
    %v1410 = stablehlo.rsqrt %v1409 : tensor<32x512x7x7xf32>
    %v1411 = stablehlo.subtract %v1403, %v1406 : tensor<32x512x7x7xf32>
    %v1412 = stablehlo.multiply %v1411, %v1410 : tensor<32x512x7x7xf32>
    %v1413 = stablehlo.broadcast_in_dim %s4b0g1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1414 = stablehlo.broadcast_in_dim %s4b0bt1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1415 = stablehlo.multiply %v1412, %v1413 : tensor<32x512x7x7xf32>
    %v1416 = stablehlo.add %v1415, %v1414 : tensor<32x512x7x7xf32>
    %v1417 = stablehlo.reshape %v1416 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1418 = stablehlo.constant dense<0.0> : tensor<32x25088xf32>
    %v1419 = stablehlo.maximum %v1417, %v1418 : tensor<32x25088xf32>
    %v1420 = stablehlo.reshape %v1419 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1421 = stablehlo.convolution(%v1420, %s4b0W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x512x7x7xf32>, tensor<512x512x3x3xf32>) -> tensor<32x512x7x7xf32>
    %v1422 = stablehlo.broadcast_in_dim %zb512, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1423 = stablehlo.add %v1421, %v1422 : tensor<32x512x7x7xf32>
    %v1424 = stablehlo.reshape %v1423 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1425 = stablehlo.reshape %v1424 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1426 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1427 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1428 = stablehlo.reduce(%v1425 init: %v1426) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1430 = stablehlo.reshape %v1424 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1431 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1432 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1433 = stablehlo.reduce(%v1430 init: %v1431) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1434 = stablehlo.divide %v1433, %v1432 : tensor<512xf32>
    %v1435 = stablehlo.broadcast_in_dim %v1434, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1436 = stablehlo.subtract %v1430, %v1435 : tensor<32x512x7x7xf32>
    %v1437 = stablehlo.multiply %v1436, %v1436 : tensor<32x512x7x7xf32>
    %v1438 = stablehlo.reduce(%v1437 init: %v1431) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1444 = stablehlo.reshape %v1424 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1447 = stablehlo.broadcast_in_dim %v1445, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1448 = stablehlo.broadcast_in_dim %v1446, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1449 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1450 = stablehlo.add %v1448, %v1449 : tensor<32x512x7x7xf32>
    %v1451 = stablehlo.rsqrt %v1450 : tensor<32x512x7x7xf32>
    %v1452 = stablehlo.subtract %v1444, %v1447 : tensor<32x512x7x7xf32>
    %v1453 = stablehlo.multiply %v1452, %v1451 : tensor<32x512x7x7xf32>
    %v1454 = stablehlo.broadcast_in_dim %s4b0g2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1455 = stablehlo.broadcast_in_dim %s4b0bt2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1456 = stablehlo.multiply %v1453, %v1454 : tensor<32x512x7x7xf32>
    %v1457 = stablehlo.add %v1456, %v1455 : tensor<32x512x7x7xf32>
    %v1458 = stablehlo.reshape %v1457 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1459 = stablehlo.reshape %v1458 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1460 = stablehlo.reshape %v1378 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1461 = stablehlo.add %v1459, %v1460 : tensor<32x512x7x7xf32>
    %v1462 = stablehlo.reshape %v1461 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1463 = stablehlo.reshape %v1462 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1464 = stablehlo.constant dense<0.0> : tensor<32x512x7x7xf32>
    %v1465 = stablehlo.maximum %v1463, %v1464 : tensor<32x512x7x7xf32>
    %v1466 = stablehlo.reshape %v1465 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1467 = stablehlo.reshape %v1466 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1468 = stablehlo.convolution(%v1467, %s4b1W1)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x512x7x7xf32>, tensor<512x512x3x3xf32>) -> tensor<32x512x7x7xf32>
    %v1469 = stablehlo.broadcast_in_dim %zb512, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1470 = stablehlo.add %v1468, %v1469 : tensor<32x512x7x7xf32>
    %v1471 = stablehlo.reshape %v1470 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1472 = stablehlo.reshape %v1471 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1473 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1474 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1475 = stablehlo.reduce(%v1472 init: %v1473) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1477 = stablehlo.reshape %v1471 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1478 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1479 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1480 = stablehlo.reduce(%v1477 init: %v1478) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1483 = stablehlo.subtract %v1477, %v1482 : tensor<32x512x7x7xf32>
    %v1484 = stablehlo.multiply %v1483, %v1483 : tensor<32x512x7x7xf32>
    %v1485 = stablehlo.reduce(%v1484 init: %v1478) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1491 = stablehlo.reshape %v1471 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1494 = stablehlo.broadcast_in_dim %v1492, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1495 = stablehlo.broadcast_in_dim %v1493, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1496 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1497 = stablehlo.add %v1495, %v1496 : tensor<32x512x7x7xf32>
    %v1498 = stablehlo.rsqrt %v1497 : tensor<32x512x7x7xf32>
    %v1499 = stablehlo.subtract %v1491, %v1494 : tensor<32x512x7x7xf32>
    %v1500 = stablehlo.multiply %v1499, %v1498 : tensor<32x512x7x7xf32>
    %v1501 = stablehlo.broadcast_in_dim %s4b1g1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1502 = stablehlo.broadcast_in_dim %s4b1bt1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1503 = stablehlo.multiply %v1500, %v1501 : tensor<32x512x7x7xf32>
    %v1504 = stablehlo.add %v1503, %v1502 : tensor<32x512x7x7xf32>
    %v1505 = stablehlo.reshape %v1504 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1506 = stablehlo.constant dense<0.0> : tensor<32x25088xf32>
    %v1507 = stablehlo.maximum %v1505, %v1506 : tensor<32x25088xf32>
    %v1508 = stablehlo.reshape %v1507 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1509 = stablehlo.convolution(%v1508, %s4b1W2)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x512x7x7xf32>, tensor<512x512x3x3xf32>) -> tensor<32x512x7x7xf32>
    %v1510 = stablehlo.broadcast_in_dim %zb512, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1511 = stablehlo.add %v1509, %v1510 : tensor<32x512x7x7xf32>
    %v1512 = stablehlo.reshape %v1511 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1513 = stablehlo.reshape %v1512 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1514 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1515 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1516 = stablehlo.reduce(%v1513 init: %v1514) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1518 = stablehlo.reshape %v1512 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1519 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1520 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1521 = stablehlo.reduce(%v1518 init: %v1519) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1522 = stablehlo.divide %v1521, %v1520 : tensor<512xf32>
    %v1523 = stablehlo.broadcast_in_dim %v1522, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1524 = stablehlo.subtract %v1518, %v1523 : tensor<32x512x7x7xf32>
    %v1525 = stablehlo.multiply %v1524, %v1524 : tensor<32x512x7x7xf32>
    %v1526 = stablehlo.reduce(%v1525 init: %v1519) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1532 = stablehlo.reshape %v1512 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1535 = stablehlo.broadcast_in_dim %v1533, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1536 = stablehlo.broadcast_in_dim %v1534, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1537 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1538 = stablehlo.add %v1536, %v1537 : tensor<32x512x7x7xf32>
    %v1539 = stablehlo.rsqrt %v1538 : tensor<32x512x7x7xf32>
    %v1540 = stablehlo.subtract %v1532, %v1535 : tensor<32x512x7x7xf32>
    %v1541 = stablehlo.multiply %v1540, %v1539 : tensor<32x512x7x7xf32>
    %v1542 = stablehlo.broadcast_in_dim %s4b1g2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1543 = stablehlo.broadcast_in_dim %s4b1bt2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1544 = stablehlo.multiply %v1541, %v1542 : tensor<32x512x7x7xf32>
    %v1545 = stablehlo.add %v1544, %v1543 : tensor<32x512x7x7xf32>
    %v1546 = stablehlo.reshape %v1545 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1547 = stablehlo.reshape %v1546 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1548 = stablehlo.reshape %v1466 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1549 = stablehlo.add %v1547, %v1548 : tensor<32x512x7x7xf32>
    %v1550 = stablehlo.reshape %v1549 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1551 = stablehlo.reshape %v1550 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1552 = stablehlo.constant dense<0.0> : tensor<32x512x7x7xf32>
    %v1553 = stablehlo.maximum %v1551, %v1552 : tensor<32x512x7x7xf32>
    %v1554 = stablehlo.reshape %v1553 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1555 = stablehlo.reshape %v1554 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1556 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1557 = stablehlo.reduce(%v1555 init: %v1556) applies stablehlo.add across dimensions = [2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<32x512xf32>
    %v1558 = stablehlo.constant dense<49.0> : tensor<32x512xf32>
    %v1559 = stablehlo.divide %v1557, %v1558 : tensor<32x512xf32>
    %v1560 = stablehlo.dot_general %v1559, %Wd, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<32x512xf32>, tensor<512x10xf32>) -> tensor<32x10xf32>
    %v1561 = stablehlo.broadcast_in_dim %bd, dims = [1] : (tensor<10xf32>) -> tensor<32x10xf32>
    %v1562 = stablehlo.add %v1560, %v1561 : tensor<32x10xf32>
    %v1563 = stablehlo.reshape %v1562 : (tensor<32x10xf32>) -> tensor<32x1x10xf32>
    %v1564 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1565 = stablehlo.exponential %v1563 : tensor<32x1x10xf32>
    %v1566 = stablehlo.reduce(%v1565 init: %v1564) applies stablehlo.add across dimensions = [2] : (tensor<32x1x10xf32>, tensor<f32>) -> tensor<32x1xf32>
    %v1567 = stablehlo.broadcast_in_dim %v1566, dims = [0, 1] : (tensor<32x1xf32>) -> tensor<32x1x10xf32>
    %v1568 = stablehlo.divide %v1565, %v1567 : tensor<32x1x10xf32>
    %v1569 = stablehlo.reshape %v1568 : (tensor<32x1x10xf32>) -> tensor<32x10xf32>
    %v1570 = stablehlo.subtract %v1569, %onehot : tensor<32x10xf32>
    %v1571 = stablehlo.constant dense<0.100000> : tensor<32x10xf32>
    %v1572 = stablehlo.multiply %onehot, %v1571 : tensor<32x10xf32>
    %v1573 = stablehlo.add %v1570, %v1572 : tensor<32x10xf32>
    %v1574 = stablehlo.constant dense<-0.010000> : tensor<32x10xf32>
    %v1575 = stablehlo.add %v1573, %v1574 : tensor<32x10xf32>
    %v1576 = stablehlo.constant dense<32.0> : tensor<32x10xf32>
    %v1577 = stablehlo.divide %v1575, %v1576 : tensor<32x10xf32>
    %v1578 = stablehlo.reshape %v1577 : (tensor<32x10xf32>) -> tensor<32x1x10xf32>
    %v1579 = stablehlo.dot_general %v1578, %Wd, contracting_dims = [2] x [1], precision = [DEFAULT, DEFAULT] : (tensor<32x1x10xf32>, tensor<512x10xf32>) -> tensor<32x1x512xf32>
    %v1580 = stablehlo.reshape %v1579 : (tensor<32x1x512xf32>) -> tensor<32x512xf32>
    %v1581 = stablehlo.dot_general %v1559, %v1577, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<32x512xf32>, tensor<32x10xf32>) -> tensor<512x10xf32>
    %v1582 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1583 = stablehlo.reduce(%v1577 init: %v1582) applies stablehlo.add across dimensions = [0] : (tensor<32x10xf32>, tensor<f32>) -> tensor<10xf32>
    %v1584 = stablehlo.broadcast_in_dim %v1580, dims = [0, 1] : (tensor<32x512xf32>) -> tensor<32x512x7x7xf32>
    %v1585 = stablehlo.constant dense<49.0> : tensor<32x512x7x7xf32>
    %v1586 = stablehlo.divide %v1584, %v1585 : tensor<32x512x7x7xf32>
    %v1587 = stablehlo.reshape %v1586 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1588 = stablehlo.reshape %v1587 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1589 = stablehlo.reshape %v1550 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1590 = stablehlo.constant dense<0.0> : tensor<32x512x7x7xf32>
    %v1591 = stablehlo.compare GT, %v1589, %v1590 : (tensor<32x512x7x7xf32>, tensor<32x512x7x7xf32>) -> tensor<32x512x7x7xi1>
    %v1592 = stablehlo.select %v1591, %v1588, %v1590 : tensor<32x512x7x7xi1>, tensor<32x512x7x7xf32>
    %v1593 = stablehlo.reshape %v1592 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1594 = stablehlo.reshape %v1512 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1597 = stablehlo.broadcast_in_dim %v1595, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1598 = stablehlo.broadcast_in_dim %v1596, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1599 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1600 = stablehlo.add %v1598, %v1599 : tensor<32x512x7x7xf32>
    %v1601 = stablehlo.rsqrt %v1600 : tensor<32x512x7x7xf32>
    %v1602 = stablehlo.subtract %v1594, %v1597 : tensor<32x512x7x7xf32>
    %v1603 = stablehlo.multiply %v1602, %v1601 : tensor<32x512x7x7xf32>
    %v1604 = stablehlo.broadcast_in_dim %s4b1g2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1605 = stablehlo.reshape %v1593 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1606 = stablehlo.multiply %v1604, %v1605 : tensor<32x512x7x7xf32>
    %v1607 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1608 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1609 = stablehlo.reduce(%v1606 init: %v1607) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1610 = stablehlo.divide %v1609, %v1608 : tensor<512xf32>
    %v1611 = stablehlo.multiply %v1603, %v1606 : tensor<32x512x7x7xf32>
    %v1612 = stablehlo.reduce(%v1611 init: %v1607) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1616 = stablehlo.reshape %v1512 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1621 = stablehlo.broadcast_in_dim %v1617, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1622 = stablehlo.broadcast_in_dim %v1618, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1623 = stablehlo.broadcast_in_dim %v1619, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1624 = stablehlo.broadcast_in_dim %v1620, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1625 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1626 = stablehlo.add %v1622, %v1625 : tensor<32x512x7x7xf32>
    %v1627 = stablehlo.rsqrt %v1626 : tensor<32x512x7x7xf32>
    %v1628 = stablehlo.subtract %v1616, %v1621 : tensor<32x512x7x7xf32>
    %v1629 = stablehlo.multiply %v1628, %v1627 : tensor<32x512x7x7xf32>
    %v1630 = stablehlo.broadcast_in_dim %s4b1g2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1631 = stablehlo.reshape %v1593 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1632 = stablehlo.multiply %v1630, %v1631 : tensor<32x512x7x7xf32>
    %v1633 = stablehlo.subtract %v1632, %v1623 : tensor<32x512x7x7xf32>
    %v1634 = stablehlo.multiply %v1629, %v1624 : tensor<32x512x7x7xf32>
    %v1635 = stablehlo.subtract %v1633, %v1634 : tensor<32x512x7x7xf32>
    %v1636 = stablehlo.multiply %v1627, %v1635 : tensor<32x512x7x7xf32>
    %v1637 = stablehlo.reshape %v1636 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1638 = stablehlo.reshape %v1637 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1641 = stablehlo.convolution(%v1638, %v1640)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x512x7x7xf32>, tensor<512x512x3x3xf32>) -> tensor<32x512x7x7xf32>
    %v1642 = stablehlo.reshape %v1641 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1643 = stablehlo.reshape %v1642 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1644 = stablehlo.reshape %v1505 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1645 = stablehlo.constant dense<0.0> : tensor<32x512x7x7xf32>
    %v1646 = stablehlo.compare GT, %v1644, %v1645 : (tensor<32x512x7x7xf32>, tensor<32x512x7x7xf32>) -> tensor<32x512x7x7xi1>
    %v1647 = stablehlo.select %v1646, %v1643, %v1645 : tensor<32x512x7x7xi1>, tensor<32x512x7x7xf32>
    %v1648 = stablehlo.reshape %v1647 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1649 = stablehlo.reshape %v1471 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1652 = stablehlo.broadcast_in_dim %v1650, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1653 = stablehlo.broadcast_in_dim %v1651, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1654 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1655 = stablehlo.add %v1653, %v1654 : tensor<32x512x7x7xf32>
    %v1656 = stablehlo.rsqrt %v1655 : tensor<32x512x7x7xf32>
    %v1657 = stablehlo.subtract %v1649, %v1652 : tensor<32x512x7x7xf32>
    %v1658 = stablehlo.multiply %v1657, %v1656 : tensor<32x512x7x7xf32>
    %v1659 = stablehlo.broadcast_in_dim %s4b1g1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1660 = stablehlo.reshape %v1648 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1661 = stablehlo.multiply %v1659, %v1660 : tensor<32x512x7x7xf32>
    %v1662 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1663 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1664 = stablehlo.reduce(%v1661 init: %v1662) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1665 = stablehlo.divide %v1664, %v1663 : tensor<512xf32>
    %v1666 = stablehlo.multiply %v1658, %v1661 : tensor<32x512x7x7xf32>
    %v1667 = stablehlo.reduce(%v1666 init: %v1662) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1671 = stablehlo.reshape %v1471 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1676 = stablehlo.broadcast_in_dim %v1672, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1677 = stablehlo.broadcast_in_dim %v1673, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1678 = stablehlo.broadcast_in_dim %v1674, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1679 = stablehlo.broadcast_in_dim %v1675, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1680 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1681 = stablehlo.add %v1677, %v1680 : tensor<32x512x7x7xf32>
    %v1682 = stablehlo.rsqrt %v1681 : tensor<32x512x7x7xf32>
    %v1683 = stablehlo.subtract %v1671, %v1676 : tensor<32x512x7x7xf32>
    %v1684 = stablehlo.multiply %v1683, %v1682 : tensor<32x512x7x7xf32>
    %v1685 = stablehlo.broadcast_in_dim %s4b1g1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1686 = stablehlo.reshape %v1648 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1687 = stablehlo.multiply %v1685, %v1686 : tensor<32x512x7x7xf32>
    %v1688 = stablehlo.subtract %v1687, %v1678 : tensor<32x512x7x7xf32>
    %v1689 = stablehlo.multiply %v1684, %v1679 : tensor<32x512x7x7xf32>
    %v1690 = stablehlo.subtract %v1688, %v1689 : tensor<32x512x7x7xf32>
    %v1691 = stablehlo.multiply %v1682, %v1690 : tensor<32x512x7x7xf32>
    %v1692 = stablehlo.reshape %v1691 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1693 = stablehlo.reshape %v1692 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1699 = stablehlo.reshape %v1593 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1700 = stablehlo.add %v1698, %v1699 : tensor<32x512x7x7xf32>
    %v1701 = stablehlo.reshape %v1700 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1702 = stablehlo.reshape %v1466 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1703 = stablehlo.reshape %v1692 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1704 = stablehlo.transpose %v1702, dims = [1, 0, 2, 3] : (tensor<32x512x7x7xf32>) -> tensor<512x32x7x7xf32>
    %v1705 = stablehlo.transpose %v1703, dims = [1, 0, 2, 3] : (tensor<32x512x7x7xf32>) -> tensor<512x32x7x7xf32>
    ...
    %v1708 = stablehlo.reshape %v1471 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1711 = stablehlo.broadcast_in_dim %v1709, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1712 = stablehlo.broadcast_in_dim %v1710, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1713 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1714 = stablehlo.add %v1712, %v1713 : tensor<32x512x7x7xf32>
    %v1715 = stablehlo.rsqrt %v1714 : tensor<32x512x7x7xf32>
    %v1716 = stablehlo.subtract %v1708, %v1711 : tensor<32x512x7x7xf32>
    %v1717 = stablehlo.multiply %v1716, %v1715 : tensor<32x512x7x7xf32>
    %v1718 = stablehlo.reshape %v1648 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1719 = stablehlo.multiply %v1718, %v1717 : tensor<32x512x7x7xf32>
    %v1720 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1721 = stablehlo.reduce(%v1719 init: %v1720) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1722 = stablehlo.reshape %v1648 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1723 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1724 = stablehlo.reduce(%v1722 init: %v1723) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1725 = stablehlo.reshape %v1507 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1726 = stablehlo.reshape %v1637 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1727 = stablehlo.transpose %v1725, dims = [1, 0, 2, 3] : (tensor<32x512x7x7xf32>) -> tensor<512x32x7x7xf32>
    %v1728 = stablehlo.transpose %v1726, dims = [1, 0, 2, 3] : (tensor<32x512x7x7xf32>) -> tensor<512x32x7x7xf32>
    ...
    %v1731 = stablehlo.reshape %v1512 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1734 = stablehlo.broadcast_in_dim %v1732, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1735 = stablehlo.broadcast_in_dim %v1733, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1736 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1737 = stablehlo.add %v1735, %v1736 : tensor<32x512x7x7xf32>
    %v1738 = stablehlo.rsqrt %v1737 : tensor<32x512x7x7xf32>
    %v1739 = stablehlo.subtract %v1731, %v1734 : tensor<32x512x7x7xf32>
    %v1740 = stablehlo.multiply %v1739, %v1738 : tensor<32x512x7x7xf32>
    %v1741 = stablehlo.reshape %v1593 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1742 = stablehlo.multiply %v1741, %v1740 : tensor<32x512x7x7xf32>
    %v1743 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1744 = stablehlo.reduce(%v1742 init: %v1743) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1745 = stablehlo.reshape %v1593 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1746 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1747 = stablehlo.reduce(%v1745 init: %v1746) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1748 = stablehlo.reshape %v1701 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1749 = stablehlo.reshape %v1462 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1750 = stablehlo.constant dense<0.0> : tensor<32x512x7x7xf32>
    %v1751 = stablehlo.compare GT, %v1749, %v1750 : (tensor<32x512x7x7xf32>, tensor<32x512x7x7xf32>) -> tensor<32x512x7x7xi1>
    %v1752 = stablehlo.select %v1751, %v1748, %v1750 : tensor<32x512x7x7xi1>, tensor<32x512x7x7xf32>
    %v1753 = stablehlo.reshape %v1752 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1754 = stablehlo.reshape %v1424 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1757 = stablehlo.broadcast_in_dim %v1755, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1758 = stablehlo.broadcast_in_dim %v1756, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1759 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1760 = stablehlo.add %v1758, %v1759 : tensor<32x512x7x7xf32>
    %v1761 = stablehlo.rsqrt %v1760 : tensor<32x512x7x7xf32>
    %v1762 = stablehlo.subtract %v1754, %v1757 : tensor<32x512x7x7xf32>
    %v1763 = stablehlo.multiply %v1762, %v1761 : tensor<32x512x7x7xf32>
    %v1764 = stablehlo.broadcast_in_dim %s4b0g2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1765 = stablehlo.reshape %v1753 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1766 = stablehlo.multiply %v1764, %v1765 : tensor<32x512x7x7xf32>
    %v1767 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1768 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1769 = stablehlo.reduce(%v1766 init: %v1767) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1770 = stablehlo.divide %v1769, %v1768 : tensor<512xf32>
    %v1771 = stablehlo.multiply %v1763, %v1766 : tensor<32x512x7x7xf32>
    %v1772 = stablehlo.reduce(%v1771 init: %v1767) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1776 = stablehlo.reshape %v1424 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1781 = stablehlo.broadcast_in_dim %v1777, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1782 = stablehlo.broadcast_in_dim %v1778, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1783 = stablehlo.broadcast_in_dim %v1779, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1784 = stablehlo.broadcast_in_dim %v1780, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1785 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1786 = stablehlo.add %v1782, %v1785 : tensor<32x512x7x7xf32>
    %v1787 = stablehlo.rsqrt %v1786 : tensor<32x512x7x7xf32>
    %v1788 = stablehlo.subtract %v1776, %v1781 : tensor<32x512x7x7xf32>
    %v1789 = stablehlo.multiply %v1788, %v1787 : tensor<32x512x7x7xf32>
    %v1790 = stablehlo.broadcast_in_dim %s4b0g2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1791 = stablehlo.reshape %v1753 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1792 = stablehlo.multiply %v1790, %v1791 : tensor<32x512x7x7xf32>
    %v1793 = stablehlo.subtract %v1792, %v1783 : tensor<32x512x7x7xf32>
    %v1794 = stablehlo.multiply %v1789, %v1784 : tensor<32x512x7x7xf32>
    %v1795 = stablehlo.subtract %v1793, %v1794 : tensor<32x512x7x7xf32>
    %v1796 = stablehlo.multiply %v1787, %v1795 : tensor<32x512x7x7xf32>
    %v1797 = stablehlo.reshape %v1796 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1798 = stablehlo.reshape %v1797 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1801 = stablehlo.convolution(%v1798, %v1800)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x512x7x7xf32>, tensor<512x512x3x3xf32>) -> tensor<32x512x7x7xf32>
    %v1802 = stablehlo.reshape %v1801 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1803 = stablehlo.reshape %v1802 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1804 = stablehlo.reshape %v1417 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1805 = stablehlo.constant dense<0.0> : tensor<32x512x7x7xf32>
    %v1806 = stablehlo.compare GT, %v1804, %v1805 : (tensor<32x512x7x7xf32>, tensor<32x512x7x7xf32>) -> tensor<32x512x7x7xi1>
    %v1807 = stablehlo.select %v1806, %v1803, %v1805 : tensor<32x512x7x7xi1>, tensor<32x512x7x7xf32>
    %v1808 = stablehlo.reshape %v1807 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1809 = stablehlo.reshape %v1383 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1812 = stablehlo.broadcast_in_dim %v1810, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1813 = stablehlo.broadcast_in_dim %v1811, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1814 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1815 = stablehlo.add %v1813, %v1814 : tensor<32x512x7x7xf32>
    %v1816 = stablehlo.rsqrt %v1815 : tensor<32x512x7x7xf32>
    %v1817 = stablehlo.subtract %v1809, %v1812 : tensor<32x512x7x7xf32>
    %v1818 = stablehlo.multiply %v1817, %v1816 : tensor<32x512x7x7xf32>
    %v1819 = stablehlo.broadcast_in_dim %s4b0g1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1820 = stablehlo.reshape %v1808 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1821 = stablehlo.multiply %v1819, %v1820 : tensor<32x512x7x7xf32>
    %v1822 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1823 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1824 = stablehlo.reduce(%v1821 init: %v1822) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1825 = stablehlo.divide %v1824, %v1823 : tensor<512xf32>
    %v1826 = stablehlo.multiply %v1818, %v1821 : tensor<32x512x7x7xf32>
    %v1827 = stablehlo.reduce(%v1826 init: %v1822) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1831 = stablehlo.reshape %v1383 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1836 = stablehlo.broadcast_in_dim %v1832, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1837 = stablehlo.broadcast_in_dim %v1833, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1838 = stablehlo.broadcast_in_dim %v1834, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1839 = stablehlo.broadcast_in_dim %v1835, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1840 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1841 = stablehlo.add %v1837, %v1840 : tensor<32x512x7x7xf32>
    %v1842 = stablehlo.rsqrt %v1841 : tensor<32x512x7x7xf32>
    %v1843 = stablehlo.subtract %v1831, %v1836 : tensor<32x512x7x7xf32>
    %v1844 = stablehlo.multiply %v1843, %v1842 : tensor<32x512x7x7xf32>
    %v1845 = stablehlo.broadcast_in_dim %s4b0g1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1846 = stablehlo.reshape %v1808 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1847 = stablehlo.multiply %v1845, %v1846 : tensor<32x512x7x7xf32>
    %v1848 = stablehlo.subtract %v1847, %v1838 : tensor<32x512x7x7xf32>
    %v1849 = stablehlo.multiply %v1844, %v1839 : tensor<32x512x7x7xf32>
    %v1850 = stablehlo.subtract %v1848, %v1849 : tensor<32x512x7x7xf32>
    %v1851 = stablehlo.multiply %v1842, %v1850 : tensor<32x512x7x7xf32>
    %v1852 = stablehlo.reshape %v1851 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1853 = stablehlo.reshape %v1852 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1856 = stablehlo.convolution(%v1853, %v1855)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x512x7x7xf32>, tensor<512x512x3x3xf32>) -> tensor<32x512x7x7xf32>
    %v1857 = stablehlo.reshape %v1856 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1858 = stablehlo.reshape %v1857 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1859 = stablehlo.reshape %v1753 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1860 = stablehlo.add %v1858, %v1859 : tensor<32x512x7x7xf32>
    %v1861 = stablehlo.reshape %v1860 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1862 = stablehlo.reshape %v1378 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1863 = stablehlo.reshape %v1852 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1864 = stablehlo.transpose %v1862, dims = [1, 0, 2, 3] : (tensor<32x512x7x7xf32>) -> tensor<512x32x7x7xf32>
    %v1865 = stablehlo.transpose %v1863, dims = [1, 0, 2, 3] : (tensor<32x512x7x7xf32>) -> tensor<512x32x7x7xf32>
    ...
    %v1868 = stablehlo.reshape %v1383 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1871 = stablehlo.broadcast_in_dim %v1869, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1872 = stablehlo.broadcast_in_dim %v1870, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1873 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1874 = stablehlo.add %v1872, %v1873 : tensor<32x512x7x7xf32>
    %v1875 = stablehlo.rsqrt %v1874 : tensor<32x512x7x7xf32>
    %v1876 = stablehlo.subtract %v1868, %v1871 : tensor<32x512x7x7xf32>
    %v1877 = stablehlo.multiply %v1876, %v1875 : tensor<32x512x7x7xf32>
    %v1878 = stablehlo.reshape %v1808 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1879 = stablehlo.multiply %v1878, %v1877 : tensor<32x512x7x7xf32>
    %v1880 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1881 = stablehlo.reduce(%v1879 init: %v1880) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1882 = stablehlo.reshape %v1808 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1883 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1884 = stablehlo.reduce(%v1882 init: %v1883) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1885 = stablehlo.reshape %v1419 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1886 = stablehlo.reshape %v1797 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1887 = stablehlo.transpose %v1885, dims = [1, 0, 2, 3] : (tensor<32x512x7x7xf32>) -> tensor<512x32x7x7xf32>
    %v1888 = stablehlo.transpose %v1886, dims = [1, 0, 2, 3] : (tensor<32x512x7x7xf32>) -> tensor<512x32x7x7xf32>
    ...
    %v1891 = stablehlo.reshape %v1424 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1894 = stablehlo.broadcast_in_dim %v1892, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1895 = stablehlo.broadcast_in_dim %v1893, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1896 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1897 = stablehlo.add %v1895, %v1896 : tensor<32x512x7x7xf32>
    %v1898 = stablehlo.rsqrt %v1897 : tensor<32x512x7x7xf32>
    %v1899 = stablehlo.subtract %v1891, %v1894 : tensor<32x512x7x7xf32>
    %v1900 = stablehlo.multiply %v1899, %v1898 : tensor<32x512x7x7xf32>
    %v1901 = stablehlo.reshape %v1753 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1902 = stablehlo.multiply %v1901, %v1900 : tensor<32x512x7x7xf32>
    %v1903 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1904 = stablehlo.reduce(%v1902 init: %v1903) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1905 = stablehlo.reshape %v1753 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1906 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1907 = stablehlo.reduce(%v1905 init: %v1906) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1908 = stablehlo.reshape %v1861 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1909 = stablehlo.reshape %v1376 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1910 = stablehlo.constant dense<0.0> : tensor<32x512x7x7xf32>
    %v1911 = stablehlo.compare GT, %v1909, %v1910 : (tensor<32x512x7x7xf32>, tensor<32x512x7x7xf32>) -> tensor<32x512x7x7xi1>
    %v1912 = stablehlo.select %v1911, %v1908, %v1910 : tensor<32x512x7x7xi1>, tensor<32x512x7x7xf32>
    %v1913 = stablehlo.reshape %v1912 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1914 = stablehlo.reshape %v1302 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1917 = stablehlo.broadcast_in_dim %v1915, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1918 = stablehlo.broadcast_in_dim %v1916, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1919 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1920 = stablehlo.add %v1918, %v1919 : tensor<32x512x7x7xf32>
    %v1921 = stablehlo.rsqrt %v1920 : tensor<32x512x7x7xf32>
    %v1922 = stablehlo.subtract %v1914, %v1917 : tensor<32x512x7x7xf32>
    %v1923 = stablehlo.multiply %v1922, %v1921 : tensor<32x512x7x7xf32>
    %v1924 = stablehlo.broadcast_in_dim %d4g2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1925 = stablehlo.reshape %v1913 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1926 = stablehlo.multiply %v1924, %v1925 : tensor<32x512x7x7xf32>
    %v1927 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1928 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1929 = stablehlo.reduce(%v1926 init: %v1927) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1930 = stablehlo.divide %v1929, %v1928 : tensor<512xf32>
    %v1931 = stablehlo.multiply %v1923, %v1926 : tensor<32x512x7x7xf32>
    %v1932 = stablehlo.reduce(%v1931 init: %v1927) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1936 = stablehlo.reshape %v1302 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1941 = stablehlo.broadcast_in_dim %v1937, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1942 = stablehlo.broadcast_in_dim %v1938, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1943 = stablehlo.broadcast_in_dim %v1939, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1944 = stablehlo.broadcast_in_dim %v1940, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1945 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1946 = stablehlo.add %v1942, %v1945 : tensor<32x512x7x7xf32>
    %v1947 = stablehlo.rsqrt %v1946 : tensor<32x512x7x7xf32>
    %v1948 = stablehlo.subtract %v1936, %v1941 : tensor<32x512x7x7xf32>
    %v1949 = stablehlo.multiply %v1948, %v1947 : tensor<32x512x7x7xf32>
    %v1950 = stablehlo.broadcast_in_dim %d4g2, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1951 = stablehlo.reshape %v1913 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1952 = stablehlo.multiply %v1950, %v1951 : tensor<32x512x7x7xf32>
    %v1953 = stablehlo.subtract %v1952, %v1943 : tensor<32x512x7x7xf32>
    %v1954 = stablehlo.multiply %v1949, %v1944 : tensor<32x512x7x7xf32>
    %v1955 = stablehlo.subtract %v1953, %v1954 : tensor<32x512x7x7xf32>
    %v1956 = stablehlo.multiply %v1947, %v1955 : tensor<32x512x7x7xf32>
    %v1957 = stablehlo.reshape %v1956 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1958 = stablehlo.reshape %v1957 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1961 = stablehlo.convolution(%v1958, %v1960)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x512x7x7xf32>, tensor<512x512x3x3xf32>) -> tensor<32x512x7x7xf32>
    %v1962 = stablehlo.reshape %v1961 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1963 = stablehlo.reshape %v1962 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1964 = stablehlo.reshape %v1295 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1965 = stablehlo.constant dense<0.0> : tensor<32x512x7x7xf32>
    %v1966 = stablehlo.compare GT, %v1964, %v1965 : (tensor<32x512x7x7xf32>, tensor<32x512x7x7xf32>) -> tensor<32x512x7x7xi1>
    %v1967 = stablehlo.select %v1966, %v1963, %v1965 : tensor<32x512x7x7xi1>, tensor<32x512x7x7xf32>
    %v1968 = stablehlo.reshape %v1967 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v1969 = stablehlo.reshape %v1261 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1972 = stablehlo.broadcast_in_dim %v1970, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1973 = stablehlo.broadcast_in_dim %v1971, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1974 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v1975 = stablehlo.add %v1973, %v1974 : tensor<32x512x7x7xf32>
    %v1976 = stablehlo.rsqrt %v1975 : tensor<32x512x7x7xf32>
    %v1977 = stablehlo.subtract %v1969, %v1972 : tensor<32x512x7x7xf32>
    %v1978 = stablehlo.multiply %v1977, %v1976 : tensor<32x512x7x7xf32>
    %v1979 = stablehlo.broadcast_in_dim %d4g1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1980 = stablehlo.reshape %v1968 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v1981 = stablehlo.multiply %v1979, %v1980 : tensor<32x512x7x7xf32>
    %v1982 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1983 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v1984 = stablehlo.reduce(%v1981 init: %v1982) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v1985 = stablehlo.divide %v1984, %v1983 : tensor<512xf32>
    %v1986 = stablehlo.multiply %v1978, %v1981 : tensor<32x512x7x7xf32>
    %v1987 = stablehlo.reduce(%v1986 init: %v1982) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1991 = stablehlo.reshape %v1261 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v1996 = stablehlo.broadcast_in_dim %v1992, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1997 = stablehlo.broadcast_in_dim %v1993, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1998 = stablehlo.broadcast_in_dim %v1994, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v1999 = stablehlo.broadcast_in_dim %v1995, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2000 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v2001 = stablehlo.add %v1997, %v2000 : tensor<32x512x7x7xf32>
    %v2002 = stablehlo.rsqrt %v2001 : tensor<32x512x7x7xf32>
    %v2003 = stablehlo.subtract %v1991, %v1996 : tensor<32x512x7x7xf32>
    %v2004 = stablehlo.multiply %v2003, %v2002 : tensor<32x512x7x7xf32>
    %v2005 = stablehlo.broadcast_in_dim %d4g1, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2006 = stablehlo.reshape %v1968 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2007 = stablehlo.multiply %v2005, %v2006 : tensor<32x512x7x7xf32>
    %v2008 = stablehlo.subtract %v2007, %v1998 : tensor<32x512x7x7xf32>
    %v2009 = stablehlo.multiply %v2004, %v1999 : tensor<32x512x7x7xf32>
    %v2010 = stablehlo.subtract %v2008, %v2009 : tensor<32x512x7x7xf32>
    %v2011 = stablehlo.multiply %v2002, %v2010 : tensor<32x512x7x7xf32>
    %v2012 = stablehlo.reshape %v2011 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v2013 = stablehlo.reshape %v2012 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2014 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2015 = stablehlo.pad %v2013, %v2014, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<32x512x14x14xf32>
    ...
    %v2020 = stablehlo.reshape %v1341 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v2023 = stablehlo.broadcast_in_dim %v2021, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2024 = stablehlo.broadcast_in_dim %v2022, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2025 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v2026 = stablehlo.add %v2024, %v2025 : tensor<32x512x7x7xf32>
    %v2027 = stablehlo.rsqrt %v2026 : tensor<32x512x7x7xf32>
    %v2028 = stablehlo.subtract %v2020, %v2023 : tensor<32x512x7x7xf32>
    %v2029 = stablehlo.multiply %v2028, %v2027 : tensor<32x512x7x7xf32>
    %v2030 = stablehlo.broadcast_in_dim %d4gp, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2031 = stablehlo.reshape %v1913 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2032 = stablehlo.multiply %v2030, %v2031 : tensor<32x512x7x7xf32>
    %v2033 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2034 = stablehlo.constant dense<1568.0> : tensor<512xf32>
    %v2035 = stablehlo.reduce(%v2032 init: %v2033) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v2036 = stablehlo.divide %v2035, %v2034 : tensor<512xf32>
    %v2037 = stablehlo.multiply %v2029, %v2032 : tensor<32x512x7x7xf32>
    %v2038 = stablehlo.reduce(%v2037 init: %v2033) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v2042 = stablehlo.reshape %v1341 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v2047 = stablehlo.broadcast_in_dim %v2043, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2048 = stablehlo.broadcast_in_dim %v2044, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2049 = stablehlo.broadcast_in_dim %v2045, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2050 = stablehlo.broadcast_in_dim %v2046, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2051 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v2052 = stablehlo.add %v2048, %v2051 : tensor<32x512x7x7xf32>
    %v2053 = stablehlo.rsqrt %v2052 : tensor<32x512x7x7xf32>
    %v2054 = stablehlo.subtract %v2042, %v2047 : tensor<32x512x7x7xf32>
    %v2055 = stablehlo.multiply %v2054, %v2053 : tensor<32x512x7x7xf32>
    %v2056 = stablehlo.broadcast_in_dim %d4gp, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2057 = stablehlo.reshape %v1913 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2058 = stablehlo.multiply %v2056, %v2057 : tensor<32x512x7x7xf32>
    %v2059 = stablehlo.subtract %v2058, %v2049 : tensor<32x512x7x7xf32>
    %v2060 = stablehlo.multiply %v2055, %v2050 : tensor<32x512x7x7xf32>
    %v2061 = stablehlo.subtract %v2059, %v2060 : tensor<32x512x7x7xf32>
    %v2062 = stablehlo.multiply %v2053, %v2061 : tensor<32x512x7x7xf32>
    %v2063 = stablehlo.reshape %v2062 : (tensor<32x512x7x7xf32>) -> tensor<32x25088xf32>
    %v2064 = stablehlo.reshape %v2063 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2065 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2066 = stablehlo.pad %v2064, %v2065, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<32x512x14x14xf32>
    ...
    %v2070 = stablehlo.reshape %v2069 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2071 = stablehlo.reshape %v2019 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2072 = stablehlo.reshape %v2070 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2073 = stablehlo.add %v2071, %v2072 : tensor<32x256x14x14xf32>
    %v2074 = stablehlo.reshape %v2073 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2075 = stablehlo.reshape %v1256 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2076 = stablehlo.reshape %v2012 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2077 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2078 = stablehlo.pad %v2076, %v2077, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<32x512x14x14xf32>
    %v2079 = stablehlo.transpose %v2075, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2080 = stablehlo.transpose %v2078, dims = [1, 0, 2, 3] : (tensor<32x512x14x14xf32>) -> tensor<512x32x14x14xf32>
    ...
    %v2083 = stablehlo.reshape %v1261 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v2086 = stablehlo.broadcast_in_dim %v2084, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2087 = stablehlo.broadcast_in_dim %v2085, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2088 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v2089 = stablehlo.add %v2087, %v2088 : tensor<32x512x7x7xf32>
    %v2090 = stablehlo.rsqrt %v2089 : tensor<32x512x7x7xf32>
    %v2091 = stablehlo.subtract %v2083, %v2086 : tensor<32x512x7x7xf32>
    %v2092 = stablehlo.multiply %v2091, %v2090 : tensor<32x512x7x7xf32>
    %v2093 = stablehlo.reshape %v1968 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2094 = stablehlo.multiply %v2093, %v2092 : tensor<32x512x7x7xf32>
    %v2095 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2096 = stablehlo.reduce(%v2094 init: %v2095) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v2097 = stablehlo.reshape %v1968 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2098 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2099 = stablehlo.reduce(%v2097 init: %v2098) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v2100 = stablehlo.reshape %v1297 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2101 = stablehlo.reshape %v1957 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2102 = stablehlo.transpose %v2100, dims = [1, 0, 2, 3] : (tensor<32x512x7x7xf32>) -> tensor<512x32x7x7xf32>
    %v2103 = stablehlo.transpose %v2101, dims = [1, 0, 2, 3] : (tensor<32x512x7x7xf32>) -> tensor<512x32x7x7xf32>
    ...
    %v2106 = stablehlo.reshape %v1302 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v2109 = stablehlo.broadcast_in_dim %v2107, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2110 = stablehlo.broadcast_in_dim %v2108, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2111 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v2112 = stablehlo.add %v2110, %v2111 : tensor<32x512x7x7xf32>
    %v2113 = stablehlo.rsqrt %v2112 : tensor<32x512x7x7xf32>
    %v2114 = stablehlo.subtract %v2106, %v2109 : tensor<32x512x7x7xf32>
    %v2115 = stablehlo.multiply %v2114, %v2113 : tensor<32x512x7x7xf32>
    %v2116 = stablehlo.reshape %v1913 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2117 = stablehlo.multiply %v2116, %v2115 : tensor<32x512x7x7xf32>
    %v2118 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2119 = stablehlo.reduce(%v2117 init: %v2118) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v2120 = stablehlo.reshape %v1913 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2121 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2122 = stablehlo.reduce(%v2120 init: %v2121) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v2123 = stablehlo.reshape %v1256 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2124 = stablehlo.reshape %v2063 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2125 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2126 = stablehlo.pad %v2124, %v2125, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<32x512x14x14xf32>
    %v2127 = stablehlo.transpose %v2123, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2128 = stablehlo.transpose %v2126, dims = [1, 0, 2, 3] : (tensor<32x512x14x14xf32>) -> tensor<512x32x14x14xf32>
    ...
    %v2131 = stablehlo.reshape %v1341 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    ...
    %v2134 = stablehlo.broadcast_in_dim %v2132, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2135 = stablehlo.broadcast_in_dim %v2133, dims = [1] : (tensor<512xf32>) -> tensor<32x512x7x7xf32>
    %v2136 = stablehlo.constant dense<1.0e-05> : tensor<32x512x7x7xf32>
    %v2137 = stablehlo.add %v2135, %v2136 : tensor<32x512x7x7xf32>
    %v2138 = stablehlo.rsqrt %v2137 : tensor<32x512x7x7xf32>
    %v2139 = stablehlo.subtract %v2131, %v2134 : tensor<32x512x7x7xf32>
    %v2140 = stablehlo.multiply %v2139, %v2138 : tensor<32x512x7x7xf32>
    %v2141 = stablehlo.reshape %v1913 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2142 = stablehlo.multiply %v2141, %v2140 : tensor<32x512x7x7xf32>
    %v2143 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2144 = stablehlo.reduce(%v2142 init: %v2143) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v2145 = stablehlo.reshape %v1913 : (tensor<32x25088xf32>) -> tensor<32x512x7x7xf32>
    %v2146 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2147 = stablehlo.reduce(%v2145 init: %v2146) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x512x7x7xf32>, tensor<f32>) -> tensor<512xf32>
    %v2148 = stablehlo.reshape %v2074 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2149 = stablehlo.reshape %v1252 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2150 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v2151 = stablehlo.compare GT, %v2149, %v2150 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v2152 = stablehlo.select %v2151, %v2148, %v2150 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v2153 = stablehlo.reshape %v2152 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2154 = stablehlo.reshape %v1214 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2157 = stablehlo.broadcast_in_dim %v2155, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2158 = stablehlo.broadcast_in_dim %v2156, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2159 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2160 = stablehlo.add %v2158, %v2159 : tensor<32x256x14x14xf32>
    %v2161 = stablehlo.rsqrt %v2160 : tensor<32x256x14x14xf32>
    %v2162 = stablehlo.subtract %v2154, %v2157 : tensor<32x256x14x14xf32>
    %v2163 = stablehlo.multiply %v2162, %v2161 : tensor<32x256x14x14xf32>
    %v2164 = stablehlo.broadcast_in_dim %s3b4g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2165 = stablehlo.reshape %v2153 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2166 = stablehlo.multiply %v2164, %v2165 : tensor<32x256x14x14xf32>
    %v2167 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2168 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v2169 = stablehlo.reduce(%v2166 init: %v2167) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2170 = stablehlo.divide %v2169, %v2168 : tensor<256xf32>
    %v2171 = stablehlo.multiply %v2163, %v2166 : tensor<32x256x14x14xf32>
    %v2172 = stablehlo.reduce(%v2171 init: %v2167) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v2176 = stablehlo.reshape %v1214 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2181 = stablehlo.broadcast_in_dim %v2177, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2182 = stablehlo.broadcast_in_dim %v2178, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2183 = stablehlo.broadcast_in_dim %v2179, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2184 = stablehlo.broadcast_in_dim %v2180, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2185 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2186 = stablehlo.add %v2182, %v2185 : tensor<32x256x14x14xf32>
    %v2187 = stablehlo.rsqrt %v2186 : tensor<32x256x14x14xf32>
    %v2188 = stablehlo.subtract %v2176, %v2181 : tensor<32x256x14x14xf32>
    %v2189 = stablehlo.multiply %v2188, %v2187 : tensor<32x256x14x14xf32>
    %v2190 = stablehlo.broadcast_in_dim %s3b4g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2191 = stablehlo.reshape %v2153 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2192 = stablehlo.multiply %v2190, %v2191 : tensor<32x256x14x14xf32>
    %v2193 = stablehlo.subtract %v2192, %v2183 : tensor<32x256x14x14xf32>
    %v2194 = stablehlo.multiply %v2189, %v2184 : tensor<32x256x14x14xf32>
    %v2195 = stablehlo.subtract %v2193, %v2194 : tensor<32x256x14x14xf32>
    %v2196 = stablehlo.multiply %v2187, %v2195 : tensor<32x256x14x14xf32>
    %v2197 = stablehlo.reshape %v2196 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2198 = stablehlo.reshape %v2197 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2201 = stablehlo.convolution(%v2198, %v2200)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v2202 = stablehlo.reshape %v2201 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2203 = stablehlo.reshape %v2202 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2204 = stablehlo.reshape %v1207 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2205 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v2206 = stablehlo.compare GT, %v2204, %v2205 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v2207 = stablehlo.select %v2206, %v2203, %v2205 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v2208 = stablehlo.reshape %v2207 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2209 = stablehlo.reshape %v1173 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2212 = stablehlo.broadcast_in_dim %v2210, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2213 = stablehlo.broadcast_in_dim %v2211, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2214 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2215 = stablehlo.add %v2213, %v2214 : tensor<32x256x14x14xf32>
    %v2216 = stablehlo.rsqrt %v2215 : tensor<32x256x14x14xf32>
    %v2217 = stablehlo.subtract %v2209, %v2212 : tensor<32x256x14x14xf32>
    %v2218 = stablehlo.multiply %v2217, %v2216 : tensor<32x256x14x14xf32>
    %v2219 = stablehlo.broadcast_in_dim %s3b4g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2220 = stablehlo.reshape %v2208 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2221 = stablehlo.multiply %v2219, %v2220 : tensor<32x256x14x14xf32>
    %v2222 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2223 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v2224 = stablehlo.reduce(%v2221 init: %v2222) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2225 = stablehlo.divide %v2224, %v2223 : tensor<256xf32>
    %v2226 = stablehlo.multiply %v2218, %v2221 : tensor<32x256x14x14xf32>
    %v2227 = stablehlo.reduce(%v2226 init: %v2222) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v2231 = stablehlo.reshape %v1173 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2236 = stablehlo.broadcast_in_dim %v2232, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2237 = stablehlo.broadcast_in_dim %v2233, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2238 = stablehlo.broadcast_in_dim %v2234, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2239 = stablehlo.broadcast_in_dim %v2235, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2240 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2241 = stablehlo.add %v2237, %v2240 : tensor<32x256x14x14xf32>
    %v2242 = stablehlo.rsqrt %v2241 : tensor<32x256x14x14xf32>
    %v2243 = stablehlo.subtract %v2231, %v2236 : tensor<32x256x14x14xf32>
    %v2244 = stablehlo.multiply %v2243, %v2242 : tensor<32x256x14x14xf32>
    %v2245 = stablehlo.broadcast_in_dim %s3b4g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2246 = stablehlo.reshape %v2208 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2247 = stablehlo.multiply %v2245, %v2246 : tensor<32x256x14x14xf32>
    %v2248 = stablehlo.subtract %v2247, %v2238 : tensor<32x256x14x14xf32>
    %v2249 = stablehlo.multiply %v2244, %v2239 : tensor<32x256x14x14xf32>
    %v2250 = stablehlo.subtract %v2248, %v2249 : tensor<32x256x14x14xf32>
    %v2251 = stablehlo.multiply %v2242, %v2250 : tensor<32x256x14x14xf32>
    %v2252 = stablehlo.reshape %v2251 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2253 = stablehlo.reshape %v2252 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2256 = stablehlo.convolution(%v2253, %v2255)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v2257 = stablehlo.reshape %v2256 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2258 = stablehlo.reshape %v2257 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2259 = stablehlo.reshape %v2153 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2260 = stablehlo.add %v2258, %v2259 : tensor<32x256x14x14xf32>
    %v2261 = stablehlo.reshape %v2260 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2262 = stablehlo.reshape %v1168 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2263 = stablehlo.reshape %v2252 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2264 = stablehlo.transpose %v2262, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2265 = stablehlo.transpose %v2263, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    ...
    %v2268 = stablehlo.reshape %v1173 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2271 = stablehlo.broadcast_in_dim %v2269, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2272 = stablehlo.broadcast_in_dim %v2270, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2273 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2274 = stablehlo.add %v2272, %v2273 : tensor<32x256x14x14xf32>
    %v2275 = stablehlo.rsqrt %v2274 : tensor<32x256x14x14xf32>
    %v2276 = stablehlo.subtract %v2268, %v2271 : tensor<32x256x14x14xf32>
    %v2277 = stablehlo.multiply %v2276, %v2275 : tensor<32x256x14x14xf32>
    %v2278 = stablehlo.reshape %v2208 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2279 = stablehlo.multiply %v2278, %v2277 : tensor<32x256x14x14xf32>
    ...
    %v2282 = stablehlo.reshape %v2208 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2283 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2284 = stablehlo.reduce(%v2282 init: %v2283) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2285 = stablehlo.reshape %v1209 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2286 = stablehlo.reshape %v2197 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2287 = stablehlo.transpose %v2285, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2288 = stablehlo.transpose %v2286, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    ...
    %v2291 = stablehlo.reshape %v1214 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2294 = stablehlo.broadcast_in_dim %v2292, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2295 = stablehlo.broadcast_in_dim %v2293, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2296 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2297 = stablehlo.add %v2295, %v2296 : tensor<32x256x14x14xf32>
    %v2298 = stablehlo.rsqrt %v2297 : tensor<32x256x14x14xf32>
    %v2299 = stablehlo.subtract %v2291, %v2294 : tensor<32x256x14x14xf32>
    %v2300 = stablehlo.multiply %v2299, %v2298 : tensor<32x256x14x14xf32>
    %v2301 = stablehlo.reshape %v2153 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2302 = stablehlo.multiply %v2301, %v2300 : tensor<32x256x14x14xf32>
    %v2303 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2304 = stablehlo.reduce(%v2302 init: %v2303) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2305 = stablehlo.reshape %v2153 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2306 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2307 = stablehlo.reduce(%v2305 init: %v2306) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2308 = stablehlo.reshape %v2261 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2309 = stablehlo.reshape %v1164 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2310 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v2311 = stablehlo.compare GT, %v2309, %v2310 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v2312 = stablehlo.select %v2311, %v2308, %v2310 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v2313 = stablehlo.reshape %v2312 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2314 = stablehlo.reshape %v1126 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2317 = stablehlo.broadcast_in_dim %v2315, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2318 = stablehlo.broadcast_in_dim %v2316, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2319 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2320 = stablehlo.add %v2318, %v2319 : tensor<32x256x14x14xf32>
    %v2321 = stablehlo.rsqrt %v2320 : tensor<32x256x14x14xf32>
    %v2322 = stablehlo.subtract %v2314, %v2317 : tensor<32x256x14x14xf32>
    %v2323 = stablehlo.multiply %v2322, %v2321 : tensor<32x256x14x14xf32>
    %v2324 = stablehlo.broadcast_in_dim %s3b3g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2325 = stablehlo.reshape %v2313 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2326 = stablehlo.multiply %v2324, %v2325 : tensor<32x256x14x14xf32>
    %v2327 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2328 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v2329 = stablehlo.reduce(%v2326 init: %v2327) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2330 = stablehlo.divide %v2329, %v2328 : tensor<256xf32>
    %v2331 = stablehlo.multiply %v2323, %v2326 : tensor<32x256x14x14xf32>
    %v2332 = stablehlo.reduce(%v2331 init: %v2327) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v2336 = stablehlo.reshape %v1126 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2341 = stablehlo.broadcast_in_dim %v2337, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2342 = stablehlo.broadcast_in_dim %v2338, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2343 = stablehlo.broadcast_in_dim %v2339, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2344 = stablehlo.broadcast_in_dim %v2340, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2345 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2346 = stablehlo.add %v2342, %v2345 : tensor<32x256x14x14xf32>
    %v2347 = stablehlo.rsqrt %v2346 : tensor<32x256x14x14xf32>
    %v2348 = stablehlo.subtract %v2336, %v2341 : tensor<32x256x14x14xf32>
    %v2349 = stablehlo.multiply %v2348, %v2347 : tensor<32x256x14x14xf32>
    %v2350 = stablehlo.broadcast_in_dim %s3b3g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2351 = stablehlo.reshape %v2313 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2352 = stablehlo.multiply %v2350, %v2351 : tensor<32x256x14x14xf32>
    %v2353 = stablehlo.subtract %v2352, %v2343 : tensor<32x256x14x14xf32>
    %v2354 = stablehlo.multiply %v2349, %v2344 : tensor<32x256x14x14xf32>
    %v2355 = stablehlo.subtract %v2353, %v2354 : tensor<32x256x14x14xf32>
    %v2356 = stablehlo.multiply %v2347, %v2355 : tensor<32x256x14x14xf32>
    %v2357 = stablehlo.reshape %v2356 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2358 = stablehlo.reshape %v2357 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2361 = stablehlo.convolution(%v2358, %v2360)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v2362 = stablehlo.reshape %v2361 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2363 = stablehlo.reshape %v2362 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2364 = stablehlo.reshape %v1119 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2365 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v2366 = stablehlo.compare GT, %v2364, %v2365 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v2367 = stablehlo.select %v2366, %v2363, %v2365 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v2368 = stablehlo.reshape %v2367 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2369 = stablehlo.reshape %v1085 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2372 = stablehlo.broadcast_in_dim %v2370, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2373 = stablehlo.broadcast_in_dim %v2371, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2374 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2375 = stablehlo.add %v2373, %v2374 : tensor<32x256x14x14xf32>
    %v2376 = stablehlo.rsqrt %v2375 : tensor<32x256x14x14xf32>
    %v2377 = stablehlo.subtract %v2369, %v2372 : tensor<32x256x14x14xf32>
    %v2378 = stablehlo.multiply %v2377, %v2376 : tensor<32x256x14x14xf32>
    %v2379 = stablehlo.broadcast_in_dim %s3b3g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2380 = stablehlo.reshape %v2368 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2381 = stablehlo.multiply %v2379, %v2380 : tensor<32x256x14x14xf32>
    %v2382 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2383 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v2384 = stablehlo.reduce(%v2381 init: %v2382) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2385 = stablehlo.divide %v2384, %v2383 : tensor<256xf32>
    %v2386 = stablehlo.multiply %v2378, %v2381 : tensor<32x256x14x14xf32>
    %v2387 = stablehlo.reduce(%v2386 init: %v2382) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v2391 = stablehlo.reshape %v1085 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2396 = stablehlo.broadcast_in_dim %v2392, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2397 = stablehlo.broadcast_in_dim %v2393, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2398 = stablehlo.broadcast_in_dim %v2394, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2399 = stablehlo.broadcast_in_dim %v2395, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2400 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2401 = stablehlo.add %v2397, %v2400 : tensor<32x256x14x14xf32>
    %v2402 = stablehlo.rsqrt %v2401 : tensor<32x256x14x14xf32>
    %v2403 = stablehlo.subtract %v2391, %v2396 : tensor<32x256x14x14xf32>
    %v2404 = stablehlo.multiply %v2403, %v2402 : tensor<32x256x14x14xf32>
    %v2405 = stablehlo.broadcast_in_dim %s3b3g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2406 = stablehlo.reshape %v2368 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2407 = stablehlo.multiply %v2405, %v2406 : tensor<32x256x14x14xf32>
    %v2408 = stablehlo.subtract %v2407, %v2398 : tensor<32x256x14x14xf32>
    %v2409 = stablehlo.multiply %v2404, %v2399 : tensor<32x256x14x14xf32>
    %v2410 = stablehlo.subtract %v2408, %v2409 : tensor<32x256x14x14xf32>
    %v2411 = stablehlo.multiply %v2402, %v2410 : tensor<32x256x14x14xf32>
    %v2412 = stablehlo.reshape %v2411 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2413 = stablehlo.reshape %v2412 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2416 = stablehlo.convolution(%v2413, %v2415)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v2417 = stablehlo.reshape %v2416 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2418 = stablehlo.reshape %v2417 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2419 = stablehlo.reshape %v2313 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2420 = stablehlo.add %v2418, %v2419 : tensor<32x256x14x14xf32>
    %v2421 = stablehlo.reshape %v2420 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2422 = stablehlo.reshape %v1080 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2423 = stablehlo.reshape %v2412 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2424 = stablehlo.transpose %v2422, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2425 = stablehlo.transpose %v2423, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    ...
    %v2428 = stablehlo.reshape %v1085 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2431 = stablehlo.broadcast_in_dim %v2429, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2432 = stablehlo.broadcast_in_dim %v2430, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2433 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2434 = stablehlo.add %v2432, %v2433 : tensor<32x256x14x14xf32>
    %v2435 = stablehlo.rsqrt %v2434 : tensor<32x256x14x14xf32>
    %v2436 = stablehlo.subtract %v2428, %v2431 : tensor<32x256x14x14xf32>
    %v2437 = stablehlo.multiply %v2436, %v2435 : tensor<32x256x14x14xf32>
    %v2438 = stablehlo.reshape %v2368 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2439 = stablehlo.multiply %v2438, %v2437 : tensor<32x256x14x14xf32>
    %v2440 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2441 = stablehlo.reduce(%v2439 init: %v2440) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2442 = stablehlo.reshape %v2368 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2443 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2444 = stablehlo.reduce(%v2442 init: %v2443) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2445 = stablehlo.reshape %v1121 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2446 = stablehlo.reshape %v2357 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2447 = stablehlo.transpose %v2445, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2448 = stablehlo.transpose %v2446, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    ...
    %v2451 = stablehlo.reshape %v1126 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2454 = stablehlo.broadcast_in_dim %v2452, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2455 = stablehlo.broadcast_in_dim %v2453, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2456 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2457 = stablehlo.add %v2455, %v2456 : tensor<32x256x14x14xf32>
    %v2458 = stablehlo.rsqrt %v2457 : tensor<32x256x14x14xf32>
    %v2459 = stablehlo.subtract %v2451, %v2454 : tensor<32x256x14x14xf32>
    %v2460 = stablehlo.multiply %v2459, %v2458 : tensor<32x256x14x14xf32>
    %v2461 = stablehlo.reshape %v2313 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2462 = stablehlo.multiply %v2461, %v2460 : tensor<32x256x14x14xf32>
    %v2463 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2464 = stablehlo.reduce(%v2462 init: %v2463) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2465 = stablehlo.reshape %v2313 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2466 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2467 = stablehlo.reduce(%v2465 init: %v2466) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2468 = stablehlo.reshape %v2421 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2469 = stablehlo.reshape %v1076 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2470 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v2471 = stablehlo.compare GT, %v2469, %v2470 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v2472 = stablehlo.select %v2471, %v2468, %v2470 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v2473 = stablehlo.reshape %v2472 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2474 = stablehlo.reshape %v1038 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2477 = stablehlo.broadcast_in_dim %v2475, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2478 = stablehlo.broadcast_in_dim %v2476, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2479 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2480 = stablehlo.add %v2478, %v2479 : tensor<32x256x14x14xf32>
    %v2481 = stablehlo.rsqrt %v2480 : tensor<32x256x14x14xf32>
    %v2482 = stablehlo.subtract %v2474, %v2477 : tensor<32x256x14x14xf32>
    %v2483 = stablehlo.multiply %v2482, %v2481 : tensor<32x256x14x14xf32>
    %v2484 = stablehlo.broadcast_in_dim %s3b2g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2485 = stablehlo.reshape %v2473 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2486 = stablehlo.multiply %v2484, %v2485 : tensor<32x256x14x14xf32>
    %v2487 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2488 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v2489 = stablehlo.reduce(%v2486 init: %v2487) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2490 = stablehlo.divide %v2489, %v2488 : tensor<256xf32>
    %v2491 = stablehlo.multiply %v2483, %v2486 : tensor<32x256x14x14xf32>
    %v2492 = stablehlo.reduce(%v2491 init: %v2487) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v2496 = stablehlo.reshape %v1038 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2501 = stablehlo.broadcast_in_dim %v2497, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2502 = stablehlo.broadcast_in_dim %v2498, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2503 = stablehlo.broadcast_in_dim %v2499, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2504 = stablehlo.broadcast_in_dim %v2500, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2505 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2506 = stablehlo.add %v2502, %v2505 : tensor<32x256x14x14xf32>
    %v2507 = stablehlo.rsqrt %v2506 : tensor<32x256x14x14xf32>
    %v2508 = stablehlo.subtract %v2496, %v2501 : tensor<32x256x14x14xf32>
    %v2509 = stablehlo.multiply %v2508, %v2507 : tensor<32x256x14x14xf32>
    %v2510 = stablehlo.broadcast_in_dim %s3b2g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2511 = stablehlo.reshape %v2473 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2512 = stablehlo.multiply %v2510, %v2511 : tensor<32x256x14x14xf32>
    %v2513 = stablehlo.subtract %v2512, %v2503 : tensor<32x256x14x14xf32>
    %v2514 = stablehlo.multiply %v2509, %v2504 : tensor<32x256x14x14xf32>
    %v2515 = stablehlo.subtract %v2513, %v2514 : tensor<32x256x14x14xf32>
    %v2516 = stablehlo.multiply %v2507, %v2515 : tensor<32x256x14x14xf32>
    ...
    %v2521 = stablehlo.convolution(%v2518, %v2520)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v2522 = stablehlo.reshape %v2521 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2523 = stablehlo.reshape %v2522 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2524 = stablehlo.reshape %v1031 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2525 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v2526 = stablehlo.compare GT, %v2524, %v2525 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v2527 = stablehlo.select %v2526, %v2523, %v2525 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v2528 = stablehlo.reshape %v2527 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2529 = stablehlo.reshape %v997 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2532 = stablehlo.broadcast_in_dim %v2530, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2533 = stablehlo.broadcast_in_dim %v2531, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2534 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2535 = stablehlo.add %v2533, %v2534 : tensor<32x256x14x14xf32>
    %v2536 = stablehlo.rsqrt %v2535 : tensor<32x256x14x14xf32>
    %v2537 = stablehlo.subtract %v2529, %v2532 : tensor<32x256x14x14xf32>
    %v2538 = stablehlo.multiply %v2537, %v2536 : tensor<32x256x14x14xf32>
    %v2539 = stablehlo.broadcast_in_dim %s3b2g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2540 = stablehlo.reshape %v2528 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2541 = stablehlo.multiply %v2539, %v2540 : tensor<32x256x14x14xf32>
    %v2542 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2543 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v2544 = stablehlo.reduce(%v2541 init: %v2542) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2545 = stablehlo.divide %v2544, %v2543 : tensor<256xf32>
    %v2546 = stablehlo.multiply %v2538, %v2541 : tensor<32x256x14x14xf32>
    %v2547 = stablehlo.reduce(%v2546 init: %v2542) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v2551 = stablehlo.reshape %v997 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2556 = stablehlo.broadcast_in_dim %v2552, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2557 = stablehlo.broadcast_in_dim %v2553, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2558 = stablehlo.broadcast_in_dim %v2554, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2559 = stablehlo.broadcast_in_dim %v2555, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2560 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2561 = stablehlo.add %v2557, %v2560 : tensor<32x256x14x14xf32>
    %v2562 = stablehlo.rsqrt %v2561 : tensor<32x256x14x14xf32>
    %v2563 = stablehlo.subtract %v2551, %v2556 : tensor<32x256x14x14xf32>
    %v2564 = stablehlo.multiply %v2563, %v2562 : tensor<32x256x14x14xf32>
    %v2565 = stablehlo.broadcast_in_dim %s3b2g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2566 = stablehlo.reshape %v2528 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2567 = stablehlo.multiply %v2565, %v2566 : tensor<32x256x14x14xf32>
    %v2568 = stablehlo.subtract %v2567, %v2558 : tensor<32x256x14x14xf32>
    %v2569 = stablehlo.multiply %v2564, %v2559 : tensor<32x256x14x14xf32>
    %v2570 = stablehlo.subtract %v2568, %v2569 : tensor<32x256x14x14xf32>
    %v2571 = stablehlo.multiply %v2562, %v2570 : tensor<32x256x14x14xf32>
    %v2572 = stablehlo.reshape %v2571 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2573 = stablehlo.reshape %v2572 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2576 = stablehlo.convolution(%v2573, %v2575)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v2577 = stablehlo.reshape %v2576 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2578 = stablehlo.reshape %v2577 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2579 = stablehlo.reshape %v2473 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2580 = stablehlo.add %v2578, %v2579 : tensor<32x256x14x14xf32>
    %v2581 = stablehlo.reshape %v2580 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2582 = stablehlo.reshape %v992 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2583 = stablehlo.reshape %v2572 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2584 = stablehlo.transpose %v2582, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2585 = stablehlo.transpose %v2583, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    ...
    %v2588 = stablehlo.reshape %v997 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2591 = stablehlo.broadcast_in_dim %v2589, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2592 = stablehlo.broadcast_in_dim %v2590, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2593 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2594 = stablehlo.add %v2592, %v2593 : tensor<32x256x14x14xf32>
    %v2595 = stablehlo.rsqrt %v2594 : tensor<32x256x14x14xf32>
    %v2596 = stablehlo.subtract %v2588, %v2591 : tensor<32x256x14x14xf32>
    %v2597 = stablehlo.multiply %v2596, %v2595 : tensor<32x256x14x14xf32>
    %v2598 = stablehlo.reshape %v2528 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2599 = stablehlo.multiply %v2598, %v2597 : tensor<32x256x14x14xf32>
    %v2600 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2601 = stablehlo.reduce(%v2599 init: %v2600) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2602 = stablehlo.reshape %v2528 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2603 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2604 = stablehlo.reduce(%v2602 init: %v2603) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2605 = stablehlo.reshape %v1033 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2606 = stablehlo.reshape %v2517 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2607 = stablehlo.transpose %v2605, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2608 = stablehlo.transpose %v2606, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    ...
    %v2611 = stablehlo.reshape %v1038 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2614 = stablehlo.broadcast_in_dim %v2612, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2615 = stablehlo.broadcast_in_dim %v2613, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2616 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2617 = stablehlo.add %v2615, %v2616 : tensor<32x256x14x14xf32>
    %v2618 = stablehlo.rsqrt %v2617 : tensor<32x256x14x14xf32>
    %v2619 = stablehlo.subtract %v2611, %v2614 : tensor<32x256x14x14xf32>
    %v2620 = stablehlo.multiply %v2619, %v2618 : tensor<32x256x14x14xf32>
    %v2621 = stablehlo.reshape %v2473 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2622 = stablehlo.multiply %v2621, %v2620 : tensor<32x256x14x14xf32>
    %v2623 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2624 = stablehlo.reduce(%v2622 init: %v2623) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2625 = stablehlo.reshape %v2473 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2626 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2627 = stablehlo.reduce(%v2625 init: %v2626) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2628 = stablehlo.reshape %v2581 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2629 = stablehlo.reshape %v988 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2630 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v2631 = stablehlo.compare GT, %v2629, %v2630 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v2632 = stablehlo.select %v2631, %v2628, %v2630 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v2633 = stablehlo.reshape %v2632 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2634 = stablehlo.reshape %v950 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2637 = stablehlo.broadcast_in_dim %v2635, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2638 = stablehlo.broadcast_in_dim %v2636, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2639 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2640 = stablehlo.add %v2638, %v2639 : tensor<32x256x14x14xf32>
    %v2641 = stablehlo.rsqrt %v2640 : tensor<32x256x14x14xf32>
    %v2642 = stablehlo.subtract %v2634, %v2637 : tensor<32x256x14x14xf32>
    %v2643 = stablehlo.multiply %v2642, %v2641 : tensor<32x256x14x14xf32>
    %v2644 = stablehlo.broadcast_in_dim %s3b1g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2645 = stablehlo.reshape %v2633 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2646 = stablehlo.multiply %v2644, %v2645 : tensor<32x256x14x14xf32>
    %v2647 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2648 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v2649 = stablehlo.reduce(%v2646 init: %v2647) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2650 = stablehlo.divide %v2649, %v2648 : tensor<256xf32>
    %v2651 = stablehlo.multiply %v2643, %v2646 : tensor<32x256x14x14xf32>
    %v2652 = stablehlo.reduce(%v2651 init: %v2647) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v2656 = stablehlo.reshape %v950 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2661 = stablehlo.broadcast_in_dim %v2657, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2662 = stablehlo.broadcast_in_dim %v2658, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2663 = stablehlo.broadcast_in_dim %v2659, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2664 = stablehlo.broadcast_in_dim %v2660, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2665 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2666 = stablehlo.add %v2662, %v2665 : tensor<32x256x14x14xf32>
    %v2667 = stablehlo.rsqrt %v2666 : tensor<32x256x14x14xf32>
    %v2668 = stablehlo.subtract %v2656, %v2661 : tensor<32x256x14x14xf32>
    %v2669 = stablehlo.multiply %v2668, %v2667 : tensor<32x256x14x14xf32>
    %v2670 = stablehlo.broadcast_in_dim %s3b1g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2671 = stablehlo.reshape %v2633 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2672 = stablehlo.multiply %v2670, %v2671 : tensor<32x256x14x14xf32>
    %v2673 = stablehlo.subtract %v2672, %v2663 : tensor<32x256x14x14xf32>
    %v2674 = stablehlo.multiply %v2669, %v2664 : tensor<32x256x14x14xf32>
    %v2675 = stablehlo.subtract %v2673, %v2674 : tensor<32x256x14x14xf32>
    %v2676 = stablehlo.multiply %v2667, %v2675 : tensor<32x256x14x14xf32>
    %v2677 = stablehlo.reshape %v2676 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2678 = stablehlo.reshape %v2677 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2681 = stablehlo.convolution(%v2678, %v2680)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v2682 = stablehlo.reshape %v2681 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2683 = stablehlo.reshape %v2682 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2684 = stablehlo.reshape %v943 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2685 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v2686 = stablehlo.compare GT, %v2684, %v2685 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v2687 = stablehlo.select %v2686, %v2683, %v2685 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v2688 = stablehlo.reshape %v2687 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2689 = stablehlo.reshape %v909 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2692 = stablehlo.broadcast_in_dim %v2690, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2693 = stablehlo.broadcast_in_dim %v2691, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2694 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2695 = stablehlo.add %v2693, %v2694 : tensor<32x256x14x14xf32>
    %v2696 = stablehlo.rsqrt %v2695 : tensor<32x256x14x14xf32>
    %v2697 = stablehlo.subtract %v2689, %v2692 : tensor<32x256x14x14xf32>
    %v2698 = stablehlo.multiply %v2697, %v2696 : tensor<32x256x14x14xf32>
    %v2699 = stablehlo.broadcast_in_dim %s3b1g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2700 = stablehlo.reshape %v2688 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2701 = stablehlo.multiply %v2699, %v2700 : tensor<32x256x14x14xf32>
    %v2702 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2703 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v2704 = stablehlo.reduce(%v2701 init: %v2702) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2705 = stablehlo.divide %v2704, %v2703 : tensor<256xf32>
    %v2706 = stablehlo.multiply %v2698, %v2701 : tensor<32x256x14x14xf32>
    %v2707 = stablehlo.reduce(%v2706 init: %v2702) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v2711 = stablehlo.reshape %v909 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2716 = stablehlo.broadcast_in_dim %v2712, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2717 = stablehlo.broadcast_in_dim %v2713, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2718 = stablehlo.broadcast_in_dim %v2714, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2719 = stablehlo.broadcast_in_dim %v2715, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2720 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2721 = stablehlo.add %v2717, %v2720 : tensor<32x256x14x14xf32>
    %v2722 = stablehlo.rsqrt %v2721 : tensor<32x256x14x14xf32>
    %v2723 = stablehlo.subtract %v2711, %v2716 : tensor<32x256x14x14xf32>
    %v2724 = stablehlo.multiply %v2723, %v2722 : tensor<32x256x14x14xf32>
    %v2725 = stablehlo.broadcast_in_dim %s3b1g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2726 = stablehlo.reshape %v2688 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2727 = stablehlo.multiply %v2725, %v2726 : tensor<32x256x14x14xf32>
    %v2728 = stablehlo.subtract %v2727, %v2718 : tensor<32x256x14x14xf32>
    %v2729 = stablehlo.multiply %v2724, %v2719 : tensor<32x256x14x14xf32>
    %v2730 = stablehlo.subtract %v2728, %v2729 : tensor<32x256x14x14xf32>
    %v2731 = stablehlo.multiply %v2722, %v2730 : tensor<32x256x14x14xf32>
    %v2732 = stablehlo.reshape %v2731 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2733 = stablehlo.reshape %v2732 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2736 = stablehlo.convolution(%v2733, %v2735)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v2737 = stablehlo.reshape %v2736 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2738 = stablehlo.reshape %v2737 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2739 = stablehlo.reshape %v2633 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2740 = stablehlo.add %v2738, %v2739 : tensor<32x256x14x14xf32>
    %v2741 = stablehlo.reshape %v2740 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2742 = stablehlo.reshape %v904 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2743 = stablehlo.reshape %v2732 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2744 = stablehlo.transpose %v2742, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2745 = stablehlo.transpose %v2743, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    ...
    %v2748 = stablehlo.reshape %v909 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2751 = stablehlo.broadcast_in_dim %v2749, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2752 = stablehlo.broadcast_in_dim %v2750, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2753 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2754 = stablehlo.add %v2752, %v2753 : tensor<32x256x14x14xf32>
    %v2755 = stablehlo.rsqrt %v2754 : tensor<32x256x14x14xf32>
    %v2756 = stablehlo.subtract %v2748, %v2751 : tensor<32x256x14x14xf32>
    %v2757 = stablehlo.multiply %v2756, %v2755 : tensor<32x256x14x14xf32>
    %v2758 = stablehlo.reshape %v2688 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2759 = stablehlo.multiply %v2758, %v2757 : tensor<32x256x14x14xf32>
    %v2760 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2761 = stablehlo.reduce(%v2759 init: %v2760) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2762 = stablehlo.reshape %v2688 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2763 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2764 = stablehlo.reduce(%v2762 init: %v2763) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2765 = stablehlo.reshape %v945 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2766 = stablehlo.reshape %v2677 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2767 = stablehlo.transpose %v2765, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2768 = stablehlo.transpose %v2766, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    ...
    %v2771 = stablehlo.reshape %v950 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2774 = stablehlo.broadcast_in_dim %v2772, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2775 = stablehlo.broadcast_in_dim %v2773, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2776 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2777 = stablehlo.add %v2775, %v2776 : tensor<32x256x14x14xf32>
    %v2778 = stablehlo.rsqrt %v2777 : tensor<32x256x14x14xf32>
    %v2779 = stablehlo.subtract %v2771, %v2774 : tensor<32x256x14x14xf32>
    %v2780 = stablehlo.multiply %v2779, %v2778 : tensor<32x256x14x14xf32>
    %v2781 = stablehlo.reshape %v2633 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2782 = stablehlo.multiply %v2781, %v2780 : tensor<32x256x14x14xf32>
    %v2783 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2784 = stablehlo.reduce(%v2782 init: %v2783) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2785 = stablehlo.reshape %v2633 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2786 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2787 = stablehlo.reduce(%v2785 init: %v2786) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2788 = stablehlo.reshape %v2741 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2789 = stablehlo.reshape %v900 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2790 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v2791 = stablehlo.compare GT, %v2789, %v2790 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v2792 = stablehlo.select %v2791, %v2788, %v2790 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v2793 = stablehlo.reshape %v2792 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2794 = stablehlo.reshape %v862 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2797 = stablehlo.broadcast_in_dim %v2795, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2798 = stablehlo.broadcast_in_dim %v2796, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2799 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2800 = stablehlo.add %v2798, %v2799 : tensor<32x256x14x14xf32>
    %v2801 = stablehlo.rsqrt %v2800 : tensor<32x256x14x14xf32>
    %v2802 = stablehlo.subtract %v2794, %v2797 : tensor<32x256x14x14xf32>
    %v2803 = stablehlo.multiply %v2802, %v2801 : tensor<32x256x14x14xf32>
    %v2804 = stablehlo.broadcast_in_dim %s3b0g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2805 = stablehlo.reshape %v2793 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2806 = stablehlo.multiply %v2804, %v2805 : tensor<32x256x14x14xf32>
    %v2807 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2808 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v2809 = stablehlo.reduce(%v2806 init: %v2807) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2810 = stablehlo.divide %v2809, %v2808 : tensor<256xf32>
    %v2811 = stablehlo.multiply %v2803, %v2806 : tensor<32x256x14x14xf32>
    %v2812 = stablehlo.reduce(%v2811 init: %v2807) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v2816 = stablehlo.reshape %v862 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2821 = stablehlo.broadcast_in_dim %v2817, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2822 = stablehlo.broadcast_in_dim %v2818, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2823 = stablehlo.broadcast_in_dim %v2819, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2824 = stablehlo.broadcast_in_dim %v2820, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2825 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2826 = stablehlo.add %v2822, %v2825 : tensor<32x256x14x14xf32>
    %v2827 = stablehlo.rsqrt %v2826 : tensor<32x256x14x14xf32>
    %v2828 = stablehlo.subtract %v2816, %v2821 : tensor<32x256x14x14xf32>
    %v2829 = stablehlo.multiply %v2828, %v2827 : tensor<32x256x14x14xf32>
    %v2830 = stablehlo.broadcast_in_dim %s3b0g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2831 = stablehlo.reshape %v2793 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2832 = stablehlo.multiply %v2830, %v2831 : tensor<32x256x14x14xf32>
    %v2833 = stablehlo.subtract %v2832, %v2823 : tensor<32x256x14x14xf32>
    %v2834 = stablehlo.multiply %v2829, %v2824 : tensor<32x256x14x14xf32>
    %v2835 = stablehlo.subtract %v2833, %v2834 : tensor<32x256x14x14xf32>
    %v2836 = stablehlo.multiply %v2827, %v2835 : tensor<32x256x14x14xf32>
    %v2837 = stablehlo.reshape %v2836 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2838 = stablehlo.reshape %v2837 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2841 = stablehlo.convolution(%v2838, %v2840)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v2842 = stablehlo.reshape %v2841 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2843 = stablehlo.reshape %v2842 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2844 = stablehlo.reshape %v855 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2845 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v2846 = stablehlo.compare GT, %v2844, %v2845 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v2847 = stablehlo.select %v2846, %v2843, %v2845 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v2848 = stablehlo.reshape %v2847 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2849 = stablehlo.reshape %v821 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2852 = stablehlo.broadcast_in_dim %v2850, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2853 = stablehlo.broadcast_in_dim %v2851, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2854 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2855 = stablehlo.add %v2853, %v2854 : tensor<32x256x14x14xf32>
    %v2856 = stablehlo.rsqrt %v2855 : tensor<32x256x14x14xf32>
    %v2857 = stablehlo.subtract %v2849, %v2852 : tensor<32x256x14x14xf32>
    %v2858 = stablehlo.multiply %v2857, %v2856 : tensor<32x256x14x14xf32>
    %v2859 = stablehlo.broadcast_in_dim %s3b0g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2860 = stablehlo.reshape %v2848 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2861 = stablehlo.multiply %v2859, %v2860 : tensor<32x256x14x14xf32>
    %v2862 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2863 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v2864 = stablehlo.reduce(%v2861 init: %v2862) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2865 = stablehlo.divide %v2864, %v2863 : tensor<256xf32>
    %v2866 = stablehlo.multiply %v2858, %v2861 : tensor<32x256x14x14xf32>
    %v2867 = stablehlo.reduce(%v2866 init: %v2862) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v2871 = stablehlo.reshape %v821 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2876 = stablehlo.broadcast_in_dim %v2872, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2877 = stablehlo.broadcast_in_dim %v2873, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2878 = stablehlo.broadcast_in_dim %v2874, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2879 = stablehlo.broadcast_in_dim %v2875, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2880 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2881 = stablehlo.add %v2877, %v2880 : tensor<32x256x14x14xf32>
    %v2882 = stablehlo.rsqrt %v2881 : tensor<32x256x14x14xf32>
    %v2883 = stablehlo.subtract %v2871, %v2876 : tensor<32x256x14x14xf32>
    %v2884 = stablehlo.multiply %v2883, %v2882 : tensor<32x256x14x14xf32>
    %v2885 = stablehlo.broadcast_in_dim %s3b0g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2886 = stablehlo.reshape %v2848 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2887 = stablehlo.multiply %v2885, %v2886 : tensor<32x256x14x14xf32>
    %v2888 = stablehlo.subtract %v2887, %v2878 : tensor<32x256x14x14xf32>
    %v2889 = stablehlo.multiply %v2884, %v2879 : tensor<32x256x14x14xf32>
    %v2890 = stablehlo.subtract %v2888, %v2889 : tensor<32x256x14x14xf32>
    %v2891 = stablehlo.multiply %v2882, %v2890 : tensor<32x256x14x14xf32>
    %v2892 = stablehlo.reshape %v2891 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2893 = stablehlo.reshape %v2892 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2896 = stablehlo.convolution(%v2893, %v2895)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v2897 = stablehlo.reshape %v2896 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2898 = stablehlo.reshape %v2897 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2899 = stablehlo.reshape %v2793 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2900 = stablehlo.add %v2898, %v2899 : tensor<32x256x14x14xf32>
    %v2901 = stablehlo.reshape %v2900 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2902 = stablehlo.reshape %v816 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2903 = stablehlo.reshape %v2892 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2904 = stablehlo.transpose %v2902, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2905 = stablehlo.transpose %v2903, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    ...
    %v2908 = stablehlo.reshape %v821 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2911 = stablehlo.broadcast_in_dim %v2909, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2912 = stablehlo.broadcast_in_dim %v2910, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2913 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2914 = stablehlo.add %v2912, %v2913 : tensor<32x256x14x14xf32>
    %v2915 = stablehlo.rsqrt %v2914 : tensor<32x256x14x14xf32>
    %v2916 = stablehlo.subtract %v2908, %v2911 : tensor<32x256x14x14xf32>
    %v2917 = stablehlo.multiply %v2916, %v2915 : tensor<32x256x14x14xf32>
    %v2918 = stablehlo.reshape %v2848 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2919 = stablehlo.multiply %v2918, %v2917 : tensor<32x256x14x14xf32>
    %v2920 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2921 = stablehlo.reduce(%v2919 init: %v2920) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2922 = stablehlo.reshape %v2848 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2923 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2924 = stablehlo.reduce(%v2922 init: %v2923) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2925 = stablehlo.reshape %v857 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2926 = stablehlo.reshape %v2837 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2927 = stablehlo.transpose %v2925, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v2928 = stablehlo.transpose %v2926, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    ...
    %v2931 = stablehlo.reshape %v862 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2934 = stablehlo.broadcast_in_dim %v2932, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2935 = stablehlo.broadcast_in_dim %v2933, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2936 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2937 = stablehlo.add %v2935, %v2936 : tensor<32x256x14x14xf32>
    %v2938 = stablehlo.rsqrt %v2937 : tensor<32x256x14x14xf32>
    %v2939 = stablehlo.subtract %v2931, %v2934 : tensor<32x256x14x14xf32>
    %v2940 = stablehlo.multiply %v2939, %v2938 : tensor<32x256x14x14xf32>
    %v2941 = stablehlo.reshape %v2793 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2942 = stablehlo.multiply %v2941, %v2940 : tensor<32x256x14x14xf32>
    %v2943 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2944 = stablehlo.reduce(%v2942 init: %v2943) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2945 = stablehlo.reshape %v2793 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2946 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2947 = stablehlo.reduce(%v2945 init: %v2946) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2948 = stablehlo.reshape %v2901 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2949 = stablehlo.reshape %v814 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2950 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v2951 = stablehlo.compare GT, %v2949, %v2950 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v2952 = stablehlo.select %v2951, %v2948, %v2950 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v2953 = stablehlo.reshape %v2952 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2954 = stablehlo.reshape %v740 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2957 = stablehlo.broadcast_in_dim %v2955, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2958 = stablehlo.broadcast_in_dim %v2956, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2959 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2960 = stablehlo.add %v2958, %v2959 : tensor<32x256x14x14xf32>
    %v2961 = stablehlo.rsqrt %v2960 : tensor<32x256x14x14xf32>
    %v2962 = stablehlo.subtract %v2954, %v2957 : tensor<32x256x14x14xf32>
    %v2963 = stablehlo.multiply %v2962, %v2961 : tensor<32x256x14x14xf32>
    %v2964 = stablehlo.broadcast_in_dim %d3g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2965 = stablehlo.reshape %v2953 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2966 = stablehlo.multiply %v2964, %v2965 : tensor<32x256x14x14xf32>
    %v2967 = stablehlo.constant dense<0.0> : tensor<f32>
    %v2968 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v2969 = stablehlo.reduce(%v2966 init: %v2967) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v2970 = stablehlo.divide %v2969, %v2968 : tensor<256xf32>
    %v2971 = stablehlo.multiply %v2963, %v2966 : tensor<32x256x14x14xf32>
    %v2972 = stablehlo.reduce(%v2971 init: %v2967) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v2976 = stablehlo.reshape %v740 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v2981 = stablehlo.broadcast_in_dim %v2977, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2982 = stablehlo.broadcast_in_dim %v2978, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2983 = stablehlo.broadcast_in_dim %v2979, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2984 = stablehlo.broadcast_in_dim %v2980, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2985 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v2986 = stablehlo.add %v2982, %v2985 : tensor<32x256x14x14xf32>
    %v2987 = stablehlo.rsqrt %v2986 : tensor<32x256x14x14xf32>
    %v2988 = stablehlo.subtract %v2976, %v2981 : tensor<32x256x14x14xf32>
    %v2989 = stablehlo.multiply %v2988, %v2987 : tensor<32x256x14x14xf32>
    %v2990 = stablehlo.broadcast_in_dim %d3g2, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v2991 = stablehlo.reshape %v2953 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v2992 = stablehlo.multiply %v2990, %v2991 : tensor<32x256x14x14xf32>
    %v2993 = stablehlo.subtract %v2992, %v2983 : tensor<32x256x14x14xf32>
    %v2994 = stablehlo.multiply %v2989, %v2984 : tensor<32x256x14x14xf32>
    %v2995 = stablehlo.subtract %v2993, %v2994 : tensor<32x256x14x14xf32>
    %v2996 = stablehlo.multiply %v2987, %v2995 : tensor<32x256x14x14xf32>
    %v2997 = stablehlo.reshape %v2996 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v2998 = stablehlo.reshape %v2997 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v3001 = stablehlo.convolution(%v2998, %v3000)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x256x14x14xf32>, tensor<256x256x3x3xf32>) -> tensor<32x256x14x14xf32>
    %v3002 = stablehlo.reshape %v3001 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v3003 = stablehlo.reshape %v3002 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3004 = stablehlo.reshape %v733 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3005 = stablehlo.constant dense<0.0> : tensor<32x256x14x14xf32>
    %v3006 = stablehlo.compare GT, %v3004, %v3005 : (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) -> tensor<32x256x14x14xi1>
    %v3007 = stablehlo.select %v3006, %v3003, %v3005 : tensor<32x256x14x14xi1>, tensor<32x256x14x14xf32>
    %v3008 = stablehlo.reshape %v3007 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v3009 = stablehlo.reshape %v699 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v3012 = stablehlo.broadcast_in_dim %v3010, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3013 = stablehlo.broadcast_in_dim %v3011, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3014 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v3015 = stablehlo.add %v3013, %v3014 : tensor<32x256x14x14xf32>
    %v3016 = stablehlo.rsqrt %v3015 : tensor<32x256x14x14xf32>
    %v3017 = stablehlo.subtract %v3009, %v3012 : tensor<32x256x14x14xf32>
    %v3018 = stablehlo.multiply %v3017, %v3016 : tensor<32x256x14x14xf32>
    %v3019 = stablehlo.broadcast_in_dim %d3g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3020 = stablehlo.reshape %v3008 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3021 = stablehlo.multiply %v3019, %v3020 : tensor<32x256x14x14xf32>
    %v3022 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3023 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v3024 = stablehlo.reduce(%v3021 init: %v3022) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v3025 = stablehlo.divide %v3024, %v3023 : tensor<256xf32>
    %v3026 = stablehlo.multiply %v3018, %v3021 : tensor<32x256x14x14xf32>
    %v3027 = stablehlo.reduce(%v3026 init: %v3022) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v3031 = stablehlo.reshape %v699 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v3036 = stablehlo.broadcast_in_dim %v3032, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3037 = stablehlo.broadcast_in_dim %v3033, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3038 = stablehlo.broadcast_in_dim %v3034, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3039 = stablehlo.broadcast_in_dim %v3035, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3040 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v3041 = stablehlo.add %v3037, %v3040 : tensor<32x256x14x14xf32>
    %v3042 = stablehlo.rsqrt %v3041 : tensor<32x256x14x14xf32>
    %v3043 = stablehlo.subtract %v3031, %v3036 : tensor<32x256x14x14xf32>
    %v3044 = stablehlo.multiply %v3043, %v3042 : tensor<32x256x14x14xf32>
    %v3045 = stablehlo.broadcast_in_dim %d3g1, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3046 = stablehlo.reshape %v3008 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3047 = stablehlo.multiply %v3045, %v3046 : tensor<32x256x14x14xf32>
    %v3048 = stablehlo.subtract %v3047, %v3038 : tensor<32x256x14x14xf32>
    %v3049 = stablehlo.multiply %v3044, %v3039 : tensor<32x256x14x14xf32>
    %v3050 = stablehlo.subtract %v3048, %v3049 : tensor<32x256x14x14xf32>
    %v3051 = stablehlo.multiply %v3042, %v3050 : tensor<32x256x14x14xf32>
    %v3052 = stablehlo.reshape %v3051 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v3053 = stablehlo.reshape %v3052 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3054 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3055 = stablehlo.pad %v3053, %v3054, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<32x256x28x28xf32>
    ...
    %v3060 = stablehlo.reshape %v779 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v3063 = stablehlo.broadcast_in_dim %v3061, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3064 = stablehlo.broadcast_in_dim %v3062, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3065 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v3066 = stablehlo.add %v3064, %v3065 : tensor<32x256x14x14xf32>
    %v3067 = stablehlo.rsqrt %v3066 : tensor<32x256x14x14xf32>
    %v3068 = stablehlo.subtract %v3060, %v3063 : tensor<32x256x14x14xf32>
    %v3069 = stablehlo.multiply %v3068, %v3067 : tensor<32x256x14x14xf32>
    %v3070 = stablehlo.broadcast_in_dim %d3gp, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3071 = stablehlo.reshape %v2953 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3072 = stablehlo.multiply %v3070, %v3071 : tensor<32x256x14x14xf32>
    %v3073 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3074 = stablehlo.constant dense<6272.0> : tensor<256xf32>
    %v3075 = stablehlo.reduce(%v3072 init: %v3073) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v3076 = stablehlo.divide %v3075, %v3074 : tensor<256xf32>
    %v3077 = stablehlo.multiply %v3069, %v3072 : tensor<32x256x14x14xf32>
    %v3078 = stablehlo.reduce(%v3077 init: %v3073) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %v3082 = stablehlo.reshape %v779 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v3087 = stablehlo.broadcast_in_dim %v3083, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3088 = stablehlo.broadcast_in_dim %v3084, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3089 = stablehlo.broadcast_in_dim %v3085, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3090 = stablehlo.broadcast_in_dim %v3086, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3091 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v3092 = stablehlo.add %v3088, %v3091 : tensor<32x256x14x14xf32>
    %v3093 = stablehlo.rsqrt %v3092 : tensor<32x256x14x14xf32>
    %v3094 = stablehlo.subtract %v3082, %v3087 : tensor<32x256x14x14xf32>
    %v3095 = stablehlo.multiply %v3094, %v3093 : tensor<32x256x14x14xf32>
    %v3096 = stablehlo.broadcast_in_dim %d3gp, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3097 = stablehlo.reshape %v2953 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3098 = stablehlo.multiply %v3096, %v3097 : tensor<32x256x14x14xf32>
    %v3099 = stablehlo.subtract %v3098, %v3089 : tensor<32x256x14x14xf32>
    %v3100 = stablehlo.multiply %v3095, %v3090 : tensor<32x256x14x14xf32>
    %v3101 = stablehlo.subtract %v3099, %v3100 : tensor<32x256x14x14xf32>
    %v3102 = stablehlo.multiply %v3093, %v3101 : tensor<32x256x14x14xf32>
    %v3103 = stablehlo.reshape %v3102 : (tensor<32x256x14x14xf32>) -> tensor<32x50176xf32>
    %v3104 = stablehlo.reshape %v3103 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3105 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3106 = stablehlo.pad %v3104, %v3105, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<32x256x28x28xf32>
    ...
    %v3110 = stablehlo.reshape %v3109 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3111 = stablehlo.reshape %v3059 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3112 = stablehlo.reshape %v3110 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3113 = stablehlo.add %v3111, %v3112 : tensor<32x128x28x28xf32>
    %v3114 = stablehlo.reshape %v3113 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3115 = stablehlo.reshape %v694 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3116 = stablehlo.reshape %v3052 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3117 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3118 = stablehlo.pad %v3116, %v3117, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<32x256x28x28xf32>
    %v3119 = stablehlo.transpose %v3115, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    %v3120 = stablehlo.transpose %v3118, dims = [1, 0, 2, 3] : (tensor<32x256x28x28xf32>) -> tensor<256x32x28x28xf32>
    ...
    %v3123 = stablehlo.reshape %v699 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v3126 = stablehlo.broadcast_in_dim %v3124, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3127 = stablehlo.broadcast_in_dim %v3125, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3128 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v3129 = stablehlo.add %v3127, %v3128 : tensor<32x256x14x14xf32>
    %v3130 = stablehlo.rsqrt %v3129 : tensor<32x256x14x14xf32>
    %v3131 = stablehlo.subtract %v3123, %v3126 : tensor<32x256x14x14xf32>
    %v3132 = stablehlo.multiply %v3131, %v3130 : tensor<32x256x14x14xf32>
    %v3133 = stablehlo.reshape %v3008 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3134 = stablehlo.multiply %v3133, %v3132 : tensor<32x256x14x14xf32>
    %v3135 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3136 = stablehlo.reduce(%v3134 init: %v3135) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v3137 = stablehlo.reshape %v3008 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3138 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3139 = stablehlo.reduce(%v3137 init: %v3138) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v3140 = stablehlo.reshape %v735 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3141 = stablehlo.reshape %v2997 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3142 = stablehlo.transpose %v3140, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    %v3143 = stablehlo.transpose %v3141, dims = [1, 0, 2, 3] : (tensor<32x256x14x14xf32>) -> tensor<256x32x14x14xf32>
    ...
    %v3146 = stablehlo.reshape %v740 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v3149 = stablehlo.broadcast_in_dim %v3147, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3150 = stablehlo.broadcast_in_dim %v3148, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3151 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v3152 = stablehlo.add %v3150, %v3151 : tensor<32x256x14x14xf32>
    %v3153 = stablehlo.rsqrt %v3152 : tensor<32x256x14x14xf32>
    %v3154 = stablehlo.subtract %v3146, %v3149 : tensor<32x256x14x14xf32>
    %v3155 = stablehlo.multiply %v3154, %v3153 : tensor<32x256x14x14xf32>
    %v3156 = stablehlo.reshape %v2953 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3157 = stablehlo.multiply %v3156, %v3155 : tensor<32x256x14x14xf32>
    %v3158 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3159 = stablehlo.reduce(%v3157 init: %v3158) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v3160 = stablehlo.reshape %v2953 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3161 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3162 = stablehlo.reduce(%v3160 init: %v3161) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v3163 = stablehlo.reshape %v694 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3164 = stablehlo.reshape %v3103 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3165 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3166 = stablehlo.pad %v3164, %v3165, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<32x256x28x28xf32>
    %v3167 = stablehlo.transpose %v3163, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    %v3168 = stablehlo.transpose %v3166, dims = [1, 0, 2, 3] : (tensor<32x256x28x28xf32>) -> tensor<256x32x28x28xf32>
    ...
    %v3171 = stablehlo.reshape %v779 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    ...
    %v3174 = stablehlo.broadcast_in_dim %v3172, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3175 = stablehlo.broadcast_in_dim %v3173, dims = [1] : (tensor<256xf32>) -> tensor<32x256x14x14xf32>
    %v3176 = stablehlo.constant dense<1.0e-05> : tensor<32x256x14x14xf32>
    %v3177 = stablehlo.add %v3175, %v3176 : tensor<32x256x14x14xf32>
    %v3178 = stablehlo.rsqrt %v3177 : tensor<32x256x14x14xf32>
    %v3179 = stablehlo.subtract %v3171, %v3174 : tensor<32x256x14x14xf32>
    %v3180 = stablehlo.multiply %v3179, %v3178 : tensor<32x256x14x14xf32>
    %v3181 = stablehlo.reshape %v2953 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3182 = stablehlo.multiply %v3181, %v3180 : tensor<32x256x14x14xf32>
    %v3183 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3184 = stablehlo.reduce(%v3182 init: %v3183) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v3185 = stablehlo.reshape %v2953 : (tensor<32x50176xf32>) -> tensor<32x256x14x14xf32>
    %v3186 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3187 = stablehlo.reduce(%v3185 init: %v3186) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x256x14x14xf32>, tensor<f32>) -> tensor<256xf32>
    %v3188 = stablehlo.reshape %v3114 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3189 = stablehlo.reshape %v690 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3190 = stablehlo.constant dense<0.0> : tensor<32x128x28x28xf32>
    %v3191 = stablehlo.compare GT, %v3189, %v3190 : (tensor<32x128x28x28xf32>, tensor<32x128x28x28xf32>) -> tensor<32x128x28x28xi1>
    %v3192 = stablehlo.select %v3191, %v3188, %v3190 : tensor<32x128x28x28xi1>, tensor<32x128x28x28xf32>
    %v3193 = stablehlo.reshape %v3192 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3194 = stablehlo.reshape %v652 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3197 = stablehlo.broadcast_in_dim %v3195, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3198 = stablehlo.broadcast_in_dim %v3196, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3199 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3200 = stablehlo.add %v3198, %v3199 : tensor<32x128x28x28xf32>
    %v3201 = stablehlo.rsqrt %v3200 : tensor<32x128x28x28xf32>
    %v3202 = stablehlo.subtract %v3194, %v3197 : tensor<32x128x28x28xf32>
    %v3203 = stablehlo.multiply %v3202, %v3201 : tensor<32x128x28x28xf32>
    %v3204 = stablehlo.broadcast_in_dim %s2b2g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3205 = stablehlo.reshape %v3193 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3206 = stablehlo.multiply %v3204, %v3205 : tensor<32x128x28x28xf32>
    %v3207 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3208 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v3209 = stablehlo.reduce(%v3206 init: %v3207) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3210 = stablehlo.divide %v3209, %v3208 : tensor<128xf32>
    %v3211 = stablehlo.multiply %v3203, %v3206 : tensor<32x128x28x28xf32>
    %v3212 = stablehlo.reduce(%v3211 init: %v3207) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v3216 = stablehlo.reshape %v652 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3221 = stablehlo.broadcast_in_dim %v3217, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3222 = stablehlo.broadcast_in_dim %v3218, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3223 = stablehlo.broadcast_in_dim %v3219, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3224 = stablehlo.broadcast_in_dim %v3220, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3225 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3226 = stablehlo.add %v3222, %v3225 : tensor<32x128x28x28xf32>
    %v3227 = stablehlo.rsqrt %v3226 : tensor<32x128x28x28xf32>
    %v3228 = stablehlo.subtract %v3216, %v3221 : tensor<32x128x28x28xf32>
    %v3229 = stablehlo.multiply %v3228, %v3227 : tensor<32x128x28x28xf32>
    %v3230 = stablehlo.broadcast_in_dim %s2b2g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3231 = stablehlo.reshape %v3193 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3232 = stablehlo.multiply %v3230, %v3231 : tensor<32x128x28x28xf32>
    %v3233 = stablehlo.subtract %v3232, %v3223 : tensor<32x128x28x28xf32>
    %v3234 = stablehlo.multiply %v3229, %v3224 : tensor<32x128x28x28xf32>
    %v3235 = stablehlo.subtract %v3233, %v3234 : tensor<32x128x28x28xf32>
    %v3236 = stablehlo.multiply %v3227, %v3235 : tensor<32x128x28x28xf32>
    %v3237 = stablehlo.reshape %v3236 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3238 = stablehlo.reshape %v3237 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3241 = stablehlo.convolution(%v3238, %v3240)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v3242 = stablehlo.reshape %v3241 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3243 = stablehlo.reshape %v3242 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3244 = stablehlo.reshape %v645 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3245 = stablehlo.constant dense<0.0> : tensor<32x128x28x28xf32>
    %v3246 = stablehlo.compare GT, %v3244, %v3245 : (tensor<32x128x28x28xf32>, tensor<32x128x28x28xf32>) -> tensor<32x128x28x28xi1>
    %v3247 = stablehlo.select %v3246, %v3243, %v3245 : tensor<32x128x28x28xi1>, tensor<32x128x28x28xf32>
    %v3248 = stablehlo.reshape %v3247 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3249 = stablehlo.reshape %v611 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3252 = stablehlo.broadcast_in_dim %v3250, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3253 = stablehlo.broadcast_in_dim %v3251, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3254 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3255 = stablehlo.add %v3253, %v3254 : tensor<32x128x28x28xf32>
    %v3256 = stablehlo.rsqrt %v3255 : tensor<32x128x28x28xf32>
    %v3257 = stablehlo.subtract %v3249, %v3252 : tensor<32x128x28x28xf32>
    %v3258 = stablehlo.multiply %v3257, %v3256 : tensor<32x128x28x28xf32>
    %v3259 = stablehlo.broadcast_in_dim %s2b2g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3260 = stablehlo.reshape %v3248 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3261 = stablehlo.multiply %v3259, %v3260 : tensor<32x128x28x28xf32>
    %v3262 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3263 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v3264 = stablehlo.reduce(%v3261 init: %v3262) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3265 = stablehlo.divide %v3264, %v3263 : tensor<128xf32>
    %v3266 = stablehlo.multiply %v3258, %v3261 : tensor<32x128x28x28xf32>
    %v3267 = stablehlo.reduce(%v3266 init: %v3262) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v3271 = stablehlo.reshape %v611 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3276 = stablehlo.broadcast_in_dim %v3272, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3277 = stablehlo.broadcast_in_dim %v3273, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3278 = stablehlo.broadcast_in_dim %v3274, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3279 = stablehlo.broadcast_in_dim %v3275, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3280 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3281 = stablehlo.add %v3277, %v3280 : tensor<32x128x28x28xf32>
    %v3282 = stablehlo.rsqrt %v3281 : tensor<32x128x28x28xf32>
    %v3283 = stablehlo.subtract %v3271, %v3276 : tensor<32x128x28x28xf32>
    %v3284 = stablehlo.multiply %v3283, %v3282 : tensor<32x128x28x28xf32>
    %v3285 = stablehlo.broadcast_in_dim %s2b2g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3286 = stablehlo.reshape %v3248 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3287 = stablehlo.multiply %v3285, %v3286 : tensor<32x128x28x28xf32>
    %v3288 = stablehlo.subtract %v3287, %v3278 : tensor<32x128x28x28xf32>
    %v3289 = stablehlo.multiply %v3284, %v3279 : tensor<32x128x28x28xf32>
    %v3290 = stablehlo.subtract %v3288, %v3289 : tensor<32x128x28x28xf32>
    %v3291 = stablehlo.multiply %v3282, %v3290 : tensor<32x128x28x28xf32>
    %v3292 = stablehlo.reshape %v3291 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3293 = stablehlo.reshape %v3292 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3296 = stablehlo.convolution(%v3293, %v3295)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v3297 = stablehlo.reshape %v3296 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3298 = stablehlo.reshape %v3297 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3299 = stablehlo.reshape %v3193 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3300 = stablehlo.add %v3298, %v3299 : tensor<32x128x28x28xf32>
    %v3301 = stablehlo.reshape %v3300 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3302 = stablehlo.reshape %v606 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3303 = stablehlo.reshape %v3292 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3304 = stablehlo.transpose %v3302, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    %v3305 = stablehlo.transpose %v3303, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    ...
    %v3308 = stablehlo.reshape %v611 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3311 = stablehlo.broadcast_in_dim %v3309, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3312 = stablehlo.broadcast_in_dim %v3310, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3313 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3314 = stablehlo.add %v3312, %v3313 : tensor<32x128x28x28xf32>
    %v3315 = stablehlo.rsqrt %v3314 : tensor<32x128x28x28xf32>
    %v3316 = stablehlo.subtract %v3308, %v3311 : tensor<32x128x28x28xf32>
    %v3317 = stablehlo.multiply %v3316, %v3315 : tensor<32x128x28x28xf32>
    %v3318 = stablehlo.reshape %v3248 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3319 = stablehlo.multiply %v3318, %v3317 : tensor<32x128x28x28xf32>
    %v3320 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3321 = stablehlo.reduce(%v3319 init: %v3320) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3322 = stablehlo.reshape %v3248 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3323 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3324 = stablehlo.reduce(%v3322 init: %v3323) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3325 = stablehlo.reshape %v647 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3326 = stablehlo.reshape %v3237 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3327 = stablehlo.transpose %v3325, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    %v3328 = stablehlo.transpose %v3326, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    ...
    %v3331 = stablehlo.reshape %v652 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3334 = stablehlo.broadcast_in_dim %v3332, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3335 = stablehlo.broadcast_in_dim %v3333, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3336 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3337 = stablehlo.add %v3335, %v3336 : tensor<32x128x28x28xf32>
    %v3338 = stablehlo.rsqrt %v3337 : tensor<32x128x28x28xf32>
    %v3339 = stablehlo.subtract %v3331, %v3334 : tensor<32x128x28x28xf32>
    %v3340 = stablehlo.multiply %v3339, %v3338 : tensor<32x128x28x28xf32>
    %v3341 = stablehlo.reshape %v3193 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3342 = stablehlo.multiply %v3341, %v3340 : tensor<32x128x28x28xf32>
    %v3343 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3344 = stablehlo.reduce(%v3342 init: %v3343) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3345 = stablehlo.reshape %v3193 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3346 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3347 = stablehlo.reduce(%v3345 init: %v3346) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3348 = stablehlo.reshape %v3301 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3349 = stablehlo.reshape %v602 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3350 = stablehlo.constant dense<0.0> : tensor<32x128x28x28xf32>
    %v3351 = stablehlo.compare GT, %v3349, %v3350 : (tensor<32x128x28x28xf32>, tensor<32x128x28x28xf32>) -> tensor<32x128x28x28xi1>
    %v3352 = stablehlo.select %v3351, %v3348, %v3350 : tensor<32x128x28x28xi1>, tensor<32x128x28x28xf32>
    %v3353 = stablehlo.reshape %v3352 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3354 = stablehlo.reshape %v564 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3357 = stablehlo.broadcast_in_dim %v3355, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3358 = stablehlo.broadcast_in_dim %v3356, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3359 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3360 = stablehlo.add %v3358, %v3359 : tensor<32x128x28x28xf32>
    %v3361 = stablehlo.rsqrt %v3360 : tensor<32x128x28x28xf32>
    %v3362 = stablehlo.subtract %v3354, %v3357 : tensor<32x128x28x28xf32>
    %v3363 = stablehlo.multiply %v3362, %v3361 : tensor<32x128x28x28xf32>
    %v3364 = stablehlo.broadcast_in_dim %s2b1g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3365 = stablehlo.reshape %v3353 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3366 = stablehlo.multiply %v3364, %v3365 : tensor<32x128x28x28xf32>
    %v3367 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3368 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v3369 = stablehlo.reduce(%v3366 init: %v3367) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3370 = stablehlo.divide %v3369, %v3368 : tensor<128xf32>
    %v3371 = stablehlo.multiply %v3363, %v3366 : tensor<32x128x28x28xf32>
    %v3372 = stablehlo.reduce(%v3371 init: %v3367) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v3376 = stablehlo.reshape %v564 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3381 = stablehlo.broadcast_in_dim %v3377, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3382 = stablehlo.broadcast_in_dim %v3378, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3383 = stablehlo.broadcast_in_dim %v3379, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3384 = stablehlo.broadcast_in_dim %v3380, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3385 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3386 = stablehlo.add %v3382, %v3385 : tensor<32x128x28x28xf32>
    %v3387 = stablehlo.rsqrt %v3386 : tensor<32x128x28x28xf32>
    %v3388 = stablehlo.subtract %v3376, %v3381 : tensor<32x128x28x28xf32>
    %v3389 = stablehlo.multiply %v3388, %v3387 : tensor<32x128x28x28xf32>
    %v3390 = stablehlo.broadcast_in_dim %s2b1g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3391 = stablehlo.reshape %v3353 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3392 = stablehlo.multiply %v3390, %v3391 : tensor<32x128x28x28xf32>
    %v3393 = stablehlo.subtract %v3392, %v3383 : tensor<32x128x28x28xf32>
    %v3394 = stablehlo.multiply %v3389, %v3384 : tensor<32x128x28x28xf32>
    %v3395 = stablehlo.subtract %v3393, %v3394 : tensor<32x128x28x28xf32>
    %v3396 = stablehlo.multiply %v3387, %v3395 : tensor<32x128x28x28xf32>
    %v3397 = stablehlo.reshape %v3396 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3398 = stablehlo.reshape %v3397 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3401 = stablehlo.convolution(%v3398, %v3400)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v3402 = stablehlo.reshape %v3401 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3403 = stablehlo.reshape %v3402 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3404 = stablehlo.reshape %v557 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3405 = stablehlo.constant dense<0.0> : tensor<32x128x28x28xf32>
    %v3406 = stablehlo.compare GT, %v3404, %v3405 : (tensor<32x128x28x28xf32>, tensor<32x128x28x28xf32>) -> tensor<32x128x28x28xi1>
    %v3407 = stablehlo.select %v3406, %v3403, %v3405 : tensor<32x128x28x28xi1>, tensor<32x128x28x28xf32>
    %v3408 = stablehlo.reshape %v3407 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3409 = stablehlo.reshape %v523 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3412 = stablehlo.broadcast_in_dim %v3410, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3413 = stablehlo.broadcast_in_dim %v3411, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3414 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3415 = stablehlo.add %v3413, %v3414 : tensor<32x128x28x28xf32>
    %v3416 = stablehlo.rsqrt %v3415 : tensor<32x128x28x28xf32>
    %v3417 = stablehlo.subtract %v3409, %v3412 : tensor<32x128x28x28xf32>
    %v3418 = stablehlo.multiply %v3417, %v3416 : tensor<32x128x28x28xf32>
    %v3419 = stablehlo.broadcast_in_dim %s2b1g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3420 = stablehlo.reshape %v3408 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3421 = stablehlo.multiply %v3419, %v3420 : tensor<32x128x28x28xf32>
    %v3422 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3423 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v3424 = stablehlo.reduce(%v3421 init: %v3422) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3425 = stablehlo.divide %v3424, %v3423 : tensor<128xf32>
    %v3426 = stablehlo.multiply %v3418, %v3421 : tensor<32x128x28x28xf32>
    %v3427 = stablehlo.reduce(%v3426 init: %v3422) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v3431 = stablehlo.reshape %v523 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3436 = stablehlo.broadcast_in_dim %v3432, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3437 = stablehlo.broadcast_in_dim %v3433, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3438 = stablehlo.broadcast_in_dim %v3434, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3439 = stablehlo.broadcast_in_dim %v3435, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3440 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3441 = stablehlo.add %v3437, %v3440 : tensor<32x128x28x28xf32>
    %v3442 = stablehlo.rsqrt %v3441 : tensor<32x128x28x28xf32>
    %v3443 = stablehlo.subtract %v3431, %v3436 : tensor<32x128x28x28xf32>
    %v3444 = stablehlo.multiply %v3443, %v3442 : tensor<32x128x28x28xf32>
    %v3445 = stablehlo.broadcast_in_dim %s2b1g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3446 = stablehlo.reshape %v3408 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3447 = stablehlo.multiply %v3445, %v3446 : tensor<32x128x28x28xf32>
    %v3448 = stablehlo.subtract %v3447, %v3438 : tensor<32x128x28x28xf32>
    %v3449 = stablehlo.multiply %v3444, %v3439 : tensor<32x128x28x28xf32>
    %v3450 = stablehlo.subtract %v3448, %v3449 : tensor<32x128x28x28xf32>
    %v3451 = stablehlo.multiply %v3442, %v3450 : tensor<32x128x28x28xf32>
    %v3452 = stablehlo.reshape %v3451 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3453 = stablehlo.reshape %v3452 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3456 = stablehlo.convolution(%v3453, %v3455)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v3457 = stablehlo.reshape %v3456 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3458 = stablehlo.reshape %v3457 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3459 = stablehlo.reshape %v3353 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3460 = stablehlo.add %v3458, %v3459 : tensor<32x128x28x28xf32>
    %v3461 = stablehlo.reshape %v3460 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3462 = stablehlo.reshape %v518 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3463 = stablehlo.reshape %v3452 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3464 = stablehlo.transpose %v3462, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    %v3465 = stablehlo.transpose %v3463, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    ...
    %v3468 = stablehlo.reshape %v523 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3471 = stablehlo.broadcast_in_dim %v3469, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3472 = stablehlo.broadcast_in_dim %v3470, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3473 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3474 = stablehlo.add %v3472, %v3473 : tensor<32x128x28x28xf32>
    %v3475 = stablehlo.rsqrt %v3474 : tensor<32x128x28x28xf32>
    %v3476 = stablehlo.subtract %v3468, %v3471 : tensor<32x128x28x28xf32>
    %v3477 = stablehlo.multiply %v3476, %v3475 : tensor<32x128x28x28xf32>
    %v3478 = stablehlo.reshape %v3408 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3479 = stablehlo.multiply %v3478, %v3477 : tensor<32x128x28x28xf32>
    %v3480 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3481 = stablehlo.reduce(%v3479 init: %v3480) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3482 = stablehlo.reshape %v3408 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3483 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3484 = stablehlo.reduce(%v3482 init: %v3483) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3485 = stablehlo.reshape %v559 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3486 = stablehlo.reshape %v3397 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3487 = stablehlo.transpose %v3485, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    %v3488 = stablehlo.transpose %v3486, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    ...
    %v3491 = stablehlo.reshape %v564 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3494 = stablehlo.broadcast_in_dim %v3492, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3495 = stablehlo.broadcast_in_dim %v3493, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3496 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3497 = stablehlo.add %v3495, %v3496 : tensor<32x128x28x28xf32>
    %v3498 = stablehlo.rsqrt %v3497 : tensor<32x128x28x28xf32>
    %v3499 = stablehlo.subtract %v3491, %v3494 : tensor<32x128x28x28xf32>
    %v3500 = stablehlo.multiply %v3499, %v3498 : tensor<32x128x28x28xf32>
    %v3501 = stablehlo.reshape %v3353 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3502 = stablehlo.multiply %v3501, %v3500 : tensor<32x128x28x28xf32>
    %v3503 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3504 = stablehlo.reduce(%v3502 init: %v3503) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3505 = stablehlo.reshape %v3353 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3506 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3507 = stablehlo.reduce(%v3505 init: %v3506) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3508 = stablehlo.reshape %v3461 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3509 = stablehlo.reshape %v514 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3510 = stablehlo.constant dense<0.0> : tensor<32x128x28x28xf32>
    %v3511 = stablehlo.compare GT, %v3509, %v3510 : (tensor<32x128x28x28xf32>, tensor<32x128x28x28xf32>) -> tensor<32x128x28x28xi1>
    %v3512 = stablehlo.select %v3511, %v3508, %v3510 : tensor<32x128x28x28xi1>, tensor<32x128x28x28xf32>
    %v3513 = stablehlo.reshape %v3512 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3514 = stablehlo.reshape %v476 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3517 = stablehlo.broadcast_in_dim %v3515, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3518 = stablehlo.broadcast_in_dim %v3516, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3519 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3520 = stablehlo.add %v3518, %v3519 : tensor<32x128x28x28xf32>
    %v3521 = stablehlo.rsqrt %v3520 : tensor<32x128x28x28xf32>
    %v3522 = stablehlo.subtract %v3514, %v3517 : tensor<32x128x28x28xf32>
    %v3523 = stablehlo.multiply %v3522, %v3521 : tensor<32x128x28x28xf32>
    %v3524 = stablehlo.broadcast_in_dim %s2b0g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3525 = stablehlo.reshape %v3513 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3526 = stablehlo.multiply %v3524, %v3525 : tensor<32x128x28x28xf32>
    %v3527 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3528 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v3529 = stablehlo.reduce(%v3526 init: %v3527) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3530 = stablehlo.divide %v3529, %v3528 : tensor<128xf32>
    %v3531 = stablehlo.multiply %v3523, %v3526 : tensor<32x128x28x28xf32>
    %v3532 = stablehlo.reduce(%v3531 init: %v3527) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v3536 = stablehlo.reshape %v476 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3541 = stablehlo.broadcast_in_dim %v3537, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3542 = stablehlo.broadcast_in_dim %v3538, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3543 = stablehlo.broadcast_in_dim %v3539, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3544 = stablehlo.broadcast_in_dim %v3540, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3545 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3546 = stablehlo.add %v3542, %v3545 : tensor<32x128x28x28xf32>
    %v3547 = stablehlo.rsqrt %v3546 : tensor<32x128x28x28xf32>
    %v3548 = stablehlo.subtract %v3536, %v3541 : tensor<32x128x28x28xf32>
    %v3549 = stablehlo.multiply %v3548, %v3547 : tensor<32x128x28x28xf32>
    %v3550 = stablehlo.broadcast_in_dim %s2b0g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3551 = stablehlo.reshape %v3513 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3552 = stablehlo.multiply %v3550, %v3551 : tensor<32x128x28x28xf32>
    %v3553 = stablehlo.subtract %v3552, %v3543 : tensor<32x128x28x28xf32>
    %v3554 = stablehlo.multiply %v3549, %v3544 : tensor<32x128x28x28xf32>
    %v3555 = stablehlo.subtract %v3553, %v3554 : tensor<32x128x28x28xf32>
    %v3556 = stablehlo.multiply %v3547, %v3555 : tensor<32x128x28x28xf32>
    %v3557 = stablehlo.reshape %v3556 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3558 = stablehlo.reshape %v3557 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3561 = stablehlo.convolution(%v3558, %v3560)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v3562 = stablehlo.reshape %v3561 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3563 = stablehlo.reshape %v3562 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3564 = stablehlo.reshape %v469 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3565 = stablehlo.constant dense<0.0> : tensor<32x128x28x28xf32>
    %v3566 = stablehlo.compare GT, %v3564, %v3565 : (tensor<32x128x28x28xf32>, tensor<32x128x28x28xf32>) -> tensor<32x128x28x28xi1>
    %v3567 = stablehlo.select %v3566, %v3563, %v3565 : tensor<32x128x28x28xi1>, tensor<32x128x28x28xf32>
    %v3568 = stablehlo.reshape %v3567 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3569 = stablehlo.reshape %v435 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3572 = stablehlo.broadcast_in_dim %v3570, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3573 = stablehlo.broadcast_in_dim %v3571, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3574 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3575 = stablehlo.add %v3573, %v3574 : tensor<32x128x28x28xf32>
    %v3576 = stablehlo.rsqrt %v3575 : tensor<32x128x28x28xf32>
    %v3577 = stablehlo.subtract %v3569, %v3572 : tensor<32x128x28x28xf32>
    %v3578 = stablehlo.multiply %v3577, %v3576 : tensor<32x128x28x28xf32>
    %v3579 = stablehlo.broadcast_in_dim %s2b0g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3580 = stablehlo.reshape %v3568 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3581 = stablehlo.multiply %v3579, %v3580 : tensor<32x128x28x28xf32>
    %v3582 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3583 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v3584 = stablehlo.reduce(%v3581 init: %v3582) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3585 = stablehlo.divide %v3584, %v3583 : tensor<128xf32>
    %v3586 = stablehlo.multiply %v3578, %v3581 : tensor<32x128x28x28xf32>
    %v3587 = stablehlo.reduce(%v3586 init: %v3582) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v3591 = stablehlo.reshape %v435 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3596 = stablehlo.broadcast_in_dim %v3592, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3597 = stablehlo.broadcast_in_dim %v3593, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3598 = stablehlo.broadcast_in_dim %v3594, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3599 = stablehlo.broadcast_in_dim %v3595, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3600 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3601 = stablehlo.add %v3597, %v3600 : tensor<32x128x28x28xf32>
    %v3602 = stablehlo.rsqrt %v3601 : tensor<32x128x28x28xf32>
    %v3603 = stablehlo.subtract %v3591, %v3596 : tensor<32x128x28x28xf32>
    %v3604 = stablehlo.multiply %v3603, %v3602 : tensor<32x128x28x28xf32>
    %v3605 = stablehlo.broadcast_in_dim %s2b0g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3606 = stablehlo.reshape %v3568 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3607 = stablehlo.multiply %v3605, %v3606 : tensor<32x128x28x28xf32>
    %v3608 = stablehlo.subtract %v3607, %v3598 : tensor<32x128x28x28xf32>
    %v3609 = stablehlo.multiply %v3604, %v3599 : tensor<32x128x28x28xf32>
    %v3610 = stablehlo.subtract %v3608, %v3609 : tensor<32x128x28x28xf32>
    %v3611 = stablehlo.multiply %v3602, %v3610 : tensor<32x128x28x28xf32>
    %v3612 = stablehlo.reshape %v3611 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3613 = stablehlo.reshape %v3612 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3616 = stablehlo.convolution(%v3613, %v3615)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v3617 = stablehlo.reshape %v3616 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3618 = stablehlo.reshape %v3617 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3619 = stablehlo.reshape %v3513 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3620 = stablehlo.add %v3618, %v3619 : tensor<32x128x28x28xf32>
    %v3621 = stablehlo.reshape %v3620 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3622 = stablehlo.reshape %v430 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3623 = stablehlo.reshape %v3612 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3624 = stablehlo.transpose %v3622, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    %v3625 = stablehlo.transpose %v3623, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    ...
    %v3628 = stablehlo.reshape %v435 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3631 = stablehlo.broadcast_in_dim %v3629, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3632 = stablehlo.broadcast_in_dim %v3630, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3633 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3634 = stablehlo.add %v3632, %v3633 : tensor<32x128x28x28xf32>
    %v3635 = stablehlo.rsqrt %v3634 : tensor<32x128x28x28xf32>
    %v3636 = stablehlo.subtract %v3628, %v3631 : tensor<32x128x28x28xf32>
    %v3637 = stablehlo.multiply %v3636, %v3635 : tensor<32x128x28x28xf32>
    %v3638 = stablehlo.reshape %v3568 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3639 = stablehlo.multiply %v3638, %v3637 : tensor<32x128x28x28xf32>
    %v3640 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3641 = stablehlo.reduce(%v3639 init: %v3640) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3642 = stablehlo.reshape %v3568 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3643 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3644 = stablehlo.reduce(%v3642 init: %v3643) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3645 = stablehlo.reshape %v471 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3646 = stablehlo.reshape %v3557 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3647 = stablehlo.transpose %v3645, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    %v3648 = stablehlo.transpose %v3646, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    ...
    %v3651 = stablehlo.reshape %v476 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3654 = stablehlo.broadcast_in_dim %v3652, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3655 = stablehlo.broadcast_in_dim %v3653, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3656 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3657 = stablehlo.add %v3655, %v3656 : tensor<32x128x28x28xf32>
    %v3658 = stablehlo.rsqrt %v3657 : tensor<32x128x28x28xf32>
    %v3659 = stablehlo.subtract %v3651, %v3654 : tensor<32x128x28x28xf32>
    %v3660 = stablehlo.multiply %v3659, %v3658 : tensor<32x128x28x28xf32>
    %v3661 = stablehlo.reshape %v3513 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3662 = stablehlo.multiply %v3661, %v3660 : tensor<32x128x28x28xf32>
    %v3663 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3664 = stablehlo.reduce(%v3662 init: %v3663) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3665 = stablehlo.reshape %v3513 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3666 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3667 = stablehlo.reduce(%v3665 init: %v3666) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3668 = stablehlo.reshape %v3621 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3669 = stablehlo.reshape %v428 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3670 = stablehlo.constant dense<0.0> : tensor<32x128x28x28xf32>
    %v3671 = stablehlo.compare GT, %v3669, %v3670 : (tensor<32x128x28x28xf32>, tensor<32x128x28x28xf32>) -> tensor<32x128x28x28xi1>
    %v3672 = stablehlo.select %v3671, %v3668, %v3670 : tensor<32x128x28x28xi1>, tensor<32x128x28x28xf32>
    %v3673 = stablehlo.reshape %v3672 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3674 = stablehlo.reshape %v354 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3677 = stablehlo.broadcast_in_dim %v3675, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3678 = stablehlo.broadcast_in_dim %v3676, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3679 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3680 = stablehlo.add %v3678, %v3679 : tensor<32x128x28x28xf32>
    %v3681 = stablehlo.rsqrt %v3680 : tensor<32x128x28x28xf32>
    %v3682 = stablehlo.subtract %v3674, %v3677 : tensor<32x128x28x28xf32>
    %v3683 = stablehlo.multiply %v3682, %v3681 : tensor<32x128x28x28xf32>
    %v3684 = stablehlo.broadcast_in_dim %d2g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3685 = stablehlo.reshape %v3673 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3686 = stablehlo.multiply %v3684, %v3685 : tensor<32x128x28x28xf32>
    %v3687 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3688 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v3689 = stablehlo.reduce(%v3686 init: %v3687) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3690 = stablehlo.divide %v3689, %v3688 : tensor<128xf32>
    %v3691 = stablehlo.multiply %v3683, %v3686 : tensor<32x128x28x28xf32>
    %v3692 = stablehlo.reduce(%v3691 init: %v3687) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v3696 = stablehlo.reshape %v354 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3701 = stablehlo.broadcast_in_dim %v3697, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3702 = stablehlo.broadcast_in_dim %v3698, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3703 = stablehlo.broadcast_in_dim %v3699, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3704 = stablehlo.broadcast_in_dim %v3700, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3705 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3706 = stablehlo.add %v3702, %v3705 : tensor<32x128x28x28xf32>
    %v3707 = stablehlo.rsqrt %v3706 : tensor<32x128x28x28xf32>
    %v3708 = stablehlo.subtract %v3696, %v3701 : tensor<32x128x28x28xf32>
    %v3709 = stablehlo.multiply %v3708, %v3707 : tensor<32x128x28x28xf32>
    %v3710 = stablehlo.broadcast_in_dim %d2g2, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3711 = stablehlo.reshape %v3673 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3712 = stablehlo.multiply %v3710, %v3711 : tensor<32x128x28x28xf32>
    %v3713 = stablehlo.subtract %v3712, %v3703 : tensor<32x128x28x28xf32>
    %v3714 = stablehlo.multiply %v3709, %v3704 : tensor<32x128x28x28xf32>
    %v3715 = stablehlo.subtract %v3713, %v3714 : tensor<32x128x28x28xf32>
    %v3716 = stablehlo.multiply %v3707, %v3715 : tensor<32x128x28x28xf32>
    %v3717 = stablehlo.reshape %v3716 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3718 = stablehlo.reshape %v3717 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3721 = stablehlo.convolution(%v3718, %v3720)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x128x28x28xf32>, tensor<128x128x3x3xf32>) -> tensor<32x128x28x28xf32>
    %v3722 = stablehlo.reshape %v3721 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3723 = stablehlo.reshape %v3722 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3724 = stablehlo.reshape %v347 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3725 = stablehlo.constant dense<0.0> : tensor<32x128x28x28xf32>
    %v3726 = stablehlo.compare GT, %v3724, %v3725 : (tensor<32x128x28x28xf32>, tensor<32x128x28x28xf32>) -> tensor<32x128x28x28xi1>
    %v3727 = stablehlo.select %v3726, %v3723, %v3725 : tensor<32x128x28x28xi1>, tensor<32x128x28x28xf32>
    %v3728 = stablehlo.reshape %v3727 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3729 = stablehlo.reshape %v313 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3732 = stablehlo.broadcast_in_dim %v3730, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3733 = stablehlo.broadcast_in_dim %v3731, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3734 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3735 = stablehlo.add %v3733, %v3734 : tensor<32x128x28x28xf32>
    %v3736 = stablehlo.rsqrt %v3735 : tensor<32x128x28x28xf32>
    %v3737 = stablehlo.subtract %v3729, %v3732 : tensor<32x128x28x28xf32>
    %v3738 = stablehlo.multiply %v3737, %v3736 : tensor<32x128x28x28xf32>
    %v3739 = stablehlo.broadcast_in_dim %d2g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3740 = stablehlo.reshape %v3728 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3741 = stablehlo.multiply %v3739, %v3740 : tensor<32x128x28x28xf32>
    %v3742 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3743 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v3744 = stablehlo.reduce(%v3741 init: %v3742) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3745 = stablehlo.divide %v3744, %v3743 : tensor<128xf32>
    %v3746 = stablehlo.multiply %v3738, %v3741 : tensor<32x128x28x28xf32>
    %v3747 = stablehlo.reduce(%v3746 init: %v3742) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v3751 = stablehlo.reshape %v313 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3756 = stablehlo.broadcast_in_dim %v3752, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3757 = stablehlo.broadcast_in_dim %v3753, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3758 = stablehlo.broadcast_in_dim %v3754, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3759 = stablehlo.broadcast_in_dim %v3755, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3760 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3761 = stablehlo.add %v3757, %v3760 : tensor<32x128x28x28xf32>
    %v3762 = stablehlo.rsqrt %v3761 : tensor<32x128x28x28xf32>
    %v3763 = stablehlo.subtract %v3751, %v3756 : tensor<32x128x28x28xf32>
    %v3764 = stablehlo.multiply %v3763, %v3762 : tensor<32x128x28x28xf32>
    %v3765 = stablehlo.broadcast_in_dim %d2g1, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3766 = stablehlo.reshape %v3728 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3767 = stablehlo.multiply %v3765, %v3766 : tensor<32x128x28x28xf32>
    %v3768 = stablehlo.subtract %v3767, %v3758 : tensor<32x128x28x28xf32>
    %v3769 = stablehlo.multiply %v3764, %v3759 : tensor<32x128x28x28xf32>
    %v3770 = stablehlo.subtract %v3768, %v3769 : tensor<32x128x28x28xf32>
    %v3771 = stablehlo.multiply %v3762, %v3770 : tensor<32x128x28x28xf32>
    %v3772 = stablehlo.reshape %v3771 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3773 = stablehlo.reshape %v3772 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3774 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3775 = stablehlo.pad %v3773, %v3774, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<32x128x56x56xf32>
    ...
    %v3779 = stablehlo.reshape %v3778 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v3780 = stablehlo.reshape %v393 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3783 = stablehlo.broadcast_in_dim %v3781, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3784 = stablehlo.broadcast_in_dim %v3782, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3785 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3786 = stablehlo.add %v3784, %v3785 : tensor<32x128x28x28xf32>
    %v3787 = stablehlo.rsqrt %v3786 : tensor<32x128x28x28xf32>
    %v3788 = stablehlo.subtract %v3780, %v3783 : tensor<32x128x28x28xf32>
    %v3789 = stablehlo.multiply %v3788, %v3787 : tensor<32x128x28x28xf32>
    %v3790 = stablehlo.broadcast_in_dim %d2gp, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3791 = stablehlo.reshape %v3673 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3792 = stablehlo.multiply %v3790, %v3791 : tensor<32x128x28x28xf32>
    %v3793 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3794 = stablehlo.constant dense<25088.0> : tensor<128xf32>
    %v3795 = stablehlo.reduce(%v3792 init: %v3793) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3796 = stablehlo.divide %v3795, %v3794 : tensor<128xf32>
    %v3797 = stablehlo.multiply %v3789, %v3792 : tensor<32x128x28x28xf32>
    %v3798 = stablehlo.reduce(%v3797 init: %v3793) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %v3802 = stablehlo.reshape %v393 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3807 = stablehlo.broadcast_in_dim %v3803, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3808 = stablehlo.broadcast_in_dim %v3804, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3809 = stablehlo.broadcast_in_dim %v3805, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3810 = stablehlo.broadcast_in_dim %v3806, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3811 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3812 = stablehlo.add %v3808, %v3811 : tensor<32x128x28x28xf32>
    %v3813 = stablehlo.rsqrt %v3812 : tensor<32x128x28x28xf32>
    %v3814 = stablehlo.subtract %v3802, %v3807 : tensor<32x128x28x28xf32>
    %v3815 = stablehlo.multiply %v3814, %v3813 : tensor<32x128x28x28xf32>
    %v3816 = stablehlo.broadcast_in_dim %d2gp, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3817 = stablehlo.reshape %v3673 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3818 = stablehlo.multiply %v3816, %v3817 : tensor<32x128x28x28xf32>
    %v3819 = stablehlo.subtract %v3818, %v3809 : tensor<32x128x28x28xf32>
    %v3820 = stablehlo.multiply %v3815, %v3810 : tensor<32x128x28x28xf32>
    %v3821 = stablehlo.subtract %v3819, %v3820 : tensor<32x128x28x28xf32>
    %v3822 = stablehlo.multiply %v3813, %v3821 : tensor<32x128x28x28xf32>
    %v3823 = stablehlo.reshape %v3822 : (tensor<32x128x28x28xf32>) -> tensor<32x100352xf32>
    %v3824 = stablehlo.reshape %v3823 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3825 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3826 = stablehlo.pad %v3824, %v3825, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<32x128x56x56xf32>
    ...
    %v3830 = stablehlo.reshape %v3829 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v3831 = stablehlo.reshape %v3779 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v3832 = stablehlo.reshape %v3830 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v3833 = stablehlo.add %v3831, %v3832 : tensor<32x64x56x56xf32>
    %v3834 = stablehlo.reshape %v3833 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v3835 = stablehlo.reshape %v308 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v3836 = stablehlo.reshape %v3772 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3837 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3838 = stablehlo.pad %v3836, %v3837, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<32x128x56x56xf32>
    %v3839 = stablehlo.transpose %v3835, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    %v3840 = stablehlo.transpose %v3838, dims = [1, 0, 2, 3] : (tensor<32x128x56x56xf32>) -> tensor<128x32x56x56xf32>
    ...
    %v3843 = stablehlo.reshape %v313 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3846 = stablehlo.broadcast_in_dim %v3844, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3847 = stablehlo.broadcast_in_dim %v3845, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3848 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3849 = stablehlo.add %v3847, %v3848 : tensor<32x128x28x28xf32>
    %v3850 = stablehlo.rsqrt %v3849 : tensor<32x128x28x28xf32>
    %v3851 = stablehlo.subtract %v3843, %v3846 : tensor<32x128x28x28xf32>
    %v3852 = stablehlo.multiply %v3851, %v3850 : tensor<32x128x28x28xf32>
    %v3853 = stablehlo.reshape %v3728 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3854 = stablehlo.multiply %v3853, %v3852 : tensor<32x128x28x28xf32>
    %v3855 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3856 = stablehlo.reduce(%v3854 init: %v3855) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3857 = stablehlo.reshape %v3728 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3858 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3859 = stablehlo.reduce(%v3857 init: %v3858) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3860 = stablehlo.reshape %v349 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3861 = stablehlo.reshape %v3717 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3862 = stablehlo.transpose %v3860, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    %v3863 = stablehlo.transpose %v3861, dims = [1, 0, 2, 3] : (tensor<32x128x28x28xf32>) -> tensor<128x32x28x28xf32>
    ...
    %v3866 = stablehlo.reshape %v354 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3869 = stablehlo.broadcast_in_dim %v3867, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3870 = stablehlo.broadcast_in_dim %v3868, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3871 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3872 = stablehlo.add %v3870, %v3871 : tensor<32x128x28x28xf32>
    %v3873 = stablehlo.rsqrt %v3872 : tensor<32x128x28x28xf32>
    %v3874 = stablehlo.subtract %v3866, %v3869 : tensor<32x128x28x28xf32>
    %v3875 = stablehlo.multiply %v3874, %v3873 : tensor<32x128x28x28xf32>
    %v3876 = stablehlo.reshape %v3673 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3877 = stablehlo.multiply %v3876, %v3875 : tensor<32x128x28x28xf32>
    %v3878 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3879 = stablehlo.reduce(%v3877 init: %v3878) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3880 = stablehlo.reshape %v3673 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3881 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3882 = stablehlo.reduce(%v3880 init: %v3881) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3883 = stablehlo.reshape %v308 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v3884 = stablehlo.reshape %v3823 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3885 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3886 = stablehlo.pad %v3884, %v3885, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<32x128x56x56xf32>
    %v3887 = stablehlo.transpose %v3883, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    %v3888 = stablehlo.transpose %v3886, dims = [1, 0, 2, 3] : (tensor<32x128x56x56xf32>) -> tensor<128x32x56x56xf32>
    ...
    %v3891 = stablehlo.reshape %v393 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    ...
    %v3894 = stablehlo.broadcast_in_dim %v3892, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3895 = stablehlo.broadcast_in_dim %v3893, dims = [1] : (tensor<128xf32>) -> tensor<32x128x28x28xf32>
    %v3896 = stablehlo.constant dense<1.0e-05> : tensor<32x128x28x28xf32>
    %v3897 = stablehlo.add %v3895, %v3896 : tensor<32x128x28x28xf32>
    %v3898 = stablehlo.rsqrt %v3897 : tensor<32x128x28x28xf32>
    %v3899 = stablehlo.subtract %v3891, %v3894 : tensor<32x128x28x28xf32>
    %v3900 = stablehlo.multiply %v3899, %v3898 : tensor<32x128x28x28xf32>
    %v3901 = stablehlo.reshape %v3673 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3902 = stablehlo.multiply %v3901, %v3900 : tensor<32x128x28x28xf32>
    %v3903 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3904 = stablehlo.reduce(%v3902 init: %v3903) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3905 = stablehlo.reshape %v3673 : (tensor<32x100352xf32>) -> tensor<32x128x28x28xf32>
    %v3906 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3907 = stablehlo.reduce(%v3905 init: %v3906) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x128x28x28xf32>, tensor<f32>) -> tensor<128xf32>
    %v3908 = stablehlo.reshape %v3834 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v3909 = stablehlo.reshape %v304 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v3910 = stablehlo.constant dense<0.0> : tensor<32x64x56x56xf32>
    %v3911 = stablehlo.compare GT, %v3909, %v3910 : (tensor<32x64x56x56xf32>, tensor<32x64x56x56xf32>) -> tensor<32x64x56x56xi1>
    %v3912 = stablehlo.select %v3911, %v3908, %v3910 : tensor<32x64x56x56xi1>, tensor<32x64x56x56xf32>
    %v3913 = stablehlo.reshape %v3912 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v3914 = stablehlo.reshape %v266 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v3917 = stablehlo.broadcast_in_dim %v3915, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3918 = stablehlo.broadcast_in_dim %v3916, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3919 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v3920 = stablehlo.add %v3918, %v3919 : tensor<32x64x56x56xf32>
    %v3921 = stablehlo.rsqrt %v3920 : tensor<32x64x56x56xf32>
    %v3922 = stablehlo.subtract %v3914, %v3917 : tensor<32x64x56x56xf32>
    %v3923 = stablehlo.multiply %v3922, %v3921 : tensor<32x64x56x56xf32>
    %v3924 = stablehlo.broadcast_in_dim %s1b2g2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3925 = stablehlo.reshape %v3913 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v3926 = stablehlo.multiply %v3924, %v3925 : tensor<32x64x56x56xf32>
    %v3927 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3928 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v3929 = stablehlo.reduce(%v3926 init: %v3927) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v3930 = stablehlo.divide %v3929, %v3928 : tensor<64xf32>
    %v3931 = stablehlo.multiply %v3923, %v3926 : tensor<32x64x56x56xf32>
    %v3932 = stablehlo.reduce(%v3931 init: %v3927) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v3936 = stablehlo.reshape %v266 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v3941 = stablehlo.broadcast_in_dim %v3937, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3942 = stablehlo.broadcast_in_dim %v3938, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3943 = stablehlo.broadcast_in_dim %v3939, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3944 = stablehlo.broadcast_in_dim %v3940, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3945 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v3946 = stablehlo.add %v3942, %v3945 : tensor<32x64x56x56xf32>
    %v3947 = stablehlo.rsqrt %v3946 : tensor<32x64x56x56xf32>
    %v3948 = stablehlo.subtract %v3936, %v3941 : tensor<32x64x56x56xf32>
    %v3949 = stablehlo.multiply %v3948, %v3947 : tensor<32x64x56x56xf32>
    %v3950 = stablehlo.broadcast_in_dim %s1b2g2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3951 = stablehlo.reshape %v3913 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v3952 = stablehlo.multiply %v3950, %v3951 : tensor<32x64x56x56xf32>
    %v3953 = stablehlo.subtract %v3952, %v3943 : tensor<32x64x56x56xf32>
    %v3954 = stablehlo.multiply %v3949, %v3944 : tensor<32x64x56x56xf32>
    %v3955 = stablehlo.subtract %v3953, %v3954 : tensor<32x64x56x56xf32>
    %v3956 = stablehlo.multiply %v3947, %v3955 : tensor<32x64x56x56xf32>
    %v3957 = stablehlo.reshape %v3956 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v3958 = stablehlo.reshape %v3957 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v3961 = stablehlo.convolution(%v3958, %v3960)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x64x56x56xf32>, tensor<64x64x3x3xf32>) -> tensor<32x64x56x56xf32>
    %v3962 = stablehlo.reshape %v3961 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v3963 = stablehlo.reshape %v3962 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v3964 = stablehlo.reshape %v259 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v3965 = stablehlo.constant dense<0.0> : tensor<32x64x56x56xf32>
    %v3966 = stablehlo.compare GT, %v3964, %v3965 : (tensor<32x64x56x56xf32>, tensor<32x64x56x56xf32>) -> tensor<32x64x56x56xi1>
    %v3967 = stablehlo.select %v3966, %v3963, %v3965 : tensor<32x64x56x56xi1>, tensor<32x64x56x56xf32>
    %v3968 = stablehlo.reshape %v3967 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v3969 = stablehlo.reshape %v225 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v3972 = stablehlo.broadcast_in_dim %v3970, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3973 = stablehlo.broadcast_in_dim %v3971, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3974 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v3975 = stablehlo.add %v3973, %v3974 : tensor<32x64x56x56xf32>
    %v3976 = stablehlo.rsqrt %v3975 : tensor<32x64x56x56xf32>
    %v3977 = stablehlo.subtract %v3969, %v3972 : tensor<32x64x56x56xf32>
    %v3978 = stablehlo.multiply %v3977, %v3976 : tensor<32x64x56x56xf32>
    %v3979 = stablehlo.broadcast_in_dim %s1b2g1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3980 = stablehlo.reshape %v3968 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v3981 = stablehlo.multiply %v3979, %v3980 : tensor<32x64x56x56xf32>
    %v3982 = stablehlo.constant dense<0.0> : tensor<f32>
    %v3983 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v3984 = stablehlo.reduce(%v3981 init: %v3982) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v3985 = stablehlo.divide %v3984, %v3983 : tensor<64xf32>
    %v3986 = stablehlo.multiply %v3978, %v3981 : tensor<32x64x56x56xf32>
    %v3987 = stablehlo.reduce(%v3986 init: %v3982) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v3991 = stablehlo.reshape %v225 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v3996 = stablehlo.broadcast_in_dim %v3992, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3997 = stablehlo.broadcast_in_dim %v3993, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3998 = stablehlo.broadcast_in_dim %v3994, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v3999 = stablehlo.broadcast_in_dim %v3995, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4000 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4001 = stablehlo.add %v3997, %v4000 : tensor<32x64x56x56xf32>
    %v4002 = stablehlo.rsqrt %v4001 : tensor<32x64x56x56xf32>
    %v4003 = stablehlo.subtract %v3991, %v3996 : tensor<32x64x56x56xf32>
    %v4004 = stablehlo.multiply %v4003, %v4002 : tensor<32x64x56x56xf32>
    %v4005 = stablehlo.broadcast_in_dim %s1b2g1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4006 = stablehlo.reshape %v3968 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4007 = stablehlo.multiply %v4005, %v4006 : tensor<32x64x56x56xf32>
    %v4008 = stablehlo.subtract %v4007, %v3998 : tensor<32x64x56x56xf32>
    %v4009 = stablehlo.multiply %v4004, %v3999 : tensor<32x64x56x56xf32>
    %v4010 = stablehlo.subtract %v4008, %v4009 : tensor<32x64x56x56xf32>
    %v4011 = stablehlo.multiply %v4002, %v4010 : tensor<32x64x56x56xf32>
    %v4012 = stablehlo.reshape %v4011 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4013 = stablehlo.reshape %v4012 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4016 = stablehlo.convolution(%v4013, %v4015)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x64x56x56xf32>, tensor<64x64x3x3xf32>) -> tensor<32x64x56x56xf32>
    %v4017 = stablehlo.reshape %v4016 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4018 = stablehlo.reshape %v4017 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4019 = stablehlo.reshape %v3913 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4020 = stablehlo.add %v4018, %v4019 : tensor<32x64x56x56xf32>
    %v4021 = stablehlo.reshape %v4020 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4022 = stablehlo.reshape %v220 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4023 = stablehlo.reshape %v4012 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4024 = stablehlo.transpose %v4022, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    %v4025 = stablehlo.transpose %v4023, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    ...
    %v4028 = stablehlo.reshape %v225 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4031 = stablehlo.broadcast_in_dim %v4029, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4032 = stablehlo.broadcast_in_dim %v4030, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4033 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4034 = stablehlo.add %v4032, %v4033 : tensor<32x64x56x56xf32>
    %v4035 = stablehlo.rsqrt %v4034 : tensor<32x64x56x56xf32>
    %v4036 = stablehlo.subtract %v4028, %v4031 : tensor<32x64x56x56xf32>
    %v4037 = stablehlo.multiply %v4036, %v4035 : tensor<32x64x56x56xf32>
    %v4038 = stablehlo.reshape %v3968 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4039 = stablehlo.multiply %v4038, %v4037 : tensor<32x64x56x56xf32>
    %v4040 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4041 = stablehlo.reduce(%v4039 init: %v4040) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4042 = stablehlo.reshape %v3968 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4043 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4044 = stablehlo.reduce(%v4042 init: %v4043) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4045 = stablehlo.reshape %v261 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4046 = stablehlo.reshape %v3957 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4047 = stablehlo.transpose %v4045, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    %v4048 = stablehlo.transpose %v4046, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    ...
    %v4051 = stablehlo.reshape %v266 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4054 = stablehlo.broadcast_in_dim %v4052, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4055 = stablehlo.broadcast_in_dim %v4053, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4056 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4057 = stablehlo.add %v4055, %v4056 : tensor<32x64x56x56xf32>
    %v4058 = stablehlo.rsqrt %v4057 : tensor<32x64x56x56xf32>
    %v4059 = stablehlo.subtract %v4051, %v4054 : tensor<32x64x56x56xf32>
    %v4060 = stablehlo.multiply %v4059, %v4058 : tensor<32x64x56x56xf32>
    %v4061 = stablehlo.reshape %v3913 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4062 = stablehlo.multiply %v4061, %v4060 : tensor<32x64x56x56xf32>
    %v4063 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4064 = stablehlo.reduce(%v4062 init: %v4063) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4065 = stablehlo.reshape %v3913 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4066 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4067 = stablehlo.reduce(%v4065 init: %v4066) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4068 = stablehlo.reshape %v4021 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4069 = stablehlo.reshape %v216 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4070 = stablehlo.constant dense<0.0> : tensor<32x64x56x56xf32>
    %v4071 = stablehlo.compare GT, %v4069, %v4070 : (tensor<32x64x56x56xf32>, tensor<32x64x56x56xf32>) -> tensor<32x64x56x56xi1>
    %v4072 = stablehlo.select %v4071, %v4068, %v4070 : tensor<32x64x56x56xi1>, tensor<32x64x56x56xf32>
    %v4073 = stablehlo.reshape %v4072 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4074 = stablehlo.reshape %v178 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4077 = stablehlo.broadcast_in_dim %v4075, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4078 = stablehlo.broadcast_in_dim %v4076, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4079 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4080 = stablehlo.add %v4078, %v4079 : tensor<32x64x56x56xf32>
    %v4081 = stablehlo.rsqrt %v4080 : tensor<32x64x56x56xf32>
    %v4082 = stablehlo.subtract %v4074, %v4077 : tensor<32x64x56x56xf32>
    %v4083 = stablehlo.multiply %v4082, %v4081 : tensor<32x64x56x56xf32>
    %v4084 = stablehlo.broadcast_in_dim %s1b1g2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4085 = stablehlo.reshape %v4073 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4086 = stablehlo.multiply %v4084, %v4085 : tensor<32x64x56x56xf32>
    %v4087 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4088 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v4089 = stablehlo.reduce(%v4086 init: %v4087) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4090 = stablehlo.divide %v4089, %v4088 : tensor<64xf32>
    %v4091 = stablehlo.multiply %v4083, %v4086 : tensor<32x64x56x56xf32>
    %v4092 = stablehlo.reduce(%v4091 init: %v4087) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v4096 = stablehlo.reshape %v178 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4101 = stablehlo.broadcast_in_dim %v4097, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4102 = stablehlo.broadcast_in_dim %v4098, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4103 = stablehlo.broadcast_in_dim %v4099, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4104 = stablehlo.broadcast_in_dim %v4100, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4105 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4106 = stablehlo.add %v4102, %v4105 : tensor<32x64x56x56xf32>
    %v4107 = stablehlo.rsqrt %v4106 : tensor<32x64x56x56xf32>
    %v4108 = stablehlo.subtract %v4096, %v4101 : tensor<32x64x56x56xf32>
    %v4109 = stablehlo.multiply %v4108, %v4107 : tensor<32x64x56x56xf32>
    %v4110 = stablehlo.broadcast_in_dim %s1b1g2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4111 = stablehlo.reshape %v4073 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4112 = stablehlo.multiply %v4110, %v4111 : tensor<32x64x56x56xf32>
    %v4113 = stablehlo.subtract %v4112, %v4103 : tensor<32x64x56x56xf32>
    %v4114 = stablehlo.multiply %v4109, %v4104 : tensor<32x64x56x56xf32>
    %v4115 = stablehlo.subtract %v4113, %v4114 : tensor<32x64x56x56xf32>
    %v4116 = stablehlo.multiply %v4107, %v4115 : tensor<32x64x56x56xf32>
    %v4117 = stablehlo.reshape %v4116 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4118 = stablehlo.reshape %v4117 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4121 = stablehlo.convolution(%v4118, %v4120)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x64x56x56xf32>, tensor<64x64x3x3xf32>) -> tensor<32x64x56x56xf32>
    %v4122 = stablehlo.reshape %v4121 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4123 = stablehlo.reshape %v4122 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4124 = stablehlo.reshape %v171 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4125 = stablehlo.constant dense<0.0> : tensor<32x64x56x56xf32>
    %v4126 = stablehlo.compare GT, %v4124, %v4125 : (tensor<32x64x56x56xf32>, tensor<32x64x56x56xf32>) -> tensor<32x64x56x56xi1>
    %v4127 = stablehlo.select %v4126, %v4123, %v4125 : tensor<32x64x56x56xi1>, tensor<32x64x56x56xf32>
    %v4128 = stablehlo.reshape %v4127 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4129 = stablehlo.reshape %v137 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4132 = stablehlo.broadcast_in_dim %v4130, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4133 = stablehlo.broadcast_in_dim %v4131, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4134 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4135 = stablehlo.add %v4133, %v4134 : tensor<32x64x56x56xf32>
    %v4136 = stablehlo.rsqrt %v4135 : tensor<32x64x56x56xf32>
    %v4137 = stablehlo.subtract %v4129, %v4132 : tensor<32x64x56x56xf32>
    %v4138 = stablehlo.multiply %v4137, %v4136 : tensor<32x64x56x56xf32>
    %v4139 = stablehlo.broadcast_in_dim %s1b1g1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4140 = stablehlo.reshape %v4128 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4141 = stablehlo.multiply %v4139, %v4140 : tensor<32x64x56x56xf32>
    %v4142 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4143 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v4144 = stablehlo.reduce(%v4141 init: %v4142) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4145 = stablehlo.divide %v4144, %v4143 : tensor<64xf32>
    %v4146 = stablehlo.multiply %v4138, %v4141 : tensor<32x64x56x56xf32>
    %v4147 = stablehlo.reduce(%v4146 init: %v4142) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v4151 = stablehlo.reshape %v137 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4156 = stablehlo.broadcast_in_dim %v4152, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4157 = stablehlo.broadcast_in_dim %v4153, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4158 = stablehlo.broadcast_in_dim %v4154, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4159 = stablehlo.broadcast_in_dim %v4155, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4160 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4161 = stablehlo.add %v4157, %v4160 : tensor<32x64x56x56xf32>
    %v4162 = stablehlo.rsqrt %v4161 : tensor<32x64x56x56xf32>
    %v4163 = stablehlo.subtract %v4151, %v4156 : tensor<32x64x56x56xf32>
    %v4164 = stablehlo.multiply %v4163, %v4162 : tensor<32x64x56x56xf32>
    %v4165 = stablehlo.broadcast_in_dim %s1b1g1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4166 = stablehlo.reshape %v4128 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4167 = stablehlo.multiply %v4165, %v4166 : tensor<32x64x56x56xf32>
    %v4168 = stablehlo.subtract %v4167, %v4158 : tensor<32x64x56x56xf32>
    %v4169 = stablehlo.multiply %v4164, %v4159 : tensor<32x64x56x56xf32>
    %v4170 = stablehlo.subtract %v4168, %v4169 : tensor<32x64x56x56xf32>
    %v4171 = stablehlo.multiply %v4162, %v4170 : tensor<32x64x56x56xf32>
    %v4172 = stablehlo.reshape %v4171 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4173 = stablehlo.reshape %v4172 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4176 = stablehlo.convolution(%v4173, %v4175)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x64x56x56xf32>, tensor<64x64x3x3xf32>) -> tensor<32x64x56x56xf32>
    %v4177 = stablehlo.reshape %v4176 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4178 = stablehlo.reshape %v4177 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4179 = stablehlo.reshape %v4073 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4180 = stablehlo.add %v4178, %v4179 : tensor<32x64x56x56xf32>
    %v4181 = stablehlo.reshape %v4180 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4182 = stablehlo.reshape %v132 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4183 = stablehlo.reshape %v4172 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4184 = stablehlo.transpose %v4182, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    %v4185 = stablehlo.transpose %v4183, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    ...
    %v4188 = stablehlo.reshape %v137 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4191 = stablehlo.broadcast_in_dim %v4189, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4192 = stablehlo.broadcast_in_dim %v4190, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4193 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4194 = stablehlo.add %v4192, %v4193 : tensor<32x64x56x56xf32>
    %v4195 = stablehlo.rsqrt %v4194 : tensor<32x64x56x56xf32>
    %v4196 = stablehlo.subtract %v4188, %v4191 : tensor<32x64x56x56xf32>
    %v4197 = stablehlo.multiply %v4196, %v4195 : tensor<32x64x56x56xf32>
    %v4198 = stablehlo.reshape %v4128 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4199 = stablehlo.multiply %v4198, %v4197 : tensor<32x64x56x56xf32>
    %v4200 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4201 = stablehlo.reduce(%v4199 init: %v4200) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4202 = stablehlo.reshape %v4128 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4203 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4204 = stablehlo.reduce(%v4202 init: %v4203) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4205 = stablehlo.reshape %v173 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4206 = stablehlo.reshape %v4117 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4207 = stablehlo.transpose %v4205, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    %v4208 = stablehlo.transpose %v4206, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    ...
    %v4211 = stablehlo.reshape %v178 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4214 = stablehlo.broadcast_in_dim %v4212, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4215 = stablehlo.broadcast_in_dim %v4213, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4216 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4217 = stablehlo.add %v4215, %v4216 : tensor<32x64x56x56xf32>
    %v4218 = stablehlo.rsqrt %v4217 : tensor<32x64x56x56xf32>
    %v4219 = stablehlo.subtract %v4211, %v4214 : tensor<32x64x56x56xf32>
    %v4220 = stablehlo.multiply %v4219, %v4218 : tensor<32x64x56x56xf32>
    %v4221 = stablehlo.reshape %v4073 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4222 = stablehlo.multiply %v4221, %v4220 : tensor<32x64x56x56xf32>
    %v4223 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4224 = stablehlo.reduce(%v4222 init: %v4223) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4225 = stablehlo.reshape %v4073 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4226 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4227 = stablehlo.reduce(%v4225 init: %v4226) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4228 = stablehlo.reshape %v4181 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4229 = stablehlo.reshape %v128 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4230 = stablehlo.constant dense<0.0> : tensor<32x64x56x56xf32>
    %v4231 = stablehlo.compare GT, %v4229, %v4230 : (tensor<32x64x56x56xf32>, tensor<32x64x56x56xf32>) -> tensor<32x64x56x56xi1>
    %v4232 = stablehlo.select %v4231, %v4228, %v4230 : tensor<32x64x56x56xi1>, tensor<32x64x56x56xf32>
    %v4233 = stablehlo.reshape %v4232 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4234 = stablehlo.reshape %v90 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4237 = stablehlo.broadcast_in_dim %v4235, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4238 = stablehlo.broadcast_in_dim %v4236, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4239 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4240 = stablehlo.add %v4238, %v4239 : tensor<32x64x56x56xf32>
    %v4241 = stablehlo.rsqrt %v4240 : tensor<32x64x56x56xf32>
    %v4242 = stablehlo.subtract %v4234, %v4237 : tensor<32x64x56x56xf32>
    %v4243 = stablehlo.multiply %v4242, %v4241 : tensor<32x64x56x56xf32>
    %v4244 = stablehlo.broadcast_in_dim %s1b0g2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4245 = stablehlo.reshape %v4233 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4246 = stablehlo.multiply %v4244, %v4245 : tensor<32x64x56x56xf32>
    %v4247 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4248 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v4249 = stablehlo.reduce(%v4246 init: %v4247) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4250 = stablehlo.divide %v4249, %v4248 : tensor<64xf32>
    %v4251 = stablehlo.multiply %v4243, %v4246 : tensor<32x64x56x56xf32>
    %v4252 = stablehlo.reduce(%v4251 init: %v4247) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v4256 = stablehlo.reshape %v90 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4261 = stablehlo.broadcast_in_dim %v4257, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4262 = stablehlo.broadcast_in_dim %v4258, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4263 = stablehlo.broadcast_in_dim %v4259, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4264 = stablehlo.broadcast_in_dim %v4260, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4265 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4266 = stablehlo.add %v4262, %v4265 : tensor<32x64x56x56xf32>
    %v4267 = stablehlo.rsqrt %v4266 : tensor<32x64x56x56xf32>
    %v4268 = stablehlo.subtract %v4256, %v4261 : tensor<32x64x56x56xf32>
    %v4269 = stablehlo.multiply %v4268, %v4267 : tensor<32x64x56x56xf32>
    %v4270 = stablehlo.broadcast_in_dim %s1b0g2, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4271 = stablehlo.reshape %v4233 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4272 = stablehlo.multiply %v4270, %v4271 : tensor<32x64x56x56xf32>
    %v4273 = stablehlo.subtract %v4272, %v4263 : tensor<32x64x56x56xf32>
    %v4274 = stablehlo.multiply %v4269, %v4264 : tensor<32x64x56x56xf32>
    %v4275 = stablehlo.subtract %v4273, %v4274 : tensor<32x64x56x56xf32>
    %v4276 = stablehlo.multiply %v4267, %v4275 : tensor<32x64x56x56xf32>
    %v4277 = stablehlo.reshape %v4276 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4278 = stablehlo.reshape %v4277 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4281 = stablehlo.convolution(%v4278, %v4280)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x64x56x56xf32>, tensor<64x64x3x3xf32>) -> tensor<32x64x56x56xf32>
    %v4282 = stablehlo.reshape %v4281 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4283 = stablehlo.reshape %v4282 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4284 = stablehlo.reshape %v83 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4285 = stablehlo.constant dense<0.0> : tensor<32x64x56x56xf32>
    %v4286 = stablehlo.compare GT, %v4284, %v4285 : (tensor<32x64x56x56xf32>, tensor<32x64x56x56xf32>) -> tensor<32x64x56x56xi1>
    %v4287 = stablehlo.select %v4286, %v4283, %v4285 : tensor<32x64x56x56xi1>, tensor<32x64x56x56xf32>
    %v4288 = stablehlo.reshape %v4287 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4289 = stablehlo.reshape %v49 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4290 = stablehlo.slice %v68 [0:64] : (tensor<128xf32>) -> tensor<64xf32>
    %v4291 = stablehlo.slice %v68 [64:128] : (tensor<128xf32>) -> tensor<64xf32>
    %v4292 = stablehlo.broadcast_in_dim %v4290, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4293 = stablehlo.broadcast_in_dim %v4291, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4294 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4295 = stablehlo.add %v4293, %v4294 : tensor<32x64x56x56xf32>
    %v4296 = stablehlo.rsqrt %v4295 : tensor<32x64x56x56xf32>
    %v4297 = stablehlo.subtract %v4289, %v4292 : tensor<32x64x56x56xf32>
    %v4298 = stablehlo.multiply %v4297, %v4296 : tensor<32x64x56x56xf32>
    %v4299 = stablehlo.broadcast_in_dim %s1b0g1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4300 = stablehlo.reshape %v4288 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4301 = stablehlo.multiply %v4299, %v4300 : tensor<32x64x56x56xf32>
    %v4302 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4303 = stablehlo.constant dense<100352.0> : tensor<64xf32>
    %v4304 = stablehlo.reduce(%v4301 init: %v4302) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4305 = stablehlo.divide %v4304, %v4303 : tensor<64xf32>
    %v4306 = stablehlo.multiply %v4298, %v4301 : tensor<32x64x56x56xf32>
    %v4307 = stablehlo.reduce(%v4306 init: %v4302) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v4311 = stablehlo.reshape %v49 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4316 = stablehlo.broadcast_in_dim %v4312, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4317 = stablehlo.broadcast_in_dim %v4313, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4318 = stablehlo.broadcast_in_dim %v4314, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4319 = stablehlo.broadcast_in_dim %v4315, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4320 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4321 = stablehlo.add %v4317, %v4320 : tensor<32x64x56x56xf32>
    %v4322 = stablehlo.rsqrt %v4321 : tensor<32x64x56x56xf32>
    %v4323 = stablehlo.subtract %v4311, %v4316 : tensor<32x64x56x56xf32>
    %v4324 = stablehlo.multiply %v4323, %v4322 : tensor<32x64x56x56xf32>
    %v4325 = stablehlo.broadcast_in_dim %s1b0g1, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4326 = stablehlo.reshape %v4288 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4327 = stablehlo.multiply %v4325, %v4326 : tensor<32x64x56x56xf32>
    %v4328 = stablehlo.subtract %v4327, %v4318 : tensor<32x64x56x56xf32>
    %v4329 = stablehlo.multiply %v4324, %v4319 : tensor<32x64x56x56xf32>
    %v4330 = stablehlo.subtract %v4328, %v4329 : tensor<32x64x56x56xf32>
    %v4331 = stablehlo.multiply %v4322, %v4330 : tensor<32x64x56x56xf32>
    %v4332 = stablehlo.reshape %v4331 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4333 = stablehlo.reshape %v4332 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4336 = stablehlo.convolution(%v4333, %v4335)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<32x64x56x56xf32>, tensor<64x64x3x3xf32>) -> tensor<32x64x56x56xf32>
    %v4337 = stablehlo.reshape %v4336 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4338 = stablehlo.reshape %v4337 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4339 = stablehlo.reshape %v4233 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4340 = stablehlo.add %v4338, %v4339 : tensor<32x64x56x56xf32>
    %v4341 = stablehlo.reshape %v4340 : (tensor<32x64x56x56xf32>) -> tensor<32x200704xf32>
    %v4342 = stablehlo.reshape %v44 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4343 = stablehlo.reshape %v4332 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4344 = stablehlo.transpose %v4342, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    %v4345 = stablehlo.transpose %v4343, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    ...
    %v4348 = stablehlo.reshape %v49 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4349 = stablehlo.slice %v68 [0:64] : (tensor<128xf32>) -> tensor<64xf32>
    %v4350 = stablehlo.slice %v68 [64:128] : (tensor<128xf32>) -> tensor<64xf32>
    %v4351 = stablehlo.broadcast_in_dim %v4349, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4352 = stablehlo.broadcast_in_dim %v4350, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4353 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4354 = stablehlo.add %v4352, %v4353 : tensor<32x64x56x56xf32>
    %v4355 = stablehlo.rsqrt %v4354 : tensor<32x64x56x56xf32>
    %v4356 = stablehlo.subtract %v4348, %v4351 : tensor<32x64x56x56xf32>
    %v4357 = stablehlo.multiply %v4356, %v4355 : tensor<32x64x56x56xf32>
    %v4358 = stablehlo.reshape %v4288 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4359 = stablehlo.multiply %v4358, %v4357 : tensor<32x64x56x56xf32>
    %v4360 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4361 = stablehlo.reduce(%v4359 init: %v4360) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4362 = stablehlo.reshape %v4288 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4363 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4364 = stablehlo.reduce(%v4362 init: %v4363) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4365 = stablehlo.reshape %v85 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4366 = stablehlo.reshape %v4277 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4367 = stablehlo.transpose %v4365, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    %v4368 = stablehlo.transpose %v4366, dims = [1, 0, 2, 3] : (tensor<32x64x56x56xf32>) -> tensor<64x32x56x56xf32>
    ...
    %v4371 = stablehlo.reshape %v90 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4374 = stablehlo.broadcast_in_dim %v4372, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4375 = stablehlo.broadcast_in_dim %v4373, dims = [1] : (tensor<64xf32>) -> tensor<32x64x56x56xf32>
    %v4376 = stablehlo.constant dense<1.0e-05> : tensor<32x64x56x56xf32>
    %v4377 = stablehlo.add %v4375, %v4376 : tensor<32x64x56x56xf32>
    %v4378 = stablehlo.rsqrt %v4377 : tensor<32x64x56x56xf32>
    %v4379 = stablehlo.subtract %v4371, %v4374 : tensor<32x64x56x56xf32>
    %v4380 = stablehlo.multiply %v4379, %v4378 : tensor<32x64x56x56xf32>
    %v4381 = stablehlo.reshape %v4233 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4382 = stablehlo.multiply %v4381, %v4380 : tensor<32x64x56x56xf32>
    %v4383 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4384 = stablehlo.reduce(%v4382 init: %v4383) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4385 = stablehlo.reshape %v4233 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    %v4386 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4387 = stablehlo.reduce(%v4385 init: %v4386) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x56x56xf32>, tensor<f32>) -> tensor<64xf32>
    %v4388 = stablehlo.reshape %v40 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v4389 = stablehlo.reshape %v4341 : (tensor<32x200704xf32>) -> tensor<32x64x56x56xf32>
    ...
    %v4392 = stablehlo.reshape %v4391 : (tensor<32x64x112x112xf32>) -> tensor<32x802816xf32>
    %v4393 = stablehlo.reshape %v4392 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v4394 = stablehlo.reshape %v38 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v4395 = stablehlo.constant dense<0.0> : tensor<32x64x112x112xf32>
    %v4396 = stablehlo.compare GT, %v4394, %v4395 : (tensor<32x64x112x112xf32>, tensor<32x64x112x112xf32>) -> tensor<32x64x112x112xi1>
    %v4397 = stablehlo.select %v4396, %v4393, %v4395 : tensor<32x64x112x112xi1>, tensor<32x64x112x112xf32>
    %v4398 = stablehlo.reshape %v4397 : (tensor<32x64x112x112xf32>) -> tensor<32x802816xf32>
    %v4399 = stablehlo.reshape %v4 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v4400 = stablehlo.slice %v23 [0:64] : (tensor<128xf32>) -> tensor<64xf32>
    %v4401 = stablehlo.slice %v23 [64:128] : (tensor<128xf32>) -> tensor<64xf32>
    %v4402 = stablehlo.broadcast_in_dim %v4400, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v4403 = stablehlo.broadcast_in_dim %v4401, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v4404 = stablehlo.constant dense<1.0e-05> : tensor<32x64x112x112xf32>
    %v4405 = stablehlo.add %v4403, %v4404 : tensor<32x64x112x112xf32>
    %v4406 = stablehlo.rsqrt %v4405 : tensor<32x64x112x112xf32>
    %v4407 = stablehlo.subtract %v4399, %v4402 : tensor<32x64x112x112xf32>
    %v4408 = stablehlo.multiply %v4407, %v4406 : tensor<32x64x112x112xf32>
    %v4409 = stablehlo.broadcast_in_dim %sg, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v4410 = stablehlo.reshape %v4398 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v4411 = stablehlo.multiply %v4409, %v4410 : tensor<32x64x112x112xf32>
    %v4412 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4413 = stablehlo.constant dense<401408.0> : tensor<64xf32>
    %v4414 = stablehlo.reduce(%v4411 init: %v4412) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x112x112xf32>, tensor<f32>) -> tensor<64xf32>
    %v4415 = stablehlo.divide %v4414, %v4413 : tensor<64xf32>
    %v4416 = stablehlo.multiply %v4408, %v4411 : tensor<32x64x112x112xf32>
    %v4417 = stablehlo.reduce(%v4416 init: %v4412) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x112x112xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v4421 = stablehlo.reshape %v4 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    ...
    %v4426 = stablehlo.broadcast_in_dim %v4422, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v4427 = stablehlo.broadcast_in_dim %v4423, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v4428 = stablehlo.broadcast_in_dim %v4424, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v4429 = stablehlo.broadcast_in_dim %v4425, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v4430 = stablehlo.constant dense<1.0e-05> : tensor<32x64x112x112xf32>
    %v4431 = stablehlo.add %v4427, %v4430 : tensor<32x64x112x112xf32>
    %v4432 = stablehlo.rsqrt %v4431 : tensor<32x64x112x112xf32>
    %v4433 = stablehlo.subtract %v4421, %v4426 : tensor<32x64x112x112xf32>
    %v4434 = stablehlo.multiply %v4433, %v4432 : tensor<32x64x112x112xf32>
    %v4435 = stablehlo.broadcast_in_dim %sg, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v4436 = stablehlo.reshape %v4398 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v4437 = stablehlo.multiply %v4435, %v4436 : tensor<32x64x112x112xf32>
    %v4438 = stablehlo.subtract %v4437, %v4428 : tensor<32x64x112x112xf32>
    %v4439 = stablehlo.multiply %v4434, %v4429 : tensor<32x64x112x112xf32>
    %v4440 = stablehlo.subtract %v4438, %v4439 : tensor<32x64x112x112xf32>
    %v4441 = stablehlo.multiply %v4432, %v4440 : tensor<32x64x112x112xf32>
    %v4442 = stablehlo.reshape %v4441 : (tensor<32x64x112x112xf32>) -> tensor<32x802816xf32>
    %v4443 = stablehlo.reshape %x : (tensor<32x150528xf32>) -> tensor<32x3x224x224xf32>
    %v4444 = stablehlo.reshape %v4442 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v4445 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4446 = stablehlo.pad %v4444, %v4445, low = [0, 0, 0, 0], high = [0, 0, 1, 1], interior = [0, 0, 1, 1] : (tensor<32x64x112x112xf32>, tensor<f32>) -> tensor<32x64x224x224xf32>
    %v4447 = stablehlo.transpose %v4443, dims = [1, 0, 2, 3] : (tensor<32x3x224x224xf32>) -> tensor<3x32x224x224xf32>
    %v4448 = stablehlo.transpose %v4446, dims = [1, 0, 2, 3] : (tensor<32x64x224x224xf32>) -> tensor<64x32x224x224xf32>
    ...
    %v4451 = stablehlo.reshape %v4 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v4452 = stablehlo.slice %v23 [0:64] : (tensor<128xf32>) -> tensor<64xf32>
    %v4453 = stablehlo.slice %v23 [64:128] : (tensor<128xf32>) -> tensor<64xf32>
    %v4454 = stablehlo.broadcast_in_dim %v4452, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v4455 = stablehlo.broadcast_in_dim %v4453, dims = [1] : (tensor<64xf32>) -> tensor<32x64x112x112xf32>
    %v4456 = stablehlo.constant dense<1.0e-05> : tensor<32x64x112x112xf32>
    %v4457 = stablehlo.add %v4455, %v4456 : tensor<32x64x112x112xf32>
    %v4458 = stablehlo.rsqrt %v4457 : tensor<32x64x112x112xf32>
    %v4459 = stablehlo.subtract %v4451, %v4454 : tensor<32x64x112x112xf32>
    %v4460 = stablehlo.multiply %v4459, %v4458 : tensor<32x64x112x112xf32>
    %v4461 = stablehlo.reshape %v4398 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v4462 = stablehlo.multiply %v4461, %v4460 : tensor<32x64x112x112xf32>
    %v4463 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4464 = stablehlo.reduce(%v4462 init: %v4463) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x112x112xf32>, tensor<f32>) -> tensor<64xf32>
    %v4465 = stablehlo.reshape %v4398 : (tensor<32x802816xf32>) -> tensor<32x64x112x112xf32>
    %v4466 = stablehlo.constant dense<0.0> : tensor<f32>
    %v4467 = stablehlo.reduce(%v4465 init: %v4466) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<32x64x112x112xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %llog = stablehlo.log %v1569 : tensor<32x10xf32>
