module @m {
  func.func @cnn_2048_train_step(%x: tensor<128x784xf32>, %W1: tensor<32x1x3x3xf32>, %b1: tensor<32xf32>, %W2: tensor<32x32x3x3xf32>, %b2: tensor<32xf32>, %W3: tensor<6272x2048xf32>, %b3: tensor<2048xf32>, %W4: tensor<2048x2048xf32>, %b4: tensor<2048xf32>, %W5: tensor<2048x10xf32>, %b5: tensor<10xf32>, %onehot: tensor<128x10xf32>) -> (tensor<32x1x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<6272x2048xf32>, tensor<2048xf32>, tensor<2048x2048xf32>, tensor<2048xf32>, tensor<2048x10xf32>, tensor<10xf32>) {
    ...
    %v18 = stablehlo.dot_general %v17, %W3, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x6272xf32>, tensor<6272x2048xf32>) -> tensor<128x2048xf32>
    %v19 = stablehlo.broadcast_in_dim %b3, dims = [1] : (tensor<2048xf32>) -> tensor<128x2048xf32>
    %v20 = stablehlo.add %v18, %v19 : tensor<128x2048xf32>
    %v21 = stablehlo.constant dense<0.0> : tensor<128x2048xf32>
    %v22 = stablehlo.maximum %v20, %v21 : tensor<128x2048xf32>
    %v23 = stablehlo.dot_general %v22, %W4, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x2048xf32>, tensor<2048x2048xf32>) -> tensor<128x2048xf32>
    %v24 = stablehlo.broadcast_in_dim %b4, dims = [1] : (tensor<2048xf32>) -> tensor<128x2048xf32>
    %v25 = stablehlo.add %v23, %v24 : tensor<128x2048xf32>
    %v26 = stablehlo.constant dense<0.0> : tensor<128x2048xf32>
    %v27 = stablehlo.maximum %v25, %v26 : tensor<128x2048xf32>
    %v28 = stablehlo.dot_general %v27, %W5, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x2048xf32>, tensor<2048x10xf32>) -> tensor<128x10xf32>
    ...
    %v37 = stablehlo.dot_general %v36, %W5, contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<128x10xf32>, tensor<2048x10xf32>) -> tensor<128x2048xf32>
    %v38 = stablehlo.constant dense<0.0> : tensor<128x2048xf32>
    %v39 = stablehlo.compare GT, %v25, %v38 : (tensor<128x2048xf32>, tensor<128x2048xf32>) -> tensor<128x2048xi1>
    %v40 = stablehlo.select %v39, %v37, %v38 : tensor<128x2048xi1>, tensor<128x2048xf32>
    %v41 = stablehlo.dot_general %v40, %W4, contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<128x2048xf32>, tensor<2048x2048xf32>) -> tensor<128x2048xf32>
    %v42 = stablehlo.constant dense<0.0> : tensor<128x2048xf32>
    %v43 = stablehlo.compare GT, %v20, %v42 : (tensor<128x2048xf32>, tensor<128x2048xf32>) -> tensor<128x2048xi1>
    %v44 = stablehlo.select %v43, %v41, %v42 : tensor<128x2048xi1>, tensor<128x2048xf32>
    %v45 = stablehlo.dot_general %v44, %W3, contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<128x2048xf32>, tensor<6272x2048xf32>) -> tensor<128x6272xf32>
    ...
    %v80 = stablehlo.dot_general %v17, %v44, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x6272xf32>, tensor<128x2048xf32>) -> tensor<6272x2048xf32>
    %v81 = stablehlo.constant dense<0.00078125> : tensor<6272x2048xf32>
    %v82 = stablehlo.multiply %v80, %v81 : tensor<6272x2048xf32>
    %v83 = stablehlo.subtract %W3, %v82 : tensor<6272x2048xf32>
    %v84 = stablehlo.constant dense<0.0> : tensor<f32>
    %v85 = stablehlo.reduce(%v44 init: %v84) applies stablehlo.add across dimensions = [0] : (tensor<128x2048xf32>, tensor<f32>) -> tensor<2048xf32>
    %v86 = stablehlo.constant dense<0.00078125> : tensor<2048xf32>
    %v87 = stablehlo.multiply %v85, %v86 : tensor<2048xf32>
    %v88 = stablehlo.subtract %b3, %v87 : tensor<2048xf32>
    %v71 = stablehlo.dot_general %v22, %v40, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x2048xf32>, tensor<128x2048xf32>) -> tensor<2048x2048xf32>
    %v72 = stablehlo.constant dense<0.00078125> : tensor<2048x2048xf32>
    %v73 = stablehlo.multiply %v71, %v72 : tensor<2048x2048xf32>
    %v74 = stablehlo.subtract %W4, %v73 : tensor<2048x2048xf32>
    %v75 = stablehlo.constant dense<0.0> : tensor<f32>
    %v76 = stablehlo.reduce(%v40 init: %v75) applies stablehlo.add across dimensions = [0] : (tensor<128x2048xf32>, tensor<f32>) -> tensor<2048xf32>
    %v77 = stablehlo.constant dense<0.00078125> : tensor<2048xf32>
    %v78 = stablehlo.multiply %v76, %v77 : tensor<2048xf32>
    %v79 = stablehlo.subtract %b4, %v78 : tensor<2048xf32>
    %v62 = stablehlo.dot_general %v27, %v36, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x2048xf32>, tensor<128x10xf32>) -> tensor<2048x10xf32>
    %v63 = stablehlo.constant dense<0.00078125> : tensor<2048x10xf32>
    %v64 = stablehlo.multiply %v62, %v63 : tensor<2048x10xf32>
    %v65 = stablehlo.subtract %W5, %v64 : tensor<2048x10xf32>
    ...
    return %v112, %v118, %v97, %v103, %v83, %v88, %v74, %v79, %v65, %v70 : tensor<32x1x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<6272x2048xf32>, tensor<2048xf32>, tensor<2048x2048xf32>, tensor<2048xf32>, tensor<2048x10xf32>, tensor<10xf32>
  }
}
