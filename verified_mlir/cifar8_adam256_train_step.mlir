module @m {
  func.func @cifar8_adam_train_step(%x: tensor<256x3072xf32>, %W1: tensor<16x3x3x3xf32>, %cb1: tensor<16xf32>, %W2: tensor<16x16x3x3xf32>, %cb2: tensor<16xf32>, %W3: tensor<16x16x3x3xf32>, %cb3: tensor<16xf32>, %W4: tensor<16x16x3x3xf32>, %cb4: tensor<16xf32>, %W5: tensor<32x16x3x3xf32>, %cb5: tensor<32xf32>, %W6: tensor<32x32x3x3xf32>, %cb6: tensor<32xf32>, %W7: tensor<32x32x3x3xf32>, %cb7: tensor<32xf32>, %W8: tensor<32x32x3x3xf32>, %cb8: tensor<32xf32>, %W9: tensor<128x64xf32>, %b9: tensor<64xf32>, %Wa: tensor<64x64xf32>, %ba: tensor<64xf32>, %Wb: tensor<64x10xf32>, %bb: tensor<10xf32>, %W1m: tensor<16x3x3x3xf32>, %cb1m: tensor<16xf32>, %W2m: tensor<16x16x3x3xf32>, %cb2m: tensor<16xf32>, %W3m: tensor<16x16x3x3xf32>, %cb3m: tensor<16xf32>, %W4m: tensor<16x16x3x3xf32>, %cb4m: tensor<16xf32>, %W5m: tensor<32x16x3x3xf32>, %cb5m: tensor<32xf32>, %W6m: tensor<32x32x3x3xf32>, %cb6m: tensor<32xf32>, %W7m: tensor<32x32x3x3xf32>, %cb7m: tensor<32xf32>, %W8m: tensor<32x32x3x3xf32>, %cb8m: tensor<32xf32>, %W9m: tensor<128x64xf32>, %b9m: tensor<64xf32>, %Wam: tensor<64x64xf32>, %bam: tensor<64xf32>, %Wbm: tensor<64x10xf32>, %bbm: tensor<10xf32>, %W1v: tensor<16x3x3x3xf32>, %cb1v: tensor<16xf32>, %W2v: tensor<16x16x3x3xf32>, %cb2v: tensor<16xf32>, %W3v: tensor<16x16x3x3xf32>, %cb3v: tensor<16xf32>, %W4v: tensor<16x16x3x3xf32>, %cb4v: tensor<16xf32>, %W5v: tensor<32x16x3x3xf32>, %cb5v: tensor<32xf32>, %W6v: tensor<32x32x3x3xf32>, %cb6v: tensor<32xf32>, %W7v: tensor<32x32x3x3xf32>, %cb7v: tensor<32xf32>, %W8v: tensor<32x32x3x3xf32>, %cb8v: tensor<32xf32>, %W9v: tensor<128x64xf32>, %b9v: tensor<64xf32>, %Wav: tensor<64x64xf32>, %bav: tensor<64xf32>, %Wbv: tensor<64x10xf32>, %bbv: tensor<10xf32>, %lr: tensor<f32>, %bc1: tensor<f32>, %bc2: tensor<f32>, %onehot: tensor<256x10xf32>) -> (tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<64xf32>, tensor<64x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>) {
    ...
    %v5 = stablehlo.reshape %v4 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v6 = stablehlo.constant dense<0.0> : tensor<256x16x32x32xf32>
    %v7 = stablehlo.maximum %v5, %v6 : tensor<256x16x32x32xf32>
    %v8 = stablehlo.reshape %v7 : (tensor<256x16x32x32xf32>) -> tensor<256x16384xf32>
    %v9 = stablehlo.reshape %v8 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    ...
    %v11 = stablehlo.broadcast_in_dim %cb2, dims = [1] : (tensor<16xf32>) -> tensor<256x16x32x32xf32>
    %v12 = stablehlo.add %v10, %v11 : tensor<256x16x32x32xf32>
    %v13 = stablehlo.reshape %v12 : (tensor<256x16x32x32xf32>) -> tensor<256x16384xf32>
    %v14 = stablehlo.reshape %v13 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v15 = stablehlo.constant dense<0.0> : tensor<256x16x32x32xf32>
    %v16 = stablehlo.maximum %v14, %v15 : tensor<256x16x32x32xf32>
    %v17 = stablehlo.reshape %v16 : (tensor<256x16x32x32xf32>) -> tensor<256x16384xf32>
    %v18 = stablehlo.reshape %v17 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    ...
    %v21 = stablehlo.reshape %v20 : (tensor<256x16x16x16xf32>) -> tensor<256x4096xf32>
    %v22 = stablehlo.reshape %v21 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    ...
    %v24 = stablehlo.broadcast_in_dim %cb3, dims = [1] : (tensor<16xf32>) -> tensor<256x16x16x16xf32>
    %v25 = stablehlo.add %v23, %v24 : tensor<256x16x16x16xf32>
    %v26 = stablehlo.reshape %v25 : (tensor<256x16x16x16xf32>) -> tensor<256x4096xf32>
    %v27 = stablehlo.reshape %v26 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v28 = stablehlo.constant dense<0.0> : tensor<256x16x16x16xf32>
    %v29 = stablehlo.maximum %v27, %v28 : tensor<256x16x16x16xf32>
    %v30 = stablehlo.reshape %v29 : (tensor<256x16x16x16xf32>) -> tensor<256x4096xf32>
    %v31 = stablehlo.reshape %v30 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v32 = stablehlo.convolution(%v31, %W4)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<256x16x16x16xf32>, tensor<16x16x3x3xf32>) -> tensor<256x16x16x16xf32>
    %v33 = stablehlo.broadcast_in_dim %cb4, dims = [1] : (tensor<16xf32>) -> tensor<256x16x16x16xf32>
    %v34 = stablehlo.add %v32, %v33 : tensor<256x16x16x16xf32>
    %v35 = stablehlo.reshape %v34 : (tensor<256x16x16x16xf32>) -> tensor<256x4096xf32>
    %v36 = stablehlo.reshape %v35 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v37 = stablehlo.constant dense<0.0> : tensor<256x16x16x16xf32>
    %v38 = stablehlo.maximum %v36, %v37 : tensor<256x16x16x16xf32>
    %v39 = stablehlo.reshape %v38 : (tensor<256x16x16x16xf32>) -> tensor<256x4096xf32>
    %v40 = stablehlo.reshape %v39 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    ...
    %v43 = stablehlo.reshape %v42 : (tensor<256x16x8x8xf32>) -> tensor<256x1024xf32>
    %v44 = stablehlo.reshape %v43 : (tensor<256x1024xf32>) -> tensor<256x16x8x8xf32>
    ...
    %v46 = stablehlo.broadcast_in_dim %cb5, dims = [1] : (tensor<32xf32>) -> tensor<256x32x8x8xf32>
    %v47 = stablehlo.add %v45, %v46 : tensor<256x32x8x8xf32>
    %v48 = stablehlo.reshape %v47 : (tensor<256x32x8x8xf32>) -> tensor<256x2048xf32>
    %v49 = stablehlo.reshape %v48 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v50 = stablehlo.constant dense<0.0> : tensor<256x32x8x8xf32>
    %v51 = stablehlo.maximum %v49, %v50 : tensor<256x32x8x8xf32>
    %v52 = stablehlo.reshape %v51 : (tensor<256x32x8x8xf32>) -> tensor<256x2048xf32>
    %v53 = stablehlo.reshape %v52 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    ...
    %v55 = stablehlo.broadcast_in_dim %cb6, dims = [1] : (tensor<32xf32>) -> tensor<256x32x8x8xf32>
    %v56 = stablehlo.add %v54, %v55 : tensor<256x32x8x8xf32>
    %v57 = stablehlo.reshape %v56 : (tensor<256x32x8x8xf32>) -> tensor<256x2048xf32>
    %v58 = stablehlo.reshape %v57 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v59 = stablehlo.constant dense<0.0> : tensor<256x32x8x8xf32>
    %v60 = stablehlo.maximum %v58, %v59 : tensor<256x32x8x8xf32>
    %v61 = stablehlo.reshape %v60 : (tensor<256x32x8x8xf32>) -> tensor<256x2048xf32>
    %v62 = stablehlo.reshape %v61 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    ...
    %v66 = stablehlo.reshape %v65 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    ...
    %v68 = stablehlo.broadcast_in_dim %cb7, dims = [1] : (tensor<32xf32>) -> tensor<256x32x4x4xf32>
    %v69 = stablehlo.add %v67, %v68 : tensor<256x32x4x4xf32>
    %v70 = stablehlo.reshape %v69 : (tensor<256x32x4x4xf32>) -> tensor<256x512xf32>
    %v71 = stablehlo.reshape %v70 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v72 = stablehlo.constant dense<0.0> : tensor<256x32x4x4xf32>
    %v73 = stablehlo.maximum %v71, %v72 : tensor<256x32x4x4xf32>
    %v74 = stablehlo.reshape %v73 : (tensor<256x32x4x4xf32>) -> tensor<256x512xf32>
    %v75 = stablehlo.reshape %v74 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v76 = stablehlo.convolution(%v75, %W8)
      dim_numbers = [b, f, 0, 1]x[o, i, 0, 1]->[b, f, 0, 1],
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<256x32x4x4xf32>, tensor<32x32x3x3xf32>) -> tensor<256x32x4x4xf32>
    %v77 = stablehlo.broadcast_in_dim %cb8, dims = [1] : (tensor<32xf32>) -> tensor<256x32x4x4xf32>
    %v78 = stablehlo.add %v76, %v77 : tensor<256x32x4x4xf32>
    %v79 = stablehlo.reshape %v78 : (tensor<256x32x4x4xf32>) -> tensor<256x512xf32>
    %v80 = stablehlo.reshape %v79 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v81 = stablehlo.constant dense<0.0> : tensor<256x32x4x4xf32>
    %v82 = stablehlo.maximum %v80, %v81 : tensor<256x32x4x4xf32>
    %v83 = stablehlo.reshape %v82 : (tensor<256x32x4x4xf32>) -> tensor<256x512xf32>
    %v84 = stablehlo.reshape %v83 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    ...
    %v87 = stablehlo.reshape %v86 : (tensor<256x32x2x2xf32>) -> tensor<256x128xf32>
    %v88 = stablehlo.dot_general %v87, %W9, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<256x128xf32>, tensor<128x64xf32>) -> tensor<256x64xf32>
    %v89 = stablehlo.broadcast_in_dim %b9, dims = [1] : (tensor<64xf32>) -> tensor<256x64xf32>
    %v90 = stablehlo.add %v88, %v89 : tensor<256x64xf32>
    %v91 = stablehlo.constant dense<0.0> : tensor<256x64xf32>
    %v92 = stablehlo.maximum %v90, %v91 : tensor<256x64xf32>
    %v93 = stablehlo.dot_general %v92, %Wa, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<256x64xf32>, tensor<64x64xf32>) -> tensor<256x64xf32>
    %v94 = stablehlo.broadcast_in_dim %ba, dims = [1] : (tensor<64xf32>) -> tensor<256x64xf32>
    %v95 = stablehlo.add %v93, %v94 : tensor<256x64xf32>
    %v96 = stablehlo.constant dense<0.0> : tensor<256x64xf32>
    %v97 = stablehlo.maximum %v95, %v96 : tensor<256x64xf32>
    %v98 = stablehlo.dot_general %v97, %Wb, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<256x64xf32>, tensor<64x10xf32>) -> tensor<256x10xf32>
    %v99 = stablehlo.broadcast_in_dim %bb, dims = [1] : (tensor<10xf32>) -> tensor<256x10xf32>
    %v100 = stablehlo.add %v98, %v99 : tensor<256x10xf32>
    %v101 = stablehlo.exponential %v100 : tensor<256x10xf32>
    %v102 = stablehlo.constant dense<0.0> : tensor<f32>
    %v103 = stablehlo.reduce(%v101 init: %v102) applies stablehlo.add across dimensions = [1] : (tensor<256x10xf32>, tensor<f32>) -> tensor<256xf32>
    %v104 = stablehlo.broadcast_in_dim %v103, dims = [0] : (tensor<256xf32>) -> tensor<256x10xf32>
    %v105 = stablehlo.divide %v101, %v104 : tensor<256x10xf32>
    %v106 = stablehlo.subtract %v105, %onehot : tensor<256x10xf32>
    %v107 = stablehlo.constant dense<0.00390625> : tensor<256x10xf32>
    %v108 = stablehlo.multiply %v106, %v107 : tensor<256x10xf32>
    ...
    %llog = stablehlo.log %v105 : tensor<256x10xf32>
    ...
    %v109 = stablehlo.dot_general %v108, %Wb, contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<256x10xf32>, tensor<64x10xf32>) -> tensor<256x64xf32>
    %v110 = stablehlo.constant dense<0.0> : tensor<256x64xf32>
    %v111 = stablehlo.compare GT, %v95, %v110 : (tensor<256x64xf32>, tensor<256x64xf32>) -> tensor<256x64xi1>
    %v112 = stablehlo.select %v111, %v109, %v110 : tensor<256x64xi1>, tensor<256x64xf32>
    %v113 = stablehlo.dot_general %v112, %Wa, contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<256x64xf32>, tensor<64x64xf32>) -> tensor<256x64xf32>
    %v114 = stablehlo.constant dense<0.0> : tensor<256x64xf32>
    %v115 = stablehlo.compare GT, %v90, %v114 : (tensor<256x64xf32>, tensor<256x64xf32>) -> tensor<256x64xi1>
    %v116 = stablehlo.select %v115, %v113, %v114 : tensor<256x64xi1>, tensor<256x64xf32>
    %v117 = stablehlo.dot_general %v116, %W9, contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<256x64xf32>, tensor<128x64xf32>) -> tensor<256x128xf32>
    %v118 = stablehlo.reshape %v83 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v119 = stablehlo.reshape %v117 : (tensor<256x128xf32>) -> tensor<256x32x2x2xf32>
    ...
    %v123 = stablehlo.reshape %v122 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v124 = stablehlo.reshape %v79 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v125 = stablehlo.constant dense<0.0> : tensor<256x32x4x4xf32>
    %v126 = stablehlo.compare GT, %v124, %v125 : (tensor<256x32x4x4xf32>, tensor<256x32x4x4xf32>) -> tensor<256x32x4x4xi1>
    %v127 = stablehlo.select %v126, %v123, %v125 : tensor<256x32x4x4xi1>, tensor<256x32x4x4xf32>
    %v128 = stablehlo.reshape %v127 : (tensor<256x32x4x4xf32>) -> tensor<256x512xf32>
    %v129 = stablehlo.reshape %v128 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    ...
    %v132 = stablehlo.convolution(%v129, %v131)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<256x32x4x4xf32>, tensor<32x32x3x3xf32>) -> tensor<256x32x4x4xf32>
    %v133 = stablehlo.reshape %v132 : (tensor<256x32x4x4xf32>) -> tensor<256x512xf32>
    %v134 = stablehlo.reshape %v133 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v135 = stablehlo.reshape %v70 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v136 = stablehlo.constant dense<0.0> : tensor<256x32x4x4xf32>
    %v137 = stablehlo.compare GT, %v135, %v136 : (tensor<256x32x4x4xf32>, tensor<256x32x4x4xf32>) -> tensor<256x32x4x4xi1>
    %v138 = stablehlo.select %v137, %v134, %v136 : tensor<256x32x4x4xi1>, tensor<256x32x4x4xf32>
    %v139 = stablehlo.reshape %v138 : (tensor<256x32x4x4xf32>) -> tensor<256x512xf32>
    %v140 = stablehlo.reshape %v139 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    ...
    %v143 = stablehlo.convolution(%v140, %v142)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<256x32x4x4xf32>, tensor<32x32x3x3xf32>) -> tensor<256x32x4x4xf32>
    %v144 = stablehlo.reshape %v143 : (tensor<256x32x4x4xf32>) -> tensor<256x512xf32>
    %v145 = stablehlo.reshape %v61 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v146 = stablehlo.reshape %v144 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    ...
    %v149 = stablehlo.reshape %v148 : (tensor<256x32x8x8xf32>) -> tensor<256x2048xf32>
    %v150 = stablehlo.reshape %v149 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v151 = stablehlo.reshape %v57 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v152 = stablehlo.constant dense<0.0> : tensor<256x32x8x8xf32>
    %v153 = stablehlo.compare GT, %v151, %v152 : (tensor<256x32x8x8xf32>, tensor<256x32x8x8xf32>) -> tensor<256x32x8x8xi1>
    %v154 = stablehlo.select %v153, %v150, %v152 : tensor<256x32x8x8xi1>, tensor<256x32x8x8xf32>
    %v155 = stablehlo.reshape %v154 : (tensor<256x32x8x8xf32>) -> tensor<256x2048xf32>
    %v156 = stablehlo.reshape %v155 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    ...
    %v159 = stablehlo.convolution(%v156, %v158)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<256x32x8x8xf32>, tensor<32x32x3x3xf32>) -> tensor<256x32x8x8xf32>
    %v160 = stablehlo.reshape %v159 : (tensor<256x32x8x8xf32>) -> tensor<256x2048xf32>
    %v161 = stablehlo.reshape %v160 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v162 = stablehlo.reshape %v48 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v163 = stablehlo.constant dense<0.0> : tensor<256x32x8x8xf32>
    %v164 = stablehlo.compare GT, %v162, %v163 : (tensor<256x32x8x8xf32>, tensor<256x32x8x8xf32>) -> tensor<256x32x8x8xi1>
    %v165 = stablehlo.select %v164, %v161, %v163 : tensor<256x32x8x8xi1>, tensor<256x32x8x8xf32>
    %v166 = stablehlo.reshape %v165 : (tensor<256x32x8x8xf32>) -> tensor<256x2048xf32>
    %v167 = stablehlo.reshape %v166 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    ...
    %v171 = stablehlo.reshape %v170 : (tensor<256x16x8x8xf32>) -> tensor<256x1024xf32>
    %v172 = stablehlo.reshape %v39 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v173 = stablehlo.reshape %v171 : (tensor<256x1024xf32>) -> tensor<256x16x8x8xf32>
    ...
    %v176 = stablehlo.reshape %v175 : (tensor<256x16x16x16xf32>) -> tensor<256x4096xf32>
    %v177 = stablehlo.reshape %v176 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v178 = stablehlo.reshape %v35 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v179 = stablehlo.constant dense<0.0> : tensor<256x16x16x16xf32>
    %v180 = stablehlo.compare GT, %v178, %v179 : (tensor<256x16x16x16xf32>, tensor<256x16x16x16xf32>) -> tensor<256x16x16x16xi1>
    %v181 = stablehlo.select %v180, %v177, %v179 : tensor<256x16x16x16xi1>, tensor<256x16x16x16xf32>
    %v182 = stablehlo.reshape %v181 : (tensor<256x16x16x16xf32>) -> tensor<256x4096xf32>
    %v183 = stablehlo.reshape %v182 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    ...
    %v186 = stablehlo.convolution(%v183, %v185)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<256x16x16x16xf32>, tensor<16x16x3x3xf32>) -> tensor<256x16x16x16xf32>
    %v187 = stablehlo.reshape %v186 : (tensor<256x16x16x16xf32>) -> tensor<256x4096xf32>
    %v188 = stablehlo.reshape %v187 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v189 = stablehlo.reshape %v26 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v190 = stablehlo.constant dense<0.0> : tensor<256x16x16x16xf32>
    %v191 = stablehlo.compare GT, %v189, %v190 : (tensor<256x16x16x16xf32>, tensor<256x16x16x16xf32>) -> tensor<256x16x16x16xi1>
    %v192 = stablehlo.select %v191, %v188, %v190 : tensor<256x16x16x16xi1>, tensor<256x16x16x16xf32>
    %v193 = stablehlo.reshape %v192 : (tensor<256x16x16x16xf32>) -> tensor<256x4096xf32>
    %v194 = stablehlo.reshape %v193 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    ...
    %v197 = stablehlo.convolution(%v194, %v196)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<256x16x16x16xf32>, tensor<16x16x3x3xf32>) -> tensor<256x16x16x16xf32>
    %v198 = stablehlo.reshape %v197 : (tensor<256x16x16x16xf32>) -> tensor<256x4096xf32>
    %v199 = stablehlo.reshape %v17 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v200 = stablehlo.reshape %v198 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    ...
    %v203 = stablehlo.reshape %v202 : (tensor<256x16x32x32xf32>) -> tensor<256x16384xf32>
    %v204 = stablehlo.reshape %v203 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v205 = stablehlo.reshape %v13 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v206 = stablehlo.constant dense<0.0> : tensor<256x16x32x32xf32>
    %v207 = stablehlo.compare GT, %v205, %v206 : (tensor<256x16x32x32xf32>, tensor<256x16x32x32xf32>) -> tensor<256x16x32x32xi1>
    %v208 = stablehlo.select %v207, %v204, %v206 : tensor<256x16x32x32xi1>, tensor<256x16x32x32xf32>
    %v209 = stablehlo.reshape %v208 : (tensor<256x16x32x32xf32>) -> tensor<256x16384xf32>
    %v210 = stablehlo.reshape %v209 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    ...
    %v213 = stablehlo.convolution(%v210, %v212)
      ...
      window = {stride = [1, 1], pad = [[1, 1], [1, 1]], lhs_dilate = [1, 1], rhs_dilate = [1, 1]}
      {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<256x16x32x32xf32>, tensor<16x16x3x3xf32>) -> tensor<256x16x32x32xf32>
    %v214 = stablehlo.reshape %v213 : (tensor<256x16x32x32xf32>) -> tensor<256x16384xf32>
    %v215 = stablehlo.reshape %v214 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v216 = stablehlo.reshape %v4 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v217 = stablehlo.constant dense<0.0> : tensor<256x16x32x32xf32>
    %v218 = stablehlo.compare GT, %v216, %v217 : (tensor<256x16x32x32xf32>, tensor<256x16x32x32xf32>) -> tensor<256x16x32x32xi1>
    %v219 = stablehlo.select %v218, %v215, %v217 : tensor<256x16x32x32xi1>, tensor<256x16x32x32xf32>
    %v220 = stablehlo.reshape %v219 : (tensor<256x16x32x32xf32>) -> tensor<256x16384xf32>
    %v221 = stablehlo.reshape %x : (tensor<256x3072xf32>) -> tensor<256x3x32x32xf32>
    %v222 = stablehlo.reshape %v220 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v223 = stablehlo.transpose %v221, dims = [1, 0, 2, 3] : (tensor<256x3x32x32xf32>) -> tensor<3x256x32x32xf32>
    %v224 = stablehlo.transpose %v222, dims = [1, 0, 2, 3] : (tensor<256x16x32x32xf32>) -> tensor<16x256x32x32xf32>
    ...
    %v264 = stablehlo.reshape %v220 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v265 = stablehlo.constant dense<0.0> : tensor<f32>
    %v266 = stablehlo.reduce(%v264 init: %v265) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<256x16x32x32xf32>, tensor<f32>) -> tensor<16xf32>
    ...
    %v304 = stablehlo.reshape %v8 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v305 = stablehlo.reshape %v209 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v306 = stablehlo.transpose %v304, dims = [1, 0, 2, 3] : (tensor<256x16x32x32xf32>) -> tensor<16x256x32x32xf32>
    %v307 = stablehlo.transpose %v305, dims = [1, 0, 2, 3] : (tensor<256x16x32x32xf32>) -> tensor<16x256x32x32xf32>
    ...
    %v347 = stablehlo.reshape %v209 : (tensor<256x16384xf32>) -> tensor<256x16x32x32xf32>
    %v348 = stablehlo.constant dense<0.0> : tensor<f32>
    %v349 = stablehlo.reduce(%v347 init: %v348) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<256x16x32x32xf32>, tensor<f32>) -> tensor<16xf32>
    ...
    %v387 = stablehlo.reshape %v21 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v388 = stablehlo.reshape %v193 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v389 = stablehlo.transpose %v387, dims = [1, 0, 2, 3] : (tensor<256x16x16x16xf32>) -> tensor<16x256x16x16xf32>
    %v390 = stablehlo.transpose %v388, dims = [1, 0, 2, 3] : (tensor<256x16x16x16xf32>) -> tensor<16x256x16x16xf32>
    ...
    %v430 = stablehlo.reshape %v193 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v431 = stablehlo.constant dense<0.0> : tensor<f32>
    %v432 = stablehlo.reduce(%v430 init: %v431) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<256x16x16x16xf32>, tensor<f32>) -> tensor<16xf32>
    ...
    %v470 = stablehlo.reshape %v30 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v471 = stablehlo.reshape %v182 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v472 = stablehlo.transpose %v470, dims = [1, 0, 2, 3] : (tensor<256x16x16x16xf32>) -> tensor<16x256x16x16xf32>
    %v473 = stablehlo.transpose %v471, dims = [1, 0, 2, 3] : (tensor<256x16x16x16xf32>) -> tensor<16x256x16x16xf32>
    ...
    %v513 = stablehlo.reshape %v182 : (tensor<256x4096xf32>) -> tensor<256x16x16x16xf32>
    %v514 = stablehlo.constant dense<0.0> : tensor<f32>
    %v515 = stablehlo.reduce(%v513 init: %v514) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<256x16x16x16xf32>, tensor<f32>) -> tensor<16xf32>
    ...
    %v553 = stablehlo.reshape %v43 : (tensor<256x1024xf32>) -> tensor<256x16x8x8xf32>
    %v554 = stablehlo.reshape %v166 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v555 = stablehlo.transpose %v553, dims = [1, 0, 2, 3] : (tensor<256x16x8x8xf32>) -> tensor<16x256x8x8xf32>
    %v556 = stablehlo.transpose %v554, dims = [1, 0, 2, 3] : (tensor<256x32x8x8xf32>) -> tensor<32x256x8x8xf32>
    ...
    %v596 = stablehlo.reshape %v166 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v597 = stablehlo.constant dense<0.0> : tensor<f32>
    %v598 = stablehlo.reduce(%v596 init: %v597) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<256x32x8x8xf32>, tensor<f32>) -> tensor<32xf32>
    ...
    %v636 = stablehlo.reshape %v52 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v637 = stablehlo.reshape %v155 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v638 = stablehlo.transpose %v636, dims = [1, 0, 2, 3] : (tensor<256x32x8x8xf32>) -> tensor<32x256x8x8xf32>
    %v639 = stablehlo.transpose %v637, dims = [1, 0, 2, 3] : (tensor<256x32x8x8xf32>) -> tensor<32x256x8x8xf32>
    ...
    %v679 = stablehlo.reshape %v155 : (tensor<256x2048xf32>) -> tensor<256x32x8x8xf32>
    %v680 = stablehlo.constant dense<0.0> : tensor<f32>
    %v681 = stablehlo.reduce(%v679 init: %v680) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<256x32x8x8xf32>, tensor<f32>) -> tensor<32xf32>
    ...
    %v719 = stablehlo.reshape %v65 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v720 = stablehlo.reshape %v139 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v721 = stablehlo.transpose %v719, dims = [1, 0, 2, 3] : (tensor<256x32x4x4xf32>) -> tensor<32x256x4x4xf32>
    %v722 = stablehlo.transpose %v720, dims = [1, 0, 2, 3] : (tensor<256x32x4x4xf32>) -> tensor<32x256x4x4xf32>
    ...
    %v762 = stablehlo.reshape %v139 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v763 = stablehlo.constant dense<0.0> : tensor<f32>
    %v764 = stablehlo.reduce(%v762 init: %v763) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<256x32x4x4xf32>, tensor<f32>) -> tensor<32xf32>
    ...
    %v802 = stablehlo.reshape %v74 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v803 = stablehlo.reshape %v128 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v804 = stablehlo.transpose %v802, dims = [1, 0, 2, 3] : (tensor<256x32x4x4xf32>) -> tensor<32x256x4x4xf32>
    %v805 = stablehlo.transpose %v803, dims = [1, 0, 2, 3] : (tensor<256x32x4x4xf32>) -> tensor<32x256x4x4xf32>
    ...
    %v845 = stablehlo.reshape %v128 : (tensor<256x512xf32>) -> tensor<256x32x4x4xf32>
    %v846 = stablehlo.constant dense<0.0> : tensor<f32>
    %v847 = stablehlo.reduce(%v845 init: %v846) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<256x32x4x4xf32>, tensor<f32>) -> tensor<32xf32>
    ...
    %v885 = stablehlo.dot_general %v87, %v116, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<256x128xf32>, tensor<256x64xf32>) -> tensor<128x64xf32>
    ...
    %v924 = stablehlo.reduce(%v116 init: %v923) applies stablehlo.add across dimensions = [0] : (tensor<256x64xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v962 = stablehlo.dot_general %v92, %v112, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<256x64xf32>, tensor<256x64xf32>) -> tensor<64x64xf32>
    ...
    %v1001 = stablehlo.reduce(%v112 init: %v1000) applies stablehlo.add across dimensions = [0] : (tensor<256x64xf32>, tensor<f32>) -> tensor<64xf32>
    ...
    %v1039 = stablehlo.dot_general %v97, %v108, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<256x64xf32>, tensor<256x10xf32>) -> tensor<64x10xf32>
    ...
    %v1078 = stablehlo.reduce(%v108 init: %v1077) applies stablehlo.add across dimensions = [0] : (tensor<256x10xf32>, tensor<f32>) -> tensor<10xf32>
