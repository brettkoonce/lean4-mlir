module @m {
  func.func @cifar8_bn_128_adam_train_step(%x: tensor<128x3072xf32>, %W1: tensor<16x3x3x3xf32>, %cb1: tensor<16xf32>, %g1: tensor<16xf32>, %bt1: tensor<16xf32>, %W2: tensor<16x16x3x3xf32>, %cb2: tensor<16xf32>, %g2: tensor<16xf32>, %bt2: tensor<16xf32>, %W3: tensor<16x16x3x3xf32>, %cb3: tensor<16xf32>, %g3: tensor<16xf32>, %bt3: tensor<16xf32>, %W4: tensor<16x16x3x3xf32>, %cb4: tensor<16xf32>, %g4: tensor<16xf32>, %bt4: tensor<16xf32>, %W5: tensor<32x16x3x3xf32>, %cb5: tensor<32xf32>, %g5: tensor<32xf32>, %bt5: tensor<32xf32>, %W6: tensor<32x32x3x3xf32>, %cb6: tensor<32xf32>, %g6: tensor<32xf32>, %bt6: tensor<32xf32>, %W7: tensor<32x32x3x3xf32>, %cb7: tensor<32xf32>, %g7: tensor<32xf32>, %bt7: tensor<32xf32>, %W8: tensor<32x32x3x3xf32>, %cb8: tensor<32xf32>, %g8: tensor<32xf32>, %bt8: tensor<32xf32>, %W9: tensor<128x128xf32>, %b9: tensor<128xf32>, %Wa: tensor<128x128xf32>, %ba: tensor<128xf32>, %Wb: tensor<128x10xf32>, %bb: tensor<10xf32>, %W1m: tensor<16x3x3x3xf32>, %cb1m: tensor<16xf32>, %g1m: tensor<16xf32>, %bt1m: tensor<16xf32>, %W2m: tensor<16x16x3x3xf32>, %cb2m: tensor<16xf32>, %g2m: tensor<16xf32>, %bt2m: tensor<16xf32>, %W3m: tensor<16x16x3x3xf32>, %cb3m: tensor<16xf32>, %g3m: tensor<16xf32>, %bt3m: tensor<16xf32>, %W4m: tensor<16x16x3x3xf32>, %cb4m: tensor<16xf32>, %g4m: tensor<16xf32>, %bt4m: tensor<16xf32>, %W5m: tensor<32x16x3x3xf32>, %cb5m: tensor<32xf32>, %g5m: tensor<32xf32>, %bt5m: tensor<32xf32>, %W6m: tensor<32x32x3x3xf32>, %cb6m: tensor<32xf32>, %g6m: tensor<32xf32>, %bt6m: tensor<32xf32>, %W7m: tensor<32x32x3x3xf32>, %cb7m: tensor<32xf32>, %g7m: tensor<32xf32>, %bt7m: tensor<32xf32>, %W8m: tensor<32x32x3x3xf32>, %cb8m: tensor<32xf32>, %g8m: tensor<32xf32>, %bt8m: tensor<32xf32>, %W9m: tensor<128x128xf32>, %b9m: tensor<128xf32>, %Wam: tensor<128x128xf32>, %bam: tensor<128xf32>, %Wbm: tensor<128x10xf32>, %bbm: tensor<10xf32>, %W1v: tensor<16x3x3x3xf32>, %cb1v: tensor<16xf32>, %g1v: tensor<16xf32>, %bt1v: tensor<16xf32>, %W2v: tensor<16x16x3x3xf32>, %cb2v: tensor<16xf32>, %g2v: tensor<16xf32>, %bt2v: tensor<16xf32>, %W3v: tensor<16x16x3x3xf32>, %cb3v: tensor<16xf32>, %g3v: tensor<16xf32>, %bt3v: tensor<16xf32>, %W4v: tensor<16x16x3x3xf32>, %cb4v: tensor<16xf32>, %g4v: tensor<16xf32>, %bt4v: tensor<16xf32>, %W5v: tensor<32x16x3x3xf32>, %cb5v: tensor<32xf32>, %g5v: tensor<32xf32>, %bt5v: tensor<32xf32>, %W6v: tensor<32x32x3x3xf32>, %cb6v: tensor<32xf32>, %g6v: tensor<32xf32>, %bt6v: tensor<32xf32>, %W7v: tensor<32x32x3x3xf32>, %cb7v: tensor<32xf32>, %g7v: tensor<32xf32>, %bt7v: tensor<32xf32>, %W8v: tensor<32x32x3x3xf32>, %cb8v: tensor<32xf32>, %g8v: tensor<32xf32>, %bt8v: tensor<32xf32>, %W9v: tensor<128x128xf32>, %b9v: tensor<128xf32>, %Wav: tensor<128x128xf32>, %bav: tensor<128xf32>, %Wbv: tensor<128x10xf32>, %bbv: tensor<10xf32>, %lr: tensor<f32>, %bc1: tensor<f32>, %bc2: tensor<f32>, %onehot: tensor<128x10xf32>) -> (tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>) {
    ...
    %h9d = stablehlo.dot_general %flat, %W9, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x128xf32>) -> tensor<128x128xf32>
    %h9b = stablehlo.broadcast_in_dim %b9, dims = [1] : (tensor<128xf32>) -> tensor<128x128xf32>
    %h9 = stablehlo.add %h9d, %h9b : tensor<128x128xf32>
    %a9z = stablehlo.constant dense<0.0> : tensor<128x128xf32>
    %a9 = stablehlo.maximum %h9, %a9z : tensor<128x128xf32>
    %had = stablehlo.dot_general %a9, %Wa, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x128xf32>) -> tensor<128x128xf32>
    %hab = stablehlo.broadcast_in_dim %ba, dims = [1] : (tensor<128xf32>) -> tensor<128x128xf32>
    %ha = stablehlo.add %had, %hab : tensor<128x128xf32>
    %aaz = stablehlo.constant dense<0.0> : tensor<128x128xf32>
    %aa = stablehlo.maximum %ha, %aaz : tensor<128x128xf32>
    %logitsd = stablehlo.dot_general %aa, %Wb, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x10xf32>) -> tensor<128x10xf32>
    ...
    %dxb = stablehlo.dot_general %dy, %Wb, contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<128x10xf32>, tensor<128x10xf32>) -> tensor<128x128xf32>
    %dyaz = stablehlo.constant dense<0.0> : tensor<128x128xf32>
    %dyam = stablehlo.compare GT, %ha, %dyaz : (tensor<128x128xf32>, tensor<128x128xf32>) -> tensor<128x128xi1>
    %dya = stablehlo.select %dyam, %dxb, %dyaz : tensor<128x128xi1>, tensor<128x128xf32>
    %dxa = stablehlo.dot_general %dya, %Wa, contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x128xf32>) -> tensor<128x128xf32>
    %dy9z = stablehlo.constant dense<0.0> : tensor<128x128xf32>
    %dy9m = stablehlo.compare GT, %h9, %dy9z : (tensor<128x128xf32>, tensor<128x128xf32>) -> tensor<128x128xi1>
    %dy9 = stablehlo.select %dy9m, %dxa, %dy9z : tensor<128x128xi1>, tensor<128x128xf32>
    %dx9 = stablehlo.dot_general %dy9, %W9, contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x128xf32>) -> tensor<128x128xf32>
    ...
    %dWb = stablehlo.dot_general %aa, %dy, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x10xf32>) -> tensor<128x10xf32>
    %dbb = stablehlo.reduce(%dy init: %sc) applies stablehlo.add across dimensions = [0] : (tensor<128x10xf32>, tensor<f32>) -> tensor<10xf32>
    %dWa = stablehlo.dot_general %a9, %dya, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x128xf32>) -> tensor<128x128xf32>
    %dba = stablehlo.reduce(%dya init: %sc) applies stablehlo.add across dimensions = [0] : (tensor<128x128xf32>, tensor<f32>) -> tensor<128xf32>
    %dW9 = stablehlo.dot_general %flat, %dy9, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x128xf32>) -> tensor<128x128xf32>
    %db9 = stablehlo.reduce(%dy9 init: %sc) applies stablehlo.add across dimensions = [0] : (tensor<128x128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %adb1W9 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adob1W9 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %admsW9 = stablehlo.multiply %adb1W9, %W9m : tensor<128x128xf32>
    %admgW9 = stablehlo.multiply %adob1W9, %dW9 : tensor<128x128xf32>
    %admnW9 = stablehlo.add %admsW9, %admgW9 : tensor<128x128xf32>
    %adb2W9 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adob2W9 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %advsW9 = stablehlo.multiply %adb2W9, %W9v : tensor<128x128xf32>
    %adg2W9 = stablehlo.multiply %dW9, %dW9 : tensor<128x128xf32>
    %advgW9 = stablehlo.multiply %adob2W9, %adg2W9 : tensor<128x128xf32>
    %advnW9 = stablehlo.add %advsW9, %advgW9 : tensor<128x128xf32>
    %adbc1W9 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adbc2W9 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %admhW9 = stablehlo.divide %admnW9, %adbc1W9 : tensor<128x128xf32>
    %advhW9 = stablehlo.divide %advnW9, %adbc2W9 : tensor<128x128xf32>
    %adlrW9 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adepsW9 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adsqW9 = stablehlo.sqrt %advhW9 : tensor<128x128xf32>
    %addenW9 = stablehlo.add %adsqW9, %adepsW9 : tensor<128x128xf32>
    %adratW9 = stablehlo.divide %admhW9, %addenW9 : tensor<128x128xf32>
    %adstW9 = stablehlo.multiply %adlrW9, %adratW9 : tensor<128x128xf32>
    %adsubW9 = stablehlo.subtract %W9, %adstW9 : tensor<128x128xf32>
    %adwdW9 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adwdlrW9 = stablehlo.multiply %adwdW9, %adlrW9 : tensor<128x128xf32>
    %adwdpW9 = stablehlo.multiply %adwdlrW9, %W9 : tensor<128x128xf32>
    %adnewW9 = stablehlo.subtract %adsubW9, %adwdpW9 : tensor<128x128xf32>
    %adb1b9 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adob1b9 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %admsb9 = stablehlo.multiply %adb1b9, %b9m : tensor<128xf32>
    %admgb9 = stablehlo.multiply %adob1b9, %db9 : tensor<128xf32>
    %admnb9 = stablehlo.add %admsb9, %admgb9 : tensor<128xf32>
    %adb2b9 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adob2b9 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %advsb9 = stablehlo.multiply %adb2b9, %b9v : tensor<128xf32>
    %adg2b9 = stablehlo.multiply %db9, %db9 : tensor<128xf32>
    %advgb9 = stablehlo.multiply %adob2b9, %adg2b9 : tensor<128xf32>
    %advnb9 = stablehlo.add %advsb9, %advgb9 : tensor<128xf32>
    %adbc1b9 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adbc2b9 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %admhb9 = stablehlo.divide %admnb9, %adbc1b9 : tensor<128xf32>
    %advhb9 = stablehlo.divide %advnb9, %adbc2b9 : tensor<128xf32>
    %adlrb9 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adepsb9 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adsqb9 = stablehlo.sqrt %advhb9 : tensor<128xf32>
    %addenb9 = stablehlo.add %adsqb9, %adepsb9 : tensor<128xf32>
    %adratb9 = stablehlo.divide %admhb9, %addenb9 : tensor<128xf32>
    %adstb9 = stablehlo.multiply %adlrb9, %adratb9 : tensor<128xf32>
    %adsubb9 = stablehlo.subtract %b9, %adstb9 : tensor<128xf32>
    %adwdb9 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adwdlrb9 = stablehlo.multiply %adwdb9, %adlrb9 : tensor<128xf32>
    %adwdpb9 = stablehlo.multiply %adwdlrb9, %b9 : tensor<128xf32>
    %adnewb9 = stablehlo.subtract %adsubb9, %adwdpb9 : tensor<128xf32>
    %adb1Wa = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adob1Wa = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %admsWa = stablehlo.multiply %adb1Wa, %Wam : tensor<128x128xf32>
    %admgWa = stablehlo.multiply %adob1Wa, %dWa : tensor<128x128xf32>
    %admnWa = stablehlo.add %admsWa, %admgWa : tensor<128x128xf32>
    %adb2Wa = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adob2Wa = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %advsWa = stablehlo.multiply %adb2Wa, %Wav : tensor<128x128xf32>
    %adg2Wa = stablehlo.multiply %dWa, %dWa : tensor<128x128xf32>
    %advgWa = stablehlo.multiply %adob2Wa, %adg2Wa : tensor<128x128xf32>
    %advnWa = stablehlo.add %advsWa, %advgWa : tensor<128x128xf32>
    %adbc1Wa = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adbc2Wa = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %admhWa = stablehlo.divide %admnWa, %adbc1Wa : tensor<128x128xf32>
    %advhWa = stablehlo.divide %advnWa, %adbc2Wa : tensor<128x128xf32>
    %adlrWa = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adepsWa = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adsqWa = stablehlo.sqrt %advhWa : tensor<128x128xf32>
    %addenWa = stablehlo.add %adsqWa, %adepsWa : tensor<128x128xf32>
    %adratWa = stablehlo.divide %admhWa, %addenWa : tensor<128x128xf32>
    %adstWa = stablehlo.multiply %adlrWa, %adratWa : tensor<128x128xf32>
    %adsubWa = stablehlo.subtract %Wa, %adstWa : tensor<128x128xf32>
    %adwdWa = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %adwdlrWa = stablehlo.multiply %adwdWa, %adlrWa : tensor<128x128xf32>
    %adwdpWa = stablehlo.multiply %adwdlrWa, %Wa : tensor<128x128xf32>
    %adnewWa = stablehlo.subtract %adsubWa, %adwdpWa : tensor<128x128xf32>
    %adb1ba = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adob1ba = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %admsba = stablehlo.multiply %adb1ba, %bam : tensor<128xf32>
    %admgba = stablehlo.multiply %adob1ba, %dba : tensor<128xf32>
    %admnba = stablehlo.add %admsba, %admgba : tensor<128xf32>
    %adb2ba = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adob2ba = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %advsba = stablehlo.multiply %adb2ba, %bav : tensor<128xf32>
    %adg2ba = stablehlo.multiply %dba, %dba : tensor<128xf32>
    %advgba = stablehlo.multiply %adob2ba, %adg2ba : tensor<128xf32>
    %advnba = stablehlo.add %advsba, %advgba : tensor<128xf32>
    %adbc1ba = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adbc2ba = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %admhba = stablehlo.divide %admnba, %adbc1ba : tensor<128xf32>
    %advhba = stablehlo.divide %advnba, %adbc2ba : tensor<128xf32>
    %adlrba = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adepsba = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adsqba = stablehlo.sqrt %advhba : tensor<128xf32>
    %addenba = stablehlo.add %adsqba, %adepsba : tensor<128xf32>
    %adratba = stablehlo.divide %admhba, %addenba : tensor<128xf32>
    %adstba = stablehlo.multiply %adlrba, %adratba : tensor<128xf32>
    %adsubba = stablehlo.subtract %ba, %adstba : tensor<128xf32>
    %adwdba = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %adwdlrba = stablehlo.multiply %adwdba, %adlrba : tensor<128xf32>
    %adwdpba = stablehlo.multiply %adwdlrba, %ba : tensor<128xf32>
    %adnewba = stablehlo.subtract %adsubba, %adwdpba : tensor<128xf32>
    %adb1Wb = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x10xf32>
    %adob1Wb = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x10xf32>
    %admsWb = stablehlo.multiply %adb1Wb, %Wbm : tensor<128x10xf32>
    %admgWb = stablehlo.multiply %adob1Wb, %dWb : tensor<128x10xf32>
    %admnWb = stablehlo.add %admsWb, %admgWb : tensor<128x10xf32>
    %adb2Wb = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x10xf32>
    %adob2Wb = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x10xf32>
    %advsWb = stablehlo.multiply %adb2Wb, %Wbv : tensor<128x10xf32>
    %adg2Wb = stablehlo.multiply %dWb, %dWb : tensor<128x10xf32>
    %advgWb = stablehlo.multiply %adob2Wb, %adg2Wb : tensor<128x10xf32>
    %advnWb = stablehlo.add %advsWb, %advgWb : tensor<128x10xf32>
    %adbc1Wb = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<128x10xf32>
    %adbc2Wb = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<128x10xf32>
    %admhWb = stablehlo.divide %admnWb, %adbc1Wb : tensor<128x10xf32>
    %advhWb = stablehlo.divide %advnWb, %adbc2Wb : tensor<128x10xf32>
    %adlrWb = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<128x10xf32>
    %adepsWb = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<128x10xf32>
    %adsqWb = stablehlo.sqrt %advhWb : tensor<128x10xf32>
    %addenWb = stablehlo.add %adsqWb, %adepsWb : tensor<128x10xf32>
    %adratWb = stablehlo.divide %admhWb, %addenWb : tensor<128x10xf32>
    %adstWb = stablehlo.multiply %adlrWb, %adratWb : tensor<128x10xf32>
    %adsubWb = stablehlo.subtract %Wb, %adstWb : tensor<128x10xf32>
    %adwdWb = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<128x10xf32>
    %adwdlrWb = stablehlo.multiply %adwdWb, %adlrWb : tensor<128x10xf32>
    %adwdpWb = stablehlo.multiply %adwdlrWb, %Wb : tensor<128x10xf32>
    %adnewWb = stablehlo.subtract %adsubWb, %adwdpWb : tensor<128x10xf32>
