module @m {
  func.func @cifar8w_adam_train_step(%x: tensor<128x3072xf32>, %W1: tensor<16x3x3x3xf32>, %cb1: tensor<16xf32>, %W2: tensor<16x16x3x3xf32>, %cb2: tensor<16xf32>, %W3: tensor<16x16x3x3xf32>, %cb3: tensor<16xf32>, %W4: tensor<16x16x3x3xf32>, %cb4: tensor<16xf32>, %W5: tensor<32x16x3x3xf32>, %cb5: tensor<32xf32>, %W6: tensor<32x32x3x3xf32>, %cb6: tensor<32xf32>, %W7: tensor<32x32x3x3xf32>, %cb7: tensor<32xf32>, %W8: tensor<32x32x3x3xf32>, %cb8: tensor<32xf32>, %W9: tensor<128x512xf32>, %b9: tensor<512xf32>, %Wa: tensor<512x512xf32>, %ba: tensor<512xf32>, %Wb: tensor<512x10xf32>, %bb: tensor<10xf32>, %W1m: tensor<16x3x3x3xf32>, %cb1m: tensor<16xf32>, %W2m: tensor<16x16x3x3xf32>, %cb2m: tensor<16xf32>, %W3m: tensor<16x16x3x3xf32>, %cb3m: tensor<16xf32>, %W4m: tensor<16x16x3x3xf32>, %cb4m: tensor<16xf32>, %W5m: tensor<32x16x3x3xf32>, %cb5m: tensor<32xf32>, %W6m: tensor<32x32x3x3xf32>, %cb6m: tensor<32xf32>, %W7m: tensor<32x32x3x3xf32>, %cb7m: tensor<32xf32>, %W8m: tensor<32x32x3x3xf32>, %cb8m: tensor<32xf32>, %W9m: tensor<128x512xf32>, %b9m: tensor<512xf32>, %Wam: tensor<512x512xf32>, %bam: tensor<512xf32>, %Wbm: tensor<512x10xf32>, %bbm: tensor<10xf32>, %W1v: tensor<16x3x3x3xf32>, %cb1v: tensor<16xf32>, %W2v: tensor<16x16x3x3xf32>, %cb2v: tensor<16xf32>, %W3v: tensor<16x16x3x3xf32>, %cb3v: tensor<16xf32>, %W4v: tensor<16x16x3x3xf32>, %cb4v: tensor<16xf32>, %W5v: tensor<32x16x3x3xf32>, %cb5v: tensor<32xf32>, %W6v: tensor<32x32x3x3xf32>, %cb6v: tensor<32xf32>, %W7v: tensor<32x32x3x3xf32>, %cb7v: tensor<32xf32>, %W8v: tensor<32x32x3x3xf32>, %cb8v: tensor<32xf32>, %W9v: tensor<128x512xf32>, %b9v: tensor<512xf32>, %Wav: tensor<512x512xf32>, %bav: tensor<512xf32>, %Wbv: tensor<512x10xf32>, %bbv: tensor<10xf32>, %lr: tensor<f32>, %bc1: tensor<f32>, %bc2: tensor<f32>, %onehot: tensor<128x10xf32>) -> (tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>) {
    ...
    %v885 = stablehlo.dot_general %v87, %v116, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x512xf32>) -> tensor<128x512xf32>
    %v886 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v887 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v888 = stablehlo.multiply %v886, %W9m : tensor<128x512xf32>
    %v889 = stablehlo.multiply %v887, %v885 : tensor<128x512xf32>
    %v890 = stablehlo.add %v888, %v889 : tensor<128x512xf32>
    %v891 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v892 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v893 = stablehlo.multiply %v891, %W9v : tensor<128x512xf32>
    %v894 = stablehlo.multiply %v885, %v885 : tensor<128x512xf32>
    %v895 = stablehlo.multiply %v892, %v894 : tensor<128x512xf32>
    %v896 = stablehlo.add %v893, %v895 : tensor<128x512xf32>
    %v897 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v898 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v899 = stablehlo.divide %v890, %v897 : tensor<128x512xf32>
    %v900 = stablehlo.divide %v896, %v898 : tensor<128x512xf32>
    %v901 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v902 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v903 = stablehlo.sqrt %v900 : tensor<128x512xf32>
    %v904 = stablehlo.add %v903, %v902 : tensor<128x512xf32>
    %v905 = stablehlo.divide %v899, %v904 : tensor<128x512xf32>
    %v906 = stablehlo.multiply %v901, %v905 : tensor<128x512xf32>
    %v907 = stablehlo.subtract %W9, %v906 : tensor<128x512xf32>
    %v908 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v909 = stablehlo.multiply %v908, %v901 : tensor<128x512xf32>
    %v910 = stablehlo.multiply %v909, %W9 : tensor<128x512xf32>
    %v911 = stablehlo.subtract %v907, %v910 : tensor<128x512xf32>
    %v912 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v913 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v914 = stablehlo.multiply %v912, %W9m : tensor<128x512xf32>
    %v915 = stablehlo.multiply %v913, %v885 : tensor<128x512xf32>
    %v916 = stablehlo.add %v914, %v915 : tensor<128x512xf32>
    %v917 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v918 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v919 = stablehlo.multiply %v917, %W9v : tensor<128x512xf32>
    %v920 = stablehlo.multiply %v885, %v885 : tensor<128x512xf32>
    %v921 = stablehlo.multiply %v918, %v920 : tensor<128x512xf32>
    %v922 = stablehlo.add %v919, %v921 : tensor<128x512xf32>
    %v923 = stablehlo.constant dense<0.0> : tensor<f32>
    %v924 = stablehlo.reduce(%v116 init: %v923) applies stablehlo.add across dimensions = [0] : (tensor<128x512xf32>, tensor<f32>) -> tensor<512xf32>
    %v925 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v926 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v927 = stablehlo.multiply %v925, %b9m : tensor<512xf32>
    %v928 = stablehlo.multiply %v926, %v924 : tensor<512xf32>
    %v929 = stablehlo.add %v927, %v928 : tensor<512xf32>
    %v930 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v931 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v932 = stablehlo.multiply %v930, %b9v : tensor<512xf32>
    %v933 = stablehlo.multiply %v924, %v924 : tensor<512xf32>
    %v934 = stablehlo.multiply %v931, %v933 : tensor<512xf32>
    %v935 = stablehlo.add %v932, %v934 : tensor<512xf32>
    %v936 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v937 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v938 = stablehlo.divide %v929, %v936 : tensor<512xf32>
    %v939 = stablehlo.divide %v935, %v937 : tensor<512xf32>
    %v940 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v941 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v942 = stablehlo.sqrt %v939 : tensor<512xf32>
    %v943 = stablehlo.add %v942, %v941 : tensor<512xf32>
    %v944 = stablehlo.divide %v938, %v943 : tensor<512xf32>
    %v945 = stablehlo.multiply %v940, %v944 : tensor<512xf32>
    %v946 = stablehlo.subtract %b9, %v945 : tensor<512xf32>
    %v947 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v948 = stablehlo.multiply %v947, %v940 : tensor<512xf32>
    %v949 = stablehlo.multiply %v948, %b9 : tensor<512xf32>
    %v950 = stablehlo.subtract %v946, %v949 : tensor<512xf32>
    %v951 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v952 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v953 = stablehlo.multiply %v951, %b9m : tensor<512xf32>
    %v954 = stablehlo.multiply %v952, %v924 : tensor<512xf32>
    %v955 = stablehlo.add %v953, %v954 : tensor<512xf32>
    %v956 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v957 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v958 = stablehlo.multiply %v956, %b9v : tensor<512xf32>
    %v959 = stablehlo.multiply %v924, %v924 : tensor<512xf32>
    %v960 = stablehlo.multiply %v957, %v959 : tensor<512xf32>
    %v961 = stablehlo.add %v958, %v960 : tensor<512xf32>
    %v962 = stablehlo.dot_general %v92, %v112, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x512xf32>, tensor<128x512xf32>) -> tensor<512x512xf32>
    %v963 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v964 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v965 = stablehlo.multiply %v963, %Wam : tensor<512x512xf32>
    %v966 = stablehlo.multiply %v964, %v962 : tensor<512x512xf32>
    %v967 = stablehlo.add %v965, %v966 : tensor<512x512xf32>
    %v968 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v969 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v970 = stablehlo.multiply %v968, %Wav : tensor<512x512xf32>
    %v971 = stablehlo.multiply %v962, %v962 : tensor<512x512xf32>
    %v972 = stablehlo.multiply %v969, %v971 : tensor<512x512xf32>
    %v973 = stablehlo.add %v970, %v972 : tensor<512x512xf32>
    %v974 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v975 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v976 = stablehlo.divide %v967, %v974 : tensor<512x512xf32>
    %v977 = stablehlo.divide %v973, %v975 : tensor<512x512xf32>
    %v978 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v979 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v980 = stablehlo.sqrt %v977 : tensor<512x512xf32>
    %v981 = stablehlo.add %v980, %v979 : tensor<512x512xf32>
    %v982 = stablehlo.divide %v976, %v981 : tensor<512x512xf32>
    %v983 = stablehlo.multiply %v978, %v982 : tensor<512x512xf32>
    %v984 = stablehlo.subtract %Wa, %v983 : tensor<512x512xf32>
    %v985 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v986 = stablehlo.multiply %v985, %v978 : tensor<512x512xf32>
    %v987 = stablehlo.multiply %v986, %Wa : tensor<512x512xf32>
    %v988 = stablehlo.subtract %v984, %v987 : tensor<512x512xf32>
    %v989 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v990 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v991 = stablehlo.multiply %v989, %Wam : tensor<512x512xf32>
    %v992 = stablehlo.multiply %v990, %v962 : tensor<512x512xf32>
    %v993 = stablehlo.add %v991, %v992 : tensor<512x512xf32>
    %v994 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v995 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v996 = stablehlo.multiply %v994, %Wav : tensor<512x512xf32>
    %v997 = stablehlo.multiply %v962, %v962 : tensor<512x512xf32>
    %v998 = stablehlo.multiply %v995, %v997 : tensor<512x512xf32>
    %v999 = stablehlo.add %v996, %v998 : tensor<512x512xf32>
    %v1000 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1001 = stablehlo.reduce(%v112 init: %v1000) applies stablehlo.add across dimensions = [0] : (tensor<128x512xf32>, tensor<f32>) -> tensor<512xf32>
    ...
    %v1004 = stablehlo.multiply %v1002, %bam : tensor<512xf32>
    ...
    %v1009 = stablehlo.multiply %v1007, %bav : tensor<512xf32>
    ...
    %v1030 = stablehlo.multiply %v1028, %bam : tensor<512xf32>
    ...
    %v1035 = stablehlo.multiply %v1033, %bav : tensor<512xf32>
    ...
    %v1039 = stablehlo.dot_general %v97, %v108, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x512xf32>, tensor<128x10xf32>) -> tensor<512x10xf32>
    %v1040 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1041 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1042 = stablehlo.multiply %v1040, %Wbm : tensor<512x10xf32>
    %v1043 = stablehlo.multiply %v1041, %v1039 : tensor<512x10xf32>
    %v1044 = stablehlo.add %v1042, %v1043 : tensor<512x10xf32>
    %v1045 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1046 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1047 = stablehlo.multiply %v1045, %Wbv : tensor<512x10xf32>
    %v1048 = stablehlo.multiply %v1039, %v1039 : tensor<512x10xf32>
    %v1049 = stablehlo.multiply %v1046, %v1048 : tensor<512x10xf32>
    %v1050 = stablehlo.add %v1047, %v1049 : tensor<512x10xf32>
    %v1051 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1052 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1053 = stablehlo.divide %v1044, %v1051 : tensor<512x10xf32>
    %v1054 = stablehlo.divide %v1050, %v1052 : tensor<512x10xf32>
    %v1055 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1056 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1057 = stablehlo.sqrt %v1054 : tensor<512x10xf32>
    %v1058 = stablehlo.add %v1057, %v1056 : tensor<512x10xf32>
    %v1059 = stablehlo.divide %v1053, %v1058 : tensor<512x10xf32>
    %v1060 = stablehlo.multiply %v1055, %v1059 : tensor<512x10xf32>
    %v1061 = stablehlo.subtract %Wb, %v1060 : tensor<512x10xf32>
    %v1062 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1063 = stablehlo.multiply %v1062, %v1055 : tensor<512x10xf32>
    %v1064 = stablehlo.multiply %v1063, %Wb : tensor<512x10xf32>
    %v1065 = stablehlo.subtract %v1061, %v1064 : tensor<512x10xf32>
    %v1066 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1067 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1068 = stablehlo.multiply %v1066, %Wbm : tensor<512x10xf32>
    %v1069 = stablehlo.multiply %v1067, %v1039 : tensor<512x10xf32>
    %v1070 = stablehlo.add %v1068, %v1069 : tensor<512x10xf32>
    %v1071 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1072 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1073 = stablehlo.multiply %v1071, %Wbv : tensor<512x10xf32>
    %v1074 = stablehlo.multiply %v1039, %v1039 : tensor<512x10xf32>
    %v1075 = stablehlo.multiply %v1072, %v1074 : tensor<512x10xf32>
    %v1076 = stablehlo.add %v1073, %v1075 : tensor<512x10xf32>
    ...
    return %v252, %v292, %v335, %v375, %v418, %v458, %v501, %v541, %v584, %v624, %v667, %v707, %v750, %v790, %v833, %v873, %v911, %v950, %v988, %v1027, %v1065, %v1104, %v257, %v297, %v340, %v380, %v423, %v463, %v506, %v546, %v589, %v629, %v672, %v712, %v755, %v795, %v838, %v878, %v916, %v955, %v993, %v1032, %v1070, %v1109, %v263, %v303, %v346, %v386, %v429, %v469, %v512, %v552, %v595, %v635, %v678, %v718, %v761, %v801, %v844, %v884, %v922, %v961, %v999, %v1038, %v1076, %v1115, %loss, %bc1, %bc2 : tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>
  }
}
