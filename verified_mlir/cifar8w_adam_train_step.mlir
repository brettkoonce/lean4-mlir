module @m {
  func.func @cifar8w_adam_train_step(%x: tensor<128x3072xf32>, %W1: tensor<16x3x3x3xf32>, %cb1: tensor<16xf32>, %W2: tensor<16x16x3x3xf32>, %cb2: tensor<16xf32>, %W3: tensor<16x16x3x3xf32>, %cb3: tensor<16xf32>, %W4: tensor<16x16x3x3xf32>, %cb4: tensor<16xf32>, %W5: tensor<32x16x3x3xf32>, %cb5: tensor<32xf32>, %W6: tensor<32x32x3x3xf32>, %cb6: tensor<32xf32>, %W7: tensor<32x32x3x3xf32>, %cb7: tensor<32xf32>, %W8: tensor<32x32x3x3xf32>, %cb8: tensor<32xf32>, %W9: tensor<128x512xf32>, %b9: tensor<512xf32>, %Wa: tensor<512x512xf32>, %ba: tensor<512xf32>, %Wb: tensor<512x10xf32>, %bb: tensor<10xf32>, %W1m: tensor<16x3x3x3xf32>, %cb1m: tensor<16xf32>, %W2m: tensor<16x16x3x3xf32>, %cb2m: tensor<16xf32>, %W3m: tensor<16x16x3x3xf32>, %cb3m: tensor<16xf32>, %W4m: tensor<16x16x3x3xf32>, %cb4m: tensor<16xf32>, %W5m: tensor<32x16x3x3xf32>, %cb5m: tensor<32xf32>, %W6m: tensor<32x32x3x3xf32>, %cb6m: tensor<32xf32>, %W7m: tensor<32x32x3x3xf32>, %cb7m: tensor<32xf32>, %W8m: tensor<32x32x3x3xf32>, %cb8m: tensor<32xf32>, %W9m: tensor<128x512xf32>, %b9m: tensor<512xf32>, %Wam: tensor<512x512xf32>, %bam: tensor<512xf32>, %Wbm: tensor<512x10xf32>, %bbm: tensor<10xf32>, %W1v: tensor<16x3x3x3xf32>, %cb1v: tensor<16xf32>, %W2v: tensor<16x16x3x3xf32>, %cb2v: tensor<16xf32>, %W3v: tensor<16x16x3x3xf32>, %cb3v: tensor<16xf32>, %W4v: tensor<16x16x3x3xf32>, %cb4v: tensor<16xf32>, %W5v: tensor<32x16x3x3xf32>, %cb5v: tensor<32xf32>, %W6v: tensor<32x32x3x3xf32>, %cb6v: tensor<32xf32>, %W7v: tensor<32x32x3x3xf32>, %cb7v: tensor<32xf32>, %W8v: tensor<32x32x3x3xf32>, %cb8v: tensor<32xf32>, %W9v: tensor<128x512xf32>, %b9v: tensor<512xf32>, %Wav: tensor<512x512xf32>, %bav: tensor<512xf32>, %Wbv: tensor<512x10xf32>, %bbv: tensor<10xf32>, %lr: tensor<f32>, %bc1: tensor<f32>, %bc2: tensor<f32>, %onehot: tensor<128x10xf32>) -> (tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>) {
    ...
    %v224 = stablehlo.reshape %v180 : (tensor<128x16384xf32>) -> tensor<128x16x32x32xf32>
    %v225 = stablehlo.constant dense<0.0> : tensor<f32>
    %v226 = stablehlo.reduce(%v224 init: %v225) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<128x16x32x32xf32>, tensor<f32>) -> tensor<16xf32>
    ...
    %v264 = stablehlo.reshape %v6 : (tensor<128x16384xf32>) -> tensor<128x16x32x32xf32>
    %v265 = stablehlo.reshape %v172 : (tensor<128x16384xf32>) -> tensor<128x16x32x32xf32>
    %v266 = stablehlo.transpose %v264, dims = [1, 0, 2, 3] : (tensor<128x16x32x32xf32>) -> tensor<16x128x32x32xf32>
    %v267 = stablehlo.transpose %v265, dims = [1, 0, 2, 3] : (tensor<128x16x32x32xf32>) -> tensor<16x128x32x32xf32>
    ...
    %v307 = stablehlo.reshape %v172 : (tensor<128x16384xf32>) -> tensor<128x16x32x32xf32>
    %v308 = stablehlo.constant dense<0.0> : tensor<f32>
    %v309 = stablehlo.reduce(%v307 init: %v308) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<128x16x32x32xf32>, tensor<f32>) -> tensor<16xf32>
    ...
    %v347 = stablehlo.reshape %v17 : (tensor<128x4096xf32>) -> tensor<128x16x16x16xf32>
    %v348 = stablehlo.reshape %v159 : (tensor<128x4096xf32>) -> tensor<128x16x16x16xf32>
    %v349 = stablehlo.transpose %v347, dims = [1, 0, 2, 3] : (tensor<128x16x16x16xf32>) -> tensor<16x128x16x16xf32>
    %v350 = stablehlo.transpose %v348, dims = [1, 0, 2, 3] : (tensor<128x16x16x16xf32>) -> tensor<16x128x16x16xf32>
    ...
    %v390 = stablehlo.reshape %v159 : (tensor<128x4096xf32>) -> tensor<128x16x16x16xf32>
    %v391 = stablehlo.constant dense<0.0> : tensor<f32>
    %v392 = stablehlo.reduce(%v390 init: %v391) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<128x16x16x16xf32>, tensor<f32>) -> tensor<16xf32>
    ...
    %v430 = stablehlo.reshape %v24 : (tensor<128x4096xf32>) -> tensor<128x16x16x16xf32>
    %v431 = stablehlo.reshape %v151 : (tensor<128x4096xf32>) -> tensor<128x16x16x16xf32>
    %v432 = stablehlo.transpose %v430, dims = [1, 0, 2, 3] : (tensor<128x16x16x16xf32>) -> tensor<16x128x16x16xf32>
    %v433 = stablehlo.transpose %v431, dims = [1, 0, 2, 3] : (tensor<128x16x16x16xf32>) -> tensor<16x128x16x16xf32>
    ...
    %v473 = stablehlo.reshape %v151 : (tensor<128x4096xf32>) -> tensor<128x16x16x16xf32>
    %v474 = stablehlo.constant dense<0.0> : tensor<f32>
    %v475 = stablehlo.reduce(%v473 init: %v474) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<128x16x16x16xf32>, tensor<f32>) -> tensor<16xf32>
    ...
    %v513 = stablehlo.reshape %v35 : (tensor<128x1024xf32>) -> tensor<128x16x8x8xf32>
    %v514 = stablehlo.reshape %v138 : (tensor<128x2048xf32>) -> tensor<128x32x8x8xf32>
    %v515 = stablehlo.transpose %v513, dims = [1, 0, 2, 3] : (tensor<128x16x8x8xf32>) -> tensor<16x128x8x8xf32>
    %v516 = stablehlo.transpose %v514, dims = [1, 0, 2, 3] : (tensor<128x32x8x8xf32>) -> tensor<32x128x8x8xf32>
    ...
    %v556 = stablehlo.reshape %v138 : (tensor<128x2048xf32>) -> tensor<128x32x8x8xf32>
    %v557 = stablehlo.constant dense<0.0> : tensor<f32>
    %v558 = stablehlo.reduce(%v556 init: %v557) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<128x32x8x8xf32>, tensor<f32>) -> tensor<32xf32>
    ...
    %v596 = stablehlo.reshape %v42 : (tensor<128x2048xf32>) -> tensor<128x32x8x8xf32>
    %v597 = stablehlo.reshape %v130 : (tensor<128x2048xf32>) -> tensor<128x32x8x8xf32>
    %v598 = stablehlo.transpose %v596, dims = [1, 0, 2, 3] : (tensor<128x32x8x8xf32>) -> tensor<32x128x8x8xf32>
    %v599 = stablehlo.transpose %v597, dims = [1, 0, 2, 3] : (tensor<128x32x8x8xf32>) -> tensor<32x128x8x8xf32>
    ...
    %v639 = stablehlo.reshape %v130 : (tensor<128x2048xf32>) -> tensor<128x32x8x8xf32>
    %v640 = stablehlo.constant dense<0.0> : tensor<f32>
    %v641 = stablehlo.reduce(%v639 init: %v640) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<128x32x8x8xf32>, tensor<f32>) -> tensor<32xf32>
    ...
    %v679 = stablehlo.reshape %v53 : (tensor<128x512xf32>) -> tensor<128x32x4x4xf32>
    %v680 = stablehlo.reshape %v117 : (tensor<128x512xf32>) -> tensor<128x32x4x4xf32>
    %v681 = stablehlo.transpose %v679, dims = [1, 0, 2, 3] : (tensor<128x32x4x4xf32>) -> tensor<32x128x4x4xf32>
    %v682 = stablehlo.transpose %v680, dims = [1, 0, 2, 3] : (tensor<128x32x4x4xf32>) -> tensor<32x128x4x4xf32>
    ...
    %v722 = stablehlo.reshape %v117 : (tensor<128x512xf32>) -> tensor<128x32x4x4xf32>
    %v723 = stablehlo.constant dense<0.0> : tensor<f32>
    %v724 = stablehlo.reduce(%v722 init: %v723) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<128x32x4x4xf32>, tensor<f32>) -> tensor<32xf32>
    ...
    %v762 = stablehlo.reshape %v60 : (tensor<128x512xf32>) -> tensor<128x32x4x4xf32>
    %v763 = stablehlo.reshape %v109 : (tensor<128x512xf32>) -> tensor<128x32x4x4xf32>
    %v764 = stablehlo.transpose %v762, dims = [1, 0, 2, 3] : (tensor<128x32x4x4xf32>) -> tensor<32x128x4x4xf32>
    %v765 = stablehlo.transpose %v763, dims = [1, 0, 2, 3] : (tensor<128x32x4x4xf32>) -> tensor<32x128x4x4xf32>
    ...
    %v805 = stablehlo.reshape %v109 : (tensor<128x512xf32>) -> tensor<128x32x4x4xf32>
    %v806 = stablehlo.constant dense<0.0> : tensor<f32>
    %v807 = stablehlo.reduce(%v805 init: %v806) applies stablehlo.add across dimensions = [0, 2, 3] : (tensor<128x32x4x4xf32>, tensor<f32>) -> tensor<32xf32>
    ...
    %v845 = stablehlo.dot_general %v71, %v100, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x128xf32>, tensor<128x512xf32>) -> tensor<128x512xf32>
    %v846 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v847 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v848 = stablehlo.multiply %v846, %W9m : tensor<128x512xf32>
    %v849 = stablehlo.multiply %v847, %v845 : tensor<128x512xf32>
    %v850 = stablehlo.add %v848, %v849 : tensor<128x512xf32>
    %v851 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v852 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v853 = stablehlo.multiply %v851, %W9v : tensor<128x512xf32>
    %v854 = stablehlo.multiply %v845, %v845 : tensor<128x512xf32>
    %v855 = stablehlo.multiply %v852, %v854 : tensor<128x512xf32>
    %v856 = stablehlo.add %v853, %v855 : tensor<128x512xf32>
    %v857 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v858 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v859 = stablehlo.divide %v850, %v857 : tensor<128x512xf32>
    %v860 = stablehlo.divide %v856, %v858 : tensor<128x512xf32>
    %v861 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v862 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v863 = stablehlo.sqrt %v860 : tensor<128x512xf32>
    %v864 = stablehlo.add %v863, %v862 : tensor<128x512xf32>
    %v865 = stablehlo.divide %v859, %v864 : tensor<128x512xf32>
    %v866 = stablehlo.multiply %v861, %v865 : tensor<128x512xf32>
    %v867 = stablehlo.subtract %W9, %v866 : tensor<128x512xf32>
    %v868 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v869 = stablehlo.multiply %v868, %v861 : tensor<128x512xf32>
    %v870 = stablehlo.multiply %v869, %W9 : tensor<128x512xf32>
    %v871 = stablehlo.subtract %v867, %v870 : tensor<128x512xf32>
    %v872 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v873 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v874 = stablehlo.multiply %v872, %W9m : tensor<128x512xf32>
    %v875 = stablehlo.multiply %v873, %v845 : tensor<128x512xf32>
    %v876 = stablehlo.add %v874, %v875 : tensor<128x512xf32>
    %v877 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v878 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<128x512xf32>
    %v879 = stablehlo.multiply %v877, %W9v : tensor<128x512xf32>
    %v880 = stablehlo.multiply %v845, %v845 : tensor<128x512xf32>
    %v881 = stablehlo.multiply %v878, %v880 : tensor<128x512xf32>
    %v882 = stablehlo.add %v879, %v881 : tensor<128x512xf32>
    %v883 = stablehlo.constant dense<0.0> : tensor<f32>
    %v884 = stablehlo.reduce(%v100 init: %v883) applies stablehlo.add across dimensions = [0] : (tensor<128x512xf32>, tensor<f32>) -> tensor<512xf32>
    %v885 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v886 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v887 = stablehlo.multiply %v885, %b9m : tensor<512xf32>
    %v888 = stablehlo.multiply %v886, %v884 : tensor<512xf32>
    %v889 = stablehlo.add %v887, %v888 : tensor<512xf32>
    %v890 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v891 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v892 = stablehlo.multiply %v890, %b9v : tensor<512xf32>
    %v893 = stablehlo.multiply %v884, %v884 : tensor<512xf32>
    %v894 = stablehlo.multiply %v891, %v893 : tensor<512xf32>
    %v895 = stablehlo.add %v892, %v894 : tensor<512xf32>
    %v896 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v897 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v898 = stablehlo.divide %v889, %v896 : tensor<512xf32>
    %v899 = stablehlo.divide %v895, %v897 : tensor<512xf32>
    %v900 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v901 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v902 = stablehlo.sqrt %v899 : tensor<512xf32>
    %v903 = stablehlo.add %v902, %v901 : tensor<512xf32>
    %v904 = stablehlo.divide %v898, %v903 : tensor<512xf32>
    %v905 = stablehlo.multiply %v900, %v904 : tensor<512xf32>
    %v906 = stablehlo.subtract %b9, %v905 : tensor<512xf32>
    %v907 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v908 = stablehlo.multiply %v907, %v900 : tensor<512xf32>
    %v909 = stablehlo.multiply %v908, %b9 : tensor<512xf32>
    %v910 = stablehlo.subtract %v906, %v909 : tensor<512xf32>
    %v911 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v912 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v913 = stablehlo.multiply %v911, %b9m : tensor<512xf32>
    %v914 = stablehlo.multiply %v912, %v884 : tensor<512xf32>
    %v915 = stablehlo.add %v913, %v914 : tensor<512xf32>
    %v916 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v917 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v918 = stablehlo.multiply %v916, %b9v : tensor<512xf32>
    %v919 = stablehlo.multiply %v884, %v884 : tensor<512xf32>
    %v920 = stablehlo.multiply %v917, %v919 : tensor<512xf32>
    %v921 = stablehlo.add %v918, %v920 : tensor<512xf32>
    %v922 = stablehlo.dot_general %v76, %v96, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x512xf32>, tensor<128x512xf32>) -> tensor<512x512xf32>
    %v923 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v924 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v925 = stablehlo.multiply %v923, %Wam : tensor<512x512xf32>
    %v926 = stablehlo.multiply %v924, %v922 : tensor<512x512xf32>
    %v927 = stablehlo.add %v925, %v926 : tensor<512x512xf32>
    %v928 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v929 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v930 = stablehlo.multiply %v928, %Wav : tensor<512x512xf32>
    %v931 = stablehlo.multiply %v922, %v922 : tensor<512x512xf32>
    %v932 = stablehlo.multiply %v929, %v931 : tensor<512x512xf32>
    %v933 = stablehlo.add %v930, %v932 : tensor<512x512xf32>
    %v934 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v935 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v936 = stablehlo.divide %v927, %v934 : tensor<512x512xf32>
    %v937 = stablehlo.divide %v933, %v935 : tensor<512x512xf32>
    %v938 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v939 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v940 = stablehlo.sqrt %v937 : tensor<512x512xf32>
    %v941 = stablehlo.add %v940, %v939 : tensor<512x512xf32>
    %v942 = stablehlo.divide %v936, %v941 : tensor<512x512xf32>
    %v943 = stablehlo.multiply %v938, %v942 : tensor<512x512xf32>
    %v944 = stablehlo.subtract %Wa, %v943 : tensor<512x512xf32>
    %v945 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v946 = stablehlo.multiply %v945, %v938 : tensor<512x512xf32>
    %v947 = stablehlo.multiply %v946, %Wa : tensor<512x512xf32>
    %v948 = stablehlo.subtract %v944, %v947 : tensor<512x512xf32>
    %v949 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v950 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v951 = stablehlo.multiply %v949, %Wam : tensor<512x512xf32>
    %v952 = stablehlo.multiply %v950, %v922 : tensor<512x512xf32>
    %v953 = stablehlo.add %v951, %v952 : tensor<512x512xf32>
    %v954 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v955 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x512xf32>
    %v956 = stablehlo.multiply %v954, %Wav : tensor<512x512xf32>
    %v957 = stablehlo.multiply %v922, %v922 : tensor<512x512xf32>
    %v958 = stablehlo.multiply %v955, %v957 : tensor<512x512xf32>
    %v959 = stablehlo.add %v956, %v958 : tensor<512x512xf32>
    %v960 = stablehlo.constant dense<0.0> : tensor<f32>
    %v961 = stablehlo.reduce(%v96 init: %v960) applies stablehlo.add across dimensions = [0] : (tensor<128x512xf32>, tensor<f32>) -> tensor<512xf32>
    %v962 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v963 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v964 = stablehlo.multiply %v962, %bam : tensor<512xf32>
    %v965 = stablehlo.multiply %v963, %v961 : tensor<512xf32>
    %v966 = stablehlo.add %v964, %v965 : tensor<512xf32>
    %v967 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v968 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v969 = stablehlo.multiply %v967, %bav : tensor<512xf32>
    %v970 = stablehlo.multiply %v961, %v961 : tensor<512xf32>
    %v971 = stablehlo.multiply %v968, %v970 : tensor<512xf32>
    %v972 = stablehlo.add %v969, %v971 : tensor<512xf32>
    %v973 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v974 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v975 = stablehlo.divide %v966, %v973 : tensor<512xf32>
    %v976 = stablehlo.divide %v972, %v974 : tensor<512xf32>
    %v977 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v978 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v979 = stablehlo.sqrt %v976 : tensor<512xf32>
    %v980 = stablehlo.add %v979, %v978 : tensor<512xf32>
    %v981 = stablehlo.divide %v975, %v980 : tensor<512xf32>
    %v982 = stablehlo.multiply %v977, %v981 : tensor<512xf32>
    %v983 = stablehlo.subtract %ba, %v982 : tensor<512xf32>
    %v984 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v985 = stablehlo.multiply %v984, %v977 : tensor<512xf32>
    %v986 = stablehlo.multiply %v985, %ba : tensor<512xf32>
    %v987 = stablehlo.subtract %v983, %v986 : tensor<512xf32>
    %v988 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v989 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v990 = stablehlo.multiply %v988, %bam : tensor<512xf32>
    %v991 = stablehlo.multiply %v989, %v961 : tensor<512xf32>
    %v992 = stablehlo.add %v990, %v991 : tensor<512xf32>
    %v993 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v994 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %v995 = stablehlo.multiply %v993, %bav : tensor<512xf32>
    %v996 = stablehlo.multiply %v961, %v961 : tensor<512xf32>
    %v997 = stablehlo.multiply %v994, %v996 : tensor<512xf32>
    %v998 = stablehlo.add %v995, %v997 : tensor<512xf32>
    %v999 = stablehlo.dot_general %v81, %v92, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<128x512xf32>, tensor<128x10xf32>) -> tensor<512x10xf32>
    %v1000 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1001 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1002 = stablehlo.multiply %v1000, %Wbm : tensor<512x10xf32>
    %v1003 = stablehlo.multiply %v1001, %v999 : tensor<512x10xf32>
    %v1004 = stablehlo.add %v1002, %v1003 : tensor<512x10xf32>
    %v1005 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1006 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1007 = stablehlo.multiply %v1005, %Wbv : tensor<512x10xf32>
    %v1008 = stablehlo.multiply %v999, %v999 : tensor<512x10xf32>
    %v1009 = stablehlo.multiply %v1006, %v1008 : tensor<512x10xf32>
    %v1010 = stablehlo.add %v1007, %v1009 : tensor<512x10xf32>
    %v1011 = stablehlo.broadcast_in_dim %bc1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1012 = stablehlo.broadcast_in_dim %bc2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1013 = stablehlo.divide %v1004, %v1011 : tensor<512x10xf32>
    %v1014 = stablehlo.divide %v1010, %v1012 : tensor<512x10xf32>
    %v1015 = stablehlo.broadcast_in_dim %lr, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1016 = stablehlo.broadcast_in_dim %eps, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1017 = stablehlo.sqrt %v1014 : tensor<512x10xf32>
    %v1018 = stablehlo.add %v1017, %v1016 : tensor<512x10xf32>
    %v1019 = stablehlo.divide %v1013, %v1018 : tensor<512x10xf32>
    %v1020 = stablehlo.multiply %v1015, %v1019 : tensor<512x10xf32>
    %v1021 = stablehlo.subtract %Wb, %v1020 : tensor<512x10xf32>
    %v1022 = stablehlo.broadcast_in_dim %wd, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1023 = stablehlo.multiply %v1022, %v1015 : tensor<512x10xf32>
    %v1024 = stablehlo.multiply %v1023, %Wb : tensor<512x10xf32>
    %v1025 = stablehlo.subtract %v1021, %v1024 : tensor<512x10xf32>
    %v1026 = stablehlo.broadcast_in_dim %b1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1027 = stablehlo.broadcast_in_dim %ob1, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1028 = stablehlo.multiply %v1026, %Wbm : tensor<512x10xf32>
    %v1029 = stablehlo.multiply %v1027, %v999 : tensor<512x10xf32>
    %v1030 = stablehlo.add %v1028, %v1029 : tensor<512x10xf32>
    %v1031 = stablehlo.broadcast_in_dim %b2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1032 = stablehlo.broadcast_in_dim %ob2, dims = [] : (tensor<f32>) -> tensor<512x10xf32>
    %v1033 = stablehlo.multiply %v1031, %Wbv : tensor<512x10xf32>
    %v1034 = stablehlo.multiply %v999, %v999 : tensor<512x10xf32>
    %v1035 = stablehlo.multiply %v1032, %v1034 : tensor<512x10xf32>
    %v1036 = stablehlo.add %v1033, %v1035 : tensor<512x10xf32>
    %v1037 = stablehlo.constant dense<0.0> : tensor<f32>
    %v1038 = stablehlo.reduce(%v92 init: %v1037) applies stablehlo.add across dimensions = [0] : (tensor<128x10xf32>, tensor<f32>) -> tensor<10xf32>
    ...
    return %v212, %v252, %v295, %v335, %v378, %v418, %v461, %v501, %v544, %v584, %v627, %v667, %v710, %v750, %v793, %v833, %v871, %v910, %v948, %v987, %v1025, %v1064, %v217, %v257, %v300, %v340, %v383, %v423, %v466, %v506, %v549, %v589, %v632, %v672, %v715, %v755, %v798, %v838, %v876, %v915, %v953, %v992, %v1030, %v1069, %v223, %v263, %v306, %v346, %v389, %v429, %v472, %v512, %v555, %v595, %v638, %v678, %v721, %v761, %v804, %v844, %v882, %v921, %v959, %v998, %v1036, %v1075, %loss, %bc1, %bc2 : tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<16x16x3x3xf32>, tensor<16xf32>, tensor<32x16x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<32x32x3x3xf32>, tensor<32xf32>, tensor<128x512xf32>, tensor<512xf32>, tensor<512x512xf32>, tensor<512xf32>, tensor<512x10xf32>, tensor<10xf32>, tensor<f32>, tensor<f32>, tensor<f32>
  }
}
