...
python3 scripts/demos/yolo_map_visdrone.py runs/neudet_fpn/logits.bin data/neu_det448/val.bin \
...
-- (`scripts/probes/neu_anchors.py --save data/neu_det` → data/neu_det/anchors_fpn_{p3,p4,p5}.txt;
...
/-- Infer: dump [N, Ntot] logits of the chosen split for scripts/demos/yolo_map_visdrone.py --fpn. -/
