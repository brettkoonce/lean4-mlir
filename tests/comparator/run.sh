...
#   config-tier.json — 21 tie / faithfulness / whole-net / DP / float / certificate
#                      theorems, machine-generated by scripts/gen_comparator_tier.py.
...
PATH="$WRAPPER_DIR:$PATH" lake env comparator config-tier.json
