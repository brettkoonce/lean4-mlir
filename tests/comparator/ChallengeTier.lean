    ...
    ∀ (nCls : ℕ),
      (0 : ℕ) < nCls →
        Proofs.mobilenetv2ForwardBFull (2 : ℕ) (Proofs.Mnv2FullBSeal.sealW nCls) (Proofs.Mnv2FullBSeal.sealX (1 : ℝ)) ≠
          Proofs.mobilenetv2ForwardBFull (2 : ℕ) (Proofs.Mnv2FullBSeal.sealW nCls) (Proofs.Mnv2FullBSeal.sealX (0 : ℝ)) := by sorry
              ...
              (∀ (r : Fin R), Proofs.StableHLO.den (dy r) = Proofs.batchShard R N (oc * (h * w)) DY r) →
                ∀ (r : Fin R),
                  Proofs.StableHLO.den
                    ...
                    Proofs.batchShard R N (oc * (h * w)) (Proofs.bnBatchTensor4GradInput (R * N) oc h w ε γ X DY) r := by sorry
          ...
          (∀ (r : Fin R),
            ...
            ∀ (r : Fin R),
              Proofs.StableHLO.den (Proofs.StableHLO.resnet34FwdGraphSyncFull R hR N epsStr w e r) =
                Proofs.batchShard R N nCls (Proofs.resnet34ForwardBFull (R * N) w X) r := by sorry
      ...
      (0 : ℕ) < N →
        ∀ {nCls : ℕ} (xN cotN vN epsStr : String) (w : Proofs.R34BWeights nCls)
          ...
          (∀ (r : Fin R), gs r = Proofs.batchShard R N nCls (fun (i : Fin (R * N * nCls)) => ↑R * G i) r) →
            Proofs.ResNet34SyncTieB.r34NetSyncTiedB R hR N xN cotN vN epsStr w X G gs := by sorry
          ...
          (∀ (r : Fin R),
            ...
            ∀ (r : Fin R),
              Proofs.StableHLO.den (Proofs.StableHLO.mobilenetv2FwdGraphSyncFull R hR N epsStr w e r) =
                Proofs.batchShard R N nCls (Proofs.mobilenetv2ForwardBFull (R * N) w X) r := by sorry
    ...
    ∀ (R : ℕ) (hR : (0 : ℕ) < R) (N : ℕ),
      (0 : ℕ) < N →
        ∀ {nCls : ℕ} (xN cotN vN epsStr : String) (w : Proofs.MNV2BWeights nCls)
          ...
          (G : Proofs.Vec (R * N * nCls)) (gs : Fin R → Proofs.Vec (N * nCls)),
          (∀ (r : Fin R), gs r = Proofs.batchShard R N nCls (fun (i : Fin (R * N * nCls)) => ↑R * G i) r) →
            Proofs.MobileNetV2SyncTieB.mnv2NetSyncTiedB R hR N xN cotN vN epsStr w X G gs := by sorry
              ...
              (∀ (r : Fin R),
                ...
                ∀ (r : Fin R),
                  Proofs.StableHLO.den (Proofs.StableHLO.resnet50FwdGraphSyncFull R hR N q epsStr w e r) =
                    Proofs.batchShard R N nCls (Proofs.resnet50ForwardBFull (R * N) q w X) r := by sorry
        ...
        ∀ (q : ℕ),
          (0 : ℕ) < q →
            ∀ {nCls : ℕ} (xN cotN vN epsStr : String) (w : Proofs.R50BWeights nCls)
              ...
              (G : Proofs.Vec (R * N * nCls)) (gs : Fin R → Proofs.Vec (N * nCls)),
              (∀ (r : Fin R), gs r = Proofs.batchShard R N nCls (fun (i : Fin (R * N * nCls)) => ↑R * G i) r) →
                Proofs.ResNet50SyncTieB.r50NetSyncTiedB R hR N q xN cotN vN epsStr w X G gs := by sorry
