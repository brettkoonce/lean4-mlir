...
`planning/archive/mobilenetv2_close.md` Item C, applied to EfficientNet-B0 ([`tests/TestEfficientNetTrain.lean`](https://github.com/brettkoonce/lean4-mlir/blob/main/tests/TestEfficientNetTrain.lean),
