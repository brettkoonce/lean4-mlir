...
1. `efficientnetBFullHasVJP` — the generic eighteen-stage apex `head ∘ b16 ∘ … ∘ b1 ∘ stem`,
   seventeen `vjpComp`s and nothing else, and `opaqueA0 … A16`, one prefix `def` per running
...
2. `efficientnetInputGradBFull_eq_efficientnetB_full_vjp` — the tie with the stem and head
   concrete and the sixteen blocks opaque: `unfold`, two `rw`s, `rfl`.
3. `efficientnetInputGradBFull_eq_efficientnetForwardB_full_vjp` — the tie instantiated at the
...
/-- **Whole-network paper EfficientNet-B0 VJP.** The VJP of the eighteen-stage chain
    `head ∘ b16 ∘ … ∘ b1 ∘ stem` — seventeen `vjpComp`s, dimension-generic and parametric in
    every component, `HasVJP` everywhere (no smooth point: every activation on this path is
    differentiable on all of `ℝ`). -/
noncomputable def efficientnetBFullHasVJP {s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 s12 s13 s14 s15 s16 s17 s18 : Nat}
  ...
  let v1 := vjpComp _ _ dstem db1 hstem hb1
  let f1 := db1.comp dstem
  let v2 := vjpComp _ _ f1 db2 v1 hb2
  let f2 := db2.comp f1
  let v3 := vjpComp _ _ f2 db3 v2 hb3
  let f3 := db3.comp f2
  let v4 := vjpComp _ _ f3 db4 v3 hb4
  let f4 := db4.comp f3
  let v5 := vjpComp _ _ f4 db5 v4 hb5
  let f5 := db5.comp f4
  let v6 := vjpComp _ _ f5 db6 v5 hb6
  let f6 := db6.comp f5
  let v7 := vjpComp _ _ f6 db7 v6 hb7
  let f7 := db7.comp f6
  let v8 := vjpComp _ _ f7 db8 v7 hb8
  let f8 := db8.comp f7
  let v9 := vjpComp _ _ f8 db9 v8 hb9
  let f9 := db9.comp f8
  let v10 := vjpComp _ _ f9 db10 v9 hb10
  let f10 := db10.comp f9
  let v11 := vjpComp _ _ f10 db11 v10 hb11
  let f11 := db11.comp f10
  let v12 := vjpComp _ _ f11 db12 v11 hb12
  let f12 := db12.comp f11
  let v13 := vjpComp _ _ f12 db13 v12 hb13
  let f13 := db13.comp f12
  let v14 := vjpComp _ _ f13 db14 v13 hb14
  let f14 := db14.comp f13
  let v15 := vjpComp _ _ f14 db15 v14 hb15
  let f15 := db15.comp f14
  let v16 := vjpComp _ _ f15 db16 v15 hb16
  let f16 := db16.comp f15
  vjpComp _ _ f16 dhead v16 hhead
...
theorem efficientnetInputGradBFull_eq_efficientnetB_full_vjp
    (N : Nat) {nCls : Nat}
    ...
    efficientnetInputGradBFull N Ws Wh Wfc
      ...
      ((swishHasVJP (N * (1280 * 7 * 7))).backward
      ...
      = (efficientnetBFullHasVJP
          ...
          (stemBHasVJP N (h := 112) (w := 112) Ws bs εs hεs γs βs)
          hb1 hb2 hb3 hb4 hb5 hb6 hb7 hb8 hb9 hb10 hb11 hb12 hb13 hb14 hb15 hb16
          (headFwdBHasVJP N (h := 7) (w := 7) Wh bh εh hεh γh βh Wfc bfc)).backward x := by
    ...
    efficientnetInputGradBFull N w.sW w.hW w.fcW
      ...
      ((swishHasVJP (N * (32 * 112 * 112))).backward
        (StableHLO.bnBatchLA N 32 112 112 w.sε w.sγ w.sβ
          (StableHLO.batchMap N (flatConvStride2Xla w.sW w.sb) x)))
      ((bnBatchLAHasVJP N 1280 7 7 w.hε hεw.h w.hγ w.hβ).backward
      ...
      ((swishHasVJP (N * (1280 * 7 * 7))).backward
        (StableHLO.bnBatchLA N 1280 7 7 w.hε w.hγ w.hβ
          (StableHLO.batchMap N (flatConv w.hW w.hb) (opaqueA16 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) (mbStridedW N 28 28 w.b4) (mbResidW N 28 28 w.b5) (mbStridedW N 14 14 w.b6) (mbResidW N 14 14 w.b7) (mbResidW N 14 14 w.b8) (mbExpW N 14 14 w.b9) (mbResidW N 14 14 w.b10) (mbResidW N 14 14 w.b11) (mbStridedW N 7 7 w.b12) (mbResidW N 7 7 w.b13) (mbResidW N 7 7 w.b14) (mbResidW N 7 7 w.b15) (mbExpW N 7 7 w.b16) x))))
      ((mbNoExpWHasVJP N 112 112 w.b1 hεw.b1.d hεw.b1.p).backward (opaqueA0 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) x))
      ((mbStridedWHasVJP N 56 56 w.b2 hεw.b2.e hεw.b2.d hεw.b2.p).backward (opaqueA1 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) x))
      ((mbResidWHasVJP N 56 56 w.b3 hεw.b3.e hεw.b3.d hεw.b3.p).backward (opaqueA2 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) x))
      ((mbStridedWHasVJP N 28 28 w.b4 hεw.b4.e hεw.b4.d hεw.b4.p).backward (opaqueA3 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) x))
      ((mbResidWHasVJP N 28 28 w.b5 hεw.b5.e hεw.b5.d hεw.b5.p).backward (opaqueA4 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) (mbStridedW N 28 28 w.b4) x))
      ((mbStridedWHasVJP N 14 14 w.b6 hεw.b6.e hεw.b6.d hεw.b6.p).backward (opaqueA5 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) (mbStridedW N 28 28 w.b4) (mbResidW N 28 28 w.b5) x))
      ((mbResidWHasVJP N 14 14 w.b7 hεw.b7.e hεw.b7.d hεw.b7.p).backward (opaqueA6 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) (mbStridedW N 28 28 w.b4) (mbResidW N 28 28 w.b5) (mbStridedW N 14 14 w.b6) x))
      ((mbResidWHasVJP N 14 14 w.b8 hεw.b8.e hεw.b8.d hεw.b8.p).backward (opaqueA7 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) (mbStridedW N 28 28 w.b4) (mbResidW N 28 28 w.b5) (mbStridedW N 14 14 w.b6) (mbResidW N 14 14 w.b7) x))
      ((mbExpWHasVJP N 14 14 w.b9 hεw.b9.e hεw.b9.d hεw.b9.p).backward (opaqueA8 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) (mbStridedW N 28 28 w.b4) (mbResidW N 28 28 w.b5) (mbStridedW N 14 14 w.b6) (mbResidW N 14 14 w.b7) (mbResidW N 14 14 w.b8) x))
      ((mbResidWHasVJP N 14 14 w.b10 hεw.b10.e hεw.b10.d hεw.b10.p).backward (opaqueA9 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) (mbStridedW N 28 28 w.b4) (mbResidW N 28 28 w.b5) (mbStridedW N 14 14 w.b6) (mbResidW N 14 14 w.b7) (mbResidW N 14 14 w.b8) (mbExpW N 14 14 w.b9) x))
      ((mbResidWHasVJP N 14 14 w.b11 hεw.b11.e hεw.b11.d hεw.b11.p).backward (opaqueA10 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) (mbStridedW N 28 28 w.b4) (mbResidW N 28 28 w.b5) (mbStridedW N 14 14 w.b6) (mbResidW N 14 14 w.b7) (mbResidW N 14 14 w.b8) (mbExpW N 14 14 w.b9) (mbResidW N 14 14 w.b10) x))
      ((mbStridedWHasVJP N 7 7 w.b12 hεw.b12.e hεw.b12.d hεw.b12.p).backward (opaqueA11 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) (mbStridedW N 28 28 w.b4) (mbResidW N 28 28 w.b5) (mbStridedW N 14 14 w.b6) (mbResidW N 14 14 w.b7) (mbResidW N 14 14 w.b8) (mbExpW N 14 14 w.b9) (mbResidW N 14 14 w.b10) (mbResidW N 14 14 w.b11) x))
      ((mbResidWHasVJP N 7 7 w.b13 hεw.b13.e hεw.b13.d hεw.b13.p).backward (opaqueA12 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) (mbStridedW N 28 28 w.b4) (mbResidW N 28 28 w.b5) (mbStridedW N 14 14 w.b6) (mbResidW N 14 14 w.b7) (mbResidW N 14 14 w.b8) (mbExpW N 14 14 w.b9) (mbResidW N 14 14 w.b10) (mbResidW N 14 14 w.b11) (mbStridedW N 7 7 w.b12) x))
      ((mbResidWHasVJP N 7 7 w.b14 hεw.b14.e hεw.b14.d hεw.b14.p).backward (opaqueA13 (stemB N (h := 112) (w := 112) w.sW w.sb w.sε w.sγ w.sβ) (mbNoExpW N 112 112 w.b1) (mbStridedW N 56 56 w.b2) (mbResidW N 56 56 w.b3) (mbStridedW N 28 28 w.b4) (mbResidW N 28 28 w.b5) (mbStridedW N 14 14 w.b6) (mbResidW N 14 14 w.b7) (mbResidW N 14 14 w.b8) (mbExpW N 14 14 w.b9) (mbResidW N 14 14 w.b10) (mbResidW N 14 14 w.b11) (mbStridedW N 7 7 w.b12) (mbResidW N 7 7 w.b13) x))
      ...
      = (efficientnetForwardBFullHasVJP N w hεw).backward x :=
  (efficientnetInputGradBFull_eq_efficientnetB_full_vjp N w.sW w.sb w.sε hεw.s w.sγ w.sβ
      w.hW w.hb w.hε hεw.h w.hγ w.hβ w.fcW w.fcb
      ...
      (mbNoExpW_differentiable N 112 112 w.b1 hεw.b1.d hεw.b1.p) (mbStridedW_differentiable N 56 56 w.b2 hεw.b2.e hεw.b2.d hεw.b2.p) (mbResidW_differentiable N 56 56 w.b3 hεw.b3.e hεw.b3.d hεw.b3.p) (mbStridedW_differentiable N 28 28 w.b4 hεw.b4.e hεw.b4.d hεw.b4.p) (mbResidW_differentiable N 28 28 w.b5 hεw.b5.e hεw.b5.d hεw.b5.p) (mbStridedW_differentiable N 14 14 w.b6 hεw.b6.e hεw.b6.d hεw.b6.p) (mbResidW_differentiable N 14 14 w.b7 hεw.b7.e hεw.b7.d hεw.b7.p) (mbResidW_differentiable N 14 14 w.b8 hεw.b8.e hεw.b8.d hεw.b8.p) (mbExpW_differentiable N 14 14 w.b9 hεw.b9.e hεw.b9.d hεw.b9.p) (mbResidW_differentiable N 14 14 w.b10 hεw.b10.e hεw.b10.d hεw.b10.p) (mbResidW_differentiable N 14 14 w.b11 hεw.b11.e hεw.b11.d hεw.b11.p) (mbStridedW_differentiable N 7 7 w.b12 hεw.b12.e hεw.b12.d hεw.b12.p) (mbResidW_differentiable N 7 7 w.b13 hεw.b13.e hεw.b13.d hεw.b13.p) (mbResidW_differentiable N 7 7 w.b14 hεw.b14.e hεw.b14.d hεw.b14.p) (mbResidW_differentiable N 7 7 w.b15 hεw.b15.e hεw.b15.d hεw.b15.p) (mbExpW_differentiable N 7 7 w.b16 hεw.b16.e hεw.b16.d hεw.b16.p)
