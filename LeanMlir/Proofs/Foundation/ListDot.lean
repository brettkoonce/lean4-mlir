...
The pooled 49-dim scorecard (`LipschitzCert.Scorecard`) evaluates its
...
Used by `LipschitzCert.ScorecardFull*` (generated by
`scripts/certs/lipschitz_cert_scorecard_full.py`). All 3-axiom clean.
-/
