...
The syntactic half of [`StableHLO`](https://github.com/brettkoonce/lean4-mlir/blob/main/LeanMlir/Proofs/Codegen/StableHLO/Basic.lean):
...
--    parser in StableHLO/Parse.lean) ──
