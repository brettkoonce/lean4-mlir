...
[`StableHLO.Pretty`](https://github.com/brettkoonce/lean4-mlir/blob/main/LeanMlir/Proofs/Codegen/StableHLO/Pretty.lean).
...
* **Syntactic** (`StableHLO.Pretty`) — `pretty` renders the same term to StableHLO text. SSA names
