...
theorem mobilenetv2FwdGraphFull_faithful
  ...
  simp only [mobilenetv2FwdGraphFull, denseF_faithful, gapF_faithful, relu6F_faithful,
             bnF_faithful, flatConvF_faithful, flatConvStridedXlaF_faithful, depthwiseF_faithful,
             depthwiseStridedXlaF_faithful, den_addV, den_operand]
...
#eval (do
  ...
  -- (cifar8TrainStepFaithfulV, den-certified in Cifar8Fold.lean).
