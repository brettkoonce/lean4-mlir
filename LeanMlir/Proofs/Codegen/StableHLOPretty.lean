...
| `#eval` writers (end of file) | `verified_mlir/{linear,mlp,cnn,cifar,cifar8,cifar8_bn,cifar8w}_*` — regenerated by elaborating this module (`lake env lean` on this file) |
