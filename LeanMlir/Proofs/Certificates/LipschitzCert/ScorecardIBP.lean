...
([`Certificates/IntervalBound.lean`](https://github.com/brettkoonce/lean4-mlir/blob/main/LeanMlir/Proofs/Certificates/IntervalBound.lean)), proved once — kernel-checking the 57th
...
`scripts/certs/lipschitz_cert_scorecard_ibp.py`; weights/images are DATA. -/
...
theorem hbSFe1_0 : ∀ j : Fin 10, j ≠ 7 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreSF0, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe1_1 : ∀ j : Fin 10, j ≠ 2 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreSF1, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe1_2 : ∀ j : Fin 10, j ≠ 1 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreSF2, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe1_3 : ∀ j : Fin 10, j ≠ 0 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreSF3, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe1_4 : ∀ j : Fin 10, j ≠ 4 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreSF4, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe1_5 : ∀ j : Fin 10, j ≠ 1 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreSF5, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe1_6 : ∀ j : Fin 10, j ≠ 4 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreSF6, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe1_7 : ∀ j : Fin 10, j ≠ 9 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreSF7, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe4_10 : ∀ j : Fin 10, j ≠ 0 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreISF10, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe8_13 : ∀ j : Fin 10, j ≠ 0 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreISF13, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe8_14 : ∀ j : Fin 10, j ≠ 1 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreISF14, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe8_17 : ∀ j : Fin 10, j ≠ 7 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreISF17, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe8_21 : ∀ j : Fin 10, j ≠ 6 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreISF21, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe8_25 : ∀ j : Fin 10, j ≠ 0 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreSF25, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
...
theorem hbSFe8_28 : ∀ j : Fin 10, j ≠ 0 →
  ...
  fin_cases j <;>
    first
    | exact absurd rfl hj
    | · simp [W2SF, W2SFQ, castM, hpreISF28, absrSF, Fin.sum_univ_succ, max_def]
        try norm_num
