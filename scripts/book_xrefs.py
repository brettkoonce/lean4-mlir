...
"""Every cross-reference in the book, grouped by what it points at.
    ...
    python3 scripts/book_xrefs.py            # one block per target, its citing sentences under it
    python3 scripts/book_xrefs.py --summary  # one line per target: how many sentences point at it
