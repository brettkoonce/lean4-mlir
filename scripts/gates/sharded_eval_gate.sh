...
#
#   scripts/gates/sharded_eval_gate.sh <net> <variant> <ckpt> [dataDir]      # nets: score-checkpoint's
#
#   e.g. scripts/gates/sharded_eval_gate.sh vit adam64 .lake/build/vit_adam64_ckpt_xla.bin
#        SHIM_PYTHON=... scripts/gates/sharded_eval_gate.sh vit-in emadp128x4wxclipdropbf16 \
