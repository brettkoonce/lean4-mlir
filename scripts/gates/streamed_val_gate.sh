...
#
#   scripts/gates/streamed_val_gate.sh golden <net> <variant> <ckpt> <outdir>   # a pre-8182b6e1 binary (drain)
#   scripts/gates/streamed_val_gate.sh test   <net> <variant> <ckpt> <outdir>   # the streamed binary
#
#   e.g. scripts/gates/streamed_val_gate.sh golden resnet50-in160 lambaccdp8x64bce \
