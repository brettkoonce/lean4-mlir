...
The sibling of scripts/gates/check_audit_coverage.py, for the other half of the
...
(scripts/gates/render_guard_baseline.txt) of artifacts known to be unguarded today,
...
Usage: python3 scripts/gates/check_render_coverage.py [--update-baseline]
       (from the repo root)
"""
...
BASELINE = Path("scripts/gates/render_guard_baseline.txt")
...
def main() -> None:
    ...
    if "--update-baseline" in sys.argv:
        BASELINE.write_text(
            ...
            "#   python3 scripts/gates/check_render_coverage.py --update-baseline\n"
