...
Usage:  python3 scripts/gates/batch_divisor_gate.py            # assert
        python3 scripts/gates/batch_divisor_gate.py --list     # every artifact
        python3 scripts/gates/batch_divisor_gate.py --control  # prove the gate can FAIL
"""
