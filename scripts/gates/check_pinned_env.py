...
"""check_pinned_env.py — assert the main `.venv` still IS the pinned environment.
    ...
    .venv/bin/python scripts/gates/check_pinned_env.py      # exit 0 = pinned, 1 = drifted
    .venv/bin/python scripts/gates/check_pinned_env.py --allow-cpu   # jax version only, on a GPU-less host
