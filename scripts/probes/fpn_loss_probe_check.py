...
Run:  ../lean4-jax/.venv/bin/python scripts/probes/fpn_loss_probe_check.py   (a python with iree.runtime)
"""
import os
import subprocess
import sys
...
# IREE comes from scripts/lib/_iree.py: run under the sibling lean4-jax venv's python (it has
