...
parameter round trip. This is what separates "the renderer" from "the system".
    ...
    .venv/bin/python scripts/probes/bf16_device_step.py verified_mlir/<f32>.mlir verified_mlir/<bf16>.mlir
...
▶ Peer tool: `scripts/probes/bf16_gate2.py`, which answers the different question of whether the bf16
