...
scripts/probes/fpn_neck_check.py exactly.

Run:  <jax-venv>/bin/python scripts/probes/fpn_neck_probe_check.py
...
# ── numpy oracle (mirrors scripts/probes/fpn_neck_check.py + emitBilinearUpsample) ──
