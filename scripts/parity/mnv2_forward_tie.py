...
emitted. `scripts/parity/mnv2_timm_parity.py` pins that reference to timm's `mobilenetv2_100`; this carries
...
Usage:
    scripts/parity/mnv2_forward_tie.py --diag
    scripts/parity/mnv2_forward_tie.py --diag --backend cuda
    scripts/parity/mnv2_forward_tie.py --imagenet
    scripts/parity/mnv2_forward_tie.py --imagenet --mlir verified_mlir/mobilenetv2in_fwd_eval.mlir   # control: must fail
"""
