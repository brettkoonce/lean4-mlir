#!/usr/bin/env python3
"""timm half of `scripts/parity/mnv4_timm_parity.py` — runs in `.venv-timm` (CPU torch, timm 1.0.28).
...
Usage (called by the parity script; not meant to be run by hand):
    .venv-timm/bin/python scripts/parity/_mnv4_timm_dump.py OUT.npz --classes 10 --batch 4 --seed 0
"""
import argparse
import numpy as np
import timm
