...
Usage:
    ...
    scripts/parity/grad_tie.py --net mnv4 --nokink

    lake build r34-train-b2 && .lake/build/bin/r34-train-b2           # emits r34's
    scripts/parity/grad_tie.py --net r34 --nokink
...
NETS = {
    ...
    "r34": dict(
        ...
        # default at exactly the stem. `scripts/gates/convention_audit.py --net r34` now reports the
