...
Usage:
    scripts/parity/mnv4_timm_parity.py              # batch 4, seed 0, tol 1e-3 (relative to max |logit|)
    scripts/parity/mnv4_timm_parity.py --tol 1e-4
"""
...
def timm_dump(tmp, classes, batch, seed):
    ...
    r = subprocess.run([TIMM_PY, os.path.join(ROOT, "scripts", "parity", "_mnv4_timm_dump.py"), out,
