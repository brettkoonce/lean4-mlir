...
never transcribed. `jax/scripts/eval_full50k.py` reads the JSON (`PROTOCOL=timm`).
    ...
    .venv-timm/bin/python scripts/parity/timm_eval_protocols.py           # write jax/timm_eval_protocols.json
    .venv-timm/bin/python scripts/parity/timm_eval_protocols.py --check   # drift -> exit 1
