...
#
#     scripts/sweeps/run_r34_ablation.sh                          # all 8 arms, GPUs 0-3
#     GPUS=1,2,3 ARMS="nowarm nocos noaug" scripts/sweeps/run_r34_ablation.sh
#     PREC=bf16 scripts/sweeps/run_r34_ablation.sh          # the precision peer of the whole sweep
#
