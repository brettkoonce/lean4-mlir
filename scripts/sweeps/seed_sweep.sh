...
#
#     scripts/sweeps/seed_sweep.sh                                 # imagenette, 4 GPUs, seeds 1 2 3
#     SUITE=small scripts/sweeps/seed_sweep.sh 0,1,2,3 "1 2 3 4 5"
#     DRY_RUN=1 scripts/sweeps/seed_sweep.sh                       # print the packing, launch nothing
#     scripts/sweeps/seed_sweep.sh 0,1 "1 2 3"                     # two cards, leave the rest free
