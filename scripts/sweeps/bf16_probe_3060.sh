...
#
#     scripts/sweeps/bf16_probe_3060.sh /tmp/probe.tsv            # every net, both precisions, fed+synth
#     scripts/sweeps/bf16_probe_3060.sh /tmp/probe.tsv r34 vit    # just those nets
#     WORKERS=12 ARMS=fed NETS=vit scripts/sweeps/bf16_probe_3060.sh /tmp/sweep.tsv    # the §1c sweep
#
...
OUT="${1:?usage: scripts/sweeps/bf16_probe_3060.sh <out.tsv> [net ...]}"; shift || true
