...
Inputs, all written by the two Lean exes into one run directory:
  ...
  python scripts/demos/blackjack_figure.py runs/2026-09-11-blackjack-dqn out.png        # curve + charts
  python scripts/demos/blackjack_figure.py runs/2026-09-11-blackjack-dqn out.png chart  # the two charts alone (the book's)
"""
import csv, sys
import matplotlib
matplotlib.use("Agg")
