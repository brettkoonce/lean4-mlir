...
Usage:
    python3 scripts/demos/brats_class_weights.py [data/brats/train.bin]
"""
import sys
...
def main():
    ...
    print("  class, while CE's is flat at p->0 (scripts/probes/seg_dice_vanishing_grad_probe.py).")
