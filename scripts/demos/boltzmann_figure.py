...
Inputs: data/boltzmann (scripts/datasets/preprocess_boltzmann.py) and one run directory holding
  ...
  corrected_kT8.bin, transfer.json                   scripts/demos/boltzmann_metrics.py transfer … --out=<run>

  python3 scripts/demos/boltzmann_figure.py runs/2026-09-11-boltzmann-generator out.png
