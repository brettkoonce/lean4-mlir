...
A single-grid renderer cannot read this head: it would assume a single
...
Usage:
    python3 scripts/demos/fpn_render.py runs/fpn_x/logits.bin data/visdrone_fpn/val.bin \\
    ...
    python3 scripts/demos/fpn_render.py runs/after/logits.bin data/visdrone_fpn/val.bin \\
