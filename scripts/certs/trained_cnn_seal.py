...
Runs scripts/certs/trained_cnn_witness.py first (deterministic) to reproduce the
...
Generated by `scripts/certs/trained_cnn_seal.py`; tables are DATA here. -/
