...
Usage:
  python3 scripts/book/log_to_pgfplots.py historical/logs/ablation_cifar-bn-sgd.log loss
  python3 scripts/book/log_to_pgfplots.py historical/logs/ablation_r34-full.log val
