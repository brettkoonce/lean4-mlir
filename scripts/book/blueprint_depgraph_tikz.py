...
blueprint/src/content.tex:
    ...
    python3 scripts/book/blueprint_depgraph_tikz.py        # writes blueprint/src/figures/depgraph/*.tex

Re-run after `scripts/book/blueprint_uses.py --fix` changes an edge or a statement moves;
