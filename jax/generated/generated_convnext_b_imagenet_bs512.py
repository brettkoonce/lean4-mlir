...
Architecture: CNXStem(3→128,4x4)+LN → ConvNeXt3(c=128) → CNXDown(128→256) → ConvNeXt3(c=256) → CNXDown(256→512) → ConvNeXt27(c=512) → CNXDown(512→1024) → ConvNeXt3(c=1024) → GAP → 1024→1000
Parameters: 88589416
...
def forward(params, x, drop_key=None):
    ...
    x = global_avg_pool(x)
    x = mm(x, params[188][0].T) + params[188][1]
    return x
...
if __name__ == "__main__":
    ...
    print("  " + "CNXStem(3→128,4x4)+LN → ConvNeXt3(c=128) → CNXDown(128→256) → ConvNeXt3(c=256) → CNXDown(256→512) → ConvNeXt27(c=512) → CNXDown(512→1024) → ConvNeXt3(c=1024) → GAP → 1024→1000")
    print()
    ...
    print("lr=0.000500  batch_size=" + str(BATCH_SIZE) +
          ...
          "  epochs=" + str(EPOCHS) + "  params=88589416")
