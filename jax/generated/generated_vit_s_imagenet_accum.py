"""ViT-S/16 (ImageNet, bf16) — Generated by Lean 4 → JAX
Architecture: Patch(3→384,16x16) → Trans(12x[6h,384]) → 384→1000
Parameters: 22050664
...
def init_params(key):
    ...
    # CLS token
    key, k_ = random.split(key)
    params.append((random.normal(k_, (384,)) * 0.02,))
    # Positional embedding (197, 384)
    key, k_ = random.split(key)
...
def init_params_from_file(path):
    ...
    idx = 0
    params = []
    # patchEmbed conv W, b (3→384, 16×16)
    W = jnp.array(buf[idx:idx+294912].reshape(384, 3, 16, 16)); idx += 294912
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # patchEmbed cls token [384]
    cls = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((cls,))
    # patchEmbed positional embedding [197, 384]
    pos = jnp.array(buf[idx:idx+75648].reshape(197, 384)); idx += 75648
    params.append((pos,))
    # trans[0] LN1 (γ, β)
    gamma = jnp.array(buf[idx:idx+384]); idx += 384
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[0] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[0] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[0] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[0] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[0] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[0] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[0] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[1] LN1 (γ, β)
    gamma = jnp.array(buf[idx:idx+384]); idx += 384
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[1] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[1] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[1] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[1] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[1] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[1] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[1] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[2] LN1 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[2] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[2] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[2] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[2] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[2] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[2] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[2] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[3] LN1 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[3] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[3] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[3] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[3] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[3] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[3] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[3] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[4] LN1 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[4] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[4] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[4] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[4] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[4] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[4] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[4] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[5] LN1 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[5] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[5] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[5] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[5] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[5] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[5] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[5] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[6] LN1 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[6] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[6] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[6] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[6] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[6] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[6] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[6] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[7] LN1 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[7] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[7] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[7] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[7] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[7] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[7] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[7] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[8] LN1 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[8] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[8] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[8] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[8] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[8] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[8] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[8] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[9] LN1 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[9] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[9] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[9] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[9] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[9] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[9] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[9] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[10] LN1 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[10] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[10] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[10] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[10] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[10] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[10] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[10] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[11] LN1 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[11] Q 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[11] K 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[11] V 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[11] Output 384→384 (W, b)
    W = jnp.array(buf[idx:idx+147456].reshape(384, 384).T); idx += 147456
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans[11] LN2 (γ, β)
    ...
    beta = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((gamma, beta))
    # trans[11] fc1 384→1536 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(384, 1536).T); idx += 589824
    b = jnp.array(buf[idx:idx+1536]); idx += 1536
    params.append((W, b))
    # trans[11] fc2 1536→384 (W, b)
    W = jnp.array(buf[idx:idx+589824].reshape(1536, 384).T); idx += 589824
    b = jnp.array(buf[idx:idx+384]); idx += 384
    params.append((W, b))
    # trans final LN (γ, β)
    ...
    params.append((gamma, beta))
    # dense 384 → 1000
    W = jnp.array(buf[idx:idx+384000].reshape(384, 1000).T); idx += 384000
...
def forward(params, x, drop_key=None):
    ...
    x = x + params[2][0]
    x = transformer_block(params, x, 3, 6, dpkeys[0], 1.000000)
    x = transformer_block(params, x, 11, 6, dpkeys[1], 0.990909)
    x = transformer_block(params, x, 19, 6, dpkeys[2], 0.981818)
    x = transformer_block(params, x, 27, 6, dpkeys[3], 0.972727)
    x = transformer_block(params, x, 35, 6, dpkeys[4], 0.963636)
    x = transformer_block(params, x, 43, 6, dpkeys[5], 0.954545)
    x = transformer_block(params, x, 51, 6, dpkeys[6], 0.945455)
    x = transformer_block(params, x, 59, 6, dpkeys[7], 0.936364)
    x = transformer_block(params, x, 67, 6, dpkeys[8], 0.927273)
    x = transformer_block(params, x, 75, 6, dpkeys[9], 0.918182)
    x = transformer_block(params, x, 83, 6, dpkeys[10], 0.909091)
...
if __name__ == "__main__":
    print("ViT-S/16 (ImageNet, bf16) · Lean 4 → JAX")
    print("  " + "Patch(3→384,16x16) → Trans(12x[6h,384]) → 384→1000")
    print()
    ...
    print("lr=0.000500  batch_size=" + str(BATCH_SIZE) +
          ...
          "  epochs=" + str(EPOCHS) + "  params=22050664")
    ...
    if _trace_f:
        _hdr = {
            ...
            'netspec_name': "ViT-S/16 (ImageNet, bf16)",
            'config': {
