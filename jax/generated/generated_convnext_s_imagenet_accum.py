...
Architecture: CNXStem(3→96,4x4)+LN → ConvNeXt3(c=96) → CNXDown(96→192) → ConvNeXt3(c=192) → CNXDown(192→384) → ConvNeXt27(c=384) → CNXDown(384→768) → ConvNeXt3(c=768) → GAP → 768→1000
Parameters: 50222152
...
if __name__ == "__main__":
    ...
    print("  " + "CNXStem(3→96,4x4)+LN → ConvNeXt3(c=96) → CNXDown(96→192) → ConvNeXt3(c=192) → CNXDown(192→384) → ConvNeXt27(c=384) → CNXDown(384→768) → ConvNeXt3(c=768) → GAP → 768→1000")
    print()
    ...
    print("lr=0.000250  batch_size=" + str(BATCH_SIZE) +
          ...
          "  epochs=" + str(EPOCHS) + "  params=50222152")
