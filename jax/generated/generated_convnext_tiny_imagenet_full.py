...
Architecture: CNXStem(3→96,4x4)+LN → ConvNeXt3(c=96) → CNXDown(96→192) → ConvNeXt3(c=192) → CNXDown(192→384) → ConvNeXt9(c=384) → CNXDown(384→768) → ConvNeXt3(c=768) → GAP → 768→1000
Parameters: 28587592
...
def forward(params, x, drop_key=None):
    ...
    x = global_avg_pool(x)
    x = mm(x, params[98][0].T) + params[98][1]
    return x
...
if __name__ == "__main__":
    ...
    print("  " + "CNXStem(3→96,4x4)+LN → ConvNeXt3(c=96) → CNXDown(96→192) → ConvNeXt3(c=192) → CNXDown(192→384) → ConvNeXt9(c=384) → CNXDown(384→768) → ConvNeXt3(c=768) → GAP → 768→1000")
    print()
    ...
    print("lr=0.000250  batch_size=" + str(BATCH_SIZE) +
          ...
          "  epochs=" + str(EPOCHS) + "  params=28587592")
