...
def forward(params, x, drop_key=None):
    ...
    x = convnext_block(params, x, 7, dpkeys[1], 0.991429)
    x = convnext_block(params, x, 12, dpkeys[2], 0.982857)
    x = convnext_downsample(params, x, 17)
    x = convnext_block(params, x, 19, dpkeys[3], 0.974286)
    x = convnext_block(params, x, 24, dpkeys[4], 0.965714)
    x = convnext_block(params, x, 29, dpkeys[5], 0.957143)
    x = convnext_downsample(params, x, 34)
    x = convnext_block(params, x, 36, dpkeys[6], 0.948571)
    x = convnext_block(params, x, 41, dpkeys[7], 0.940000)
    x = convnext_block(params, x, 46, dpkeys[8], 0.931429)
    x = convnext_block(params, x, 51, dpkeys[9], 0.922857)
    x = convnext_block(params, x, 56, dpkeys[10], 0.914286)
    x = convnext_block(params, x, 61, dpkeys[11], 0.905714)
    x = convnext_block(params, x, 66, dpkeys[12], 0.897143)
    x = convnext_block(params, x, 71, dpkeys[13], 0.888571)
    x = convnext_block(params, x, 76, dpkeys[14], 0.880000)
    x = convnext_block(params, x, 81, dpkeys[15], 0.871429)
    x = convnext_block(params, x, 86, dpkeys[16], 0.862857)
    x = convnext_block(params, x, 91, dpkeys[17], 0.854286)
    x = convnext_block(params, x, 96, dpkeys[18], 0.845714)
    x = convnext_block(params, x, 101, dpkeys[19], 0.837143)
    x = convnext_block(params, x, 106, dpkeys[20], 0.828571)
    x = convnext_block(params, x, 111, dpkeys[21], 0.820000)
    x = convnext_block(params, x, 116, dpkeys[22], 0.811429)
    x = convnext_block(params, x, 121, dpkeys[23], 0.802857)
    x = convnext_block(params, x, 126, dpkeys[24], 0.794286)
    x = convnext_block(params, x, 131, dpkeys[25], 0.785714)
    x = convnext_block(params, x, 136, dpkeys[26], 0.777143)
    x = convnext_block(params, x, 141, dpkeys[27], 0.768571)
    x = convnext_block(params, x, 146, dpkeys[28], 0.760000)
    x = convnext_block(params, x, 151, dpkeys[29], 0.751429)
    x = convnext_block(params, x, 156, dpkeys[30], 0.742857)
    x = convnext_block(params, x, 161, dpkeys[31], 0.734286)
    x = convnext_block(params, x, 166, dpkeys[32], 0.725714)
    x = convnext_downsample(params, x, 171)
    x = convnext_block(params, x, 173, dpkeys[33], 0.717143)
    x = convnext_block(params, x, 178, dpkeys[34], 0.708571)
    x = convnext_block(params, x, 183, dpkeys[35], 0.700000)
    x = global_avg_pool(x)
...
if __name__ == "__main__":
    ...
    if _trace_f:
        _hdr = {
            ...
            'config': {
                'lr': 0.000250, 'batch_size': 256, 'epochs': 80,
                'use_adam': True,
