...
RUNLOG=/tmp/convnext_t_80ep_6gpu.log                           # full training stdout (current attempt)
MASTER=/tmp/convnext_t_80ep_6gpu_master.log                    # supervisor narration (persists across attempts)
...
echo "[sup] $(date '+%F %T') START 80-epoch ConvNeXt-T bf16 on GPUs $DEVS (6-GPU, post-Gen3)" | tee -a "$MASTER"
