...
XLA/PJRT backend. Companions: `planning/archive/visdrone_detector.md` (the detector itself),
`planning/archive/coco_visdrone_two_stage.md` (what this unblocks, §4b), `planning/archive/xla_pjrt_handoff.md`
...
1. **The blocker was not `Train.lean`.** Threading `mkSession` was necessary but not
   ...
   the specialised ones, and none existed. `planning/archive/xla_pjrt_ladder.md` had this right as
