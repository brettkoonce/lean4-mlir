...
plan; the decision + short gap summary also live in `planning/archive/resnet50_imagenet.md` (RSB-A2 section).
...
* ⚠ **What it voids**: this doc's **76.66% / 93.03%**, and `planning/archive/r34_imagenet.md`'s R34/ImageNet
  **72.1% / 90.7%** (90 ep). Both need re-running before anything is quoted again.
* ⚠ It was found from the *verified* side, not here — `planning/archive/rsb_a3_r50_verified.md` §4b has the
...
## References
- `planning/archive/resnet50_imagenet.md` — RSB-A2 vs SGD-fallback decision + compute estimate + supervisor/eval scaffolding notes.
- `planning/archive/jax_imagenet_sweep.md` — gaps A–D status, per-net faithfulness, subrun selector.
