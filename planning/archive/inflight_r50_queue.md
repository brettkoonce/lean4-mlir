...
| file | state | what |
|---|---|---|
| `planning/archive/imagenet_rerun_sweep.md` | modified | **C6** added to §1, §5.4's re-score advice CORRECTED, new §6 with the re-score results + equality gate |
...
| `planning/archive/inflight_r50_queue.md` | new | this file |
