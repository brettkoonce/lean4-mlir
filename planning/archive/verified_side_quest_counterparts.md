...
▶ Sibling docs, read first: `planning/archive/blueprint_lowerer_pattern.md` (the §5.7 chapter shape, and
why the verified path is the artifact and JAX the oracle) and `planning/archive/chapter_makeover.md` §5
...
`planning/archive/stochastic_depth.md` quotes `_drop_branch` — the per-example one — as *the* reference and
...
✅ **`planning/archive/chapter_makeover.md`'s DP row was stale and is fixed** (`fd9981e`). It said MNv4
