...
- R50 has a deeper writeup in `planning/archive/rsb_a2_resnet50.md` → "FIDELITY LEDGER".
- **Per-net deviation diffs (what exactly differs, and by how much): `planning/archive/recipe_fidelity_diffs.md`** — audited 2026-07-27 from the emitted Python,
...
- Run logistics / supervisors / the older per-net audit: `planning/archive/jax_imagenet_sweep.md`
...
`planning/archive/rsb_a2_resnet50.md`.
