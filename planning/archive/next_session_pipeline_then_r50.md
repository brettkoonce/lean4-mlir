...
## ▶▶ SUPERSEDED FOR §4 — read `planning/archive/next_session_rsb_a3.md` first
...
⚠ Read `planning/archive/rsb_a3_r50_verified.md` for the R50 *architecture* scoping — §1's op-cost
