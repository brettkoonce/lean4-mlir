...
checked. Companions: `planning/archive/mnv4_imagenet.md` (the **JAX reference** side — recipe, timm decode,
the Conv-S/Conv-M distinction), `planning/archive/rsb_a3_r50_verified.md` (the closest precedent: a new
...
* The SGD pair (`mobilenetv2_fwd`, `mobilenetv2_train_step`) is deliberately **untouched** and
  ...
  *(Superseded 2026-09-05: the SGD pair moved to XLA-`SAME` too, via per-example
  ...
  `planning/archive/xla_same_respell_and_blueprint_audit.md` step 0.)*
