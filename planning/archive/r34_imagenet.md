...
detection bootstrap, see `yolo_demo_v3.md` Phase 4, folded into `planning/archive/yolo_final.md` at a0a33a3).
...
- `yolo_demo_v3.md` (folded into `planning/archive/yolo_final.md` at a0a33a3) — the downstream consumer of whatever
