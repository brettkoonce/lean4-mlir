...
then bump blueprint §7.2 / §8.2 / §9.3 + planning/archive/imagenet_sweep.md.**
...
`planning/archive/resnet50_imagenet.md`, near-zero new code). ViT is its own codegen project
(`planning/archive/vit_imagenet.md`, transformer stochastic depth).
...
`planning/archive/resnet50_imagenet.md`.
...
> `planning/archive/paper_faithfulness.md` (fresh hostile audit, code as ground truth, incl. R50 + the
