...
optimizer-as-metric ladder (`planning/archive/math_threads.md` Thread 1; `planning/archive/muon.md` was the first).
...
- `planning/archive/muon.md` (the single-step limit; the NS + diagonalization machinery this reuses),
  `planning/archive/math_threads.md` Thread 1 (the ladder + the jewel derivation).
