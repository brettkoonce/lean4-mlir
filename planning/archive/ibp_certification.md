...
**Where this sits.** The robustness thread (`planning/archive/robustness_ladder.md`, [[robustness-ladder-thread]])
...
margin cert), the forward-fold composition pattern. Companion to `planning/archive/robustness_ladder.md`,
`LeanMlir/Proofs/LipschitzCert.lean`, and `planning/archive/power_iteration_lipschitz.md` (the other deterministic
