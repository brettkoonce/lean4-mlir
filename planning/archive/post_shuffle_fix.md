...
**Written 2026-07-22 for a fresh session.** Prereq: `planning/archive/jax_gradient_oracle.md` §0
...
`train_step_adam_seg` port validation — see `planning/archive/demo_xla_port.md` §4.5.
...
3. **The causal story is void, not just the measurements** — the vanishing-Dice-
   ...
   loss-floor ratio. Each explained an artifact. `planning/archive/brats_demo.md` now
...
`planning/archive/yolo_scoring.md` and `planning/archive/yolo_assignment.md` now open with ⛔ banners marking
