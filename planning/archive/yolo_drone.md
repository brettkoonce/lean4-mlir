...
> Work from **`planning/archive/visdrone_detector.md`** — §0 for what is on disk and which
...
Prerequisite reading: `planning/archive/yolo_final.md` (the existing YOLOv1 path — what
detection infrastructure already exists). Sibling demo: `planning/archive/brats_demo.md`
...
0.90 — see the STOP banner in `planning/archive/brats_demo.md`. The *honesty* precedent
