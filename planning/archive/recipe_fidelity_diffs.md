...
Companion to `planning/archive/paper_faithfulness.md`. That doc is the **scoreboard** (measured
...
**only RSB-A3** are fixed; see `planning/archive/resize_eval_reconciliation.md` §2, which also shows this
