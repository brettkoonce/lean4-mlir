...
(`planning/archive/robustness.md`, `planning/archive/robustness_ladder.md`) from linear/MLP up through CIFAR +
...
> See `planning/archive/robustness_ladder.md` §4.3b for the full table; logs `runs/smooth_{mlp,cnn,cifar}.log`.
...
> hours on conv-weak gfx1100). Next-session entry point. See `planning/archive/robustness_ladder.md` §4;
...
1. **Randomized-smoothing certificate** (`planning/archive/robustness_ladder.md` §3 — the *real* deep-net
...
- `planning/archive/robustness.md` (Thread-4 status log, every rung), `planning/archive/robustness_ladder.md` (the
