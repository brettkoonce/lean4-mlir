...
Companion to `planning/archive/brats_demo.md`, which built the 2D demo and
...
It is not a gap here. `planning/archive/conv3d_spike.mlir` hand-writes the five ops
