...
`planning/archive/imagenette_error_intervals.md` §8.2: the book prints **89.71**; five seeds give
...
`planning/archive/bf16_batchnorm.md` §6). §4.1 now forward-references Chapter 5 for the schedule:
...
Chapter 4's §4.5 was rewritten 2026-09-01 (`planning/archive/bf16_batchnorm.md`) and now ends:
...
`planning/archive/blueprint_lowerer_pattern.md` rule 2: *"'PJRT lowerer' and 'JAX lowerer' survive;
