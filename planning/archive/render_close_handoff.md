...
This continued `planning/archive/verified_train_step.md`. Status as of the session that closed it:
...
live frontier is **MobileNetV2** → see `planning/archive/mobilenetv2_close.md`.
...
- ~~**MobileNetV2** (ch7) — the live frontier.~~ ✅ **FULLY closed (C+A+B+D)**, see
  `planning/archive/mobilenetv2_close.md`. **ResNet-34 too** (`planning/archive/resnet34_close.md`).
