...
> `planning/archive/post_shuffle_fix.md` §1 lists Pets as invalidation item #3.
>
...
> `train_step_adam_seg`. See `planning/archive/brats_demo.md` §3 for the full account.
...
Prerequisite reading: `planning/archive/unet_demo.md` (v1 plan + the
2026-05-05/06 progress log). Companion: `planning/archive/yolo_demo_v2.md`
