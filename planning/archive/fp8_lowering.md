...
## 0.0 ⭐⭐⭐ THE BLOCKING GATE IS OPEN — 2026-08-25, ON XLA. See `planning/archive/cifar_lowprec_stability.md`.
...
- Quant-planning (precision-scaling table, §1c/§3a/§3b/§3c): `planning/archive/floatbridge_quantization.md`
