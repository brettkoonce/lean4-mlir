...
- `planning/archive/r34_imagenet.md` — the R34 ImageNet run (timing/recipe baseline).
- `planning/archive/jax_imagenet_sweep.md` — the convnet sweep + paper-length TODO + gap table.
