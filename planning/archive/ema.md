...
**Written 2026-08-02**, as the peer of `planning/archive/stochastic_depth.md` so the two can be compared
before either is built. `planning/archive/recipe_gaps.md` files EMA as **Tier C**, *"needs a shadow buffer
