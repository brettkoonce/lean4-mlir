...
Scoping how far to chase the phase-3 robustness demo (`planning/archive/robustness.md`: PGD attack via the
...
- In-repo: `LeanMlir/VerifiedTrain.lean` (`attackPgd`/`attackPgdMlp`/`genLinearPgdStep`/`genMlpPgdStep`/
  ...
  the proven `convBack`/`maxPoolBack`/`*_grad_floatBridges` (the deep-net input-VJPs), `planning/archive/robustness.md`.
