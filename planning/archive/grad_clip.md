...
**Written 2026-08-02, before any code.** The v1.4b item of `planning/archive/recipe_gaps.md`, sketched in
`xla_pjrt_handoff.md` §0.2. Same discipline as `planning/archive/ema.md` and `planning/archive/stochastic_depth.md`:
