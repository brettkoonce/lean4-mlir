...
`planning/archive/tier23_float_and_syntactic_faithfulness.md` Part B (B1/B2). Effort medium, risk low. Honest
...
`planning/archive/tier23_float_and_syntactic_faithfulness.md`. **Much smaller than it looks** — `pretty =
