...
[[math-threads-demo-first]] demo-first protocol). Companion to `planning/archive/robustness_ladder.md` and
`planning/archive/muon_ns_convergence.md`. Sequence it before natural gradient (`planning/archive/natural_gradient.md`).
