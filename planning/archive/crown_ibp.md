...
`planning/archive/scorecard_trim.md` §7 says trimming explicitly does not move.
...
* The **LipSDP 16 GB problem** — that is `linarith` over a 256-monomial slack
  ...
  `planning/archive/certs_heavy_psd_memory.md`; still needs the diagonally-dominant
  witnesses.
