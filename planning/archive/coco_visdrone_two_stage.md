...
FPN detector on MS-COCO, fine-tune on VisDrone. Companion to `planning/archive/visdrone_detector.md`
...
* **500 → 12 or 36 *in this configuration* — but the number is coupled to augmentation,
  ...
  train loss halved through epoch 30** (`planning/archive/visdrone_detector.md` §6.1) — this
...
**Augmentation is unrun and is the known-mandatory lever.** `planning/archive/visdrone_detector.md`
