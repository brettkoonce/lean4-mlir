...
Successor to `planning/archive/fp8_lowering.md` (the design) and `planning/archive/cifar_lowprec_stability.md`
...
* `planning/archive/fp8_lowering.md` — the original design; §3's emit table is still the shape.
