...
input-sensitivity, projections, multi-head — see `planning/archive/floatbridge_enet_vit.md`,
...
## 3. Descent, not just closeness — the scientific punchline (§3.5)  ✅ DONE (2026-06-25)  → log: `planning/archive/floatbridge_descent_pass.md` + `planning/archive/floatbridge_descent_cnn.md`
...
+ `planning/archive/floatbridge_descent_cnn.md`).** Pattern = one master theorem (`linear_float_sgd_descends`,
