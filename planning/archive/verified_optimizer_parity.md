...
**Opened 2026-08-14**, out of the timm-fidelity work (`planning/archive/resize_eval_reconciliation.md`,
`planning/archive/recipe_fidelity_diffs.md` D1/D2). Companion to
`planning/archive/next_session_verified_trainer_code.md` §3, which lists the same knobs from the RSB-A2
...
* **`sd`** — stochastic depth, the biggest of the three and the only one with a design question:
  ...
  `planning/archive/stochastic_depth.md` §7b before placing a single site: an all-ones-mask gate is
