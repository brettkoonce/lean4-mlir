...
**76.66% top-1 / 93.03% top-5 @ ep100** (`planning/archive/rsb_a2_resnet50.md`) against paper RSB-A3 78.1%
...
returns nothing. The JAX side has it (`planning/archive/grad_accum.md`, GPU-validated) and **the 76.66%
...
* `planning/archive/rsb_a2_resnet50.md` — the JAX side: phases 1–5, the fidelity ledger, the (now VOID)
...
* `planning/archive/resnet50_imagenet.md` — the original R50 decision + compute estimates.
* `planning/archive/xla_pjrt_handoff.md` §2l — the 1×1 projection, the odd-kernel side condition, and the
...
* `planning/archive/grad_accum.md` — the JAX-side grad accum §3 would need a verified peer of.
