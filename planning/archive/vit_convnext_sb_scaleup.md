...
▶▶ **Sequel: `planning/archive/next_session_verified_trainer_code.md`** — what to BUILD next (the
...
`planning/archive/imagenet_rerun_sweep.md` records for the generated files themselves.
