...
("Side quest: ResNet-50, RSB-A3"). Companion to `planning/archive/recipe_fidelity_diffs.md` C1, which
owns the measurement, and to `planning/archive/a3_paper_fidelity.md` §4b, which owns the timm diffs.
