...
The follow-on to `planning/archive/vit_close.md` (which closed the *render*) and
`planning/archive/verified_train_step.md` (the TCB philosophy). Goal: bring the **verified**
...
proof boundary — same discipline as `planning/archive/verified_train_step.md`'s TCB.
...
| prior context | `planning/archive/vit_close.md`, `planning/archive/verified_vit.md`, `planning/archive/verified_train_step.md` |
