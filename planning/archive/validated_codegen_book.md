...
else there is done). Predecessors: `planning/archive/validation_sweep.md` (the completed book
...
1. Read this + `planning/archive/validation_sweep.md` ("Extending…" section) + `verified_codegen.md`.
