...
linear→CIFAR-BN ladder reached (see `planning/archive/render_close_handoff.md`) — **(a)** the train-step
...
`planning/archive/render_close_handoff.md` §"Validation recipe" (here the swap-train was replaced by an
