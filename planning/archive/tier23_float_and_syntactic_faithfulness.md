...
Reference style/state: `planning/archive/floatbridge_certificate_gaps.md` (the TRUSTED/MEASURED/PROVEN
...
`planning/archive/a3_backward_deepnet_assembly.md`** (per-op backward bridges still needed, per-net
