...
The robustness thread from `planning/archive/math_threads.md` (Thread 4) — the dimension the repo lacks and
...
- **Phase-3 CNN — DONE 2026-06-28: `mnist-cnn-pgd` (the first conv rung,
  `planning/archive/robustness_ladder.md`).** `genCnnPgdStep` emits the full input-VJP to `dx` —
...
- `planning/archive/math_threads.md` Thread 4; in-repo `mlpInputGrad_floatBridges` (the input-VJP the
