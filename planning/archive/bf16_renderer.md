...
4. ⭐⭐⭐ **A bf16 DOT'S RESULT TYPE IS A CORRECTNESS NON-ISSUE AND A ~1.2× PERFORMANCE ISSUE**
   ...
   ~0 % on both nets it was scoped for. ▶ `planning/archive/bf16_dtype_ir.md` is now a record of a
...
`planning/archive/bf16_dtype_ir.md` scoped letting activations STAY bf16 between ops, on the strength of
...
STRONG — corrected 2026-08-25, `planning/archive/bf16_dtype_ir.md` §2.** What forces the f32 boundary is
...
* ⛔⛔ **The boundary converts — SCOPED, THEN CANCELLED BY ITS OWN TEST (§20.3).** Do not start
  `planning/archive/bf16_dtype_ir.md`. ⚠ Its §5.1 gate ("the convert count must FALL") is separately
...
* ⭐⭐ **CIFAR IN bf16 AND fp8 — ✅ SCOPED 2026-08-25 in `planning/archive/cifar_lowprec_stability.md`.**
