...
## Status (2026-09-18, main `046ec333` = origin + the staged row)

**Landed** — about 6.8k lines out, every pinned theorem name and statement unchanged:
...
**Next, in order:**
1. **Other near-clones**, one family per commit, largest first: the head drift/margin family (the four
