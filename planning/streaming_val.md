...
§4.4's smoke passed too (in-run bitmap == score-checkpoint's, trainer RSS 2.4 GiB).
Open: the ViT-e300/ConvNeXt goldens (other box), the pre-spawn point, the eval window on a real run.
