#!/usr/bin/env bash
# 2026-09-25: does 4 × 128 bf16 fit, and at what ms/step? Scratch renders at B=128 (the current
...
ROW='mnv4|mobilenetv4-imagenet-verified|adamdp128|adamdp128bf16|128|SHIM_WORKERS=4'
ROWS="$ROW" NETS=mnv4 PRECS=bf16 ARMS="synth fed" CKPT_TAG=probe-b128 scripts/bf16_probe_3060.sh $R/probe_b128.tsv
