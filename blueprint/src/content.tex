...
which is \texttt{timm}'s figure for \texttt{convnext\_tiny} exactly. So the
listing above is not a description of the network that got trained, it is
the object the renderer consumed.
