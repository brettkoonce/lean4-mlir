...
On one RTX 3060 (CUDA 13.3), from
\texttt{runs/2026-09-01-r34-imagenette-rerun.log}. XLA's startup banner is
removed, the network description line is wrapped, each interval is wrapped onto
an indented continuation, and epochs 5 through 75 are elided:

\begin{verbatim}
[pjrt_ffi] XLA backend: PJRT 0.114, 1 device(s)
[pjrt_ffi] command buffers: enabled (CUDA default)
[pjrt_ffi] compiled verified_mlir/resnet34_adam_train_step.mlir
             (@resnet34_adam_train_step, 405 outputs, 1 replica) in 7248 ms
[pjrt_ffi] compiled verified_mlir/resnet34_fwd.mlir
             (@resnet34_fwd, 1 outputs, 1 replica) in 485 ms
[pjrt_ffi] compiled verified_mlir/resnet34_fwd_eval.mlir
             (@resnet34_fwd_eval, 1 outputs, 1 replica) in 204 ms
...
Epoch 1/80: loss=2.052759 lr=0.000333
  epoch 1: val_acc = 693/3925 = 17.656051%  top5 = 2457/3925 = 62.598726%
    [95% CI 16.49–18.88]
Epoch 2/80: loss=1.532879 lr=0.000667
  epoch 2: val_acc = 1114/3925 = 28.382166%  top5 = 2935/3925 = 74.777070%
    [95% CI 26.99–29.81]
Epoch 3/80: loss=1.371930 lr=0.001000
  epoch 3: val_acc = 1778/3925 = 45.299363%  top5 = 3294/3925 = 83.923567%
    [95% CI 43.75–46.86]
Epoch 4/80: loss=1.297244 lr=0.001000
  epoch 4: val_acc = 1692/3925 = 43.108280%  top5 = 3531/3925 = 89.961783%
    [95% CI 41.57–44.66]
Epoch 76/80: loss=0.502241 lr=0.000007
  epoch 76: val_acc = 3508/3925 = 89.375796%  top5 = 3851/3925 = 98.114650%
    [95% CI 88.37–90.30]
Epoch 79/80: loss=0.502180 lr=0.000000
  epoch 79: val_acc = 3516/3925 = 89.579618%  top5 = 3854/3925 = 98.191083%
    [95% CI 88.58–90.50]
Epoch 80/80: loss=0.502146 lr=0.000000
  epoch 80: val_acc = 3513/3925 = 89.503185%  top5 = 3856/3925 = 98.242038%
    [95% CI 88.51–90.42]
done (trained ResNet-34 adam + cosine/warmup via packed threading).
\end{verbatim}

Eighty epochs at about 60 seconds each, roughly eighty minutes in total, and
\textbf{89.50\%} top-1 with \textbf{98.24\%} top-5 on Imagenette's 3,925-image
validation split. The best epoch reached $89.81\%$.
...
--    Variant, batch and rate are overridable; the defaults are §5.1's.
...
\medskip\noindent \textbf{The schedule.} Chapter~\ref{chap:bn} trains at a constant rate
deliberately --- it changes one thing at a time, and a schedule is one more
thing changing. Annealing the rate to zero on a cosine is worth $4.48$ points, the largest contribution of any knob in the
recipe except augmentation itself, and more than the optimizer, the warmup, the
weight decay and the label smoothing combined. It buys that by taking large
...
\S\ref{sec:r34_runit} has the run: 80 epochs on one RTX 3060, finishing at
\textbf{89.50\%} top-1
and \textbf{98.24\%} top-5 on Imagenette's 3,925-image validation split. That
...
- \textbf{Per-step time is about 200\,ms} at batch 32, 295 steps to the epoch,
