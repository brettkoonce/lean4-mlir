...
One name in this listing is historical residue rather than description.
The session type is called \texttt{IreeSession}, from an earlier backend,
and it is on the list to rename. What the code opens is the XLA shim.
