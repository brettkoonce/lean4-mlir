...
NEU-DET & NEU & Song \& Yan, 2013; He et al., 2020 &
...
PlantVillage & PV & Hughes \& Salath\'e, 2015; Mohanty et al., 2016 &
...
The Verified VJP Proofs suite proves \textbf{67 VJP correctness
theorems}: the 44 contracts and 16 witnesses of the table in \emph{How
this book is organized}, their restatements at fixed dimensions and over
the committed specs, and the two smooth-point forms that global theorems
superseded, each asserting backward \(= \sum_j \pdiv f\,x\,i\,j \cdot dy_j\), on
...
zero project axioms. It runs 52 theorems (the foundation rules,
...
The 52-theorem coverage is illustrative rather than exhaustive, since
