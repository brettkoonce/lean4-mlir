...
the cotangent). Across Chapters 2--10 there are \textbf{34 VJP
correctness theorems}, one citable contract per layer, operator, and
whole-network architecture. The foundation calculus rules,
...
drift from the math. \textbf{Cross-checked} (empirical): because IREE and
...
The Verified VJP Proofs suite proves \textbf{34 VJP correctness
...
architecture definitions in the bestiary, across 12 Lean proof files,
with zero project axioms. Earlier drafts shipped 30
