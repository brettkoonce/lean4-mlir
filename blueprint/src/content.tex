...
\texttt{mobilenetv2FwdGraphB\_full\_faithful}. The tie from the
\texttt{mobilenetv2Verified} layer list to the paper's architecture,
\texttt{mobilenetv2Verified\_denote\_eq} with
\texttt{mobilenetv2Verified\_fwd\_faithful} above it, is still stated at
per-example BatchNorm, the forward of the retired SGD artifact rather than
of this one.
