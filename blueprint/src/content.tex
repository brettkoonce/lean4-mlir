...
9 (ViT)           & 6  & --- & MHSA, block, depth-2 ($\times$2 LN forms), \textbf{every depth $k$} (ViT-Tiny is $k = 12$), \texttt{vit\_full} \\
\hline
...
backward is the derivative, and \texttt{Proofs/Nets/Small/Cifar8Close.lean} carries
