...
Read, build, and verify the proofs without running any training. Covers
everything in Part 1 at the proof level, and depends on neither lowerer ---
the theorems are about the emitted graph, not about anything that executes it.
...
\begin{verbatim}
lake run mnist        # verified MNIST: linear, MLP, CNN            (~10 min)
lake run cifar        # ch.4 cifar8: SGD/momentum/Adam x bn/no-bn   (~1 hr)
lake run imagenette   # the 7 Part-I nets at 224^2, 80-epoch AdamW  (~37 h)
\end{verbatim}
