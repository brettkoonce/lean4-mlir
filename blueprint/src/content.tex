...
\begin{theorem}[Conv2d input VJP]
  ...
  Phase 1 (Apr 2026). No hypotheses: conv2d is affine in its input.
\end{theorem}
...
\begin{theorem}[Conv2d weight VJP]
  ...
  Phase 7: the transpose-trick formula. As with the dense weight
...
\begin{theorem}[Conv2d bias VJP]
  ...
  Phase 9: sum the cotangent over spatial dims per channel.
