...
\end{verbatim}
    ...
    below set it; without it the same run takes 1.3--2$\times$ the wall
    clock and its numerics are unchanged. Use
...
\begin{verbatim}
lake run mnist        # verified MNIST: linear, MLP, CNN             (~2 min)
lake run cifar        # ch.4 cifar8w: SGD/momentum/Adam x bn/no-bn  (~25 min)
