...
redistributable, so the repository ships no fetch script: obtain it from
\nolinkurl{image-net.org} under its terms and point the JAX-bridge
trainers (\texttt{jax/runs/*\_imagenet\_*}) at the local copy.
\normalsize

\section{Demo datasets}
\label{sec:data_demos}

The \texttt{demos/} trainers step past image classification into the
...
the models but the author, not the machine.
