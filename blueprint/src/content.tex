...
\sqstatus{} The only accuracy calibration is this repo's ViT-Ti at $70.28\%$
against DeiT-Ti's $72.2\%$, a $1.9$-point recipe gap
(\S\ref{sec:vit_imagenet}). DeiT quotes $79.8\%$ for S and $81.8\%$ for B;
everything missing from that $1.9$ is \emph{regularization}, and S has four
times Tiny's capacity, so the gap plausibly widens.
