...
the gap attributable to the missing RMSProp optimizer and original
...
wired in the codegen but left off at this validation tier.
...
${<}5\%$ per epoch; RMSProp, the geometric half of RandAugment, and
...
the ReLU a minor variant. With the augmentation pack above still off,
an 80-epoch run lands under the paper's $82.1\%$; the 80 here is the
validation tier of an 80$\to$300 ladder.
...
gap to ConvNeXt-T's $\sim$82\% headline is geometric AutoAugment and
