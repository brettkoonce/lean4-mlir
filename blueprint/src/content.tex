...
(\emph{How to Write a 21\textsuperscript{st} Century Proof}).
...
exactly the facts it follows from; the final step is always \Qed{} ---
the explanation of why the steps prove the goal. In equational chains,
