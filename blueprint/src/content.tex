...
\texttt{convnext-s-imagenet-verified}  & \withheld         & rendered fp32; bf16 owed & \S\ref{sec:convnext_sb} \\
\texttt{convnext-b-imagenet-verified}  & \withheld         & rendered fp32 + bf16; unbenchmarked & \S\ref{sec:convnext_sb} \\
