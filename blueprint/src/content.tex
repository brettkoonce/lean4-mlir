...
is that question being answered. It is a second trusted lowerer,
\texttt{ffi/pjrt\_ffi.c}, implementing the same C surface as the IREE
(phase 3) shim and handing the graph to XLA through the PJRT C API. Nothing above the shim changes --- the
...
GPU & Precision & Per epoch & Epochs & Total & Val top-1 & Val top-5 \\
\hline
2$\times$ 7900 XTX (ROCm) & fp32 & ---           & 30 & ---          & --- & --- \\
4$\times$ 4060 Ti (CUDA)  & fp32 & $\sim$32 min  & 30 & $\sim$16 hr  & --- & --- \\
\hline
\end{tabular}
\end{center}
