...
\hline \\[-6pt]
\texttt{resnet34-imagenet-verified} (2018) & \texttt{r34-default-4gpu} \\
\texttt{resnet50-imagenet-verified}     & \texttt{r50-a3-4gpu} (a3) \\
\texttt{resnet50-imagenet-verified}     & \texttt{r50-2018-4gpu} \\
\texttt{mobilenetv2-imagenet-verified}  & \texttt{mnv2-default-4gpu} \\
\texttt{mobilenetv4-imagenet-verified}         & \withheld \\
\texttt{efficientnet-imagenet-verified} & \texttt{enet-default-4gpu} \\
\texttt{convnext-imagenet-verified}     & \texttt{cnx-default-4gpu} \\
\texttt{vit-imagenet-verified}          & \texttt{vit-default-4gpu} \\
\end{tabular}
\end{center}
