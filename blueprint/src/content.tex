...
\emph{Note:} this image still builds the IREE CPU runtime from source, which
is what makes the first build take $\sim$10 minutes. Subsequent
...
\texttt{mobilenet-v3-train}, \texttt{efficientnet-v2-train} --- also build,
for architectures outside the verified set.)
