...
\hline
\textbf{R34+FPN (this stack)} & \textbf{0.1526} & 0.682 & 0.393 \\
...
\noindent The stack sits at $99.6\%$ of a hand-written PyTorch replica
of \emph{this same architecture}, and runs at 65\,fps on one RTX 4060 Ti.
...
runs from car at $0.573$ down to bicycle at $0.015$ --- a $38\times$
spread. Detection on aerial imagery does not degrade uniformly; it
