...
network, which is what lets the two rows be read against each other: the
difference between them is $\mathbf{+1.31}$ points for A3 ($76.95 \to 78.26$),
...
\S\ref{sec:r50_pjrt} below. It shows the three-part shape ResNet-34 does: a
...
The same recipe on the verified path of \S\ref{sec:r34_pjrt}, unchanged. The
artifact is

\smallskip
{\centering\texttt{resnet50in160\_lambaccdp8x64wxclipbcebf16\_train\_step}\par}
\smallskip

\noindent --- LAMB $\times$ BCE-with-logits $\times$ gradient accumulation
$k=8$, four replicas at per-replica batch 64 for an effective batch of 2048,
train@160 / eval@224.
...
4$\times$ 3060 (bf16)     & RSB-A3 (100 ep) & Ghost-BN (64) & $\sim$13.7 min & $\sim$22.8 hr & $\mathbf{77.98\%}$ & $\mathbf{93.76\%}$ \\
\hline
\end{tabular}
\end{center}

\noindent The first row is the same network on the \emph{2018} recipe --- the
ResNet-34 configuration of \S\ref{sec:r34_pjrt} with the bottleneck backbone
substituted, so the only thing separating it from the A3 row is the recipe. It
runs with:
...
\texttt{shimScript} (\S\ref{sec:r34_pjrt}) is a field on the network rather than
on the recipe, so at $224^2$ the two recipes need two shims and choosing the
wrong one trains the right optimizer on the wrong data. \texttt{scripts/jobs/}
encodes that, and the schedule knobs, as refusing prechecks.

\textbf{How to quote these.} The A3 row lands $0.28$ points behind the JAX
reference above ($78.26\%$ / $93.79\%$) and $0.07$ behind \texttt{timm}'s own
...
\addlegendentry{top-1}
\addplot[orange, mark=*, mark options={fill=orange}] coordinates {
(1,9.58) (2,21.21) (3,36.32) (4,45.89) (5,48.37) (6,54.72) (7,59.19) (8,61.90) (9,67.03) (10,69.04) (11,69.46) (12,72.21) (13,74.33) (14,71.18) (15,75.00) (16,74.56) (17,75.99) (18,77.10) (19,75.91) (20,77.87) (21,73.00) (22,77.06) (23,78.45) (24,76.79) (25,78.24) (26,78.66) (27,77.40) (28,78.45) (29,77.15) (30,79.13) (31,77.95) (32,81.01) (33,79.37) (34,80.47) (35,80.16) (36,80.17) (37,83.34) (38,77.02) (39,83.57) (40,83.41) (41,81.83) (42,82.67) (43,83.01) (44,85.82) (45,84.22) (46,85.20) (47,84.37) (48,85.25) (49,82.72) (50,86.56) (51,84.27) (52,86.73) (53,87.37) (54,87.02) (55,87.64) (56,87.82) (57,87.57) (58,87.74) (59,87.86) (60,88.26) (61,89.59) (62,89.73) (63,89.72) (64,90.02) (65,90.39) (66,90.06) (67,90.03) (68,91.12) (69,90.82) (70,91.46) (71,91.17) (72,91.49) (73,92.08) (74,91.87) (75,92.20) (76,92.30) (77,92.60) (78,92.44) (79,92.50) (80,92.84) (81,92.82) (82,93.04) (83,92.94) (84,93.23) (85,93.21) (86,93.32) (87,93.45) (88,93.42) (89,93.53) (90,93.59) (91,93.66) (92,93.67) (93,93.63) (94,93.68) (95,93.74) (96,93.76) (97,93.76) (98,93.74) (99,93.78) (100,93.76)
};
\addlegendentry{top-5}
\end{axis}
\end{tikzpicture}
...
above so the two can be read against each other. The endpoint is $0.28$ points
below the reference. The curve is also visibly noisy in its middle third ---
epoch~40 sits at $50.4$ against epoch~39's $54.3$ --- which is the LAMB
trust-ratio recipe at effective batch $2048$ under a cosine that has barely
begun to anneal, and it says a mid-training comparison between these panels
carries much less information than their endpoints do.

\medskip\noindent A closer comparison than the endpoints --- the two curves
epoch by epoch, or a paired test over the same $50{,}000$ images --- would need
the reference's per-example output, which this book does not carry.

\medskip\noindent What that gap is \emph{not} evidence of: the two paths
still differ in more than the codegen. The reference normalises BatchNorm over
$512$ and this run over $64$, an eightfold difference in the statistic group
and much the largest known asymmetry between them. Attributing the $0.28$ to
the verified codegen requires closing that first.

\medskip\noindent \textbf{Precision is not one of those differences.} This row
and the reference are both bf16, on the same recipe at the same effective
batch, so the $-0.28$ is not carrying a precision term. The top-5 gap is
$-0.03$ --- three thousandths of a point, or seventeen images out of fifty
thousand.

\medskip\noindent\emph{In, and in the $77.98\%$ above.} What this run
...
\begin{itemize}
  \item Ghost-BN group 64 against the reference's 512; no collective
    ...
    two paths, and \emph{untested}: the $-0.28$ points between them is its
    upper bound only if nothing else contributes. It is the \emph{only} known
...
\noindent \textbf{The two lowerers agree within $0.28$ points of top-1 on both
recipes}, and both agree to within $0.04$ on top-5. That is the claim the grid
...
$+1.31$ points on the JAX lowerer and by $+0.91$ on the verified one. Agreement
...
\medskip\noindent Both columns are internally uniform in precision and in box:
every cell is bf16, the JAX column is four 4060\,Ti and the PJRT column is four
3060. That is what lets the $\Delta$ column be read as a lowerer difference
rather than a lowerer-and-precision one.

\medskip\noindent \textbf{What this is not evidence of.} Each cell is one run
at one seed, and $0.28$ points is inside what seed variance alone produces on
ImageNet --- the agreement is consistent with the lowerers matching, not proof
that they do. Nothing here is a paired test: these are four scalars with
overlapping intervals, and the $95\%$ binomial half-width on $50{,}000$ images
at $77\%$ is $\pm0.37$, wider than every $\Delta$ in the table. The A3 column
trains at $160$ and evaluates at $224$ while the 2018 column does both at
$224$, so the recipe delta confounds resolution with recipe, by A3's own
design. And one non-uniformity does survive: the A3/PJRT cell is the only one
rendered after \texttt{f4e4172} (2026-08-29), which moved $124$ artifacts to
their 4-D pointwise shape and shifted a ResNet-34 Imagenette number by $0.33$
with no reduction axis changed. Measured on A3, that rendering change is worth
$+0.07$ --- inside the $\pm0.37$ --- which is why the other three cells are
quoted as they stand.
...
are now in them.} The ledger \S\ref{sec:r50_pjrt} keeps for A3, before anything
is run:
...
$256$. Section~\ref{sec:r34_pjrt} measured that same fourfold
difference as worth $0.02$ points on ResNet-34 at convergence. The $+0.012$
here is the same order. So the honest claim is that the two paths agree to
