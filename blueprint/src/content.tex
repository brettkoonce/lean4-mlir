...
past image classification into the four other task families in the book,
which are detection, segmentation, language and signal processing, and each
pulls a dataset of its own:
...
M\"uller-Brown density & MB & M\"uller \& Brown, 1979 &
  generated by \texttt{preprocess\_boltzmann.py}, no download &
