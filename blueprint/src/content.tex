...
Chapter~2 cashes its toolkit straight into a proven model --- the
...
where attention first uses them. The chapter then cashes the kit into
its first proven model: the \textbf{4 VJP contracts} of the MNIST
