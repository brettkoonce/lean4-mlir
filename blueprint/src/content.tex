...
just at different token alphabets. Image classification + segmentation
+ diffusion + NLP, all on the same Lean$\to$MLIR$\to$IREE pipeline,
covers most of what people mean by ``modern deep learning.''
