...
\texttt{peak\_memory\_in\_bytes}, against the $11.68$\,GiB the allocator leaves
usable on a $16$\,GB card:

\begin{center}
\begin{tabular}{@{}l l c r r@{}}
\hline
render & precision & BN group & peak & of budget \\
\hline
$8\times64$                  & fp32 & $64$  & $6.23$\,GiB & $53\%$ \\
$8\times64$                  & bf16 & $64$  & $4.32$\,GiB & $37\%$ \\
$8\times64$ + EMA + sd       & fp32 & $64$  & $6.42$\,GiB & $55\%$ \\
$4\times128$ + EMA + sd      & fp32 & $128$ & $11.13$\,GiB & $95\%$ \\
$4\times128$ + EMA + sd      & bf16 & $128$ & $8.09$\,GiB & $69\%$ \\
\hline
\end{tabular}
\end{center}

\noindent The fifth region costs $0.19$\,GiB, all of it arguments. Stochastic
depth costs nothing measurable. And $4\times128$ in fp32 is $95\%$ of the budget,
so that pair ships with no fp32 twin --- \emph{the missing twin is the finding},
since precision and batch-norm group were meant to be independent axes.
