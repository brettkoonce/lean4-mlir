...
by `Proofs/Float/E4M3Fold.lean` (§3b render-tie) and whose accuracy bound is
`Proofs/Float/MlpFloatBridge.lean` (§3c argmax-preservation). The E4M3 quantizer is pure Lean
