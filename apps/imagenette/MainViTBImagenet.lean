...
/-! # `vitb-imagenet-verified` — ViT-**Small** on full ImageNet-1k, verified → XLA
...
single-device default to fall back to. `adamdp32x4wxclipdrop` at 128 per device × 4 = the global
