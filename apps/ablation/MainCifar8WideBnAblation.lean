...
def main (argv : List String) : IO Unit := do
  ...
  cifar8wBnVerified.toNet.trainAdamSched cfg d 0.1 0.9 0.999 0 "sgd" 1.0 1.0
  IO.println "════════ cifar8w-BN (wide head) — Nesterov momentum (μ.9, lr 0.02) ════════"
  cifar8wBnVerified.toNet.trainAdamSched cfg d 0.02 0.9 0.999 0 "mom" 1.0 1.0
  IO.println "════════ cifar8w-BN (wide head) — AdamW (lr 1e-3) ════════"
  cifar8wBnVerified.toNet.trainAdamSched cfg d 0.001 0.9 0.999 0 "adam" 1.0 1.0
