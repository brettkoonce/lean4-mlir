...
def main (argv : List String) : IO Unit := do
  ...
  cifar8wVerified.toNet.trainAdamSchedE4M3 cfg d 0.1 0.9 0.999 3 "sgd"
  IO.println "════════ cifar8w fp8 E4M3 — Nesterov momentum (μ.9, lr 0.02) ════════"
  cifar8wVerified.toNet.trainAdamSchedE4M3 cfg d 0.02 0.9 0.999 3 "mom"
  IO.println "════════ cifar8w fp8 E4M3 — AdamW (lr 1e-3) ════════"
  cifar8wVerified.toNet.trainAdamSchedE4M3 cfg d 0.001 0.9 0.999 3 "adam"
